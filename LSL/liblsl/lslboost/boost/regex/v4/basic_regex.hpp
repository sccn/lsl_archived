...
struct regex_data : public named_subexpressions
{
   ...
   regex_data() 
      : m_ptraits(new ::lslboost::regex_traits_wrapper<traits>()), m_expression(0), m_expression_len(0), m_disable_match_any(false) {}
...
public:
   ...
   lslboost::shared_ptr<BOOST_REGEX_DETAIL_NS::named_subexpressions > get_named_subs()const
   {
      return m_pimpl;
   }
