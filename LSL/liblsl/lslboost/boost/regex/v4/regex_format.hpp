...
struct trivial_format_traits
{
   ...
   {
      return ::lslboost::BOOST_REGEX_DETAIL_NS::global_lower(c);
   }
   static charT toupper(charT c)
   {
      return ::lslboost::BOOST_REGEX_DETAIL_NS::global_upper(c);
   }
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_perl()
{
   ...
   default:
      ...
      {
         std::ptrdiff_t len = ::lslboost::BOOST_REGEX_DETAIL_NS::distance(m_position, m_end);
...
void basic_regex_formatter<OutputIterator, Results, traits, ForwardIter>::format_escape()
{
   ...
   default:
      ...
      else if(v == 0)
      {
         ...
         --m_position;
         len = ::lslboost::BOOST_REGEX_DETAIL_NS::distance(m_position, m_end);
