...
void cpp_regex_traits_char_layer<charT>::init()
{
   ...
   if(cat_name.size() && (this->m_pmessages != 0))
   {
      ...
      if((int)cat < 0)
      {
         ...
         lslboost::BOOST_REGEX_DETAIL_NS::raise_runtime_error(err);
      }
   }
   //
...
public:
   ...
   typedef typename lslboost::make_unsigned<native_mask_type>::type  unsigned_native_mask_type;
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      // Error messages:
      //
      for(lslboost::regex_constants::error_type i = static_cast<lslboost::regex_constants::error_type>(0); 
         i <= lslboost::regex_constants::error_unknown; 
         i = static_cast<lslboost::regex_constants::error_type>(i + 1))
      {
      ...
      static const char_class_type masks[16] = 
      {
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_alnum,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_alpha,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_cntrl,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_digit,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_graph,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_lower,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_print,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_punct,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_space,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_upper,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_blank,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_word,
         ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_upper,
      ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
      ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::lslboost::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_word) && (c == '_'))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_unicode) && ::lslboost::BOOST_REGEX_DETAIL_NS::is_extended(c))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::lslboost::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline lslboost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l)
{
   cpp_regex_traits_base<charT> key(l);
   return ::lslboost::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
public:
   ...
   bool isctype(charT c, char_class_type f) const
   {
      ...
      if((f & mask_base) 
         ...
         && (::lslboost::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v')))
         return true;
   ...
   lslboost::intmax_t toi(const charT*& p1, const charT* p2, int radix)const;
...
private:
   lslboost::shared_ptr<const BOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
template <class charT>
lslboost::intmax_t cpp_regex_traits<charT>::toi(const charT*& first, const charT* last, int radix)const
{
