...
template <class T> struct is_nothrow_move_assignable<T volatile> : public ::lslboost::false_type{};
template <class T> struct is_nothrow_move_assignable<T&> : public ::lslboost::false_type{};
