...
template<> struct is_integral< ::lslboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::lslboost::long_long_type> : public true_type{};
...
template<> struct is_integral<lslboost::int128_type> : public true_type{};
template<> struct is_integral<lslboost::uint128_type> : public true_type{};
#endif
