...
template<class T> struct common_type<T>: lslboost::decay<T>
{
};
...
template<class T1, class T2> using builtin_common_type = typename lslboost::decay<decltype( lslboost::declval<bool>()? lslboost::declval<T1>(): lslboost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( lslboost::declval<bool>()? lslboost::declval<T1>(): lslboost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename lslboost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: lslboost::decay<decltype( lslboost::declval<bool>()? lslboost::declval<T1>(): lslboost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename lslboost::decay<T1>::type, class T2d = typename lslboost::decay<T2>::type> struct common_type_decay_helper: lslboost::common_type<T1d, T2d>
{
};
