...
struct has_nothrow_copy_constructor_imp : public lslboost::integral_constant<bool, false>{};
template <class T>
struct has_nothrow_copy_constructor_imp<T, true> : public lslboost::integral_constant<bool, noexcept(T(lslboost::declval<const T&>()))>{};

}

template <class T> struct has_nothrow_copy_constructor : public detail::has_nothrow_copy_constructor_imp<T, lslboost::is_copy_constructible<T>::value>{};
...
template <class T> struct has_nothrow_copy_constructor : public integral_constant<bool, ::lslboost::has_trivial_copy<T>::value>{};
