...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<lslboost::is_void<From>, lslboost::is_function<To>, lslboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(lslboost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::lslboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::lslboost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static lslboost::type_traits::no_type _m_check(any_conversion ...);
    static lslboost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( lslboost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::lslboost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( lslboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::lslboost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::lslboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::lslboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::lslboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::lslboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::lslboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::lslboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::lslboost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::lslboost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::lslboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::lslboost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::lslboost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::lslboost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::lslboost::is_function<typename ::lslboost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::lslboost::detail::is_convertible_basic_impl<From,To>::value && ! ::lslboost::is_array<To>::value && ! ::lslboost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::lslboost::detail::is_convertible_basic_impl<From, To>::value && !::lslboost::is_array<To>::value && !::lslboost::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::lslboost::is_arithmetic<From>::value, 
      ::lslboost::is_arithmetic<To>::value,
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::lslboost::detail::is_convertible_impl_dispatch<From, To>::value> {};
