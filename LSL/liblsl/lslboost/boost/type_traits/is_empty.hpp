...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::lslboost::detail::empty_helper<cvt,::lslboost::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
template <class T> struct is_empty : integral_constant<bool, ::lslboost::detail::is_empty_impl<T>::value> {};
