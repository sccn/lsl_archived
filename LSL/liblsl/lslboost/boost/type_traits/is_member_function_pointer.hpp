...
template <class T> struct is_member_function_pointer 
   : public ::lslboost::integral_constant<bool, ::lslboost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value>{};
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select< 
      ::lslboost::is_reference<T>::value || ::lslboost::is_array<T>::value>::template result_<T>{};
...
struct is_member_function_pointer
   : public integral_constant<bool, ::lslboost::detail::is_member_function_pointer_impl<T>::value>{};
