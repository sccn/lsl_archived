...
private:
    ...
    typedef typename lslboost::remove_cv<T>::type T2;
    typedef typename lslboost::remove_cv<U>::type U2;

public:

    BOOST_STATIC_CONSTANT( bool, value =
        (lslboost::is_same<T2, U2>::value)
        || lslboost::is_void<T2>::value
        || lslboost::is_void<U2>::value
        || (lslboost::is_base_of<T2, U2>::value)
        || (lslboost::is_base_of<U2, T2>::value) );
};
...
public:
    ...
    typedef typename lslboost::conditional<
        ...
        lslboost::is_same<T2, U2>::value || lslboost::is_void<T2>::value || lslboost::is_base_of<T2, U2>::value,
        typename lslboost::copy_cv<T, U>::type,
        typename lslboost::copy_cv<U, T>::type
...
public:
    ...
    typedef typename lslboost::copy_cv<typename lslboost::copy_cv<typename composite_pointer_type<T2, U2>::type const, T>::type, U>::type type;
};

//Old compilers like MSVC-7.1 have problems using lslboost::conditional in
