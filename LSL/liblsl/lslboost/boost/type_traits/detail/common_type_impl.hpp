...
{
    BOOST_STATIC_CONSTANT( bool, ct = lslboost::is_class<T>::value || lslboost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = lslboost::is_class<U>::value || lslboost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public lslboost::conditional<

    lslboost::is_convertible<T, U>::value && !lslboost::is_convertible<U, T>::value,
    lslboost::type_identity<U>,

    typename lslboost::conditional<

        lslboost::is_convertible<U, T>::value && !lslboost::is_convertible<T, U>::value,
        lslboost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public lslboost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public lslboost::conditional<
    lslboost::is_pointer<T>::value || lslboost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public lslboost::conditional<
    lslboost::is_member_pointer<T>::value || lslboost::is_member_pointer<U>::value,
