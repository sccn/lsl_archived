...
namespace lslboost{
   ...
   namespace detail{
      ...
      struct has_nothrow_destructor_imp : public lslboost::integral_constant<bool, false>{};
      template <class T>
      struct has_nothrow_destructor_imp<T, true> : public lslboost::integral_constant<bool, noexcept(lslboost::declval<T*&>()->~T())>{};

   }

   template <class T> struct has_nothrow_destructor : public detail::has_nothrow_destructor_imp<T, lslboost::is_destructible<T>::value>{};
...
template <class T> struct has_nothrow_destructor : public ::lslboost::has_trivial_destructor<T> {};
