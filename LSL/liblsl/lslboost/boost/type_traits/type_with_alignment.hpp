...
namespace lslboost {
   namespace detail{
      ...
      union max_align
      {
         ...
         lslboost::long_long_type ll;
#endif
#ifdef BOOST_HAS_INT128
         lslboost::int128_type i128;
#endif
         float f;
         double d;
         long double ld;
...
template <std::size_t Target> struct long_double_alignment<Target, false>{ typedef lslboost::detail::max_align type; };

template <std::size_t Target, bool check> struct double_alignment{ typedef double type; };
template <std::size_t Target> struct double_alignment<Target, false>{ typedef typename long_double_alignment<Target, lslboost::alignment_of<long double>::value >= Target>::type type; };

#ifndef BOOST_NO_LONG_LONG
template <std::size_t Target, bool check> struct long_long_alignment{ typedef lslboost::long_long_type type; };
template <std::size_t Target> struct long_long_alignment<Target, false>{ typedef typename double_alignment<Target, lslboost::alignment_of<double>::value >= Target>::type type; };
#endif

template <std::size_t Target, bool check> struct long_alignment{ typedef long type; };
#ifndef BOOST_NO_LONG_LONG
template <std::size_t Target> struct long_alignment<Target, false>{ typedef typename long_long_alignment<Target, lslboost::alignment_of<lslboost::long_long_type>::value >= Target>::type type; };
#else
template <std::size_t Target> struct long_alignment<Target, false>{ typedef typename double_alignment<Target, lslboost::alignment_of<double>::value >= Target>::type type; };
#endif

template <std::size_t Target, bool check> struct int_alignment{ typedef int type; };
template <std::size_t Target> struct int_alignment<Target, false>{ typedef typename long_alignment<Target, lslboost::alignment_of<long>::value >= Target>::type type; };

template <std::size_t Target, bool check> struct short_alignment{ typedef short type; };
template <std::size_t Target> struct short_alignment<Target, false>{ typedef typename int_alignment<Target, lslboost::alignment_of<int>::value >= Target>::type type; };

template <std::size_t Target, bool check> struct char_alignment{ typedef char type; };
template <std::size_t Target> struct char_alignment<Target, false>{ typedef typename short_alignment<Target, lslboost::alignment_of<short>::value >= Target>::type type; };
...
{
   typedef typename lslboost::detail::char_alignment<Align, lslboost::alignment_of<char>::value >= Align>::type type;
};
...
template<> struct is_pod< ::lslboost::tt_align_ns::a2> : public true_type{};
...
{ 
   typedef lslboost::conditional<
      ...
      tt_align_ns::a8,
      lslboost::detail::char_alignment<8, false> >::type t1;
public: 
...
{ 
   typedef lslboost::conditional<
      ...
      tt_align_ns::a16,
      lslboost::detail::char_alignment<16, false> >::type t1;
public: 
   typedef t1::type type;
};
...
{ 
   typedef lslboost::conditional<
      ...
      tt_align_ns::a32,
      lslboost::detail::char_alignment<32, false> >::type t1;
public: 
   typedef t1::type type;
};
template<> struct type_with_alignment<64> {
   typedef lslboost::conditional<
      ...
      tt_align_ns::a64,
      lslboost::detail::char_alignment<64, false> >::type t1;
public: 
   typedef t1::type type;
};
template<> struct type_with_alignment<128> {
   typedef lslboost::conditional<
      ...
      tt_align_ns::a128,
      lslboost::detail::char_alignment<128, false> >::type t1;
public: 
   typedef t1::type type;
};
...
typedef ::lslboost::tt_align_ns::a16 max_align;
