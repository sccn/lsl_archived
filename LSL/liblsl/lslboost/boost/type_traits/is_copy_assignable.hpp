...
// https://connect.microsoft.com/VisualStudio/feedback/details/800328/std-is-copy-constructible-is-broken
    ...
    template <class T1>
    static lslboost::type_traits::no_type test(T1&, typename T1::boost_move_no_copy_constructor_or_assign* = 0);
...
template <class T> struct is_copy_assignable : public integral_constant<bool, ::lslboost::detail::is_copy_assignable_impl<T>::value>{};
