...
private:
    ...
    typedef typename lslboost::conditional<lslboost::is_const<U>::value, typename lslboost::add_const<T>::type, T>::type CT;

public:

    typedef typename lslboost::conditional<lslboost::is_volatile<U>::value, typename lslboost::add_volatile<CT>::type, CT>::type type;
};
