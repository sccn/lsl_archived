...
{
   BOOST_STATIC_CONSTANT(bool, value = (::lslboost::detail::is_unsigned_values<T>::minus_one > ::lslboost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::lslboost::detail::is_unsigned_select_helper< ::lslboost::is_integral<T>::value || ::lslboost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, lslboost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::lslboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::lslboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::lslboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::lslboost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::lslboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::lslboost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::lslboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::lslboost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
