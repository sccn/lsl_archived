...
namespace lslboost{
   ...
   namespace detail{
      ...
      {
          static const bool value = sizeof(is_default_constructible_imp::test<T>(0)) == sizeof(lslboost::type_traits::yes_type);
      };
      template<class T> 
...
#if BOOST_WORKAROUND(BOOST_GCC_VERSION, < 40700)
   template <class T> struct is_default_constructible : public integral_constant<bool, detail::is_default_constructible_abstract_filter<T, lslboost::is_abstract<T>::value>::value>{};
#else
   template <class T> struct is_default_constructible : public integral_constant<bool, sizeof(detail::is_default_constructible_imp::test<T>(0)) == sizeof(lslboost::type_traits::yes_type)>{};
#endif
