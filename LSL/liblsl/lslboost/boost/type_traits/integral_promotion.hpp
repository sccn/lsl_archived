...
{
private:
   typedef lslboost::type_traits::detail::need_promotion<typename remove_cv<T>::type> tag_type;
public:
   typedef typename lslboost::type_traits::detail::integral_promotion<T, tag_type::value>::type type;
};
