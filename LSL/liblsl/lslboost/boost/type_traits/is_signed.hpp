...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::lslboost::detail::is_signed_values<T>::minus_one  > lslboost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::lslboost::detail::is_signed_select_helper< ::lslboost::is_integral<T>::value || ::lslboost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, lslboost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::lslboost::long_long_type> : public true_type{};
template <> struct is_signed<const ::lslboost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::lslboost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::lslboost::long_long_type> : public true_type{};

template <> struct is_signed< ::lslboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::lslboost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::lslboost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::lslboost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
