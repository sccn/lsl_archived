...
#pragma warning(push)
// 'lslboost::atomics::atomic<T>' : multiple assignment operators specified
...
template< typename T, bool IsFunction = lslboost::atomics::detail::is_function< T >::value >
...
template< typename T, bool IsInt = lslboost::atomics::detail::is_integral< T >::value >
struct classify
{
    typedef void type;
};
...
protected:
    ...
    typedef typename lslboost::atomics::detail::conditional< sizeof(value_type) <= sizeof(void*), value_type, value_type const& >::type value_arg_type;
...
protected:
    typedef atomics::detail::operations< storage_size_of< value_type >::value, lslboost::atomics::detail::is_signed< T >::value > operations;
...
typedef atomic< lslboost::ulong_long_type > atomic_ullong;
typedef atomic< lslboost::long_long_type > atomic_llong;
#endif
