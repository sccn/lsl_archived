...
{
    typedef lslboost::uint8_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::int8_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::uint16_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::int16_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::uint32_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::int32_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::uint64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::int64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::uint128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef lslboost::int128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
