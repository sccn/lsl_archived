...
class vec_iterator
{
   ...
   typedef typename lslboost::intrusive::pointer_traits<Pointer>::element_type         value_type;
   typedef typename lslboost::intrusive::pointer_traits<Pointer>::difference_type      difference_type;
   typedef typename if_c
      < IsConst
      , typename lslboost::intrusive::pointer_traits<Pointer>::template
                                 rebind_pointer<const value_type>::type
      , Pointer
      >::type                                                                       pointer;
   typedef typename lslboost::intrusive::pointer_traits<pointer>                       ptr_traits;
   ...
   : public Allocator
{
   ...
   typedef lslboost::container::allocator_traits<Allocator> allocator_traits_type;
   ...
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(lslboost::forward<AllocConvertible>(a)), m_start(), m_size(), m_capacity()
   {}

   //Constructor, does not throw
   template<class AllocConvertible>
   vector_alloc_holder(uninitialized_size_t, BOOST_FWD_REF(AllocConvertible) a, size_type initial_size)
      : Allocator(lslboost::forward<AllocConvertible>(a))
      , m_start()
   ...
   vector_alloc_holder(pointer p, size_type n, BOOST_FWD_REF(AllocFwd) a)
      : Allocator(::lslboost::forward<AllocFwd>(a))
      , m_start(p)
      , m_size()
      , m_capacity(n)
   {}
   ...
   BOOST_CONTAINER_FORCEINLINE pointer allocation_command(lslboost::container::allocation_type command,
   ...
   {
      lslboost::adl_move_swap(this->m_start, x.m_start);
      lslboost::adl_move_swap(this->m_size, x.m_size);
      lslboost::adl_move_swap(this->m_capacity, x.m_capacity);
   }
   ...
   BOOST_CONTAINER_FORCEINLINE pointer priv_allocation_command(version_1, lslboost::container::allocation_type command,
                         size_type ,
   ...
   pointer priv_allocation_command(version_2, lslboost::container::allocation_type command,
   ...
   : public Allocator
{
   ...
   template<class AllocConvertible>
   explicit vector_alloc_holder(BOOST_FWD_REF(AllocConvertible) a) BOOST_NOEXCEPT_OR_NOTHROW
      : Allocator(lslboost::forward<AllocConvertible>(a)), m_size()
   {}
   ...
   {
      ::lslboost::container::uninitialized_move_alloc_n
         (this->alloc(), lslboost::movelib::to_raw_pointer(holder.start()), m_size, lslboost::movelib::to_raw_pointer(this->start()));
   }
      ...
      , m_size(holder.m_size) //Initialize it to m_size as first_allocation can only succeed or abort
   {
      ...
      ::lslboost::container::uninitialized_move_alloc_n
         (this->alloc(), lslboost::movelib::to_raw_pointer(holder.start()), n, lslboost::movelib::to_raw_pointer(this->start()));
   }
   ...
   void priv_deep_swap(vector_alloc_holder<OtherAllocator, OtherAllocatorVersion> &x)
   {
      ...
      value_type *const first_this = lslboost::movelib::to_raw_pointer(this->start());
      value_type *const first_x = lslboost::movelib::to_raw_pointer(x.start());

      if(this->m_size < x.m_size){
         lslboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_this, this->m_size, first_x, x.m_size);
      }
      else{
         lslboost::container::deep_swap_alloc_n<MaxTmpStorage>(this->alloc(), first_x, x.m_size, first_this, this->m_size);
      }
      lslboost::adl_move_swap(this->m_size, x.m_size);
   }
};
...
class vector
{
   ...
   struct value_less
   {
      typedef typename lslboost::container::allocator_traits<Allocator>::value_type value_type;
      bool operator()(const value_type &a, const value_type &b) const
         {  return a < b;  }
   };

   typedef typename container_detail::version<Allocator>::type alloc_version;
   typedef lslboost::container::container_detail::vector_alloc_holder<Allocator> alloc_holder_t;
   ...
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer           pointer;
   typedef typename ::lslboost::container::allocator_traits<Allocator>::const_pointer     const_pointer;
   typedef typename ::lslboost::container::allocator_traits<Allocator>::reference         reference;
   typedef typename ::lslboost::container::allocator_traits<Allocator>::const_reference   const_reference;
   typedef typename ::lslboost::container::allocator_traits<Allocator>::size_type         size_type;
   ...
   BOOST_CONTAINER_FORCEINLINE vector(initial_capacity_t, pointer initial_memory, size_type capacity, BOOST_FWD_REF(AllocFwd) a)
      : m_holder(initial_memory, capacity, ::lslboost::forward<AllocFwd>(a))
   {}
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      lslboost::container::uninitialized_value_init_alloc_n
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      lslboost::container::uninitialized_default_init_alloc_n
         (this->m_holder.alloc(), n, this->priv_raw_begin());
   }
      ...
      :  m_holder(container_detail::uninitialized_size, n)
   {
      ...
      this->num_alloc += n != 0;
      #endif
      lslboost::container::uninitialized_fill_alloc_n
                 ...
                 , x.size())
   {
      ...
      #endif
      ::lslboost::container::uninitialized_copy_alloc_n
   ...
   vector(BOOST_RV_REF(vector) x) BOOST_NOEXCEPT_OR_NOTHROW
      :  m_holder(lslboost::move(x.m_holder))
      ...
      :  m_holder(container_detail::uninitialized_size, a, x.size())
   {
      ...
      this->num_alloc += x.size() != 0;
      #endif
      ::lslboost::container::uninitialized_copy_alloc_n_source
         ( this->m_holder.alloc(), x.priv_raw_begin()
         , x.size(), this->priv_raw_begin());
   }
                 ...
                 )
   {
      if(is_propagable_from(x.get_stored_allocator(), x.m_holder.start(), a, true)){
         ...
         this->num_alloc += n != 0;
         #endif
         ::lslboost::container::uninitialized_move_alloc_n_source
            ( this->m_holder.alloc(), x.priv_raw_begin()
   ...
   {
      lslboost::container::destroy_alloc_n
   ...
   {
      BOOST_ASSERT(&x != this);
      this->priv_move_assign(lslboost::move(x));
      return *this;
   }
      ...
      )
   {
      ...
      if (first == last){
         ...
         const size_type n = static_cast<size_type>(end_pos - lslboost::movelib::iterator_to_raw_pointer(cur));
      ...
      )
   {
      ...
      const size_type input_sz = static_cast<size_type>(lslboost::container::iterator_distance(first, last));
   ...
   BOOST_CONTAINER_FORCEINLINE reference emplace_back(BOOST_FWD_REF(Args)...args)
   {
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct(this->m_holder.alloc(), p, ::lslboost::forward<Args>(args)...);
         ...
         return *this->priv_forward_range_insert_no_capacity
            (this->back_ptr(), 1, type(::lslboost::forward<Args>(args)...), alloc_version());
      }
   }
   ...
   BOOST_CONTAINER_FORCEINLINE bool stable_emplace_back(BOOST_FWD_REF(Args)...args)
   {
      ...
      if (BOOST_LIKELY(is_room_enough)){
         //There is more memory, just construct a new object at the end
         allocator_traits_type::construct(this->m_holder.alloc(), this->priv_raw_end(), ::lslboost::forward<Args>(args)...);
         ++this->m_holder.m_size;
      }
   ...
   iterator emplace(const_iterator position, BOOST_FWD_REF(Args) ...args)
   {
      ...
      return this->priv_forward_range_insert( vector_iterator_get_ptr(position), 1
                                            , type(::lslboost::forward<Args>(args)...));
   }
   ...
   //!
   //! <b>Complexity</b>: Linear to lslboost::container::iterator_distance [first, last).
   template <class InIt>
      ...
      )
   {
      ...
      return this->priv_forward_range_insert(vector_iterator_get_ptr(pos), lslboost::container::iterator_distance(first, last), proxy);
   }
   #endif

   //! <b>Requires</b>: p must be a valid iterator of *this. num, must
   //!   be equal to lslboost::container::iterator_distance(first, last)
   //!
   //! <b>Effects</b>: Insert a copy of the [first, last) range before pos.
   //!
   //! <b>Returns</b>: an iterator to the first inserted element or pos if first == last.
   ...
   //! <b>Complexity</b>: Linear to lslboost::container::iterator_distance [first, last).
   //!
   //! <b>Note</b>: This function avoids a linear operation to calculate lslboost::container::iterator_distance[first, last)
   ...
   iterator insert(const_iterator pos, size_type num, InIt first, InIt last)
   {
      ...
      BOOST_ASSERT(container_detail::is_input_iterator<InIt>::value ||
                   num == static_cast<size_type>(lslboost::container::iterator_distance(first, last)));
      (void)last;
   ...
   iterator erase(const_iterator position)
   {
      ...
      T *const pos_ptr = lslboost::movelib::to_raw_pointer(p);
      T *const beg_ptr = this->priv_raw_begin();
      T *const new_end_ptr = ::lslboost::container::move(pos_ptr + 1, beg_ptr + this->m_holder.m_size, pos_ptr);
   ...
   iterator erase(const_iterator first, const_iterator last)
   {
      ...
      if (first != last){
         ...
         T* const first_ptr = lslboost::movelib::to_raw_pointer(vector_iterator_get_ptr(first));
         T* const last_ptr  = lslboost::movelib::to_raw_pointer(vector_iterator_get_ptr(last));
         T* const ptr = lslboost::movelib::to_raw_pointer(lslboost::container::move(last_ptr, old_end_ptr, first_ptr));
   ...
   {  return x.size() == y.size() && ::lslboost::container::algo_equal(x.begin(), x.end(), y.begin());  }
   ...
   {
      size_type const n = static_cast<size_type>(lslboost::container::iterator_distance(first, last));
      ...
      if(BOOST_LIKELY(s)){
         ...
         if(free_c < n){
            ...
            lslboost::movelib::adaptive_merge(raw_beg, raw_pos, raw_end, comp, raw_end, free_c - n);
            if(UniqueBool::value){
               size_type const count =
                  static_cast<size_type>(raw_end - lslboost::movelib::unique(raw_beg, raw_end, lslboost::movelib::negate<Compare>(comp)));
      ...
      (UniqueBool, FwdIt first, size_type n, Compare comp, pointer new_storage, size_type const new_cap)
   {
      ...
      T* d_first = lslboost::movelib::to_raw_pointer(new_storage);
      size_type added = n;
      //Merge in new buffer loop
      while(1){
         if(!n) {
            ::lslboost::container::uninitialized_move_alloc(this->m_holder.alloc(), pbeg, pend, d_first);
            break;
         } 
         else if(pbeg == pend) {
            ::lslboost::container::uninitialized_move_alloc_n(this->m_holder.alloc(), first, n, d_first);
            break;
         }
         ...
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      lslboost::container::move_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
         ...
         >::type * = 0)
   {
      ...
      //Else do a one by one move
         ...
         this->assign( lslboost::make_move_iterator(lslboost::movelib::iterator_to_raw_pointer(x.begin()))
                     , lslboost::make_move_iterator(lslboost::movelib::iterator_to_raw_pointer(x.end()  ))
                     );
      }
         ...
         < container_detail::is_version<OtherAllocator, 0>::value >::type * = 0)
   {
      ...
      const size_type this_sz  = m_holder.m_size;
      const size_type other_sz = static_cast<size_type>(x.m_holder.m_size);
      lslboost::container::copy_assign_range_alloc_n(this->m_holder.alloc(), other_start, other_sz, this_start, this_sz);
      this->m_holder.m_size = other_sz;
   }
   ...
   void priv_swap(Vector &x, container_detail::false_type)  //version_N
   {
      ...
      if(are_swap_propagable( this->get_stored_allocator(), this->m_holder.start()
         ...
         for(size_type i = 0; i != common_elements; ++i){
            lslboost::adl_move_swap(sml[i], big[i]);
         }
         //... and move-insert the remaining range
         sml.insert( sml.cend()
                   , lslboost::make_move_iterator(lslboost::movelib::iterator_to_raw_pointer(big.nth(common_elements)))
                   , lslboost::make_move_iterator(lslboost::movelib::iterator_to_raw_pointer(big.end()))
                   );
   ...
   container_detail::insert_range_proxy<Allocator, lslboost::move_iterator<T*>, T*> priv_dummy_empty_proxy()
   {
      return container_detail::insert_range_proxy<Allocator, lslboost::move_iterator<T*>, T*>
         (::lslboost::make_move_iterator((T *)0));
   }
   ...
   void priv_reserve_no_capacity(size_type new_cap, version_1)
   {
      ...
      this->priv_forward_range_insert_new_allocation
         ( lslboost::movelib::to_raw_pointer(p), new_cap, this->priv_raw_end(), 0, this->priv_dummy_empty_proxy());
   }
   ...
   void priv_reserve_no_capacity(size_type new_cap, version_2)
   {
      ...
      if(same_buffer_start){
         ...
         T * const new_mem = lslboost::movelib::to_raw_pointer(ret);
   ...
   void priv_destroy_last_n(const size_type n) BOOST_NOEXCEPT_OR_NOTHROW
   {
      ...
      if(!value_traits::trivial_dctr){
         ...
         lslboost::container::destroy_alloc_n(this->get_stored_allocator(), destroy_pos, n);
      }
   ...
   void priv_uninitialized_construct_at_end(InpIt first, InpIt last)
   {
      ...
      T* const new_end_pos = lslboost::container::uninitialized_copy_alloc(this->m_holder.alloc(), first, last, old_end_pos);
   ...
   iterator priv_insert(const const_iterator &p, BOOST_FWD_REF(U) x)
   {
      ...
      return this->priv_forward_range_insert
         ( vector_iterator_get_ptr(p), 1, container_detail::get_insert_value_proxy<T*, Allocator>(::lslboost::forward<U>(x)));
   }
   ...
   void priv_push_back(BOOST_FWD_REF(U) u)
   {
      if (BOOST_LIKELY(this->room_enough())){
         ...
         allocator_traits_type::construct
            ( this->m_holder.alloc(), this->priv_raw_end(), ::lslboost::forward<U>(u) );
         ++this->m_holder.m_size;
      }
      else{
         this->priv_forward_range_insert_no_capacity
            ( this->back_ptr(), 1
            , this->priv_single_insert_proxy(::lslboost::forward<U>(u)), alloc_version());
      }
   }
   ...
   void priv_shrink_to_fit(version_1)
   {
      ...
      if(cp){
         ...
         if(!sz){
            ...
            #endif
            this->priv_forward_range_insert_new_allocation
               ( lslboost::movelib::to_raw_pointer(p), sz
      ...
      (const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy, version_1)
   {
      ...
      T *const raw_pos = lslboost::movelib::to_raw_pointer(pos);

      const size_type new_cap = this->m_holder.next_capacity(n);
      //Pass the hint so that allocators can take advantage of this.
      T * const new_buf = lslboost::movelib::to_raw_pointer
      ...
      (const pointer &pos, const size_type n, const InsertionProxy insert_range_proxy, version_2)
   {
      ...
      if(reuse){
         ...
         //Backwards (and possibly forward) expansion
            ...
            #endif
            this->priv_forward_range_insert_expand_backwards
               (lslboost::movelib::to_raw_pointer(ret), real_cap, raw_pos, n, insert_range_proxy);
         }
      }
      //New buffer
      else{
      ...
      (size_type first_pos, size_type last_pos, size_type limit_pos, size_type shift_count)
   {
      ...
      if((last_pos + shift_count) <= limit_pos){
         //All move assigned
         lslboost::container::move_backward(first_ptr, last_ptr, last_ptr + shift_count);
      }
      //Case B:
      else if((first_pos + shift_count) >= limit_pos){
         //All uninitialized_moved
         ::lslboost::container::uninitialized_move_alloc
      ...
      //Case C:
         ...
         ::lslboost::container::uninitialized_move_alloc(this->m_holder.alloc(), boundary_ptr, last_ptr, limit_ptr);
         //The rest is move assigned
         lslboost::container::move_backward(first_ptr, boundary_ptr, limit_ptr);
      }
      return hole_size;
   }
   ...
   {  return lslboost::movelib::to_raw_pointer(m_holder.start());  }
   ...
   void priv_forward_range_insert_expand_forward(T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if (!elems_after){
         ...
         lslboost::container::move_backward(pos, old_finish - n, old_finish);
         ...
         ::lslboost::container::uninitialized_move_alloc(this->m_holder.alloc(), pos, old_finish, pos + n);
         BOOST_TRY{
         ...
         BOOST_CATCH(...){
            lslboost::container::destroy_alloc_n(this->get_stored_allocator(), pos + n, elems_after);
            BOOST_RETHROW
         }
         BOOST_CATCH_END
      }
      ...
      (T* const new_start, size_type new_cap, T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(old_buffer){
         new_finish = ::lslboost::container::uninitialized_move_alloc
          ...
          T* const pos, const size_type n, InsertionProxy insert_range_proxy)
   {
      ...
      if(s_before >= before_plus_new){
         ...
         T *const new_elem_pos =
            ::lslboost::container::uninitialized_move_alloc(this->m_holder.alloc(), old_start, pos, new_start);
         ...
         //s_before is so big that divides old_end
            ...
            if(!value_traits::trivial_dctr){
               ...
               if(remaining_pos != old_start){  //Make sure data has to be moved
                  ::lslboost::container::move(remaining_pos, old_finish, old_start);
               }
         ...
         if (s_before <= elemsbefore) {
            ...
            T *const next = ::lslboost::container::move(old_start + s_before, pos, old_start);
            ...
            if(!do_after && (n != s_before)){
               ...
               ::lslboost::container::move(pos, old_finish, next + new_1st_range);
            }
         }
         else {
            ...
            T * const new_pos = ::lslboost::container::uninitialized_move_alloc
            ...
            if(do_after){
               ...
               T* const move_end = move_start != pos ? ::lslboost::container::move(pos, old_finish, move_start)
                                                     : old_finish;
               //Destroy remaining moved elements from old_end except if they
               //have trivial destructor after being moved
               size_type n_destroy = s_before - n;
               if(!value_traits::trivial_dctr_after_move)
                  lslboost::container::destroy_alloc_n(this->get_stored_allocator(), move_end, n_destroy);
         ...
         if(do_after){
            ...
            if (elemsafter >= n_after){
               ...
               lslboost::container::move_backward(pos, finish_n, old_finish);
...
struct has_trivial_destructor_after_move<lslboost::container::vector<T, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::lslboost::has_trivial_destructor_after_move<pointer>::value;
};
