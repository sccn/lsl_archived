...
#define BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_BEG namespace lslboost { namespace container { namespace is_contiguous_container_detail {
...
struct is_contiguous_container
{
   static const bool value =
      lslboost::container::is_contiguous_container_detail::
