...
class constant_iterator
  : public ::lslboost::container::iterator
...
struct emplace_functor
{
   ...
   {
      typedef typename lslboost::container::iterator_traits<DestIt>::value_type value_type;
      value_type && tmp= value_type(::lslboost::forward<Args>(container_detail::get<IdxPack>(args_))...);
      *dest = ::lslboost::move(tmp);
   }
...
{\
   ...
   {\
      ...
      *dest = ::lslboost::move(const_cast<value_type &>(BOOST_MOVE_IF(N, tmp, tmp.get())));\
   }\
   \
   BOOST_MOVE_MREF##N\
};\
...
struct iiterator_types
{
   ...
   typedef typename lslboost::container::iterator_traits<IIterator>::pointer         it_pointer;
   typedef typename lslboost::container::iterator_traits<IIterator>::difference_type difference_type;
...
{
   typedef typename ::lslboost::container::iterator
...
using ::lslboost::intrusive::reverse_iterator;
