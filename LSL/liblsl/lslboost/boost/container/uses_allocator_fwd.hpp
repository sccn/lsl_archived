...
//! \file
//!   This header forward declares lslboost::container::constructible_with_allocator_prefix,
//!   lslboost::container::constructible_with_allocator_suffix and
//!   lslboost::container::uses_allocator. Also defines the following types:
