   ...
   ///@endcond
{
   ...
   BOOST_CONTAINER_FORCEINLINE flat_set(BOOST_RV_REF(flat_set) x)
      BOOST_NOEXCEPT_IF(lslboost::container::container_detail::is_nothrow_move_constructible<Compare>::value)
   ...
   BOOST_CONTAINER_FORCEINLINE flat_set& operator=(BOOST_RV_REF(flat_set) x)
      BOOST_NOEXCEPT_IF( (allocator_traits_type::propagate_on_container_move_assignment::value ||
                          allocator_traits_type::is_always_equal::value) &&
                           lslboost::container::container_detail::is_nothrow_move_assignable<Compare>::value)
   ...
   {  return this->base_t::emplace_unique(lslboost::forward<Args>(args)...); }
   ...
   {  return this->base_t::emplace_hint_unique(p, lslboost::forward<Args>(args)...); }
   ...
   //! @copydoc ::lslboost::container::flat_map::merge(flat_map<Key, T, C2, Allocator>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_set<Key, C2, Allocator>& source)
   {  this->base_t::merge_unique(source.tree());   }

   //! @copydoc ::lslboost::container::flat_set::merge(flat_set<Key, C2, Allocator>&)
   template<class C2>
   ...
   //! @copydoc ::lslboost::container::flat_map::merge(flat_multimap<Key, T, C2, Allocator>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_multiset<Key, C2, Allocator>& source)
   {  this->base_t::merge_unique(source.tree());   }

   //! @copydoc ::lslboost::container::flat_set::merge(flat_multiset<Key, C2, Allocator>&)
   template<class C2>
   ...
   void swap(flat_set& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && lslboost::container::container_detail::is_nothrow_swappable<Compare>::value );
   ...
   {  this->base_t::adopt_sequence_unique(lslboost::move(seq));  }
   ...
   {  this->base_t::adopt_sequence_unique(ordered_unique_range_t(), lslboost::move(seq));  }

   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   template<class KeyType>
   BOOST_CONTAINER_FORCEINLINE std::pair<iterator, bool> priv_insert(BOOST_FWD_REF(KeyType) x)
   {  return this->base_t::insert_unique(::lslboost::forward<KeyType>(x));  }

   template<class KeyType>
   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return this->base_t::insert_unique(p, ::lslboost::forward<KeyType>(x)); }
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
};
...
template <class Key, class Compare, class Allocator>
struct has_trivial_destructor_after_move<lslboost::container::flat_set<Key, Compare, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ...
                             ::lslboost::has_trivial_destructor_after_move<Compare>::value;
};
   ...
   ///@endcond
{
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set()
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(const Compare&)
   BOOST_CONTAINER_FORCEINLINE explicit flat_multiset(const Compare& comp)
      : base_t(comp)
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE explicit flat_multiset(const allocator_type& a)
      : base_t(a)
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(const Compare&, const allocator_type&)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(const Compare& comp, const allocator_type& a)
      : base_t(comp, a)
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(InputIterator, InputIterator)
   template <class InputIterator>
   BOOST_CONTAINER_FORCEINLINE flat_multiset(InputIterator first, InputIterator last)
      : base_t(false, first, last)
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(InputIterator, InputIterator, const allocator_type&)
   template <class InputIterator>
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(InputIterator, InputIterator, const Compare& comp)
   template <class InputIterator>
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(InputIterator, InputIterator, const Compare& comp, const allocator_type&)
   template <class InputIterator>
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::lslboost::container::flat_set::flat_set(std::initializer_list<value_type)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(std::initializer_list<value_type> il)
      : base_t(false, il.begin(), il.end())
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(std::initializer_list<value_type>, const allocator_type&)
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(std::initializer_list<value_type>, const Compare& comp)
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(const flat_set &)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(const flat_multiset& x)
      : base_t(static_cast<const base_t&>(x))
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(flat_set &&)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(BOOST_RV_REF(flat_multiset) x)
      BOOST_NOEXCEPT_IF(lslboost::container::container_detail::is_nothrow_move_constructible<Compare>::value)
      : base_t(lslboost::move(static_cast<base_t&>(x)))
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(const flat_set &, const allocator_type &)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(const flat_multiset& x, const allocator_type &a)
      : base_t(static_cast<const base_t&>(x), a)
   {}

   //! @copydoc ::lslboost::container::flat_set::flat_set(flat_set &&, const allocator_type &)
   BOOST_CONTAINER_FORCEINLINE flat_multiset(BOOST_RV_REF(flat_multiset) x, const allocator_type &a)
      : base_t(BOOST_MOVE_BASE(base_t, x), a)
   {}

   //! @copydoc ::lslboost::container::flat_set::operator=(const flat_set &)
   ...
   //! @copydoc ::lslboost::container::flat_set::operator=(flat_set &&)
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::lslboost::container::flat_set::operator=(std::initializer_list<value_type>)
   ...
   //! @copydoc ::lslboost::container::flat_set::get_allocator()
   allocator_type get_allocator() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::begin()
   iterator begin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::begin() const
   const_iterator begin() const;

   //! @copydoc ::lslboost::container::flat_set::cbegin() const
   const_iterator cbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::end()
   iterator end() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::end() const
   const_iterator end() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::cend() const
   const_iterator cend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::rbegin()
   reverse_iterator rbegin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::rbegin() const
   const_reverse_iterator rbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::crbegin() const
   const_reverse_iterator crbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::rend()
   reverse_iterator rend() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::rend() const
   const_reverse_iterator rend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::crend() const
   const_reverse_iterator crend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::empty() const
   bool empty() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::size() const
   size_type size() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::max_size() const
   size_type max_size() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::capacity() const
   size_type capacity() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::reserve(size_type)
   void reserve(size_type cnt);

   //! @copydoc ::lslboost::container::flat_set::shrink_to_fit()
   void shrink_to_fit();
   ...
   {  return this->base_t::emplace_equal(lslboost::forward<Args>(args)...); }
   ...
   template <class... Args>
   BOOST_CONTAINER_FORCEINLINE iterator emplace_hint(const_iterator p, BOOST_FWD_REF(Args)... args)
   {  return this->base_t::emplace_hint_equal(p, lslboost::forward<Args>(args)...); }
   ...
   //! @copydoc ::lslboost::container::flat_multimap::merge(flat_multimap<Key, T, C2, Allocator>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_multiset<Key, C2, Allocator>& source)
   {  this->base_t::merge_equal(source.tree());   }

   //! @copydoc ::lslboost::container::flat_multiset::merge(flat_multiset<Key, C2, Allocator>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG flat_multiset<Key, C2, Allocator> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_multiset<Key, C2, Allocator>&>(source));   }

   //! @copydoc ::lslboost::container::flat_multimap::merge(flat_map<Key, T, C2, Allocator>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(flat_set<Key, C2, Allocator>& source)
   {  this->base_t::merge_equal(source.tree());   }

   //! @copydoc ::lslboost::container::flat_multiset::merge(flat_set<Key, C2, Allocator>&)
   template<class C2>
   BOOST_CONTAINER_FORCEINLINE void merge(BOOST_RV_REF_BEG flat_set<Key, C2, Allocator> BOOST_RV_REF_END source)
   {  return this->merge(static_cast<flat_set<Key, C2, Allocator>&>(source));   }
   ...
   //! @copydoc ::lslboost::container::flat_set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::lslboost::container::flat_set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::lslboost::container::flat_set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);

   //! @copydoc ::lslboost::container::flat_set::swap
   void swap(flat_multiset& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && lslboost::container::container_detail::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::lslboost::container::flat_set::clear
   void clear() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::lslboost::container::flat_set::value_comp
   value_compare value_comp() const;

   //! @copydoc ::lslboost::container::flat_set::find(const key_type& )
   iterator find(const key_type& x);

   //! @copydoc ::lslboost::container::flat_set::find(const key_type& ) const
   const_iterator find(const key_type& x) const;

   //! @copydoc ::lslboost::container::flat_set::nth(size_type)
   iterator nth(size_type n) BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::nth(size_type) const
   const_iterator nth(size_type n) const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::index_of(iterator)
   size_type index_of(iterator p) BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::index_of(const_iterator) const
   size_type index_of(const_iterator p) const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::flat_set::count(const key_type& ) const
   size_type count(const key_type& x) const;

   //! @copydoc ::lslboost::container::flat_set::lower_bound(const key_type& )
   iterator lower_bound(const key_type& x);

   //! @copydoc ::lslboost::container::flat_set::lower_bound(const key_type& ) const
   const_iterator lower_bound(const key_type& x) const;

   //! @copydoc ::lslboost::container::flat_set::upper_bound(const key_type& )
   iterator upper_bound(const key_type& x);

   //! @copydoc ::lslboost::container::flat_set::upper_bound(const key_type& ) const
   const_iterator upper_bound(const key_type& x) const;

   //! @copydoc ::lslboost::container::flat_set::equal_range(const key_type& ) const
   std::pair<const_iterator, const_iterator> equal_range(const key_type& x) const;

   //! @copydoc ::lslboost::container::flat_set::equal_range(const key_type& )
   ...
   //! <b>Throws</b>: If the comparison or the move constructor throws
   BOOST_CONTAINER_FORCEINLINE void adopt_sequence(BOOST_RV_REF(sequence_type) seq)
   {  this->base_t::adopt_sequence_equal(lslboost::move(seq));  }
   ...
   {  this->base_t::adopt_sequence_equal(ordered_range_t(), lslboost::move(seq));  }

   #ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
   private:
   template <class KeyType>
   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(BOOST_FWD_REF(KeyType) x)
   {  return this->base_t::insert_equal(::lslboost::forward<KeyType>(x));  }

   template <class KeyType>
   BOOST_CONTAINER_FORCEINLINE iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return this->base_t::insert_equal(p, ::lslboost::forward<KeyType>(x)); }
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
};
...
//!specialization for optimizations
template <class Key, class Compare, class Allocator>
struct has_trivial_destructor_after_move<lslboost::container::flat_multiset<Key, Compare, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::lslboost::has_trivial_destructor_after_move<pointer>::value &&
