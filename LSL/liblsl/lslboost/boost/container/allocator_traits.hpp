...
struct allocator_traits
{
   ...
   {  return a;  }
      ...
      {  ::new((void*)p, boost_container_new_t()) T(::lslboost::forward<Args>(args)...); }
   #else // #if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
      public:
   ...
   template<class T>
   BOOST_CONTAINER_FORCEINLINE static void priv_construct(container_detail::false_type, Allocator &, T *p, const ::lslboost::container::default_init_t&)
