...
// MinGW64 gcc 4.8.2 fails to compile function declarations with lslboost::winapi::VOID_ arguments even though
...
typedef lslboost::uint64_t ULONG64_;
typedef ULONG64_ * PULONG64_;

typedef lslboost::int64_t LONGLONG_;
typedef lslboost::uint64_t ULONGLONG_;
