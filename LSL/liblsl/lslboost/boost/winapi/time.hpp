...
BOOST_SYMBOL_IMPORT lslboost::winapi::VOID_ WINAPI
...
BOOST_SYMBOL_IMPORT lslboost::winapi::ULONGLONG_ WINAPI
...
{
    lslboost::winapi::SYSTEMTIME_ st;
    lslboost::winapi::GetSystemTime(&st);
    lslboost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
