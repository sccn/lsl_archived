...
FormatMessageA(
    ...
    lslboost::winapi::DWORD_ dwMessageId,
    lslboost::winapi::DWORD_ dwLanguageId,
    lslboost::winapi::LPSTR_ lpBuffer,
...
FormatMessageW(
    ...
    lslboost::winapi::DWORD_ dwMessageId,
    lslboost::winapi::DWORD_ dwLanguageId,
    lslboost::winapi::LPWSTR_ lpBuffer,
    lslboost::winapi::DWORD_ nSize,
    va_list *Arguments);

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_SYMBOL_IMPORT lslboost::winapi::UINT_ WINAPI
