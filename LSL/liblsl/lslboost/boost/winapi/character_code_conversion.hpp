...
MultiByteToWideChar(
    ...
    lslboost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
...
WideCharToMultiByte(
    lslboost::winapi::UINT_ CodePage,
    lslboost::winapi::DWORD_ dwFlags,
    lslboost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    lslboost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    lslboost::winapi::LPCSTR_ lpDefaultChar,
    lslboost::winapi::LPBOOL_ lpUsedDefaultChar);
