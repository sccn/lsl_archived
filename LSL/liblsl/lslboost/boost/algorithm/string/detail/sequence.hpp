...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::lslboost::algorithm::detail::insert( Input, At, ::lslboost::begin(Insert), ::lslboost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::lslboost::algorithm::detail::replace( Input, From, To, ::lslboost::begin(Insert), ::lslboost::end(Insert) );
                }
                else
                {
                    ::lslboost::algorithm::detail::insert( Input, From, ::lslboost::begin(Insert), ::lslboost::end(Insert) );
                }
            }
