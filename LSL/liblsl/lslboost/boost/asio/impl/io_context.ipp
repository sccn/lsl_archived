...
{
  lslboost::asio::detail::scoped_ptr<impl_type> scoped_impl(impl);
  lslboost::asio::add_service<impl_type>(*this, scoped_impl.get());
...
io_context::count_type io_context::run(lslboost::system::error_code& ec)
{
  return impl_.run(ec);
}
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::run_one(lslboost::system::error_code& ec)
{
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll(lslboost::system::error_code& ec)
{
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll_one(lslboost::system::error_code& ec)
{
...
io_context::service::service(lslboost::asio::io_context& owner)
