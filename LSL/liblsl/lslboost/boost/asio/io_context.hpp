 ...
 *
 * To submit functions to the io_context, use the @ref lslboost::asio::dispatch,
 * @ref lslboost::asio::post or @ref lslboost::asio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * lslboost::asio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * lslboost::asio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * lslboost::asio::executor_work_guard<io_context::executor_type>:
 *
 * @code lslboost::asio::io_context io_context;
 * lslboost::asio::executor_work_guard<lslboost::asio::io_context::executor_type>
 *   = lslboost::asio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   * without blocking.
   */
  BOOST_ASIO_DECL count_type run(lslboost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  BOOST_ASIO_DECL count_type run_one(lslboost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL count_type poll(lslboost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL count_type poll_one(lslboost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
  ...
  /// (Deprecated: Use lslboost::asio::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use lslboost::asio::post().) Request the io_context to invoke
  ...
  /// (Deprecated: Use lslboost::asio::bind_executor().) Create a new handler that
   ...
   * @code io_context.dispatch(lslboost::bind(f, a1, ... an)); @endcode
   */
...
public:
   ...
   */
  explicit work(lslboost::asio::io_context& io_context);
...
protected:
   ...
   */
  BOOST_ASIO_DECL service(lslboost::asio::io_context& owner);
...
class service_base
  : public lslboost::asio::io_context::service
{
public:
  static lslboost::asio::detail::service_id<Type> id;

  // Constructor.
  service_base(lslboost::asio::io_context& io_context)
    : lslboost::asio::io_context::service(io_context)
  {
  }
};
