...
public:
  ...
  BOOST_ASIO_DECL scheduler(lslboost::asio::execution_context& ctx,
  ...
  BOOST_ASIO_DECL std::size_t wait_one(
      long usec, lslboost::system::error_code& ec);
...
private:
  ...
  BOOST_ASIO_DECL std::size_t do_wait_one(mutex::scoped_lock& lock,
      thread_info& this_thread, long usec, const lslboost::system::error_code& ec);
