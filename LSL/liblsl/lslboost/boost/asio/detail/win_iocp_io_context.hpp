...
public:
  ...
  BOOST_ASIO_DECL win_iocp_io_context(lslboost::asio::execution_context& ctx,
  ...
  BOOST_ASIO_DECL size_t wait_one(long usec, lslboost::system::error_code& ec);
...
private:
  ...
  // either 0 or 1).
  BOOST_ASIO_DECL size_t do_one(DWORD msec, lslboost::system::error_code& ec);
