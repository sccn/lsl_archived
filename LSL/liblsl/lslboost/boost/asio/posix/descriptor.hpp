...
#define BOOST_ASIO_SVC_T lslboost::asio::detail::reactive_descriptor_service
...
public:
   ...
   * descriptor.
   */
  explicit descriptor(lslboost::asio::io_context& io_context)
   ...
   */
  descriptor(lslboost::asio::io_context& io_context,
   ...
   * lslboost::asio::error::operation_aborted error.
   *
   ...
   * the function indicates an error, the underlying descriptor is closed.
   */
  BOOST_ASIO_SYNC_OP_VOID close(lslboost::system::error_code& ec)
  {
    this->get_service().close(this->get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the lslboost::asio::error::operation_aborted error.
   *
   * @throws lslboost::system::system_error Thrown on failure.
   */
  void cancel()
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID cancel(lslboost::system::error_code& ec)
  {
    this->get_service().cancel(this->get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * lslboost::asio::posix::descriptor_base::bytes_readable @n
   * lslboost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * lslboost::asio::posix::stream_descriptor descriptor(io_context);
   * ...
   * lslboost::asio::posix::stream_descriptor::bytes_readable command;
   ...
   * lslboost::asio::posix::stream_descriptor descriptor(io_context);
   * ...
   * descriptor.wait(lslboost::asio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * lslboost::system::error_code ec;
   * descriptor.wait(lslboost::asio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
  BOOST_ASIO_SYNC_OP_VOID wait(wait_type w, lslboost::system::error_code& ec)
  {
    this->get_service().wait(this->get_implementation(), w, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * @par Example
   * @code
   * void wait_handler(const lslboost::system::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Wait succeeded.
   ...
   *     lslboost::asio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   */
