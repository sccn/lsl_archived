...
#define BOOST_ASIO_SVC_T lslboost::asio::detail::win_iocp_handle_service
...
public:
   ...
   */
  explicit overlapped_handle(lslboost::asio::io_context& io_context)
   ...
   */
  overlapped_handle(lslboost::asio::io_context& io_context,
