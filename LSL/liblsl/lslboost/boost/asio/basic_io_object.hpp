...
protected:
   ...
   */
  explicit basic_io_object(lslboost::asio::io_service& io_service)
    : service(lslboost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(lslboost::asio::io_service& io_service)
    : service_(&lslboost::asio::use_service<IoObjectService>(io_service))
  {
  ...
  basic_io_object(IoObjectService1& other_service,
      typename IoObjectService1::implementation_type& other_implementation)
    : service_(&lslboost::asio::use_service<IoObjectService>(
