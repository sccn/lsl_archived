...
{
    static lslboost::core::typeinfo ti_;
...
template<class T> lslboost::core::typeinfo core_typeid_< T >::ti_ = core_typeid_< T >::name();
#else
template<class T> lslboost::core::typeinfo core_typeid_< T >::ti_(core_typeid_< T >::name());
#endif
...
#define BOOST_CORE_TYPEID(T) (lslboost::detail::core_typeid_<T>::ti_)
