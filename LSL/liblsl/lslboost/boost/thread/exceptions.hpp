...
namespace lslboost
{
    ...
    public:
        lock_error()
        : base_type(0, "lslboost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "lslboost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::resource_unavailable_try_again), "lslboost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "lslboost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::invalid_argument), "lslboost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "lslboost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(static_cast<int>(system::errc::invalid_argument), "lslboost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "lslboost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::permission_denied), "lslboost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "lslboost::thread_permission_error")
          {
          }
