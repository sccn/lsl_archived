...
//            {}
        ...
        template<typename F>
        class thread_data<lslboost::reference_wrapper<F> >:
            public detail::thread_data_base
        {
        private:
            F& f;
        public:
            BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(lslboost::reference_wrapper<F> f_):
                f(f_)
            {}
            void run()
            {
        ...
        template<typename F>
        class thread_data<const lslboost::reference_wrapper<F> >:
            public detail::thread_data_base
        {
        private:
            F& f;
        public:
            BOOST_THREAD_NO_COPYABLE(thread_data)
            thread_data(const lslboost::reference_wrapper<F> f_):
                f(f_)
            {}
            void run()
            {
...
namespace thread_detail {
    ...
    private:
        ...
        static inline detail::thread_data_ptr make_thread_info(BOOST_THREAD_RV_REF(F) f, BOOST_THREAD_RV_REF(ArgTypes)... args)
        {
            return detail::thread_data_ptr(detail::heap_new<
                  detail::thread_data<typename lslboost::remove_reference<F>::type, ArgTypes...>
                  >(
                    lslboost::forward<F>(f), lslboost::forward<ArgTypes>(args)...
                  )
                );
        }
#else
        ...
        {
            return detail::thread_data_ptr(detail::heap_new<detail::thread_data<typename lslboost::remove_reference<F>::type> >(
                lslboost::forward<F>(f)));
        }
#endif
        static inline detail::thread_data_ptr make_thread_info(void (*f)())
        {
            return detail::thread_data_ptr(detail::heap_new<detail::thread_data<void(*)()> >(
                lslboost::forward<void(*)()>(f)));
        }
#else
        template<typename F>
    ...
    public:
        ...
        //, typename disable_if<is_same<typename decay<F>::type, thread>, dummy* >::type=0
          ...
          thread_info(make_thread_info(thread_detail::decay_copy(lslboost::forward<F>(f))))
        {
            start_thread();
        }
        template <
        ...
        thread_info(make_thread_info(lslboost::move<F>(f))) // todo : Add forward
#else
        ...
        thread(F&& f, Arg&& arg, Args&&... args) :
          thread_info(make_thread_info(
              ...
              thread_detail::decay_copy(lslboost::forward<Arg>(arg)),
              thread_detail::decay_copy(lslboost::forward<Args>(args))...)
          )
        ...
        thread(F f,A1 a1,typename disable_if<lslboost::thread_detail::is_convertible<F&,thread_attributes >, dummy* >::type=0):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1)))
        {
            start_thread();
        }
        template <class F,class A1,class A2>
        thread(F f,A1 a1,A2 a2):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3,a4)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3,a4,a5)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3,a4,a5,a6)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7,a8)))
        {
            start_thread();
        }
        ...
        thread(F f,A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8,A9 a9):
            thread_info(make_thread_info(lslboost::bind(lslboost::type<void>(),f,a1,a2,a3,a4,a5,a6,a7,a8,a9)))
        {
            start_thread();
        }
#endif
  ...
  std::basic_ostream<charT, traits>&
    ...
    void thread::join() {
        if (this_thread::get_id() == get_id())
          lslboost::throw_exception(thread_resource_error(static_cast<int>(system::errc::resource_deadlock_would_occur), "boost thread: trying joining itself"));
    ...
    {
        template<typename F>
        void lslboostat_thread_exit(F f)
        {
