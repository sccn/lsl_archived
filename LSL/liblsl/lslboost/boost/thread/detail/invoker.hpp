...
namespace lslboost
{
  namespace detail
  {
    ...
    private:
      ...
      {
        return detail::invoke(lslboost::move(csbl::get<0>(f_)), lslboost::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return detail::invoke<R>(lslboost::move(csbl::get<0>(f_)), lslboost::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    public: \
      ...
      \
      result_type operator()() { \
        return detail::invoke(lslboost::move(fp_) \
