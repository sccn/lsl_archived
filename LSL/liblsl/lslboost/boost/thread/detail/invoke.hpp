...
#define BOOST_THREAD_PROVIDES_INVOKE
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(Args) ...args)
        -> decltype((lslboost::forward<A0>(a0).*f)(lslboost::forward<Args>(args)...))
    {
        return (lslboost::forward<A0>(a0).*f)(lslboost::forward<Args>(args)...);
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0)
        -> decltype(lslboost::forward<A0>(a0).*f)
    {
        return lslboost::forward<A0>(a0).*f;
    }
    ...
    -> decltype(lslboost::forward<Fp>(f)(lslboost::forward<Args>(args)...))
    {
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1)
        -> decltype((lslboost::forward<A0>(a0).*f)(lslboost::forward<A1>(a1)))
    {
        return (lslboost::forward<A0>(a0).*f)(lslboost::forward<A1>(a1));
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
        -> decltype((lslboost::forward<A0>(a0).*f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2)))
    {
        return (lslboost::forward<A0>(a0).*f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2));
    }
    ...
    -> decltype(lslboost::forward<Fp>(f)())
    {
    ...
    -> decltype(lslboost::forward<Fp>(f)(lslboost::forward<A1>(a1)))
    {
    ...
    -> decltype(lslboost::forward<Fp>(f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2)))
    {
    ...
    -> decltype(lslboost::forward<Fp>(f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2), lslboost::forward<A3>(a3)))
    {
    ...
    {
      return std::bind(lslboost::forward<Fp>(f), lslboost::forward<A1>(a1))();
    }
    ...
    {
      return std::bind(lslboost::forward<Fp>(f), lslboost::forward<A1>(a1), lslboost::forward<A2>(a2))();
    }
    ...
    {
      return std::bind(lslboost::forward<Fp>(f), lslboost::forward<A1>(a1), lslboost::forward<A2>(a2), lslboost::forward<A3>(a3))();
    }
...
//    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), lslboost::forward<Args>(args)...);
    }
#else // BOOST_NO_CXX11_VARIADIC_TEMPLATES
    // bullet 1
    // (t1.*f)(t2, ..., tN) when f is a pointer to a member function of a class T and t1 is an object of
    ...
    {
        return (a0.*f)(lslboost::forward<A1>(a1));
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
    ...
    {
        return (a0.*f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2));
    }
    template <class Ret, class A, class A0, class A1, class A2>
    inline
    typename enable_if_c
    ...
    {
        return (a0.*f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2), lslboost::forward<A3>(a3));
    }
    template <class Ret, class A, class A0, class A1, class A2, class A3>
    inline
    typename enable_if_c
...
///
    ...
    {
        return (lslboost::forward<A0>(a0).*f)(lslboost::forward<A1>(a1), lslboost::forward<A2>(a2), lslboost::forward<A3>(a3));
    }
    template <class Ret, class A, class A0, class A1, class A2, class A3>
    inline
    typename enable_if_c
...
///
    ...
    {
      return ((*lslboost::forward<A0>(a0)).*f)(a1);
    }
    template <class Ret, class A, class A0, class A1>
    inline
    typename enable_if_c
...
//    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f));
    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), lslboost::forward<A1>(a1));
    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), lslboost::forward<A1>(a1), lslboost::forward<A2>(a2));
    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), lslboost::forward<A1>(a1), lslboost::forward<A2>(a2), lslboost::forward<A3>(a3));
    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), a1);
    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), a1, a2);
    }
    ...
    {
      return lslboost::detail::do_invoke<Ret>(lslboost::is_pointer<Fp>(), lslboost::forward<Fp>(f), a1, a2, a3);
    }
