...
namespace lslboost
{
  ...
  {
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::lslboost::future_errc> : public true_type {};

    #ifdef BOOST_NO_CXX11_SCOPED_ENUMS
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::lslboost::future_errc::enum_type> : public true_type { };
    #endif
  } // system
  ...
  namespace system
  {
    ...
    {
        return error_condition(underlying_cast<int>(e), lslboost::future_category());
    }
  } // system
} // boost
