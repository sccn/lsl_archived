  ...
  namespace detail {
    ...
    //private: // used by lslboost::thread::try_join_until
            ...
            struct timespec const &timeout)
        {
            ...
            struct timespec ts = lslboost::detail::timespec_now_realtime();
            ...
            return do_wait_until(lock, lslboost::detail::timespec_plus(timeout, ts));
#else
            // old behavior was fine for monotonic
            return do_wait_until(lock, lslboost::detail::timespec_plus(timeout, lslboost::detail::timespec_now_realtime()));
#endif
        }
...
#endif
                lslboost::throw_exception(thread_resource_error(res, "lslboost::condition_variable::condition_variable() constructor failed in detail::monotonic_pthread_cond_init"));
            }
        }
        ~condition_variable()
        {
