...
//#endif
    ...
    namespace this_thread
    {
        ...
        {
            return lslboost::this_thread::hidden::sleep_for(lslboost::detail::to_timespec(ns));
        }
#endif
        ...
        namespace no_interruption_point
        {
          ...
          void BOOST_SYMBOL_VISIBLE sleep_for(const chrono::nanoseconds& ns)
          {
              return lslboost::this_thread::no_interruption_point::hidden::sleep_for(lslboost::detail::to_timespec(ns));
          }
    #endif
    #endif // BOOST_THREAD_USES_CHRONO
