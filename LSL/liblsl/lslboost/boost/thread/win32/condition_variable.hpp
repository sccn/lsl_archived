...
namespace lslboost
{
    namespace detail
    {
        ...
        public:
            ...
            static bool no_waiters(lslboost::intrusive_ptr<basic_cv_list_entry> const& entry)
            {
        ...
        class basic_condition_variable
        {
            ...
            typedef lslboost::intrusive_ptr<list_entry> entry_ptr;
            ...
            {
                lslboost::lock_guard<lslboost::mutex> lk(internal_mutex);
                if(!wake_sem)
                {
            ...
            struct entry_manager
            {
                ...
                entry_manager(entry_ptr&& entry_, lslboost::mutex& mutex_):
