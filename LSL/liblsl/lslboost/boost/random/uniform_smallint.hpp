...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        ...
        return generate(eng, lslboost::random::traits::is_integral<base_result>());
    }
...
private:
    ...
    result_type generate(Engine& eng, lslboost::mpl::true_) const
    {
        ...
        typedef typename Engine::result_type base_result;
        typedef typename lslboost::random::traits::make_unsigned<base_result>::type base_unsigned;
        typedef typename lslboost::random::traits::make_unsigned_or_unbounded<result_type>::type range_type;
#ifdef BOOST_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS
    ...
    {
        typedef typename Engine::result_type base_result;
        typedef typename lslboost::random::traits::make_unsigned<result_type>::type range_type;
        range_type range = random::detail::subtract<result_type>()(_max, _min);
