...
public:
    ...
    { return max_imp(lslboost::is_integral<UIntType>()); }
...
private:
    ...
    /// \cond show_private
    typedef typename lslboost::random::traits::make_unsigned<base_result_type>::type base_unsigned;

    static UIntType max_imp(const lslboost::true_type&)
    {
       return lslboost::low_bits_mask_t<w>::sig_bits;
    }
    static UIntType max_imp(const lslboost::false_type&)
    {
