...
BOOST_SYMBOL_IMPORT lslboost::detail::winapi::VOID_ WINAPI
...
BOOST_SYMBOL_IMPORT lslboost::detail::winapi::ULONGLONG_ WINAPI
...
{
    lslboost::detail::winapi::SYSTEMTIME_ st;
    lslboost::detail::winapi::GetSystemTime(&st);
    lslboost::detail::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
