...
MultiByteToWideChar(
    lslboost::detail::winapi::UINT_ CodePage,
    lslboost::detail::winapi::DWORD_ dwFlags,
    lslboost::detail::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    lslboost::detail::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    lslboost::detail::winapi::UINT_ CodePage,
    lslboost::detail::winapi::DWORD_ dwFlags,
    lslboost::detail::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    lslboost::detail::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    lslboost::detail::winapi::LPCSTR_ lpDefaultChar,
    lslboost::detail::winapi::LPBOOL_ lpUsedDefaultChar);
