...
BOOST_SYMBOL_IMPORT lslboost::detail::winapi::DWORD_ WINAPI
FormatMessageA(
    lslboost::detail::winapi::DWORD_ dwFlags,
    lslboost::detail::winapi::LPCVOID_ lpSource,
    lslboost::detail::winapi::DWORD_ dwMessageId,
    lslboost::detail::winapi::DWORD_ dwLanguageId,
    lslboost::detail::winapi::LPSTR_ lpBuffer,
    lslboost::detail::winapi::DWORD_ nSize,
    va_list *Arguments);
#endif
...
FormatMessageW(
    ...
    lslboost::detail::winapi::DWORD_ dwMessageId,
    lslboost::detail::winapi::DWORD_ dwLanguageId,
    lslboost::detail::winapi::LPWSTR_ lpBuffer,
    lslboost::detail::winapi::DWORD_ nSize,
    va_list *Arguments);

BOOST_SYMBOL_IMPORT lslboost::detail::winapi::UINT_ WINAPI
SetErrorMode(lslboost::detail::winapi::UINT_ uMode);
}
#endif
