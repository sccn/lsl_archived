...
BOOST_SYMBOL_IMPORT lslboost::detail::winapi::BOOL_ WINAPI
CryptEnumProvidersA(
    lslboost::detail::winapi::DWORD_ dwIndex,
    lslboost::detail::winapi::DWORD_ *pdwReserved,
    lslboost::detail::winapi::DWORD_ dwFlags,
    lslboost::detail::winapi::DWORD_ *pdwProvType,
    lslboost::detail::winapi::LPSTR_ szProvName,
    lslboost::detail::winapi::DWORD_ *pcbProvName);
#else
...
CryptEnumProvidersA(
    ...
    lslboost::detail::winapi::DWORD_ dwFlags,
    lslboost::detail::winapi::DWORD_ *pdwProvType,
    lslboost::detail::winapi::LPWSTR_ szProvName,
    lslboost::detail::winapi::DWORD_ *pcbProvName);
#endif

BOOST_SYMBOL_IMPORT lslboost::detail::winapi::BOOL_ WINAPI
CryptAcquireContextA(
    lslboost::detail::winapi::HCRYPTPROV_ *phProv,
    lslboost::detail::winapi::LPCSTR_ pszContainer,
    lslboost::detail::winapi::LPCSTR_ pszProvider,
    lslboost::detail::winapi::DWORD_ dwProvType,
    lslboost::detail::winapi::DWORD_ dwFlags);
...
CryptAcquireContextW(
    lslboost::detail::winapi::HCRYPTPROV_ *phProv,
    lslboost::detail::winapi::LPCWSTR_ szContainer,
    lslboost::detail::winapi::LPCWSTR_ szProvider,
    lslboost::detail::winapi::DWORD_ dwProvType,
    lslboost::detail::winapi::DWORD_ dwFlags);

BOOST_SYMBOL_IMPORT lslboost::detail::winapi::BOOL_ WINAPI
CryptGenRandom(
    lslboost::detail::winapi::HCRYPTPROV_ hProv,
    lslboost::detail::winapi::DWORD_ dwLen,
    lslboost::detail::winapi::BYTE_ *pbBuffer);
...
CryptReleaseContext(
    lslboost::detail::winapi::HCRYPTPROV_ hProv,
    lslboost::detail::winapi::ULONG_PTR_ dwFlags);
#else
BOOST_SYMBOL_IMPORT lslboost::detail::winapi::BOOL_ WINAPI
CryptReleaseContext(
    lslboost::detail::winapi::HCRYPTPROV_ hProv,
