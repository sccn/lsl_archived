...
namespace lslboost { namespace property_tree
{
    ...
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::const_iterator : public lslboost::iterator_adaptor<
    ...
    class basic_ptree<K, D, C>::reverse_iterator
        : public lslboost::reverse_iterator<iterator>
    {
    public:
        reverse_iterator() {}
        explicit reverse_iterator(iterator b)
            : lslboost::reverse_iterator<iterator>(b)
        {}
    };
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::const_reverse_iterator
        : public lslboost::reverse_iterator<const_iterator>
    {
    public:
        const_reverse_iterator() {}
        explicit const_reverse_iterator(const_iterator b)
            : lslboost::reverse_iterator<const_iterator>(b)
        {}
        const_reverse_iterator(
    ...
    class basic_ptree<K, D, C>::assoc_iterator
        : public lslboost::iterator_adaptor<assoc_iterator,
                                         typename subs::by_name_index::iterator,
                                         value_type>
    {
        friend class lslboost::iterator_core_access;
        typedef lslboost::iterator_adaptor<assoc_iterator,
                                         typename subs::by_name_index::iterator,
                                         value_type>
            baset;
    public:
    ...
    class basic_ptree<K, D, C>::const_assoc_iterator
        : public lslboost::iterator_adaptor<const_assoc_iterator,
    ...
    {
        lslboost::swap(m_data, rhs.m_data);
    ...
    {
        if(lslboost::optional<Type> o = get_value_optional<Type>(tr)) {
            return *o;
        }
