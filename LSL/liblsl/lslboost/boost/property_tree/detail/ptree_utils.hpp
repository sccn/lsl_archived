...
namespace lslboost { namespace property_tree { namespace detail
{
    ...
    struct is_character : public lslboost::false_type {};
    template <>
    struct is_character<char> : public lslboost::true_type {};
    template <>
    struct is_character<wchar_t> : public lslboost::true_type {};


    BOOST_MPL_HAS_XXX_TRAIT_DEF(internal_type)
    BOOST_MPL_HAS_XXX_TRAIT_DEF(external_type)
    template <typename T>
    struct is_translator : public lslboost::mpl::and_<
