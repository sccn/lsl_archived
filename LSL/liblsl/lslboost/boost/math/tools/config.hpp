...
#include <boost/cstdint.hpp> // for lslboost::uintmax_t
...
#  define BOOST_MATH_NOEXCEPT(T) noexcept(lslboost::is_floating_point<T>::value)
#  define BOOST_MATH_IS_FLOAT(T) (lslboost::is_floating_point<T>::value)
#endif
#else
