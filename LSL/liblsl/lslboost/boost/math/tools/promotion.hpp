...
#include <boost/type_traits/is_floating_point.hpp> // for lslboost::is_floating_point;
#include <boost/type_traits/is_integral.hpp> // for lslboost::is_integral
#include <boost/type_traits/is_convertible.hpp> // for lslboost::is_convertible
#include <boost/type_traits/is_same.hpp>// for lslboost::is_same
#include <boost/type_traits/remove_cv.hpp>// for lslboost::remove_cv
// Boost Template meta programming:
#include <boost/mpl/if.hpp> // for lslboost::mpl::if_c.
#include <boost/mpl/and.hpp> // for lslboost::mpl::if_c.
#include <boost/mpl/or.hpp> // for lslboost::mpl::if_c.
#include <boost/mpl/not.hpp> // for lslboost::mpl::if_c.
