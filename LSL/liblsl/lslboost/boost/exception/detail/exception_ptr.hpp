...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( lslboost::exception const * e2 = get_boost_exception(&e1) )
        ...
        inline
        exception_ptr
        current_exception_unknown_boost_exception( lslboost::exception const & e )
            {
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( lslboost::exception const * be = get_boost_exception(&e) )
