...
#define BOOST_MOVE_CATCH_CONST(U)  \
   typename ::lslboost::move_detail::if_< ::lslboost::move_detail::is_class<U>, BOOST_CATCH_CONST_RLVALUE(U), const U &>::type
#define BOOST_MOVE_CATCH_RVALUE(U)\
   typename ::lslboost::move_detail::if_< ::lslboost::move_detail::is_class<U>, BOOST_RV_REF(U), ::lslboost::move_detail::nat>::type
...
////////////////////////////////////////
   ...
   struct boost_move_conversion_aware_catch_1
      : public ::lslboost::move_detail::enable_if_and
                        < RETURN_VALUE
                        , ::lslboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>
                        , ::lslboost::move_detail::is_class<TYPE>
   ...
   struct boost_move_conversion_aware_catch_2
      : public ::lslboost::move_detail::disable_if_or
                        < RETURN_VALUE
                        , ::lslboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM> 
                        , ::lslboost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>
                        , ::lslboost::move_detail::and_
                                    < ::lslboost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>
                                    , ::lslboost::move_detail::is_class<BOOST_MOVE_TEMPL_PARAM>
                                    >
                        >
   {};
   ...
   //
      ...
      #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
         ...
         BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u,\
            typename boost_move_conversion_aware_catch_1< ::lslboost::move_detail::nat, BOOST_MOVE_TEMPL_PARAM, TYPE>::type* = 0)\
         { return FWD_FUNCTION(u); }\
         \
         template<class BOOST_MOVE_TEMPL_PARAM>\
         BOOST_MOVE_FORCEINLINE RETURN_VALUE PUB_FUNCTION(const BOOST_MOVE_TEMPL_PARAM &u,\
            typename boost_move_conversion_aware_catch_2< ::lslboost::move_detail::nat, BOOST_MOVE_TEMPL_PARAM, TYPE>::type* = 0)\
         {\
            TYPE t((u));\
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION)\
      ...
      \
      template<class BOOST_MOVE_TEMPL_PARAM>\
      BOOST_MOVE_FORCEINLINE typename ::lslboost::move_detail::enable_if_c\
...
////////////////////////////////////////
   ...
   struct boost_move_conversion_aware_catch_1arg_1
      : public ::lslboost::move_detail::enable_if_and
                        < RETURN_VALUE
                        , ::lslboost::move_detail::not_< ::lslboost::move_detail::is_same_or_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO> >
                        , ::lslboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>
                        , ::lslboost::has_move_emulation_disabled<BOOST_MOVE_TEMPL_PARAM>
                        >
   {};
   ...
   struct boost_move_conversion_aware_catch_1arg_2
      : public ::lslboost::move_detail::disable_if_or
                        < RETURN_VALUE
                        , ::lslboost::move_detail::is_same_or_convertible< BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO>
                        , ::lslboost::move_detail::is_rv_impl<BOOST_MOVE_TEMPL_PARAM>
                        , ::lslboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM>
                        >
   {};
   ...
   #define BOOST_MOVE_CONVERSION_AWARE_CATCH_1ARG(PUB_FUNCTION, TYPE, RETURN_VALUE, FWD_FUNCTION, ARG1, UNLESS_CONVERTIBLE_TO)\
      ...
      \
      template<class BOOST_MOVE_TEMPL_PARAM>\
      BOOST_MOVE_FORCEINLINE typename ::lslboost::move_detail::disable_if_or\
                        < RETURN_VALUE \
                        , ::lslboost::move_detail::is_same<TYPE, BOOST_MOVE_TEMPL_PARAM> \
                        , ::lslboost::move_detail::is_same_or_convertible<BOOST_MOVE_TEMPL_PARAM, UNLESS_CONVERTIBLE_TO> \
                        >::type\
