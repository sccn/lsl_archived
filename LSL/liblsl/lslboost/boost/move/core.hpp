...
// @endcond
   ...
   class rv
      : public ::lslboost::move_detail::if_c
         < ::lslboost::move_detail::is_class<T>::value
         , T
         , ::lslboost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::lslboost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::lslboost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::lslboost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };
   ...
   BOOST_MOVE_FORCEINLINE typename ::lslboost::move_detail::enable_if_c
      <  ::lslboost::move_detail::is_lvalue_reference<Ret>::value ||
        !::lslboost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::lslboost::move_detail::enable_if_c
      < !::lslboost::move_detail::is_lvalue_reference<Ret>::value &&
         ::lslboost::has_move_emulation_enabled<T>::value
      , ::lslboost::rv<T>&>::type
         move_return(::lslboost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      lslboost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::lslboost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::lslboost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::lslboost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::lslboost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::lslboost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   //!cast to the base type before calling `::lslboost::move()` due to rvalue reference limitations.
   //!
