...
namespace lslboost {
    namespace detail
    {
        ...
        // We workaround that by making `is_booststring` trait, instead of specializing `is_stdstring` for `lslboost::container::basic_string`.
        template<typename T>
        ...
        template<typename CharT, typename Traits, typename Alloc>
        struct is_booststring< lslboost::container::basic_string<CharT, Traits, Alloc> >
            : lslboost::true_type
        {};
        ...
        // Sun Studio has problem with partial specialization of templates differing only in namespace.
        // We workaround that by making `is_char_array_to_booststring` trait, instead of specializing `is_char_array_to_stdstring` for `lslboost::container::basic_string`.
        template<typename Target, typename Source>
        ...
        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_booststring< lslboost::container::basic_string<CharT, Traits, Alloc>, CharT* >
            : lslboost::true_type
        {};

        template<typename CharT, typename Traits, typename Alloc>
        struct is_char_array_to_booststring< lslboost::container::basic_string<CharT, Traits, Alloc>, const CharT* >
            : lslboost::true_type
        {};
...
// fixed in 2013 RTM).
    ...
    namespace conversion { namespace detail {
        ...
        inline bool try_lexical_convert(const Source& arg, Target& result)
        {
            ...
            typedef lslboost::mpl::bool_<
                ...
                (
                     ...
                     (lslboost::detail::is_stdstring<Target >::value || lslboost::detail::is_booststring<Target >::value)
                ) ||
                (
                     lslboost::is_same<Target, src >::value &&
                     lslboost::detail::is_character<Target >::value
            ...
            typedef lslboost::detail::is_arithmetic_and_not_xchars<Target, src >
        ...
        inline bool try_lexical_convert(const CharacterT* chars, std::size_t count, Target& result)
        {
            BOOST_STATIC_ASSERT_MSG(
                lslboost::detail::is_character<CharacterT>::value,
                "This overload of try_lexical_convert is meant to be used only with arrays of characters."
            );
            return ::lslboost::conversion::detail::try_lexical_convert(
                ::lslboost::iterator_range<const CharacterT*>(chars, chars + count), result
            );
        }
    ...
    namespace conversion {
        // ADL barrier
        using ::lslboost::conversion::detail::try_lexical_convert;
    }
