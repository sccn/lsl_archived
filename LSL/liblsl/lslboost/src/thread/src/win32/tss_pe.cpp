...
namespace lslboost
{
    void lslboosttss_cleanup_implemented() {}
}
...
namespace {
    void NTAPI on_tls_callback(void* , DWORD dwReason, PVOID )
    {
        ...
        {
            lslboost::lslbooston_thread_exit();
            break;
        }
        }
    }
...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = lslboost::lslbooston_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = lslboost::lslbooston_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = lslboost::lslbooston_process_exit;
...
#pragma warning(pop)
        ...
        {
            //Schedule lslbooston_thread_exit() to be called for the main
            ...
            atexit(lslboost::lslbooston_thread_exit);

            //Call Boost process entry callback here

            lslboost::lslbooston_process_enter();
        ...
        {
            lslboost::lslbooston_process_exit();
            return INIRETSUCCESS;
        }
...
namespace lslboost
{
    void lslboosttss_cleanup_implemented()
    {
        ...
        lslboosttss_cleanup_implemented() function to eliminate the linker's
