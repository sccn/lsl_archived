...
namespace lslboost { namespace program_options {
    ...
    parse(lslboost::any& value_store, 
    ...
    void 
    untyped_value::xparse(lslboost::any& value_store,
                          const std::vector<std::string>& new_tokens) const
    {
        ...
        if (new_tokens.size() > 1)
            lslboost::throw_exception(multiple_values());
    ...
    */
                       ...
                       bool*, int)
    {
        ...
        if (s.empty() || s == "on" || s == "yes" || s == "1" || s == "true")
            ...
            lslboost::throw_exception(invalid_bool_value(s));
    }
    ...
    void validate(any& v, const vector<wstring>& xs, bool*, int)
    {
        ...
        if (s.empty() || s == L"on" || s == L"yes" || s == L"1" || s == L"true")
            ...
            lslboost::throw_exception(invalid_bool_value(convert_value(s)));
    }
#endif
    BOOST_PROGRAM_OPTIONS_DECL 
    ...
    namespace validators {
        ...
        BOOST_PROGRAM_OPTIONS_DECL 
        void check_first_occurrence(const lslboost::any& value)
        {
            if (!value.empty())
                lslboost::throw_exception(
                    multiple_occurrences());
