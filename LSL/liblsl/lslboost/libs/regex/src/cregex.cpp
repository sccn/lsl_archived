 ...
 */
  ...
  *   DESCRIPTION: Implements high level class lslboost::RexEx
  */
...
typedef lslboost::match_flag_type match_flag_type;
#include <cstdio>
...
{
   lslboost::uint_fast32_t f = icase ? regex::normal | regex::icase : regex::normal;
