 ...
 */
  ...
  *   DESCRIPTION: Misc lslboost::regbase member funnctions.
  */
...
regex_error::regex_error(regex_constants::error_type err) 
   : std::runtime_error(::lslboost::BOOST_REGEX_DETAIL_NS::get_default_error_string(err))
   , m_error_code(err)
   , m_position(0) 
{
}
...
// error checking API:
//
BOOST_REGEX_DECL void BOOST_REGEX_CALL verify_options(lslboost::regex::flag_type /*ef*/, match_flag_type mf)
{
