   ...
   namespace {
                                      ...
                                      bool short_ignore_case) const
    {
        ...
        if (full_matches.size() > 1) 
            lslboost::throw_exception(ambiguous_option(full_matches));
        ...
        if (full_matches.empty() && approximate_matches.size() > 1)
            lslboost::throw_exception(ambiguous_option(approximate_matches));
        ...
        */
        ...
        {                    
            ...
            else
            {
                ...
                {
                    lslboost::throw_exception(program_options::error(
                                ...
                                unsigned line_length)
        {
            ...
            // lslboost::tokenizer, not typedef.
            typedef lslboost::tokenizer<lslboost::char_separator<char> > tok;
          
            tok paragraphs(
                desc,
                char_separator<char>("\n", "", lslboost::keep_empty_tokens));
