...
#include BOOST_PATH(/archive/basic_binary_iprimitive.hpp)
#include BOOST_PATH(/archive/basic_binary_iarchive.hpp)
...
// funny polymorphics
#if BOOST_VERSION < 103500
#include BOOST_PATH(/archive/detail/polymorphic_iarchive_impl.hpp)
#define POLYMORPHIC(T) boost::archive::detail::polymorphic_iarchive_impl<T>

#elif BOOST_VERSION < 103600
#include BOOST_PATH(/archive/detail/polymorphic_iarchive_dispatch.hpp)
#define POLYMORPHIC(T) boost::archive::detail::polymorphic_iarchive_dispatch<T>

#else
#include BOOST_PATH(/archive/detail/polymorphic_iarchive_route.hpp)
...
#include BOOST_PATH(/type_traits/is_unsigned.hpp)
...
#include BOOST_PATH(/archive/impl/basic_binary_iarchive.ipp)
#include BOOST_PATH(/archive/impl/basic_binary_iprimitive.ipp)

#if BOOST_VERSION < 104000
#include BOOST_PATH(/archive/impl/archive_pointer_iserializer.ipp)
