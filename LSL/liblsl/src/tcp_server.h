...
namespace lsl {
	...
	*/
	...
	public:
		...
		*/
		tcp_server(const stream_info_impl_p &info, const io_service_p &io, const send_buffer_p &sendbuf, tcp protocol, int chunk_size);
	...
	private:
		...
		*/
		...
		private:
			...
			void handle_read_feedparams(error_code err);
			...
			eos::portable_oarchive outarch_;	// output archive (wrapped around the feed buffer)
