...
#include <lslboost/algorithm/string/split.hpp>
    ...
    #   endif
      ...
      namespace hiden
      {
        void BOOST_THREAD_DECL sleep_for(const timespec& ts)
        {
            ...
            {
              lslboost::this_thread::no_interruption_point::hiden::sleep_for(ts);
            }
        }
        ...
        void BOOST_THREAD_DECL sleep_until(const timespec& ts)
        {
            ...
            {
              lslboost::this_thread::no_interruption_point::hiden::sleep_until(ts);
            }
        }
      } // hiden
    } // this_thread
