...
//               lslboost::detail::iterator_traits_. Some progress made on fixes
...
//               lslboost::iterator and which redefine difference_type.
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_mutable_iterator,T,::lslboost::detail::is_mutable_iterator_impl<T>::value)
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_full_iterator_traits,T,::lslboost::detail::is_full_iterator_traits_impl<T>::value)
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    is_stlport_40_debug_iterator,T,::lslboost::detail::is_stlport_40_debug_iterator_impl<T>::value)
...
} // namespace lslboost::detail::iterator_traits_
...
distance(Iterator first, Iterator last)
{
    ...
    typedef typename ::lslboost::detail::iterator_traits<Iterator>::iterator_category iterator_category;
