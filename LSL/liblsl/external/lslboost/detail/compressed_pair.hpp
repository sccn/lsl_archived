...
namespace details
{
   ...
   public:
      ...
      void swap(::lslboost::compressed_pair<T1, T2>& y)
      {
   ...
   class compressed_pair_imp<T1, T2, 1>
      : protected ::lslboost::remove_cv<T1>::type
   {
   public:
      typedef T1                                                 first_type;
      typedef T2                                                 second_type;
   ...
   class compressed_pair_imp<T1, T2, 2>
      : protected ::lslboost::remove_cv<T2>::type
   {
   public:
      typedef T1                                                 first_type;
      typedef T2                                                 second_type;
   ...
   public:
      ...
      void swap(::lslboost::compressed_pair<T1,T2>&) {}
   };
...
public:
   ...
   void swap(::lslboost::compressed_pair<T,T>& y) { base::swap(y); }
};
