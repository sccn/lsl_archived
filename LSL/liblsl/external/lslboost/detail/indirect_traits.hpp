...
#   include <lslboost/detail/is_function_ref_tester.hpp>
#  endif 
...
using namespace lslboost::detail::is_function_ref_tester_;
...
struct is_reference_to_function_aux
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(detail::is_function_ref_tester(t,0)) == sizeof(::lslboost::type_traits::yes_type));
...
struct is_pointer_to_function_aux
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, value
        = sizeof(::lslboost::type_traits::is_function_ptr_tester(t)) == sizeof(::lslboost::type_traits::yes_type));
    typedef mpl::bool_<value> type;
};
...
}} // namespace lslboost::python::detail
