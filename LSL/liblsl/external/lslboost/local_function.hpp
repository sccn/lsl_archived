...
#include <lslboost/local_function/aux_/macro/name.hpp>
...
like <c>lslboost::function</c> (see Boost.Function).
...
declared within the same enclosing scope (but <c>lslboost::overloaded_function</c>
