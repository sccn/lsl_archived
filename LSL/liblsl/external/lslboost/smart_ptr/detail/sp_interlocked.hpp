...
//
//  lslboost/detail/sp_interlocked.hpp
//
...
# define BOOST_SP_INTERLOCKED_INCREMENT ::lslboost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::lslboost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::lslboost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::lslboost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::lslboost::detail::InterlockedExchangeAdd
