...
namespace lslboost {
    namespace detail {
        typedef lslboost::true_type  ms_is_trivial;
        typedef lslboost::false_type ms_no_trivial;
        ...
        inline void ms_destroy(T* memory, std::size_t size) {
            lslboost::has_trivial_destructor<T> trivial;
        ...
        inline void ms_init(T* memory, std::size_t size) {
            lslboost::has_trivial_default_constructor<T> trivial;
