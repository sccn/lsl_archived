...
//
//  See http://www.lslboost.org/libs/smart_ptr/shared_array.htm for documentation.
//
...
public:
    ...
    shared_array( lslboost::detail::sp_nullptr_t ) BOOST_NOEXCEPT : px( 0 ), pn()
    {
    }
...
// ... except in C++0x, move disables the implicit copy
    ...
    shared_array( shared_array<Y> const & r, typename lslboost::detail::sp_enable_if_convertible< Y[], T[] >::type = lslboost::detail::sp_empty() )
...
template<class T> inline bool operator==( shared_array<T> const & p, lslboost::detail::sp_nullptr_t ) BOOST_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( lslboost::detail::sp_nullptr_t, shared_array<T> const & p ) BOOST_NOEXCEPT
{
    return p.get() == 0;
}
