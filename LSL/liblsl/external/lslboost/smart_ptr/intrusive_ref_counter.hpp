...
#include <lslboost/smart_ptr/detail/atomic_count.hpp>
...
{
    typedef lslboost::detail::atomic_count type;

    static unsigned int load(lslboost::detail::atomic_count const& counter) BOOST_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(lslboost::detail::atomic_count& counter) BOOST_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(lslboost::detail::atomic_count& counter) BOOST_NOEXCEPT
    {
        return --counter;
    }
};
