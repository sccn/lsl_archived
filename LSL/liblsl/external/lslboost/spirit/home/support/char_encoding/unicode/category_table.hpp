...
{
    static const ::lslboost::uint8_t category_stage1[] = {
    ...
    static const ::lslboost::uint16_t category_stage2[] = {
    ...
    inline ::lslboost::uint16_t category_lookup(::lslboost::uint32_t ch)
    {
        ::lslboost::uint32_t block_offset = category_stage1[ch / 256] * 256;
