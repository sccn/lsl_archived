...
{
    static const ::lslboost::uint8_t lowercase_stage1[] = {
    ...
    static const ::lslboost::uint32_t lowercase_stage2[] = {
    ...
    inline ::lslboost::uint32_t lowercase_lookup(::lslboost::uint32_t ch)
    {
        ::lslboost::uint32_t block_offset = lowercase_stage1[ch / 256] * 256;
