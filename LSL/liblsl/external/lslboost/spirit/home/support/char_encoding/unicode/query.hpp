...
namespace lslboost { namespace spirit { namespace ucd
{
    ...
    inline bool is_graph(::lslboost::uint32_t ch)
    {
        return !(   is_white_space(ch)
    ...
    inline bool is_print(::lslboost::uint32_t ch)
    {
        return (is_graph(ch) || is_blank(ch)) && !is_control(ch);
    }

    inline bool is_noncharacter_code_point(::lslboost::uint32_t ch)
    {
        return (detail::category_lookup(ch) & properties::noncharacter_code_point) != 0;
    }

    inline bool is_default_ignorable_code_point(::lslboost::uint32_t ch)
    {
    ...
    inline ::lslboost::uint32_t to_lowercase(::lslboost::uint32_t ch)
    {
        ...
        ::lslboost::uint32_t r = detail::lowercase_lookup(ch);
        return (r == 0)? ch : r;
    }

    inline ::lslboost::uint32_t to_uppercase(::lslboost::uint32_t ch)
    {
        // The table returns 0 to signal that this code maps to itself
        ::lslboost::uint32_t r = detail::uppercase_lookup(ch);
        return (r == 0)? ch : r;
    }
}}}
