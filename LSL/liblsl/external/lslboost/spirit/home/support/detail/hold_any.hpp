/*=============================================================================
    ...
    The class lslboost::spirit::hold_any is built based on the any class
...
namespace lslboost { namespace spirit
{
    struct bad_any_cast
      : std::bad_cast
    {
        bad_any_cast(lslboost::detail::sp_typeinfo const& src, lslboost::detail::sp_typeinfo const& dest)
    ...
    namespace detail
    {
        ...
        {
            lslboost::detail::sp_typeinfo const& (*get_type)();
        ...
        struct fxns<mpl::true_>
        {
            ...
            struct type
            {
                static lslboost::detail::sp_typeinfo const& get_type()
                {
    ...
    public:
        ...
        lslboost::detail::sp_typeinfo const& type() const
        {
...
// implicit casting is disabled by default for compatibility with lslboost::any
    ...
    T any_cast(basic_hold_any<Char>& operand)
    {
        ...
        if(!result)
            lslboost::throw_exception(bad_any_cast(operand.type(), BOOST_SP_TYPEID(T)));
        return *result;
    }
