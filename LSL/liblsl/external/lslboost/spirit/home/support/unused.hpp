...
{
    ///////////////////////////////////////////////////////////////////////////
    // We do not import fusion ::unused_type anymore to avoid lslboost::fusion
    // being turned into an associate namespace for lslboost::spirit, as this
    // interferes with ADL in unexpected ways. We rather copy the full 
    // unused_type implementation from lslboost::fusion.
    ///////////////////////////////////////////////////////////////////////////
    struct unused_type
    {
        unused_type()
