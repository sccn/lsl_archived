...
#include <lslboost/spirit/home/support/utree.hpp>
#include <lslboost/spirit/home/qi/domain.hpp>
#include <lslboost/spirit/home/karma/domain.hpp>
#include <lslboost/spirit/home/qi/nonterminal/nonterminal_fwd.hpp>
...
namespace lslboost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        struct attribute_as_string_type
        {
            ...
            {
                return lslboost::get<utf8_string_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_symbol_type
        {
            ...
            static type call(utree const& attr)
            {
                return lslboost::get<utf8_symbol_range_type>(attr);
            }
    ...
    namespace detail
    {
        struct attribute_as_binary_string_type
        {
            ...
            static type call(utree const& attr)
            {
                return lslboost::get<binary_range_type>(attr);
            }
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_list_container<lslboost::optional<Attribute> >
          : mpl::true_
        {};
    ...
    namespace detail
    {
        ...
        template <typename Attribute>
        struct handles_utree_container<lslboost::optional<Attribute> >
          : mpl::true_
        {};
    ...
    struct symbols_lookup<utree, utf8_symbol_type>
    {
        ...
        {
            utf8_symbol_range_type r = lslboost::get<utf8_symbol_range_type>(t);
    ...
    namespace detail
    {
        ...
        {
            if (detail::is_list(t))
                return lslboost::get<T>(t.front());
            return lslboost::get<T>(t);
        }
    }
        ...
        iterator_range<Iterator> const, utree, karma::domain>
    {
        ...
        static type pre(iterator_range<Iterator> const& t)
        {
            ...
            Iterator it = lslboost::begin(t);
            utree result(lslboost::ref(*it));
            ++it;
            return result;
        }
    };
