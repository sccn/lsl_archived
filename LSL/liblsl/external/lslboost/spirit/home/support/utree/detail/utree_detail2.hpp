...
namespace lslboost { namespace spirit { namespace detail
{
    ...
    struct list::node : lslboost::noncopyable
    {
        template <typename T>
    ...
    class list::node_iterator
      : public lslboost::iterator_facade<
            node_iterator<Value>
          , Value
          , lslboost::bidirectional_traversal_tag>
    {
    public:
    ...
    private:
        ...
        friend class lslboost::spirit::utree;
        friend struct lslboost::spirit::detail::list;
    ...
    template <typename Value>
    class list::node_iterator<lslboost::reference_wrapper<Value> >
      : public lslboost::iterator_facade<
            node_iterator<lslboost::reference_wrapper<Value> >
          , lslboost::reference_wrapper<Value>
          , lslboost::bidirectional_traversal_tag>
    {
    public:
    ...
    private:
        ...
        void increment()
        {
            if (node != 0) // not at end
            {
                prev = node;
                node = node->next;
                curr = lslboost::ref(node ? node->val : nil_node);
            }
        }
        ...
        mutable lslboost::reference_wrapper<Value> curr;
    };

    template <typename Value>
    Value list::node_iterator<lslboost::reference_wrapper<Value> >::nil_node = Value();
    ...
    struct visit_impl
    {
        ...
        {
            typedef typename
                lslboost::mpl::if_<lslboost::is_const<UTreeX>,
                typename UTreeX::const_iterator,
                typename UTreeX::iterator>::type
            iterator;

            typedef lslboost::iterator_range<iterator> list_range;
...
namespace lslboost { namespace spirit
{
    ...
    inline utree::utree(lslboost::reference_wrapper<utree> ref)
    {
        s.initialize();
        p = ref.get_pointer();
    ...
    inline utree::utree(lslboost::iterator_range<Iter> r)
    {
        s.initialize();
    ...
    inline utree& utree::operator=(lslboost::reference_wrapper<utree> ref)
    {
        free();
        p = ref.get_pointer();
        set_type(type::reference_type);
    ...
    template <typename Iter>
    inline utree& utree::operator=(lslboost::iterator_range<Iter> r)
    {
        free();
        assign(r.begin(), r.end());
        return *this;
    ...
    template <typename F>
    typename lslboost::result_of<F(utree const&)>::type
    ...
    template <typename F>
    typename lslboost::result_of<F(utree&)>::type
    ...
    template <typename F>
    typename lslboost::result_of<F(utree const&, utree const&)>::type
    ...
    template <typename F>
    typename lslboost::result_of<F(utree const&, utree&)>::type
    ...
    template <typename F>
    typename lslboost::result_of<F(utree&, utree const&)>::type
    ...
    template <typename F>
    typename lslboost::result_of<F(utree&, utree&)>::type
    ...
    template <typename Iterator>
    struct is_iterator_range<lslboost::iterator_range<Iterator> >
      : lslboost::mpl::true_
    {};
    ...
    struct utree_cast
    {
        ...
        To dispatch(From const& val, lslboost::mpl::true_) const
        {
            return To(val); // From is convertible to To
        }

        template <typename From>
        To dispatch(From const&, lslboost::mpl::false_) const
        {
        ...
        {
            // lslboost::iterator_range has a templated constructor, accepting
            // any argument and hence any type is 'convertible' to it.
            typedef typename lslboost::mpl::eval_if<
                is_iterator_range<To>
              , lslboost::is_same<From, To>, lslboost::is_convertible<From, To>
            >::type is_convertible;
