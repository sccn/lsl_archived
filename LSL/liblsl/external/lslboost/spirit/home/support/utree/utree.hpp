...
#include <lslboost/spirit/home/support/utree/detail/utree_detail1.hpp>
...
namespace lslboost { namespace spirit
{
    ...
    */
    struct utree_type
    {
        ...
        typedef lslboost::uint_t<sizeof(info)*8>::exact exact_integral_type; 
        typedef lslboost::uint_t<sizeof(info)*8>::fast fast_integral_type; 
    };
    //]
    ...
    {
        lslboost::io::ios_all_saver saver(out);
        switch (t) {
    ...
    */
    typedef basic_string<
        lslboost::iterator_range<char const*>, utree_type::binary_type
    > binary_range_type;
    typedef basic_string<
    ...
    */
    typedef basic_string<
        lslboost::iterator_range<char const*>, utree_type::string_type
    ...
    */
    typedef basic_string<
        lslboost::iterator_range<char const*>, utree_type::symbol_type
    ...
    public:
        ...
        typename lslboost::disable_if<
            lslboost::is_polymorphic<
                typename lslboost::remove_pointer<Ptr>::type>,
            Ptr>::type
        get() const
        {
            if (*i == typeid(Ptr))
    ...
    public:
        ...
        typedef detail::list::node_iterator<lslboost::reference_wrapper<utree> >
          ref_iterator;

        typedef lslboost::iterator_range<iterator> range;
        typedef lslboost::iterator_range<const_iterator> const_range;
        ...
        */
        ...
        // where a lslboost::optional is expected (i.e. as an attribute for the 
        ...
        utree(lslboost::reference_wrapper<utree>);
        reference operator=(lslboost::reference_wrapper<utree>);
        ...
        utree(lslboost::iterator_range<Iterator>);
        template <class Iterator>
        reference operator=(lslboost::iterator_range<Iterator>);
