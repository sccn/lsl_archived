...
#include <lslboost/spirit/home/support/attributes_fwd.hpp>
#include <lslboost/spirit/home/support/container.hpp>
#include <lslboost/spirit/home/support/detail/hold_any.hpp>
#include <lslboost/spirit/home/support/detail/as_variant.hpp>
#include <lslboost/optional/optional.hpp>
#include <lslboost/fusion/include/transform.hpp>
#include <lslboost/fusion/include/filter_if.hpp>
#include <lslboost/fusion/include/as_vector.hpp>
#include <lslboost/fusion/include/push_front.hpp>
#include <lslboost/fusion/include/pop_front.hpp>
#include <lslboost/fusion/include/is_sequence.hpp>
#include <lslboost/fusion/include/for_each.hpp>
#include <lslboost/fusion/include/is_view.hpp>
#include <lslboost/fusion/include/mpl.hpp>
#include <lslboost/foreach.hpp>
...
#include <lslboost/proto/proto_fwd.hpp>
...
//        {};
    ...
    template <typename T, typename Expected>
    struct is_weak_substitute<lslboost::variant<T>, Expected>
      : is_weak_substitute<T, Expected>
    {};

    template <typename T0, typename T1, typename ...TN, typename Expected>
    struct is_weak_substitute<lslboost::variant<T0, T1, TN...>,
            Expected>
      : mpl::bool_<is_weak_substitute<T0, Expected>::type::value &&
            is_weak_substitute<lslboost::variant<T1, TN...>, Expected>::type::value>
    {};
#else
#define BOOST_SPIRIT_IS_WEAK_SUBSTITUTE(z, N, _)                              \
    ...
    struct is_weak_substitute<lslboost::detail::variant::void_, Expected>
      : mpl::true_
    {};

    template <BOOST_VARIANT_ENUM_PARAMS(typename T), typename Expected>
    struct is_weak_substitute<
            lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Expected>
...
#undef BOOST_SPIRIT_IS_WEAK_SUBSTITUTE
    ...
    struct not_is_variant<lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Domain>
      : mpl::false_
    {};

    template <typename T, typename Domain>
    struct not_is_variant<lslboost::optional<T>, Domain>
    ...
    template <typename T>
    struct variant_type<lslboost::optional<T> >
      : variant_type<T>
    {};
    ...
    namespace detail
    {
        ...
        template <typename Expected, typename Attribute>
        struct attribute_is_compatible<Expected, lslboost::optional<Attribute> >
          : is_convertible<Attribute, Expected>
        {};
    ...
    struct variant_which<lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        static int call(lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const& v)
        {
            return v.which();
        }
    };
    ...
    template <typename T, typename Domain>
    struct not_is_optional<lslboost::optional<T>, Domain>
      : mpl::false_
    {};
    ...
    {
        typedef typename lslboost::detail::iterator_traits<Iterator>::
            difference_type type;

        static type call(iterator_range<Iterator> const& r)
        {
            return lslboost::detail::distance(r.begin(), r.end());
        }
    };
    ...
    // build_optional
    //
    // Build a lslboost::optional from T. Return unused_type if T is unused_type.
    ///////////////////////////////////////////////////////////////////////////
    template <typename T>
    struct build_optional
    {
        typedef lslboost::optional<T> type;
    };

    template <typename T>
    struct build_optional<lslboost::optional<T> >
    {
        typedef lslboost::optional<T> type;
    };
    ...
    // build_variant
    //
    // Build a lslboost::variant from a fusion sequence. build_variant makes sure
    ...
    struct make_attribute
    {
        ...
        static Attribute call(unused_type)
        {
            ...
            return lslboost::get(value_initialized<attribute_type>());
        }
    ...
    // optionals
    template <typename T>
    struct clear_value<lslboost::optional<T> >
    {
        static void call(lslboost::optional<T>& val)
        {
            if (val)
    ...
    struct print_attribute_debug<Out, lslboost::optional<T> >
    {
        static void call(Out& out, lslboost::optional<T> const& val)
        {
            if (val)
                spirit::traits::print_attribute(out, *val);
            else
...
///////////////////////////////////////////////////////////////////////////////
namespace lslboost { namespace spirit { namespace result_of
{
    template <typename Exposed, typename Transformed, typename Domain>
