...
#include <lslboost/spirit/home/support/iterators/detail/fixed_size_queue.hpp>
...
namespace lslboost { namespace spirit { namespace iterator_policies
{
    ...
    //  lslboost::spirit::fixed_size_queue class) that is size N+1 and stores N 
    //  elements.
    // 
    ...
    struct fixed_size_queue
    {
        ...
        protected:
            ...
            void swap(unique& x)
            {
                lslboost::swap(queued_position, x.queued_position);
            }
