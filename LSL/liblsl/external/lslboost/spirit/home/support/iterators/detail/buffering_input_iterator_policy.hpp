...
#include <lslboost/spirit/home/support/iterators/multi_pass_fwd.hpp>
...
namespace lslboost { namespace spirit { namespace iterator_policies
{
    ///////////////////////////////////////////////////////////////////////////
    ...
    struct buffering_input_iterator
    {
        ...
        private:
            typedef
                typename lslboost::detail::iterator_traits<T>::value_type
            result_type;

        public:
            typedef
                typename lslboost::detail::iterator_traits<T>::difference_type
            difference_type;
            typedef
                typename lslboost::detail::iterator_traits<T>::difference_type
            distance_type;
