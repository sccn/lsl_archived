...
namespace lslboost { namespace spirit { namespace iterator_policies
{
    ...
    template <typename T
      ...
      , bool OwnershipIsEmpty = lslboost::is_empty<Ownership>::value
      , bool CheckingIsEmpty = lslboost::is_empty<Checking>::value
      , bool InputIsEmpty = lslboost::is_empty<Input>::value>
    struct multi_pass_unique;
