...
# include <lslboost/spirit/home/support/char_encoding/unicode.hpp>
#endif
...
#define BOOST_SPIRIT_DEFINE_CHAR_CODES(charset)                                 \
    namespace lslboost { namespace spirit { namespace tag { namespace charset      \
    {                                                                           \
        BOOST_SPIRIT_TAG_CHAR_SPEC(spirit::char_encoding::charset)              \
    }}}}                                                                        \
    namespace lslboost { namespace spirit { namespace charset                      \
    {                                                                           \
...
BOOST_SPIRIT_DEFINE_CHAR_CODES(unicode)
    ...
    namespace lslboost { namespace spirit { namespace tag { namespace unicode
    {
        BOOST_SPIRIT_TAG_CHAR_SPEC(spirit::char_encoding::unicode)
    }}}}

    namespace lslboost { namespace spirit { namespace unicode
    {
