...
#include <lslboost/spirit/include/phoenix_function.hpp>
#include <lslboost/proto/proto.hpp>
#include <lslboost/fusion/include/void.hpp>
#include <lslboost/spirit/home/support/meta_compiler.hpp>
#include <lslboost/spirit/home/support/detail/make_vector.hpp>
...
#include <lslboost/spirit/home/support/terminal_expression.hpp>
...
// Common placeholders are placed in the main lslboost::spirit namespace
...
#define BOOST_SPIRIT_TERMINAL_NAME(name, type_name)                             \
    ...
    typedef lslboost::proto::terminal<tag::name>::type type_name;                  \
...
#define BOOST_SPIRIT_TERMINAL_NAME_EX(name, type_name)                          \
    namespace tag { struct name { BOOST_SPIRIT_IS_TAG() }; }                    \
    typedef lslboost::spirit::terminal<tag::name> type_name;                       \
