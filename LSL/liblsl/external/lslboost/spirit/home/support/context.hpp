...
#include <lslboost/spirit/home/support/nonterminal/expand_arg.hpp>
#include <lslboost/spirit/home/support/assert_msg.hpp>
#include <lslboost/spirit/home/support/argument.hpp>
#include <lslboost/spirit/home/support/limits.hpp>
...
BOOST_PHOENIX_DEFINE_CUSTOM_TERMINAL(
    template <int N>
  , lslboost::spirit::local_variable<N>
  , mpl::false_                 // is not nullary
  , v2_eval(
        proto::make<
            lslboost::spirit::local_variable<N>()
