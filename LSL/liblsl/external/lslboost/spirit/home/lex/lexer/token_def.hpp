...
#include <lslboost/spirit/home/qi/detail/construct.hpp>
#include <lslboost/spirit/home/qi/detail/assign_to.hpp>
#include <lslboost/spirit/home/lex/reference.hpp>
#include <lslboost/spirit/home/lex/lexer_type.hpp>
...
namespace lslboost { namespace spirit { namespace lex
{
    ...
    public:
        ...
        {
            if (0 == def_.which()) 
                return info("token_def", lslboost::get<string_type>(def_));

            return info("token_def", lslboost::get<char_type>(def_));
        }
          ...
          , String const& targetstate) const
        {
            ...
            if (0 == def_.which()) {
                unique_id_ = lexdef.add_token(state.c_str()
                  , lslboost::get<string_type>(def_), token_id_, target);
            }
            else {
                unique_id_ = lexdef.add_token(state.c_str()
                  , lslboost::get<char_type>(def_), token_id_, target);
            }
        }
    ...
    public:
        ...
        { 
            return (0 == def_.which()) ? 
                lslboost::get<string_type>(def_) : 
                string_type(1, lslboost::get<char_type>(def_));
        }
