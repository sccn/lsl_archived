...
BOOST_PHOENIX_DEFINE_EXPRESSION(
    (lslboost)(spirit)(lex)(less)
  , (lslboost::phoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (lslboost)(spirit)(lex)(lookahead)
  , (lslboost::phoenix::meta_grammar)
    (lslboost::phoenix::meta_grammar)
)
...
namespace lslboost { namespace phoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<lslboost::spirit::lex::more_type> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<lslboost::spirit::lex::more_type, Dummy> : mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<lslboost::spirit::lex::more_type, Dummy>
        : proto::call<
            v2_eval(
                proto::make<lslboost::spirit::lex::more_type()>
