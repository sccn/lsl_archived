...
#include <lslboost/spirit/home/support/detail/lexer/char_traits.hpp>
#include <lslboost/spirit/home/support/detail/lexer/consts.hpp>
#include <lslboost/spirit/home/support/detail/lexer/rules.hpp>
#include <lslboost/spirit/home/support/detail/lexer/size_t.hpp>
#include <lslboost/spirit/home/support/detail/lexer/state_machine.hpp>
#include <lslboost/spirit/home/support/detail/lexer/debug.hpp>
#include <lslboost/spirit/home/lex/lexer/lexertl/static_version.hpp>
#include <lslboost/algorithm/string.hpp>
#include <lslboost/lexical_cast.hpp>
#include <lslboost/scoped_array.hpp>

///////////////////////////////////////////////////////////////////////////////
namespace lslboost { namespace spirit { namespace lex { namespace lexertl
{
    namespace detail
    {
    ...
    struct string_lit<wchar_t>
    {
        ...
        static std::basic_string<wchar_t> get(char const* source = "")
        {
            ...
            lslboost::scoped_array<wchar_t> result (new wchar_t[len+1]);
            result.get()[len] = '\0';
    ...
    template <typename Char>
    inline bool
    generate_cpp_state_info (lslboost::lexer::basic_rules<Char> const& rules_
      , std::basic_ostream<Char> &os_, Char const* name_suffix)
    {
        ...
        typedef typename
            lslboost::lexer::basic_rules<Char>::string_size_t_map::const_iterator
        state_iterator;
        ...
        os_ << lslboost::lexer::detail::strings<Char>::char_name()
        ...
        for (iterator rit = reverse_state_map.begin(); rit != rend; ++last_id)
        {
            ...
            os_ << "    "
                << lslboost::lexer::detail::strings<Char>::char_prefix()
                << "\"" << (*rit).second << "\"";
            if (++rit != rend)
                os_ << ",\n";
            else
      ...
      , Char const* name_suffix, bool bol, bool eol)
    {
        ...
        os_ << "    enum\n";
        os_ << "    {\n        static_version = "
            << lslboost::lexical_cast<std::basic_string<Char> >(SPIRIT_STATIC_LEXER_VERSION)
            << ",\n";
        ...
        os_ << "    static " << lslboost::lexer::detail::strings<Char>::char_name()
    ...
    bool generate_function_body_dfa(std::basic_ostream<Char>& os_
      , lslboost::lexer::basic_state_machine<Char> const &sm_)
    {
    ...
    inline std::basic_string<Char> get_charlit(Char ch)
    {
        ...
        lslboost::lexer::basic_string_token<Char>::escape_char(ch, result);
        return result;
    }
      ...
      , lslboost::lexer::basic_state_machine<Char> const &sm_)
    {
        ...
        for (std::size_t dfa_ = 0; dfa_ < dfas_; ++dfa_)
        {
            ...
            for (std::size_t state_ = 0; state_ < states_; ++state_)
            {
                ...
                if (t_ < transitions_ ||
                    iter_->bol_index != lslboost::lexer::npos ||
    ...
    inline bool
    generate_cpp (lslboost::lexer::basic_state_machine<Char> const& sm_
      , lslboost::lexer::basic_rules<Char> const& rules_
      , std::basic_ostream<Char> &os_, Char const* name_suffix
...
//         std::size_t const lookups_ = sm_.data()._lookup->front()->size();
        ...
        os_ << "// Auto-generated by lslboost::lexer, do not edit\n\n";
        ...
        lslboost::to_upper(guard);

        os_ << "#if !defined(BOOST_SPIRIT_LEXER_NEXT_TOKEN_" << guard << ")\n";
        os_ << "#define BOOST_SPIRIT_LEXER_NEXT_TOKEN_" << guard << "\n\n";

        os_ << "#include <lslboost/detail/iterator.hpp>\n";
        os_ << "#include <lslboost/spirit/home/support/detail/lexer/char_traits.hpp>\n\n";

        generate_delimiter(os_);
        os_ << "// the generated table of state names and the tokenizer have to be\n"
               "// defined in the lslboost::spirit::lex::lexertl::static_ namespace\n";
        os_ << "namespace lslboost { namespace spirit { namespace lex { "
        ...
        os_ << "}}}}}  // namespace lslboost::spirit::lex::lexertl::static_\n\n";
