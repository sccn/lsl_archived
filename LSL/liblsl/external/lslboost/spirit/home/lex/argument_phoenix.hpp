...
#include <lslboost/spirit/include/phoenix_core.hpp>

namespace lslboost { namespace spirit { namespace lex
{
    ///////////////////////////////////////////////////////////////////////////
...
BOOST_PHOENIX_DEFINE_EXPRESSION(
  ...
  , (lslboost::phoenix::meta_grammar)
)

BOOST_PHOENIX_DEFINE_EXPRESSION(
    (lslboost)(spirit)(lex)(state_setter)
  , (lslboost::phoenix::meta_grammar)
)
...
namespace lslboost { namespace phoenix
{
    ...
    {
        template <>
        struct is_nullary<custom_terminal<lslboost::spirit::lex::value_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<lslboost::spirit::lex::value_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<lslboost::spirit::lex::value_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<lslboost::spirit::lex::value_getter()>
    ...
    struct actor<spirit::lex::value_context>
      : lslboost::phoenix::actor<proto::terminal<spirit::lex::value_context>::type>
    {
        typedef lslboost::phoenix::actor<
    ...
    {
        template <>
        struct is_nullary<custom_terminal<lslboost::spirit::lex::state_context> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<lslboost::spirit::lex::state_context, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<lslboost::spirit::lex::state_context, Dummy>
      : proto::call<
            v2_eval(
                proto::make<lslboost::spirit::lex::state_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
    ...
    struct actor<spirit::lex::state_context>
      : lslboost::phoenix::actor<proto::terminal<spirit::lex::state_context>::type>
    {
        typedef lslboost::phoenix::actor<
    ...
    {
        template <>
        struct is_nullary<custom_terminal<lslboost::spirit::lex::eoi_getter> >
          : mpl::false_
        {};
    }
    
    template <typename Dummy>
    struct is_custom_terminal<lslboost::spirit::lex::eoi_getter, Dummy>: mpl::true_ {};
    
    template <typename Dummy>
    struct custom_terminal<lslboost::spirit::lex::eoi_getter, Dummy>
      : proto::call<
            v2_eval(
                proto::make<lslboost::spirit::lex::eoi_getter()>
              , proto::call<functional::env(proto::_state)>
            )
        >
    {};
