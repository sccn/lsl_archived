...
#include <lslboost/iostreams/stream.hpp>
...
namespace lslboost { namespace spirit { namespace qi { namespace detail
{
    ...
    struct iterator_source
    {
        ...
        char_type;
        typedef lslboost::iostreams::seekable_device_tag category;
        ...
        // lslboost::iostreams::seekable_device. We need to have see support to
        ...
        std::streampos seek(lslboost::iostreams::stream_offset, std::ios_base::seekdir way) 
        {
