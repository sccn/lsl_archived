...
namespace lslboost { namespace spirit { namespace traits
{
    ...
    namespace detail
    {
        ...
        template <typename I>
        struct is_iter_range<lslboost::iterator_range<I> > : mpl::true_ {};
    ...
    template <typename Attribute, typename Iterator>
    struct assign_to_attribute_from_iterators<
        lslboost::optional<Attribute>, Iterator>
    {
        static void
        call(Iterator const& first, Iterator const& last
          , lslboost::optional<Attribute>& attr)
        {
            Attribute val;
    ...
    template <typename Attribute, typename T>
    struct assign_to_attribute_from_value<Attribute, lslboost::optional<T>
      , typename disable_if<is_same<Attribute, lslboost::optional<T> > >::type>
    {
        static void
        call(lslboost::optional<T> const& val, Attribute& attr)
        {
            assign_to(val.get(), attr);
        }
    };
    ...
    template <typename Attribute, typename T>
    struct assign_to_container_from_value<Attribute, lslboost::optional<T>
      , typename disable_if<is_same<Attribute, lslboost::optional<T> > >::type>
    {
        static void
        call(lslboost::optional<T> const& val, Attribute& attr)
