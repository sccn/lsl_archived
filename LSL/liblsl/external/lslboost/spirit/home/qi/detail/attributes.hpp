...
namespace lslboost { namespace spirit { namespace qi
{
    ...
    template <typename Exposed, typename Transformed>
    struct transform_attribute<lslboost::optional<Exposed>, Transformed
      , typename disable_if<is_same<lslboost::optional<Exposed>, Transformed> >::type>
    {
        typedef Transformed& type;
        static Transformed& pre(lslboost::optional<Exposed>& val)
        {
            if (!val)
                val = Transformed();
            return lslboost::get<Transformed>(val);
        }
        static void post(lslboost::optional<Exposed>&, Transformed const&) {}
        static void fail(lslboost::optional<Exposed>& val)
        {
