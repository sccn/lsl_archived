...
#include <lslboost/spirit/home/qi/operator/sequence_base.hpp>
#include <lslboost/spirit/home/qi/detail/expect_function.hpp>
...
namespace lslboost { namespace spirit { namespace qi
{
    ...
    struct expectation_failure : std::runtime_error
    {
        expectation_failure(Iterator first_, Iterator last_, info const& what)
          : std::runtime_error("lslboost::spirit::qi::expectation_failure")
