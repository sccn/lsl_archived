...
#include <lslboost/spirit/home/support/detail/endian.hpp>
...
#include <lslboost/spirit/home/qi/detail/assign_to.hpp>
#include <lslboost/spirit/home/qi/skip_over.hpp>
#include <lslboost/spirit/home/support/common_terminals.hpp>
...
namespace lslboost { namespace spirit { namespace qi
{
    ...
    using lslboost::spirit::byte_;
    using lslboost::spirit::word;
    using lslboost::spirit::big_word;
    using lslboost::spirit::little_word;
    using lslboost::spirit::dword;
    using lslboost::spirit::big_dword;
    using lslboost::spirit::little_dword;
#ifdef BOOST_HAS_LONG_LONG
    using lslboost::spirit::qword;
    using lslboost::spirit::big_qword;
    using lslboost::spirit::little_qword;
#endif
    using lslboost::spirit::bin_float;
    using lslboost::spirit::big_bin_float;
    using lslboost::spirit::little_bin_float;
    using lslboost::spirit::bin_double;
    using lslboost::spirit::big_bin_double;
    using lslboost::spirit::little_bin_double;
#endif

    using lslboost::spirit::byte_type;
    using lslboost::spirit::word_type;
    using lslboost::spirit::big_word_type;
    using lslboost::spirit::little_word_type;
    using lslboost::spirit::dword_type;
    using lslboost::spirit::big_dword_type;
    using lslboost::spirit::little_dword_type;
#ifdef BOOST_HAS_LONG_LONG
    using lslboost::spirit::qword_type;
    using lslboost::spirit::big_qword_type;
    using lslboost::spirit::little_qword_type;
#endif
    using lslboost::spirit::bin_float_type;
    using lslboost::spirit::big_bin_float_type;
    using lslboost::spirit::little_bin_float_type;
    using lslboost::spirit::bin_double_type;
    using lslboost::spirit::big_bin_double_type;
    using lslboost::spirit::little_bin_double_type;
    ...
    namespace detail
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <BOOST_SCOPED_ENUM(lslboost::endian::endianness) bits>
        struct what;

        template <>
        struct what<lslboost::endian::endianness::native>
        {
        ...
        template <>
        struct what<lslboost::endian::endianness::little>
        {
        ...
        template <>
        struct what<lslboost::endian::endianness::big>
        {
            static char const* is()
            {
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, BOOST_SCOPED_ENUM(lslboost::endian::endianness) endian, int bits>
    struct any_binary_parser : primitive_parser<any_binary_parser<T, endian, bits> >
    {
        template <typename Context, typename Iterator>
        struct attribute
        {
            typedef lslboost::endian::endian<endian, typename T::type,
                bits> type;
        };
    ...
    template <typename V, typename T
      , BOOST_SCOPED_ENUM(lslboost::endian::endianness) endian, int bits>
      ...
      : primitive_parser<binary_lit_parser<V, T, endian, bits> >
    {
          ...
          , Attribute& attr_param) const
        {
            ...
            lslboost::endian::endian<endian, typename T::type, bits> attr_;
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, bits)            \
    ...
    struct make_primitive<tag::name, Modifiers>                               \
      : make_binary_parser<detail::integer<bits>,                             \
        lslboost::endian::endianness::endiantype, bits> {};                      \
                                                                              \
...
#define BOOST_SPIRIT_MAKE_BINARY_IEEE754_PRIMITIVE(name, endiantype, bits)    \
    ...
    struct make_primitive<                                                    \
      ...
      : make_binary_lit_parser<A0, detail::floating_point<bits>,              \
        lslboost::endian::endianness::endiantype,                                \
        bits> {};                                                             \
                                                                              \
    /***/
