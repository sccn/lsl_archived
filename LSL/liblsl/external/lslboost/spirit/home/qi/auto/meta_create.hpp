...
#include <lslboost/spirit/home/support/auto/meta_create.hpp>
...
namespace lslboost { namespace spirit { namespace qi
{
    ...
    // optional
    template <typename T>
    struct meta_create<lslboost::optional<T> >
    {
        typedef make_unary_proto_expr<
    ...
    struct meta_create<lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> >
    {
        typedef make_nary_proto_expr<
            typename lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::types
    ...
    template <>
    struct meta_create<lslboost::long_long_type>
    {
        typedef spirit::long_long_type type;
        static type call() { return type(); }
    };
    template <>
    struct meta_create<lslboost::ulong_long_type>
    {
