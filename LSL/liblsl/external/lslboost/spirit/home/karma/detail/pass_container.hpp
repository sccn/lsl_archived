...
#include <lslboost/fusion/include/deduce_sequence.hpp>
...
namespace lslboost { namespace spirit { namespace karma { namespace detail
{
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, ValueType, lslboost::optional<Attribute>, Sequence>
    ...
    template <typename Container, typename ValueType, typename Attribute
      , typename Sequence>
    struct pass_through_container<
            Container, lslboost::optional<ValueType>, lslboost::optional<Attribute>
          , Sequence>
    ...
    template <typename Container, typename ValueType, typename Sequence
      , typename T>
    struct pass_through_container<Container, ValueType, lslboost::variant<T>
          , Sequence>
...
#define BOOST_SPIRIT_PASS_THROUGH_CONTAINER(z, N, _)                          \
    ...
    template <typename Container, typename ValueType, typename Sequence>
    struct pass_through_container<Container, ValueType
          , lslboost::detail::variant::void_, Sequence>
      : mpl::false_
    {};
    ...
    struct pass_through_container<Container, ValueType
          , lslboost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Sequence>
