...
#include <lslboost/spirit/home/karma/detail/extract_from.hpp>
...
namespace lslboost { namespace spirit { namespace karma
{
      ...
      : primitive_generator<any_binary_generator<T, endian, bits> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            lslboost::endian::endian<endian, typename T::type, bits> p;
...
#pragma warning(pop)
    ...
    namespace detail
    {
        template <typename T, BOOST_SCOPED_ENUM(lslboost::endian::endianness) endian
          , int bits>
        struct basic_binary
        {
