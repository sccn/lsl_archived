...
#include <lslboost/spirit/home/karma/stream/detail/format_manip.hpp>
#include <lslboost/spirit/home/karma/stream/detail/iterator_sink.hpp>
...
namespace lslboost { namespace spirit { namespace karma
{
      ...
      : primitive_generator<any_stream_generator<Char, CharEncoding, Tag> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            {
                lslboost::iostreams::stream<sink_device> ostr(sink);
