...
#include <lslboost/spirit/home/karma/char/char_generator.hpp>
...
namespace lslboost { namespace spirit { namespace karma
{
    ...
    // the same name
    namespace ascii { using namespace lslboost::spirit::ascii; }
    namespace iso8859_1 { using namespace lslboost::spirit::iso8859_1; }
    namespace standard { using namespace lslboost::spirit::standard; }
    namespace standard_wide { using namespace lslboost::spirit::standard_wide; }
#if defined(BOOST_SPIRIT_UNICODE)
    namespace unicode { using namespace lslboost::spirit::unicode; }
#endif
    ...
    using namespace lslboost::spirit::standard;
...
}}}  // namespace lslboost::spirit::karma
