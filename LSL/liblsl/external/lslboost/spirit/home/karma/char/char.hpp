...
#include <lslboost/spirit/home/support/char_set/basic_chset.hpp>
...
namespace lslboost { namespace spirit { namespace karma
{
      ...
      : char_generator<char_range<CharEncoding, Tag>, CharEncoding, Tag>
    {
        ...
        info what(Context& /*context*/) const
        {
            ...
            lslboost::get<std::string>(result.value) += '-';
            lslboost::get<std::string>(result.value) += to_utf8(char_encoding::toucs4(to));
            return result;
        }
