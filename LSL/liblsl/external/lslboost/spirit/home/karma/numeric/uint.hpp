...
namespace lslboost { namespace spirit
{
    ...
    struct use_terminal<karma::domain, lslboost::ulong_long_type>
      : mpl::true_ {};
#endif
...
namespace lslboost { namespace spirit { namespace karma
{
    ...
    struct make_primitive<tag::ulong_long, Modifiers>
      : detail::make_uint<lslboost::ulong_long_type, Modifiers> {};
#endif
    ...
    struct make_primitive<
      ...
      : detail::make_uint_direct<lslboost::ulong_long_type, Modifiers> {};
#endif
...
#ifdef BOOST_HAS_LONG_LONG
    template <typename Modifiers>
    struct make_primitive<lslboost::ulong_long_type, Modifiers>
      : detail::basic_uint_literal<lslboost::ulong_long_type, Modifiers> {};
#endif
