...
#include <lslboost/spirit/home/support/detail/pow10.hpp>
#include <lslboost/spirit/home/support/detail/sign.hpp>
...
#define BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(unsignedtype)                    \
    ...
    BOOST_SPIRIT_ABSOLUTE_VALUE(lslboost::long_long_type, lslboost::ulong_long_type);
    BOOST_SPIRIT_ABSOLUTE_VALUE_UNSIGNED(lslboost::ulong_long_type);
#endif
...
#define BOOST_KARMA_NUMERICS_INNER_LOOP_SUFFIX(z, x, data)                    \
    ...
    private:
        ...
        // a lslboost::long_long_type (if this does exist) or in a plain long
        // otherwise
#if defined(BOOST_HAS_LONG_LONG)
        typedef lslboost::long_long_type biggest_long_type;
#else
