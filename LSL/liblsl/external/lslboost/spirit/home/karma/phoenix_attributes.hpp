...
#include <lslboost/spirit/include/version.hpp>
...
namespace lslboost { namespace spirit { namespace traits
{
    ...
    struct is_container<phoenix::actor<Eval> const>
      : is_container<typename lslboost::result_of<phoenix::actor<Eval>()>::type>
    {};
    ...
    {
        typedef typename lslboost::result_of<phoenix::actor<Eval>()>::type type;
        static type call(phoenix::actor<Eval> const& f)
        {
            return f();
        }
