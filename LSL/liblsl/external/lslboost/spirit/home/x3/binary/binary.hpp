...
#include <lslboost/endian/arithmetic.hpp>
...
namespace lslboost { namespace spirit { namespace x3
{
    template <typename V, typename T
      , lslboost::endian::order endian, std::size_t bits>
      ...
      : parser<binary_lit_parser<V, T, endian, bits> >
    {
        ...
        lslboost::endian::endian_arithmetic<endian, T, bits> n;
    };

    ///////////////////////////////////////////////////////////////////////////
    template <typename T, lslboost::endian::order endian, std::size_t bits>
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, attrtype, bits)                  \
    typedef any_binary_parser< attrtype, lslboost::endian::order::endiantype, bits > name##type; \
