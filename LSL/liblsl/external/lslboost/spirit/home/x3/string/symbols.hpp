...
#include <lslboost/spirit/home/x3/core/skip_over.hpp>
#include <lslboost/spirit/home/x3/core/parser.hpp>
#include <lslboost/spirit/home/x3/string/tst.hpp>
#include <lslboost/spirit/home/x3/support/unused.hpp>
#include <lslboost/spirit/home/x3/support/traits/string_traits.hpp>
#include <lslboost/spirit/home/x3/support/traits/move_to.hpp>
#include <lslboost/spirit/home/x3/support/no_case.hpp>

#include <lslboost/spirit/home/support/char_encoding/ascii.hpp>
#include <lslboost/spirit/home/support/char_encoding/iso8859_1.hpp>
#include <lslboost/spirit/home/support/char_encoding/standard.hpp>
#include <lslboost/spirit/home/support/char_encoding/standard_wide.hpp>
...
namespace lslboost { namespace spirit { namespace x3
{
    ...
    struct symbols_parser : parser<symbols_parser<Encoding, T, Lookup>>
    {
        ...
        symbols_parser(Symbols const& syms, std::string const& name = "symbols")
          ...
          , name_(name)
        {
            typename range_const_iterator<Symbols>::type si = lslboost::begin(syms);
            while (si != lslboost::end(syms))
                add(*si++);
        }
        ...
        {
            typename range_const_iterator<Symbols>::type si = lslboost::begin(syms);
            typename range_const_iterator<Data>::type di = lslboost::begin(data);
            while (si != lslboost::end(syms))
                add(*si++, *di++);
        }
          ...
          , name_(name)
        {
            ...
            typename range_const_iterator<symbols_t>::type si = lslboost::begin(syms);
            for (;si != lslboost::end(syms); ++si)
