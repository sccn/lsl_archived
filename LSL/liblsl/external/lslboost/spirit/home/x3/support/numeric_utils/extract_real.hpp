...
#include <lslboost/spirit/home/x3/support/numeric_utils/pow10.hpp>
#include <lslboost/spirit/home/x3/support/numeric_utils/sign.hpp>
...
namespace lslboost { namespace spirit { namespace x3 { namespace extension
{
    ...
    scale(int exp, T& n)
    {
        if (exp >= 0)
        {
            // $$$ Why is this failing for lslboost.math.concepts ? $$$
