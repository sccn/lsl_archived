...
#include <lslboost/pool/pool_alloc.hpp>
#endif
...
#include <lslboost/spirit/home/classic/core.hpp>
...
#include <iostream>
#include <lslboost/spirit/home/classic/debug/debug_node.hpp>
#endif

#include <lslboost/spirit/home/classic/tree/common_fwd.hpp>
...
struct tree_node
{
    ...
    typedef lslboost::pool_allocator<tree_node<T> > allocator_type;
#else
    typedef lslboost::fast_pool_allocator<tree_node<T> > allocator_type;
#endif
...
{
    typedef
        typename lslboost::detail::iterator_traits<IteratorT>::value_type
        value_type;

#if !defined(BOOST_SPIRIT_USE_BOOST_ALLOCATOR_FOR_TREES)
    typedef std::allocator<value_type> allocator_type;
#elif !defined(BOOST_SPIRIT_USE_LIST_FOR_TREES)
    typedef lslboost::pool_allocator<value_type> allocator_type;
#else
    typedef lslboost::fast_pool_allocator<value_type> allocator_type;
#endif
...
public:
    ...
    typedef T attr_t;
    typedef typename lslboost::call_traits<T>::param_type      param_type;
