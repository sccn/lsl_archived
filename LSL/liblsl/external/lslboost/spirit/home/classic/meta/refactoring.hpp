...
#include <lslboost/spirit/home/classic/meta/impl/refactoring.ipp>
...
public:
    ...
    //  parser
    BOOST_STATIC_ASSERT((
        lslboost::is_convertible<typename BinaryT::parser_category_t,
...
public:
    ...
    //  parser
    BOOST_STATIC_ASSERT((
        lslboost::is_convertible<typename ActionT::parser_category_t,
