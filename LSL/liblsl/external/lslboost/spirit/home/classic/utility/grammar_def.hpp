...
#include <lslboost/spirit/home/classic/core/assert.hpp>
#include <lslboost/spirit/home/classic/utility/grammar_def_fwd.hpp>
...
namespace impl {
    ...
    private:
        ...
        BOOST_STATIC_ASSERT((!lslboost::is_same<T0, same>::value));

        typedef typename lslboost::mpl::if_c<
                    lslboost::is_same<T, same>::value,
                    T0 const *,
                    T const *
                >::type
            ptr_type;
    ...
    public:
        ...
        typedef typename lslboost::mpl::if_c<
                    lslboost::is_same<T, ::phoenix::nil_t>::value,
                    ::phoenix::nil_t,
                    ptr_type
                >::type
            type;
    ...
    struct init_tuple_member {
        ...
        do_(TupleT &t)
        {
            typedef typename lslboost::mpl::eval_if_c<
                        (N < TupleT::length),
