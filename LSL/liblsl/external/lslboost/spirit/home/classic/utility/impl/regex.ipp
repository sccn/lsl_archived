...
///////////////////////////////////////////////////////////////////////////////
#include <lslboost/spirit/home/classic/core/primitives/impl/primitives.ipp>
...
public:
    ...
    {
        lslboost::match_results<typename ScannerT::iterator_t> what;
        lslboost::regex_search(scan.first, scan.last, what, rxstr,
            lslboost::match_default);
...
private:
    ...
    lslboost::basic_regex<CharT> rxstr;       // regular expression to match
#else
    lslboost::reg_expression<CharT> rxstr;    // regular expression to match
#endif
};
