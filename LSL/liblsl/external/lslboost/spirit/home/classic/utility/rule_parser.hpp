...
//
//   http://www.lslboost.org/libs/spirit/doc/techniques.html#no_rules
//   http://www.lslboost.org/libs/spirit/doc/techniques.html#typeof
//
...
#   include <lslboost/preprocessor/tuple/to_seq.hpp>
...
#   include <lslboost/preprocessor/logical/nor.hpp>
...
#   define BOOST_SPIRIT_RP__PM_STATIC(r,data,i,elem)                           \
      static typename ::lslboost::call_traits< data ## i >::reference elem ;

// PM_CTOR_PARAMS
#   define BOOST_SPIRIT_RP__PM_CTOR_PARAMS(r,data,i,elem)                      \
      BOOST_PP_COMMA_IF(i)                                                     \
      typename ::lslboost::call_traits< data ## i >::param_type elem 
...
#   define BOOST_SPIRIT_RP__PM_OPAQUE_CTOR_PARAMS(r,data,i,elem)               \
      BOOST_PP_COMMA_IF(i) ::lslboost::call_traits<                               \
          BOOST_SPIRIT_RP_TYPE(BOOST_PP_TUPLE_ELEM(2,0,elem))                  \
...
#   define BOOST_SPIRIT_RP__MV_STATIC(r,data,i,elem)                           \
      static data() ::lslboost::call_traits<                                      \
            data() BOOST_SPIRIT_RP_TYPE(BOOST_PP_TUPLE_ELEM(3,0,elem))         \
...
#   define BOOST_SPIRIT_RP__AP_CTOR_PARAMS(r,data,i,elem)                      \
      ...
      typename ::lslboost::call_traits< __A ## i >::param_type elem
