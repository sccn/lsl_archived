...
//  of lslboost::iterator_adaptor, that is inhering an object created with it.
...
//  with lslboost::iterator_adaptor only 5 functions are needed to implement
...
//  platforms, and uses memory mapped files, which gives a decent speed lslboost.
//
///////////////////////////////////////////////////////////////////////////////
//
//  TODO LIST:
...
#include <lslboost/iterator_adaptors.hpp>
#include <lslboost/spirit/home/classic/namespace.hpp>
#include <lslboost/spirit/home/classic/core/safe_bool.hpp>

#include <lslboost/spirit/home/classic/iterator/file_iterator_fwd.hpp>
...
namespace fileiter_impl {
    ...
    //  file_iter_generator
    //
    //  Template meta-function to invoke lslboost::iterator_adaptor
...
public:
    ...
    // operator bool. This borrows a trick from lslboost::shared_ptr to avoid
...
///////////////////////////////////////////////////////////////////////////////
#include <lslboost/spirit/home/classic/iterator/impl/file_iterator.ipp> /* implementation */
