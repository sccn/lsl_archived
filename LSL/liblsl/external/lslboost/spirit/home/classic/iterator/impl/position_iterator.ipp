...
#include <lslboost/spirit/home/classic/core/nil.hpp>  // for nil_t
...
/* namespace lslboost::spirit { */ namespace iterator_ { namespace impl {

///////////////////////////////////////////////////////////////////////////////
//
//  position_iterator_base_generator
//
//  Metafunction to generate the iterator type using lslboost::iterator_adaptors,
...
{
private:
    typedef lslboost::detail::iterator_traits<ForwardIterT> traits;
    typedef typename traits::value_type value_type;
    typedef typename traits::iterator_category iter_category_t;

    // Position iterator is always a non-mutable iterator
    typedef typename lslboost::add_const<value_type>::type const_value_type;
...
public:
    ...
    typedef typename lslboost::mpl::if_<
        typename lslboost::is_same<MainIterT, nil_t>::type,
...
}} /* namespace lslboost::spirit::iterator_::impl */
