...
#include <lslboost/spirit/home/classic/core/assert.hpp> // for BOOST_SPIRIT_ASSERT
#include <lslboost/spirit/home/classic/iterator/fixed_size_queue.hpp>
#include <lslboost/detail/iterator.hpp> // for lslboost::detail::iterator_traits

#include <lslboost/spirit/home/classic/iterator/multi_pass_fwd.hpp>
...
class buf_id_check
{
    protected:
        ...
        void check_if_valid() const
        {
            ...
            {
                lslboost::throw_exception(illegal_backtracking());
            }
        }
...
class inner
{
    private:
        typedef
            typename lslboost::detail::iterator_traits<InputT>::value_type
            result_type;
    ...
    public:
        typedef
            typename lslboost::detail::iterator_traits<InputT>::difference_type
            difference_type;
        typedef
            typename lslboost::detail::iterator_traits<InputT>::pointer
            pointer;
        typedef
            typename lslboost::detail::iterator_traits<InputT>::reference
            reference;
...
// We are using lslboost::iterator<> because it offers an automatic workaround
