...
#include <lslboost/spirit/home/classic/core/non_terminal/impl/object_with_id.ipp>
#include <algorithm>
#include <functional>
...
#include <lslboost/spirit/home/classic/core/non_terminal/impl/static.hpp>
...
struct grammar_definition
{
    ...
    struct grammar_helper : private grammar_helper_base<GrammarT>
    {
        ...
        typedef lslboost::shared_ptr<helper_t> helper_ptr_t;
        typedef lslboost::weak_ptr<helper_t>   helper_weak_ptr_t;
...
#ifdef BOOST_SPIRIT_THREADSAFE
            lslboost::unique_lock<lslboost::mutex> lock(helpers.mutex());
#endif
...
# ifdef BOOST_SPIRIT_THREADSAFE
        lslboost::thread_specific_ptr<ptr_t> & tld_helper
            = static_<lslboost::thread_specific_ptr<ptr_t>,
