...
#include <lslboost/spirit/home/phoenix/stl/container/detail/container.hpp>
    ...
    namespace stl
    {
        ...
        struct erase
        {
            ...
            struct result
            {
                ...
                //  lslboost::phoenix::stl::erase::operator() 'void' function
                //  returning a value. Oh well... :*

                typedef
                    lslboost::mpl::eval_if<
                        lslboost::is_same<Arg1, typename iterator_of<C>::type>
        ...
        struct insert
        {
            ...
            class result
            {
                ...
                typedef
                    lslboost::mpl::eval_if<
                        lslboost::mpl::and_<
                            lslboost::is_same<Arg3, fusion::void_>
                          , lslboost::mpl::not_<lslboost::is_same<Arg1, Arg2> > >
                      , iterator_of<C>
                      , lslboost::mpl::identity<void>
                    >
                choice_2;
            ...
            public:
                ...
                typedef typename
                    lslboost::mpl::eval_if<
                        lslboost::is_same<Arg2, fusion::void_>
                      , choice_1
                      , choice_2
                    >::type
                type;
