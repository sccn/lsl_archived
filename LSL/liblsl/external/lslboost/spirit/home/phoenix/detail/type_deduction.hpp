...
/*=============================================================================
    ...
    through a lslboost::mpl vector which holds each of the corresponding
    result types.
...
namespace lslboost { namespace type_deduction_detail
{
...
}} // namespace lslboost::type_deduction_detail
