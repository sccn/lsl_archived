...
#pragma once
#endif
#include <lslboost/fusion/include/nview.hpp>
#include <lslboost/spirit/home/qi/string/lit.hpp>
#include <lslboost/fusion/include/at.hpp>
namespace lslboost { namespace spirit { namespace repository { namespace qi { namespace detail {
    ...
    struct is_distinct< spirit::qi::hold_directive<T> > : T::distinct { };
        ...
        struct parse_dispatcher
            : public lslboost::static_visitor<bool>
        {
    ...
    template <typename Elements, typename StringKeywords, typename IndexList, typename FlagsType, typename Modifiers>
        struct string_keywords
        {
            ...
            typedef typename get_keyword_char_type<
                typename mpl::if_<
                  mpl::equal_to<
                    ...
                    , mpl::int_<0>
                    >
                  , mpl::vector< lslboost::spirit::standard::char_type >
                  , char_types >::type
                >::type  char_type;
            ...
            struct keyword_entry_adder
            {
                ...
                const String get_string(const lslboost::spirit::qi::literal_string<String,no_attribute> &parser) const
                {
                        return parser.str;
                }

                template <typename String, bool no_attribute>
                const typename lslboost::spirit::qi::no_case_literal_string<String,no_attribute>::string_type &
                        get_string(const lslboost::spirit::qi::no_case_literal_string<String,no_attribute> &parser) const
                {
