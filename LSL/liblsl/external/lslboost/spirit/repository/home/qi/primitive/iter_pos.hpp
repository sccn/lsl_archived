...
#include <lslboost/spirit/include/qi_parse.hpp>
...
namespace lslboost { namespace spirit { namespace repository { namespace qi
{
    struct iter_pos_parser 
      : lslboost::spirit::qi::primitive_parser<iter_pos_parser>
    {
        ...
        {
            lslboost::spirit::qi::skip_over(first, last, skipper);
            lslboost::spirit::traits::assign_to(first, attr);
            return true;
        }
        ...
        lslboost::spirit::info what(Context&) const
        {
            return lslboost::spirit::info("iter_pos");
        }
    };
}}}}
