...
#include <lslboost/spirit/home/qi/detail/permute_function.hpp>
...
#include <lslboost/fusion/include/iter_fold.hpp>
...
#include <lslboost/spirit/home/qi/string/symbols.hpp>
#include <lslboost/spirit/home/qi/string/lit.hpp>
#include <lslboost/spirit/home/qi/action/action.hpp>
#include <lslboost/spirit/home/qi/directive/hold.hpp>
...
#include <lslboost/mpl/filter_view.hpp>
...
#include <lslboost/spirit/repository/home/qi/operator/detail/keywords.hpp>
#include <lslboost/fusion/include/any.hpp>
...
namespace lslboost { namespace spirit { namespace repository { namespace qi
{
    ...
    struct keywords : spirit::qi::nary_parser<keywords<Elements,Modifiers> >
    {
        ...
        // build_parser_tags
        //
        // Builds a lslboost::variant from an mpl::range_c in order to "mark" every 
        ...
        typedef lslboost::array<bool, fusion::result_of::size<Elements>::value> flags_type;
        typedef lslboost::array<int, fusion::result_of::size<Elements>::value> counters_type;
