...
#include <lslboost/spirit/home/qi/operator/kleene.hpp>
#include <lslboost/spirit/home/support/container.hpp>
#include <lslboost/spirit/home/qi/detail/attributes.hpp>
#include <lslboost/spirit/home/qi/detail/fail_function.hpp>
#include <lslboost/spirit/home/support/info.hpp>
#include <lslboost/spirit/repository/home/support/kwd.hpp>
...
namespace lslboost { namespace spirit { namespace qi
{
    ...
    struct make_directive_internal_2_args
    {
        ...
        result_type create_kwd_string(Terminal const &term, Subject const & subject, lslboost::mpl::true_ ) const
        {
        ...
        template <typename Terminal>
        result_type create_kwd_string(Terminal const &term, Subject const & subject, lslboost::mpl::false_ ) const
        {
           return result_type(subject
        ...
        template <typename Terminal>
        result_type create_kwd(Terminal const &term, Subject const & subject, Modifiers const& modifiers, lslboost::mpl::true_ ) const
        {
           return create_kwd_string(term,subject,no_case());
        }
        // Return a complex_kwd parser object
        template <typename Terminal>
        result_type create_kwd(Terminal const &term , Subject const & subject, Modifiers const& modifiers, lslboost::mpl::false_ ) const
        {
           return result_type(subject
