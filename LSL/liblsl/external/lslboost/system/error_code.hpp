//  lslboost/system/error_code.hpp  ---------------------------------------------//
...
# endif
    ...
    //
    //       <lslboost/system/cygwin_error.hpp>
    //       <lslboost/system/linux_error.hpp>
    //       <lslboost/system/windows_error.hpp>
    //
    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename lslboost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorConditionEnum>
        typename lslboost::enable_if<is_error_condition_enum<ErrorConditionEnum>, error_condition>::type &
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename lslboost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0) BOOST_SYSTEM_NOEXCEPT
      {
