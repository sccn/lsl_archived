...
namespace lslboost 
{
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_result
        {
            ...
            template< typename T > struct x< lslboost::reference_wrapper<T> >
            { typedef T& t; };
...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        lslboost::detail::lightweight_forward_adapter_impl< \
...
#       define  BOOST_PP_FILENAME_1 \
            <lslboost/functional/lightweight_forward_adapter.hpp>
...
#       include BOOST_PP_ITERATE()
    ...
    struct result_of<lslboost::lightweight_forward_adapter<F,A0,A1> const ()>
        : lslboost::detail::lightweight_forward_adapter_result::template apply<
            lslboost::lightweight_forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<lslboost::lightweight_forward_adapter<F,A0,A1>()>
        : lslboost::detail::lightweight_forward_adapter_result::template apply<
            lslboost::lightweight_forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<lslboost::lightweight_forward_adapter<F,A0,A1> const& ()>
        : lslboost::detail::lightweight_forward_adapter_result::template apply<
...
#     define N BOOST_PP_ITERATION() 
            ...
            : lightweight_forward_adapter_result
        {
            ...
            inline typename lslboost::result_of< F(BOOST_PP_ENUM_BINARY_PARAMS(N,
