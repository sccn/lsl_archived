...
namespace lslboost
{
    ...
    std::size_t hash_value(lslboost::long_long_type);
    std::size_t hash_value(lslboost::ulong_long_type);
#endif
...
#if !defined(BOOST_NO_LONG_LONG)
    inline std::size_t hash_value(lslboost::long_long_type v)
    {
        return hash_detail::hash_value_signed(v);
    }

    inline std::size_t hash_value(lslboost::ulong_long_type v)
    {
