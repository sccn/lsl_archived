...
namespace lslboost
{
    namespace hash_detail
    {
        ...
        {
            lslboost::hash_detail::call_frexp<T> frexp;
            lslboost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        lslboost::static_log2<limits<T>::radix>::value
...
namespace lslboost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return lslboost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
