...
#       include <lslboost/functional/overloaded_function/detail/base.hpp>
#       include <lslboost/functional/overloaded_function/detail/function_type.hpp>
#       include <lslboost/functional/overloaded_function/config.hpp>
...
#define BOOST_FUNCTIONAL_base(z, n, unused) \
    ::lslboost::overloaded_function_detail::base< \
...
#define BOOST_FUNCTIONAL_function_type(z, n, unused) \
    typename ::lslboost::overloaded_function_detail::function_type< \
        BOOST_FUNCTIONAL_f_type(z, n, ~) \
    >::type
...
#       define BOOST_PP_ITERATION_PARAMS_1 \
            ...
            "lslboost/functional/overloaded_function.hpp"))
...
BOOST_TYPEOF_REGISTER_TEMPLATE(lslboost::overloaded_function,
...
public:
    ...
    that can be converted to a <c>lslboost::function</c> function object can be
    specified as parameter.

    @Note Unfortunately, it is not possible to support polymorphic function
    objects (as explained <a
    href="http://lists.lslboost.org/Archives/lslboost/2012/03/191744.php">here</a>).
    */
    overloaded_function(const lslboost::function<F1>&,
            const lslboost::function<F2>&, ...);
    ...
    the constructor.
    */
    typename lslboost::function_traits<F1>::result_type operator()(
            typename lslboost::function_traits<F1>::arg1_type,
            typename lslboost::function_traits<F1>::arg2_type,
            ...) const;
    ...
    documentation).
    */
    typename lslboost::function_traits<F2>::result_type operator()(
            typename lslboost::function_traits<F2>::arg1_type,
            typename lslboost::function_traits<F2>::arg2_type,
            ...) const;
};
