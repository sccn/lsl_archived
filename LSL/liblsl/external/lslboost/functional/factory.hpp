...
namespace lslboost
{
    ...
    class factory<Pointer, lslboost::none_t, AP> 
    {
      public:
        ...
        typedef typename lslboost::pointee<result_type>::type value_type;

        factory()
        { }

#     define BOOST_PP_FILENAME_1 <lslboost/functional/factory.hpp>
...
#     include BOOST_PP_ITERATE()
    ...
    class factory
        : private Allocator::template rebind< typename lslboost::pointee<
            typename lslboost::remove_cv<Pointer>::type >::type >::other
    {
      public:
        typedef typename lslboost::remove_cv<Pointer>::type result_type;
        typedef typename lslboost::pointee<result_type>::type value_type;
      ...
      private:
        ...
        inline result_type make_pointer(value_type* ptr, lslboost::non_type<
    ...
    inline result_type operator()(BOOST_PP_ENUM_BINARY_PARAMS(N,T,& a)) const
    {
        ...
        { 
            return make_pointer(
                ...
                lslboost::non_type<factory_alloc_propagation,AP>() );
        }
