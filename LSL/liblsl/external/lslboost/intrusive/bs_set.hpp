...
#endif
{
   ...
   {  return static_cast<bs_set_impl&>(tree_type::operator=(::lslboost::move(static_cast<tree_type&>(x)))); }
   ...
   >::type
{
   ...
   {  return static_cast<bs_set &>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
...
#endif
{
   ...
   {  return static_cast<bs_multiset_impl&>(tree_type::operator=(::lslboost::move(static_cast<tree_type&>(x)))); }
      ...
      >::type
{
   ...
   {  return static_cast<bs_multiset &>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
