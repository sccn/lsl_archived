...
#include <lslboost/intrusive/detail/clear_on_destructor_base.hpp>
#include <lslboost/intrusive/detail/utilities.hpp>
//Implementation utilities
#include <lslboost/intrusive/trivial_value_traits.hpp>
...
struct get_slist_impl
{
   ...
   struct type : make_slist
      ...
      , lslboost::intrusive::value_traits<trivial_traits>
      , lslboost::intrusive::constant_time_size<false>
	  , lslboost::intrusive::size_type<typename lslboost::make_unsigned
      ...
      , typename Config::size_type>
{
   ...
   bucket_plus_size(BOOST_FWD_REF(BucketTraits) b_traits)
      :  bucket_traits_(::lslboost::forward<BucketTraits>(b_traits))
   {}
   ...
   : public detail::ebo_functor_holder<typename Config::hash> //hash
{
   ...
   bucket_hash_t(BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h)
      :  detail::ebo_functor_holder<hasher>(h), bucket_plus_size_(::lslboost::forward<BucketTraits>(b_traits))
   {}
   ...
   : public detail::ebo_functor_holder<typename Config::equal>
{
   ...
   bucket_hash_equal_t(BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h, const equal &e)
      ...
      , bucket_hash(::lslboost::forward<BucketTraits>(b_traits), h)
   {}
...
struct hashtable_data_t : public Config::value_traits
{
   ...
   hashtable_data_t( BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h
      ...
      , internal_(::lslboost::forward<BucketTraits>(b_traits), h, e)
   {}
         ...
         , typename Config::size_type>
   {
      ...
      internal(BOOST_FWD_REF(BucketTraits) b_traits, const hasher & h, const equal &e)
         :  bucket_hash_equal_(::lslboost::forward<BucketTraits>(b_traits), h, e)
      {}
   ...
   :  private detail::clear_on_destructor_base<hashtable_impl<Config> >
{
   ...
   hashtable_impl(BOOST_RV_REF(hashtable_impl) x)
      : data_( ::lslboost::move(x.priv_bucket_traits())
             , ::lslboost::move(x.priv_hasher())
             , ::lslboost::move(x.priv_equal())
             , ::lslboost::move(x.priv_value_traits())
             )
   {
   ...
   bool empty() const
   {
      if(constant_time_size){
         ...
         const bucket_type *b = lslboost::intrusive::detail::to_raw_pointer(this->priv_buckets());
   ...
   {  return node_ptr(const_cast<node*>(lslboost::intrusive::detail::to_raw_pointer(ptr)));  }
         ...
         >::type
{
   ...
   {  this->Base::operator=(::lslboost::move(static_cast<Base&>(x))); return *this;  }
};
