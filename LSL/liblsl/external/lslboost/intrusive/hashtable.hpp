...
#include <lslboost/intrusive/detail/hashtable_node.hpp>
#include <lslboost/intrusive/detail/transform_iterator.hpp>
#include <lslboost/intrusive/link_mode.hpp>
#include <lslboost/intrusive/detail/ebo_functor_holder.hpp>
#include <lslboost/intrusive/detail/is_stateful_value_traits.hpp>
#include <lslboost/intrusive/detail/node_to_value.hpp>
#include <lslboost/intrusive/detail/exception_disposer.hpp>
#include <lslboost/intrusive/detail/node_cloner_disposer.hpp>
#include <lslboost/intrusive/detail/simple_disposers.hpp>
#include <lslboost/intrusive/detail/size_holder.hpp>
#include <lslboost/intrusive/detail/iterator.hpp>

//Implementation utilities
#include <lslboost/intrusive/unordered_set_hook.hpp>
...
//std C++
#include <lslboost/intrusive/detail/minimal_less_equal_header.hpp>   //std::equal_to
...
template<class InputIt, class T>
typename lslboost::intrusive::iterator_traits<InputIt>::difference_type
   priv_algo_count(InputIt first, InputIt last, const T& value)
{
   typename lslboost::intrusive::iterator_traits<InputIt>::difference_type ret = 0;
   for (; first != last; ++first) {
      if (*first == value) {
            ret++;
      }
...
{
   typedef typename
      lslboost::intrusive::iterator_traits<ForwardIterator2>::difference_type
         distance_type;
   ...
   lslboost::intrusive::iterator_advance(last2, lslboost::intrusive::iterator_distance(first1, last1));
...
struct bucket_plus_vtraits
{
   ...
   bucket_plus_vtraits(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits)
      :  data(val_traits, ::lslboost::forward<BucketTraitsType>(b_traits))
   {}
   ...
   struct data_type : public ValueTraits
   {
      ...
      data_type(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits)
         : ValueTraits(val_traits), bucket_traits_(::lslboost::forward<BucketTraitsType>(b_traits))
      {}
...
{
   typedef ::lslboost::intrusive::detail::identity<T> type;
};
   ...
   , bucket_plus_vtraits<ValueTraits, BucketTraits>  //4
{
   ...
   bucket_hash_t(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits, const hasher & h)
      :  detail::ebo_functor_holder<hasher>(h), bucket_plus_vtraits_t(val_traits, ::lslboost::forward<BucketTraitsType>(b_traits))
   {}
   ...
   , public hashtable_equal_holder<ValueTraits, BucketTraits, VoidOrKeyOfValue, VoidOrKeyEqual>::type //equal
{
   ...
   bucket_hash_equal_t(const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits, const hasher & h, const key_equal &e)
      : bucket_hash_type(val_traits, ::lslboost::forward<BucketTraitsType>(b_traits), h)
      , equal_holder_t(e)
   {}
   ...
   , hashtable_equal_holder<ValueTraits, BucketTraits, VoidOrKeyOfValue, VoidOrKeyEqual>::type
{
   ...
   {
      ::lslboost::adl_move_swap(this->cached_begin_, other.cached_begin_);
   }
   ...
   : public DeriveFrom
{
   ...
   hashtable_size_traits_wrapper( BOOST_FWD_REF(Base) base, BOOST_FWD_REF(Arg0) arg0
      ...
      :  DeriveFrom(::lslboost::forward<Base>(base)
      , ::lslboost::forward<Arg0>(arg0)
      ...
      >
{
   ...
   hashdata_internal( const ValueTraits &val_traits, BOOST_FWD_REF(BucketTraitsType) b_traits
      ...
      :  internal_type(val_traits, ::lslboost::forward<BucketTraitsType>(b_traits), h, e)
   {}
      ...
      >
{
   ...
   hashtable_impl(BOOST_RV_REF(hashtable_impl) x)
      : internal_type( ::lslboost::move(x.priv_value_traits())
                     , ::lslboost::move(x.priv_bucket_traits())
                     , ::lslboost::move(x.priv_hasher())
                     , ::lslboost::move(x.priv_equal())
                     )
   {
   ...
   bool empty() const
   {
      if(constant_time_size){
         ...
         const bucket_type *b = lslboost::intrusive::detail::to_raw_pointer(this->priv_bucket_pointer());
   ...
   {
      //These can throw
      ::lslboost::adl_move_swap(this->priv_equal(),  other.priv_equal());
      ::lslboost::adl_move_swap(this->priv_hasher(), other.priv_hasher());
      //These can't throw
      ::lslboost::adl_move_swap(this->priv_bucket_traits(), other.priv_bucket_traits());
      ::lslboost::adl_move_swap(this->priv_value_traits(), other.priv_value_traits());
      this->priv_swap_cache(other);
      ::lslboost::adl_move_swap(this->priv_size_traits(), other.priv_size_traits());
      ::lslboost::adl_move_swap(this->priv_split_traits(), other.priv_split_traits());
   }
   ...
   friend bool operator==(const hashtable_impl &x, const hashtable_impl &y)
   {
      ...
      for (const_iterator ix = x.cbegin(), ex = x.cend(); ix != ex; ++ix){
         ...
         if (lslboost::intrusive::iterator_distance(eqx.first, eqx.second) !=
             lslboost::intrusive::iterator_distance(eqy.first, eqy.second) ||
      ...
      , size_type &cnt) const
   {
      ...
      if(to_return.first != to_return.second){
         ...
         if(optimize_multikey){
            ...
            cnt += lslboost::intrusive::iterator_distance(++it, to_return.second);
         }
         else{
