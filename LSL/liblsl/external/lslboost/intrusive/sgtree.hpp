...
#include <lslboost/intrusive/detail/math.hpp>
   ...
   /// @endcond
{
   ...
   {  ::lslboost::adl_move_swap(this->get_alpha_traits(), x.get_alpha_traits());   }
   ...
   void swap(sgtree_impl& other)
   {
      ...
      ::lslboost::adl_move_swap(this->get_alpha_traits(), other.get_alpha_traits());
   }
   ...
   void clone_from(BOOST_RV_REF(sgtree_impl) src, Cloner cloner, Disposer disposer)
   {
      ...
      this->get_alpha_traits() = ::lslboost::move(src.get_alpha_traits());
   }
