   ...
   :  private detail::clear_on_destructor_base<sgtree_impl<Config> >
{
   ...
   typedef lslboost::intrusive::detail::reverse_iterator<iterator>      reverse_iterator;
   typedef lslboost::intrusive::detail::reverse_iterator<const_iterator>const_reverse_iterator;
   ...
   sgtree_impl(BOOST_RV_REF(sgtree_impl) x)
      : data_(::lslboost::move(x.priv_comp()), ::lslboost::move(x.priv_value_traits()))
   {
      node_algorithms::init_header(this->priv_header_ptr()); 
      this->priv_size_traits().set_size(size_type(0));
      this->swap(x);
...
/*
   ...
   static void remove_node(T& value)
   {
      ...
      BOOST_STATIC_ASSERT((lslboost::is_convertible<T, value_type>::value));
...
*/
   ...
   static sgtree_impl &priv_container_from_end_iterator(const const_iterator &end_iterator)
   {
      header_plus_alpha *r = detail::parent_from_member<header_plus_alpha, node>
         ( lslboost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()), &header_plus_alpha::header_);
