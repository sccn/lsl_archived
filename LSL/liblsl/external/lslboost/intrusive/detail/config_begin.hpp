...
#include <lslboost/config.hpp>
   ...
   #pragma warning (disable : 4541) //'typeid' used on polymorphic type 'lslboost::exception' with /GR-
   #pragma warning (disable : 4512) //'typeid' used on polymorphic type 'lslboost::exception' with /GR-
#endif
