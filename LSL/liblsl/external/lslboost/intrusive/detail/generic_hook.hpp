   ...
   /// @endcond
{
   ...
   public:
   struct lslboost_intrusive_tags
   {
   ...
   generic_hook()
   {
      if(lslboost_intrusive_tags::safemode_or_autounlink){
   ...
   {
      destructor_impl
         (*this, detail::link_dispatch<lslboost_intrusive_tags::link_mode>());
   }
   ...
   bool is_linked() const
   {
      ...
      BOOST_STATIC_ASSERT(( lslboost_intrusive_tags::safemode_or_autounlink ));
      return !node_algorithms::unique(this->this_ptr());
   }

   void unlink()
   {
      BOOST_STATIC_ASSERT(( (int)lslboost_intrusive_tags::link_mode == (int)auto_unlink ));
