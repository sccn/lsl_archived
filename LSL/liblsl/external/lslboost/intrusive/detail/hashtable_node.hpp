...
//#include <lslboost/intrusive/detail/slist_node.hpp> //remove-me
#include <lslboost/intrusive/pointer_traits.hpp>
#include <cstddef>
         ...
         >
{
   ...
   {
      return lslboost::intrusive::detail::to_raw_pointer(this->get_real_value_traits()->to_value_ptr
   ...
   void increment()
   {
      const Container *cont =  lslboost::intrusive::detail::to_raw_pointer(cont_);
      bucket_type* buckets = lslboost::intrusive::detail::to_raw_pointer(cont->bucket_pointer());
