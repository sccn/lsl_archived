...
struct internal_base_hook_bool
{
   ...
   template <class U> static two_or_three<U::lslboost_intrusive_tags::is_base_hook> test (int);
...
inline typename lslboost::intrusive::pointer_traits<Pointer>::element_type*
...
struct constptr
{
   typedef typename lslboost::intrusive::pointer_traits<VoidPointer>::
   ...
   const void *get_ptr() const
   {  return lslboost::intrusive::detail::to_raw_pointer(const_void_ptr_);  }
...
struct member_hook_traits
{
   ...
   typedef typename hook_type::lslboost_intrusive_tags::node_traits     node_traits;
   ...
   static const link_mode_type link_mode = Hook::lslboost_intrusive_tags::link_mode;
   ...
   static pointer to_value_ptr(const node_ptr & n)
   {
      return pointer_traits<pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<Hook*>(lslboost::intrusive::detail::to_raw_pointer(n)), P));
   }
   ...
   static const_pointer to_value_ptr(const const_node_ptr & n)
   {
      return pointer_traits<const_pointer>::pointer_to
         (*detail::parent_from_member<T, Hook>
            (static_cast<const Hook*>(lslboost::intrusive::detail::to_raw_pointer(n)), P));
   }
};
...
struct function_hook_traits
{
   ...
   static const link_mode_type link_mode = hook_type::lslboost_intrusive_tags::link_mode;

   static node_ptr to_node_ptr(reference value)
   {  return static_cast<node*>(lslboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }

   static const_node_ptr to_node_ptr(const_reference value)
   {  return static_cast<const node*>(lslboost::intrusive::detail::to_raw_pointer(Functor::to_hook_ptr(value)));  }
...
{
   static const lslboost::uint32_t value = 0xb504f334;
...
{
   static const lslboost::uint64_t value = 0xb504f333f9de6484ull;
