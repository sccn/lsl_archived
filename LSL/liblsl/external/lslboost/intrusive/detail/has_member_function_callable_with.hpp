...
// sample.h
   ...
   #define BOOST_INTRUSIVE_DETAIL_HAS_MEMBER_FUNCTION_CALLABLE_WITH_DETAILS_INCLUDED
      ...
      namespace lslboost_intrusive_has_member_function_callable_with {
      ...
      }  //lslboost_intrusive_has_member_function_callable_with
   ...
   #error "BOOST_PP_ITERATION_START() must be zero (0)"
      ...
      class BOOST_PP_CAT(has_member_function_named_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)
      {
         ...
         template <typename U>
         static lslboost_intrusive_has_member_function_callable_with::no_type  deduce
            (U*, Helper<void (BaseMixin::*)(), &U::BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME>* = 0);
         static lslboost_intrusive_has_member_function_callable_with::yes_type deduce(...);

         public:
         static const bool value =
            sizeof(lslboost_intrusive_has_member_function_callable_with::yes_type) == sizeof(deduce((Base*)(0)));
      };
         ...
         //!
            ...
            template< class F
                  , std::size_t N =
                        sizeof((lslboost::move_detail::declval<F>().
            ...
            {
               lslboost_intrusive_has_member_function_callable_with::yes_type dummy;
            ...
            {
               lslboost_intrusive_has_member_function_callable_with::no_type dummy;
               BOOST_PP_CAT(zeroarg_checker_, BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME)(int);
            };
            ...
            {
               template<class U>
               static decltype( lslboost::move_detail::declval<Fun>().BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME()
                              , lslboost_intrusive_has_member_function_callable_with::yes_type())
                  Test(Fun*);
            ...
            : Fun
         {
            ...
            lslboost_intrusive_has_member_function_callable_with::private_type
            ...
            <Fun, true , Args...>
         {
            ...
            {
               typedef lslboost_intrusive_has_member_function_callable_with::dont_care type;
            };
            ...
            static bool const value = (sizeof(lslboost_intrusive_has_member_function_callable_with::no_type) ==
                                       sizeof(lslboost_intrusive_has_member_function_callable_with::is_private_type
                                                ( (::lslboost::move_detail::declval< FunWrap >().
                                          BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
                                             ( ::lslboost::move_detail::declval<Args>()... ), 0) )
                                             )
                                       );
         };
      ...
      BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_NS_END
            ...
            : Fun
         {
            ...
            lslboost_intrusive_has_member_function_callable_with::private_type
               BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
                  ...
                  , lslboost_intrusive_has_member_function_callable_with::dont_care))  const;
         };
                                  ...
                                  , void)>
         {
            ...
            (sizeof(lslboost_intrusive_has_member_function_callable_with::no_type) ==
               sizeof(lslboost_intrusive_has_member_function_callable_with::is_private_type
                        (  (lslboost::move_detail::declval<FunWrap>().
                              BOOST_INTRUSIVE_HAS_MEMBER_FUNCTION_CALLABLE_WITH_FUNCNAME
