...
struct tree_value_compare
   :  public lslboost::intrusive::detail::ebo_functor_holder<KeyCompare>
{
   typedef lslboost::intrusive::detail::ebo_functor_holder<KeyCompare> base_t;
   ...
   template<class U>
   struct is_key
      : lslboost::intrusive::detail::is_same<const U, const key_type>
   {};

   template<class U>
   typename lslboost::intrusive::detail::enable_if<is_key<U>, const key_type &>::type
      key_forward(const U &key) const
   {  return key; }

   template<class U>
   typename lslboost::intrusive::detail::disable_if<is_key<U>, const key_type &>::type
      key_forward(const U &key) const
