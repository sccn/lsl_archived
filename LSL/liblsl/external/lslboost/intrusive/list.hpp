...
#include <lslboost/intrusive/list_hook.hpp>
#include <lslboost/intrusive/circular_list_algorithms.hpp>
...
#include <lslboost/intrusive/detail/list_iterator.hpp>
#include <lslboost/intrusive/detail/array_initializer.hpp>
#include <lslboost/intrusive/detail/exception_disposer.hpp>
#include <lslboost/intrusive/detail/equal_to_value.hpp>
...
#include <lslboost/intrusive/detail/minimal_less_equal_header.hpp>//std::less
...
class list_impl
{
   ...
   list_impl(BOOST_RV_REF(list_impl) x)
      : data_(::lslboost::move(x.priv_value_traits()))
   {
      this->priv_size_traits().set_size(size_type(0));
      node_algorithms::init_header(this->get_root_node());
      //nothrow, no need to rollback to release elements on exception
