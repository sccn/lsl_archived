         ...
         >
{
   ...
   static list_impl &priv_container_from_end_iterator(const const_iterator &end_iterator)
   {
      root_plus_size *r = detail::parent_from_member<root_plus_size, node>
         ( lslboost::intrusive::detail::to_raw_pointer(end_iterator.pointed_node()), &root_plus_size::root_);
   ...
   >::type
{
   ...
   {  return static_cast<list &>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
