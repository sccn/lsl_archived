...
#include <lslboost/intrusive/treap_algorithms.hpp>
#include <lslboost/intrusive/link_mode.hpp>
#include <lslboost/move/move.hpp>
#include <lslboost/intrusive/priority_compare.hpp>
   ...
   /// @endcond
{
   ...
   treap_impl(BOOST_RV_REF(treap_impl) x)
      ...
      , prio_base(::lslboost::move(x.priv_pcomp()))
   {}
      ...
      >::type
{
   ...
   {  return static_cast<treap&>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
