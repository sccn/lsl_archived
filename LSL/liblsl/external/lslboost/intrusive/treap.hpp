   ...
   /// @endcond
{
   ...
   void swap(treap_impl& other)
   {
      ...
      //This can throw
      ::lslboost::adl_move_swap(this->priv_pcomp(), other.priv_pcomp());
   }
   ...
   void clone_from(BOOST_RV_REF(treap_impl) src, Cloner cloner, Disposer disposer)
   {
      ...
      this->priv_pcomp() = ::lslboost::move(src.priv_pcomp());
   }
   ...
   //! @copydoc ::lslboost::intrusive::bstree::check(ExtraChecker)const
   ...
   //! @copydoc ::lslboost::intrusive::bstree::check()const
   void check() const
