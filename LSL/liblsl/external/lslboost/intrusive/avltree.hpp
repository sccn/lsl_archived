   ...
   /// @endcond
{
   ...
   {  return static_cast<avltree_impl&>(tree_type::operator=(::lslboost::move(static_cast<tree_type&>(x)))); }
      ...
      >::type
{
   ...
   {  return static_cast<avltree &>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
