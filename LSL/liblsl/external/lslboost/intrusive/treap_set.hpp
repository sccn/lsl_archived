...
#include <lslboost/intrusive/treap.hpp>
...
#endif
{
   ...
   {  return static_cast<treap_set_impl&>(tree_type::operator=(::lslboost::move(static_cast<tree_type&>(x))));  }

   #ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
   //! @copydoc ::lslboost::intrusive::treap::~treap()
   ~treap_set_impl();

   //! @copydoc ::lslboost::intrusive::treap::begin()
   iterator begin();

   //! @copydoc ::lslboost::intrusive::treap::begin()const
   const_iterator begin() const;

   //! @copydoc ::lslboost::intrusive::treap::cbegin()const
   const_iterator cbegin() const;

   //! @copydoc ::lslboost::intrusive::treap::end()
   iterator end();

   //! @copydoc ::lslboost::intrusive::treap::end()const
   const_iterator end() const;

   //! @copydoc ::lslboost::intrusive::treap::cend()const
   const_iterator cend() const;

   //! @copydoc ::lslboost::intrusive::treap::rbegin()
   reverse_iterator rbegin();

   //! @copydoc ::lslboost::intrusive::treap::rbegin()const
   const_reverse_iterator rbegin() const;

   //! @copydoc ::lslboost::intrusive::treap::crbegin()const
   const_reverse_iterator crbegin() const;

   //! @copydoc ::lslboost::intrusive::treap::rend()
   reverse_iterator rend();

   //! @copydoc ::lslboost::intrusive::treap::rend()const
   const_reverse_iterator rend() const;

   //! @copydoc ::lslboost::intrusive::treap::crend()const
   const_reverse_iterator crend() const;

   //! @copydoc ::lslboost::intrusive::treap::container_from_end_iterator(iterator)
   static treap_set_impl &container_from_end_iterator(iterator end_iterator);

   //! @copydoc ::lslboost::intrusive::treap::container_from_end_iterator(const_iterator)
   static const treap_set_impl &container_from_end_iterator(const_iterator end_iterator);

   //! @copydoc ::lslboost::intrusive::treap::container_from_iterator(iterator)
   static treap_set_impl &container_from_iterator(iterator it);

   //! @copydoc ::lslboost::intrusive::treap::container_from_iterator(const_iterator)
   static const treap_set_impl &container_from_iterator(const_iterator it);

   //! @copydoc ::lslboost::intrusive::treap::key_comp()const
   key_compare key_comp() const;

   //! @copydoc ::lslboost::intrusive::treap::value_comp()const
   value_compare value_comp() const;

   //! @copydoc ::lslboost::intrusive::treap::empty()const
   bool empty() const;

   //! @copydoc ::lslboost::intrusive::treap::size()const
   size_type size() const;

   //! @copydoc ::lslboost::intrusive::treap::swap
   void swap(treap_set_impl& other);

   //! @copydoc ::lslboost::intrusive::treap::clone_from
   template <class Cloner, class Disposer>
   void clone_from(const treap_set_impl &src, Cloner cloner, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::treap::top()
   iterator top();

   //! @copydoc ::lslboost::intrusive::treap::top()const
   const_iterator top() const;

   //! @copydoc ::lslboost::intrusive::treap::ctop()const
   const_iterator ctop() const;

   //! @copydoc ::lslboost::intrusive::treap::rtop()
   reverse_iterator rtop();

   //! @copydoc ::lslboost::intrusive::treap::rtop()const
   const_reverse_iterator rtop() const;

   //! @copydoc ::lslboost::intrusive::treap::crtop()const
   ...
   //! @copydoc ::lslboost::intrusive::treap::insert_unique(reference)
   std::pair<iterator, bool> insert(reference value)
   {  return tree_type::insert_unique(value);  }

   //! @copydoc ::lslboost::intrusive::treap::insert_unique(const_iterator,reference)
   iterator insert(const_iterator hint, reference value)
   {  return tree_type::insert_unique(hint, value);  }

   //! @copydoc ::lslboost::intrusive::treap::insert_unique_check(const KeyType&,KeyValueCompare,KeyValuePrioCompare,insert_commit_data&)
   ...
   //! @copydoc ::lslboost::intrusive::treap::insert_unique_check(const_iterator,const KeyType&,KeyValueCompare,KeyValuePrioCompare,insert_commit_data&)
   template<class KeyType, class KeyValueCompare, class KeyValuePrioCompare>
   std::pair<iterator, bool> insert_check
   ...
   //! @copydoc ::lslboost::intrusive::treap::insert_unique(Iterator,Iterator)
   template<class Iterator>
   void insert(Iterator b, Iterator e)
   {  tree_type::insert_unique(b, e);  }

   //! @copydoc ::lslboost::intrusive::treap::insert_unique_commit
   iterator insert_commit(reference value, const insert_commit_data &commit_data)
   {  return tree_type::insert_unique_commit(value, commit_data);  }

   #ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED
   //! @copydoc ::lslboost::intrusive::treap::insert_before
   iterator insert_before(const_iterator pos, reference value);

   //! @copydoc ::lslboost::intrusive::treap::push_back
   void push_back(reference value);

   //! @copydoc ::lslboost::intrusive::treap::push_front
   void push_front(reference value);

   //! @copydoc ::lslboost::intrusive::treap::erase(const_iterator)
   iterator erase(const_iterator i);

   //! @copydoc ::lslboost::intrusive::treap::erase(const_iterator,const_iterator)
   iterator erase(const_iterator b, const_iterator e);

   //! @copydoc ::lslboost::intrusive::treap::erase(const_reference)
   size_type erase(const_reference value);

   //! @copydoc ::lslboost::intrusive::treap::erase(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   size_type erase(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::lslboost::intrusive::treap::erase_and_dispose(const_iterator,Disposer)
   template<class Disposer>
   iterator erase_and_dispose(const_iterator i, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::treap::erase_and_dispose(const_iterator,const_iterator,Disposer)
   template<class Disposer>
   iterator erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::treap::erase_and_dispose(const_reference, Disposer)
   template<class Disposer>
   size_type erase_and_dispose(const_reference value, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::treap::erase_and_dispose(const KeyType&,KeyValueCompare,Disposer)
   template<class KeyType, class KeyValueCompare, class Disposer>
   size_type erase_and_dispose(const KeyType& key, KeyValueCompare comp, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::treap::clear
   void clear();

   //! @copydoc ::lslboost::intrusive::treap::clear_and_dispose
   template<class Disposer>
   void clear_and_dispose(Disposer disposer);

   //! @copydoc ::lslboost::intrusive::treap::count(const_reference)const
   size_type count(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::treap::count(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   size_type count(const KeyType& key, KeyValueCompare comp) const;
   
   //! @copydoc ::lslboost::intrusive::treap::lower_bound(const_reference)
   iterator lower_bound(const_reference value);
   
   //! @copydoc ::lslboost::intrusive::treap::lower_bound(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   iterator lower_bound(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::lslboost::intrusive::treap::lower_bound(const_reference)const
   const_iterator lower_bound(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::treap::lower_bound(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   const_iterator lower_bound(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::lslboost::intrusive::treap::upper_bound(const_reference)
   iterator upper_bound(const_reference value);

   //! @copydoc ::lslboost::intrusive::treap::upper_bound(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   iterator upper_bound(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::lslboost::intrusive::treap::upper_bound(const_reference)const
   const_iterator upper_bound(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::treap::upper_bound(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   const_iterator upper_bound(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::lslboost::intrusive::treap::find(const_reference)
   iterator find(const_reference value);

   //! @copydoc ::lslboost::intrusive::treap::find(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   iterator find(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::lslboost::intrusive::treap::find(const_reference)const
   const_iterator find(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::treap::find(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   const_iterator find(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::lslboost::intrusive::treap::equal_range(const_reference)
   std::pair<iterator,iterator> equal_range(const_reference value);

   //! @copydoc ::lslboost::intrusive::treap::equal_range(const KeyType&,KeyValueCompare)
   template<class KeyType, class KeyValueCompare>
   std::pair<iterator,iterator> equal_range(const KeyType& key, KeyValueCompare comp);

   //! @copydoc ::lslboost::intrusive::treap::equal_range(const_reference)const
   std::pair<const_iterator, const_iterator>
      equal_range(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::treap::equal_range(const KeyType&,KeyValueCompare)const
   template<class KeyType, class KeyValueCompare>
   std::pair<const_iterator, const_iterator>
      equal_range(const KeyType& key, KeyValueCompare comp) const;

   //! @copydoc ::lslboost::intrusive::treap::bounded_range(const_reference,const_reference,bool,bool)
   std::pair<iterator,iterator> bounded_range
      (const_reference lower_value, const_reference upper_value, bool left_closed, bool right_closed);

   //! @copydoc ::lslboost::intrusive::treap::bounded_range(const KeyType&,const KeyType&,KeyValueCompare,bool,bool)
   template<class KeyType, class KeyValueCompare>
   std::pair<iterator,iterator> bounded_range
      (const KeyType& lower_key, const KeyType& upper_key, KeyValueCompare comp, bool left_closed, bool right_closed);

   //! @copydoc ::lslboost::intrusive::treap::bounded_range(const_reference,const_reference,bool,bool)const
   std::pair<const_iterator, const_iterator>
      bounded_range(const_reference lower_value, const_reference upper_value, bool left_closed, bool right_closed) const;

   //! @copydoc ::lslboost::intrusive::treap::bounded_range(const KeyType&,const KeyType&,KeyValueCompare,bool,bool)const
   template<class KeyType, class KeyValueCompare>
   std::pair<const_iterator, const_iterator> bounded_range
         (const KeyType& lower_key, const KeyType& upper_key, KeyValueCompare comp, bool left_closed, bool right_closed) const;

   //! @copydoc ::lslboost::intrusive::treap::s_iterator_to(reference)
   static iterator s_iterator_to(reference value);

   //! @copydoc ::lslboost::intrusive::treap::s_iterator_to(const_reference)
   static const_iterator s_iterator_to(const_reference value);

   //! @copydoc ::lslboost::intrusive::treap::iterator_to(reference)
   iterator iterator_to(reference value);

   //! @copydoc ::lslboost::intrusive::treap::iterator_to(const_reference)const
   const_iterator iterator_to(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::treap::init_node(reference)
   static void init_node(reference value);

   //! @copydoc ::lslboost::intrusive::treap::unlink_leftmost_without_rebalance
   pointer unlink_leftmost_without_rebalance();

   //! @copydoc ::lslboost::intrusive::treap::replace_node
   void replace_node(iterator replace_this, reference with_this);

   //! @copydoc ::lslboost::intrusive::treap::remove_node
      ...
      >::type
{
   ...
   {  return static_cast<treap_set &>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
...
#endif
{
   ...
   {  return static_cast<treap_multiset_impl&>(tree_type::operator=(::lslboost::move(static_cast<tree_type&>(x))));  }
   ...
   //! @copydoc ::lslboost::intrusive::treap::insert_equal(reference)
   iterator insert(reference value)
   {  return tree_type::insert_equal(value);  }

   //! @copydoc ::lslboost::intrusive::treap::insert_equal(const_iterator,reference)
   iterator insert(const_iterator hint, reference value)
   {  return tree_type::insert_equal(hint, value);  }

   //! @copydoc ::lslboost::intrusive::treap::insert_equal(Iterator,Iterator)
   template<class Iterator>
   void insert(Iterator b, Iterator e)
      ...
      >::type
{
   ...
   {  return static_cast<treap_multiset &>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
