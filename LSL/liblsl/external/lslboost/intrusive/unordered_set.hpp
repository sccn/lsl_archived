   ...
   : public hashtable_impl<ValueTraits, Hash, Equal, SizeType, BucketTraits, BoolFlags>
{
   ...
   unordered_set_impl(BOOST_RV_REF(unordered_set_impl) x)
      :  table_type(::lslboost::move(static_cast<table_type&>(x)))
   {}

   //! <b>Effects</b>: to-do
   //!
   unordered_set_impl& operator=(BOOST_RV_REF(unordered_set_impl) x)
   {  return static_cast<unordered_set_impl&>(table_type::operator=(::lslboost::move(static_cast<table_type&>(x)))); }
      ...
      >::type
{
   ...
   {  return static_cast<unordered_set&>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
};
   ...
   : public hashtable_impl<ValueTraits, Hash, Equal, SizeType, BucketTraits, BoolFlags>
{
   ...
   {  return static_cast<unordered_multiset_impl&>(table_type::operator=(::lslboost::move(static_cast<table_type&>(x))));  }
      ...
      >::type
{
   ...
   {  return static_cast<unordered_multiset&>(this->Base::operator=(::lslboost::move(static_cast<Base&>(x))));  }
};
