...
#include <lslboost/intrusive/hashtable.hpp>
   ...
   : public hashtable_impl<ValueTraits, VoidOrKeyOfValue, VoidOrKeyHash, VoidOrKeyEqual, BucketTraits, SizeType, BoolFlags|hash_bool_flags::unique_keys_pos>
{
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::hashtable(const bucket_traits &,const hasher &,const key_equal &,const value_traits &)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::hashtable(bool,Iterator,Iterator,const bucket_traits &,const hasher &,const key_equal &,const value_traits &)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::hashtable(hashtable&&)
   unordered_set_impl(BOOST_RV_REF(unordered_set_impl) x)
      :  table_type(BOOST_MOVE_BASE(table_type, x))
   {}

   //! @copydoc ::lslboost::intrusive::hashtable::operator=(hashtable&&)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::~hashtable()
   ~unordered_set_impl();

   //! @copydoc ::lslboost::intrusive::hashtable::begin()
   iterator begin();

   //! @copydoc ::lslboost::intrusive::hashtable::begin()const
   const_iterator begin() const;

   //! @copydoc ::lslboost::intrusive::hashtable::cbegin()const
   const_iterator cbegin() const;

   //! @copydoc ::lslboost::intrusive::hashtable::end()
   iterator end();

   //! @copydoc ::lslboost::intrusive::hashtable::end()const
   const_iterator end() const;

   //! @copydoc ::lslboost::intrusive::hashtable::cend()const
   const_iterator cend() const;

   //! @copydoc ::lslboost::intrusive::hashtable::hash_function()const
   hasher hash_function() const;

   //! @copydoc ::lslboost::intrusive::hashtable::key_eq()const
   key_equal key_eq() const;

   //! @copydoc ::lslboost::intrusive::hashtable::empty()const
   bool empty() const;

   //! @copydoc ::lslboost::intrusive::hashtable::size()const
   size_type size() const;

   //! @copydoc ::lslboost::intrusive::hashtable::hashtable
   void swap(unordered_set_impl& other);

   //! @copydoc ::lslboost::intrusive::hashtable::clone_from(const hashtable&,Cloner,Disposer)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::clone_from(hashtable&&,Cloner,Disposer)
   template <class Cloner, class Disposer>
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::insert_unique(reference)
   std::pair<iterator, bool> insert(reference value)
   {  return table_type::insert_unique(value);  }

   //! @copydoc ::lslboost::intrusive::hashtable::insert_unique(Iterator,Iterator)
   template<class Iterator>
   void insert(Iterator b, Iterator e)
   {  table_type::insert_unique(b, e);  }

   //! @copydoc ::lslboost::intrusive::hashtable::insert_unique_check(const KeyType&,KeyHasher,KeyEqual,insert_commit_data&)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::insert_unique_commit
   iterator insert_commit(reference value, const insert_commit_data &commit_data)
   {  return table_type::insert_unique_commit(value, commit_data); }

   #ifdef BOOST_INTRUSIVE_DOXYGEN_INVOKED

   //! @copydoc ::lslboost::intrusive::hashtable::erase(const_iterator)
   void erase(const_iterator i);

   //! @copydoc ::lslboost::intrusive::hashtable::erase(const_iterator,const_iterator)
   void erase(const_iterator b, const_iterator e);

   //! @copydoc ::lslboost::intrusive::hashtable::erase(const key_type &)
   size_type erase(const key_type &key);

   //! @copydoc ::lslboost::intrusive::hashtable::erase(const KeyType&,KeyHasher,KeyEqual)
   template<class KeyType, class KeyHasher, class KeyEqual>
   size_type erase(const KeyType& key, KeyHasher hash_func, KeyEqual equal_func);

   //! @copydoc ::lslboost::intrusive::hashtable::erase_and_dispose(const_iterator,Disposer)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::erase_and_dispose(const_iterator,const_iterator,Disposer)
   template<class Disposer>
   void erase_and_dispose(const_iterator b, const_iterator e, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::hashtable::erase_and_dispose(const key_type &,Disposer)
   template<class Disposer>
   size_type erase_and_dispose(const key_type &key, Disposer disposer);

   //! @copydoc ::lslboost::intrusive::hashtable::erase_and_dispose(const KeyType&,KeyHasher,KeyEqual,Disposer)
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::clear
   void clear();

   //! @copydoc ::lslboost::intrusive::hashtable::clear_and_dispose
   template<class Disposer>
   void clear_and_dispose(Disposer disposer);

   //! @copydoc ::lslboost::intrusive::hashtable::count(const key_type &)const
   size_type count(const key_type &key) const;

   //! @copydoc ::lslboost::intrusive::hashtable::count(const KeyType&,KeyHasher,KeyEqual)const
   template<class KeyType, class KeyHasher, class KeyEqual>
   size_type count(const KeyType& key, KeyHasher hash_func, KeyEqual equal_func) const;

   //! @copydoc ::lslboost::intrusive::hashtable::find(const key_type &)
   iterator find(const key_type &key);

   //! @copydoc ::lslboost::intrusive::hashtable::find(const KeyType &,KeyHasher,KeyEqual)
   template<class KeyType, class KeyHasher, class KeyEqual>
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::find(const KeyType &,KeyHasher,KeyEqual)const
   template<class KeyType, class KeyHasher, class KeyEqual>
   const_iterator find(const KeyType& key, KeyHasher hash_func, KeyEqual equal_func) const;
   #endif

   //! @copydoc ::lslboost::intrusive::hashtable::equal_range(const key_type&)
   std::pair<iterator,iterator> equal_range(const key_type &key)
   {  return this->equal_range(key, this->hash_function(), this->key_eq());  }

   //! @copydoc ::lslboost::intrusive::hashtable::equal_range(const KeyType &,KeyHasher,KeyEqual)
   template<class KeyType, class KeyHasher, class KeyEqual>
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::equal_range(const key_type&)const
   std::pair<const_iterator, const_iterator>
      equal_range(const key_type &key) const
   {  return this->equal_range(key, this->hash_function(), this->key_eq());  }

   //! @copydoc ::lslboost::intrusive::hashtable::equal_range(const KeyType &,KeyHasher,KeyEqual)const
   template<class KeyType, class KeyHasher, class KeyEqual>
   std::pair<const_iterator, const_iterator>
   ...
   #if defined(BOOST_INTRUSIVE_DOXYGEN_INVOKED)
   //! @copydoc ::lslboost::intrusive::hashtable::iterator_to(reference)
   iterator iterator_to(reference value);

   //! @copydoc ::lslboost::intrusive::hashtable::iterator_to(const_reference)const
   const_iterator iterator_to(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::hashtable::s_local_iterator_to(reference)
   static local_iterator s_local_iterator_to(reference value);

   //! @copydoc ::lslboost::intrusive::hashtable::s_local_iterator_to(const_reference)
   static const_local_iterator s_local_iterator_to(const_reference value);

   //! @copydoc ::lslboost::intrusive::hashtable::local_iterator_to(reference)
   local_iterator local_iterator_to(reference value);

   //! @copydoc ::lslboost::intrusive::hashtable::local_iterator_to(const_reference)
   const_local_iterator local_iterator_to(const_reference value) const;

   //! @copydoc ::lslboost::intrusive::hashtable::bucket_count
   size_type bucket_count() const;

   //! @copydoc ::lslboost::intrusive::hashtable::bucket_size
   size_type bucket_size(size_type n) const;

   //! @copydoc ::lslboost::intrusive::hashtable::bucket(const key_type&)const
   size_type bucket(const key_type& k) const;

   //! @copydoc ::lslboost::intrusive::hashtable::bucket(const KeyType&,KeyHasher)const
   template<class KeyType, class KeyHasher>
   size_type bucket(const KeyType& k,  KeyHasher hash_func) const;

   //! @copydoc ::lslboost::intrusive::hashtable::bucket_pointer
   bucket_ptr bucket_pointer() const;

   //! @copydoc ::lslboost::intrusive::hashtable::begin(size_type)
   local_iterator begin(size_type n);

   //! @copydoc ::lslboost::intrusive::hashtable::begin(size_type)const
   const_local_iterator begin(size_type n) const;

   //! @copydoc ::lslboost::intrusive::hashtable::cbegin(size_type)const
   const_local_iterator cbegin(size_type n) const;

   //! @copydoc ::lslboost::intrusive::hashtable::end(size_type)
   local_iterator end(size_type n);

   //! @copydoc ::lslboost::intrusive::hashtable::end(size_type)const
   const_local_iterator end(size_type n) const;

   //! @copydoc ::lslboost::intrusive::hashtable::cend(size_type)const
   const_local_iterator cend(size_type n) const;

   //! @copydoc ::lslboost::intrusive::hashtable::rehash(const bucket_traits &)
   void rehash(const bucket_traits &new_bucket_traits);

   //! @copydoc ::lslboost::intrusive::hashtable::incremental_rehash(bool)
   bool incremental_rehash(bool grow = true);

   //! @copydoc ::lslboost::intrusive::hashtable::incremental_rehash(const bucket_traits &)
   bool incremental_rehash(const bucket_traits &new_bucket_traits);

   //! @copydoc ::lslboost::intrusive::hashtable::split_count
   size_type split_count() const;

   //! @copydoc ::lslboost::intrusive::hashtable::suggested_upper_bucket_count
   static size_type suggested_upper_bucket_count(size_type n);

   //! @copydoc ::lslboost::intrusive::hashtable::suggested_lower_bucket_count
   ...
   friend bool operator<(const unordered_set_impl &x, const unordered_set_impl &y)
   {  return ::lslboost::intrusive::algo_lexicographical_compare(x.begin(), x.end(), y.begin(), y.end());  }
   ...
   : public hashtable_impl<ValueTraits, VoidOrKeyOfValue, VoidOrKeyHash, VoidOrKeyEqual, BucketTraits, SizeType, BoolFlags>
{
   ...
   //! @copydoc ::lslboost::intrusive::hashtable::insert_equal(reference)
   iterator insert(reference value)
   {  return table_type::insert_equal(value);  }

   //! @copydoc ::lslboost::intrusive::hashtable::insert_equal(Iterator,Iterator)
   template<class Iterator>
   void insert(Iterator b, Iterator e)
