...
#include <lslboost/intrusive/slist_hook.hpp>
#include <lslboost/intrusive/circular_slist_algorithms.hpp>
#include <lslboost/intrusive/linear_slist_algorithms.hpp>
...
#include <lslboost/intrusive/detail/slist_iterator.hpp>
   ...
   void incorporate_after(const_iterator prev_pos, const node_ptr & f, const node_ptr & before_l, size_type n)
   {
      if(n){
         ...
         BOOST_INTRUSIVE_INVARIANT_ASSERT
            (size_type(lslboost::intrusive::iterator_distance
