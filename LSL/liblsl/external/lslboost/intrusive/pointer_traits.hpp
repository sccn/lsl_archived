...
struct pointer_traits
{
      ...
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_EVAL_DEFAULT
         ( lslboost::intrusive::detail::, Ptr, element_type
         , lslboost::intrusive::detail::first_param<Ptr>)                        element_type;
      //
      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (lslboost::intrusive::detail::, Ptr, difference_type, std::ptrdiff_t)   difference_type;

      typedef BOOST_INTRUSIVE_OBTAIN_TYPE_WITH_DEFAULT
         (lslboost::intrusive::detail::, Ptr, reference, typename lslboost::intrusive::detail::unvoid_ref<element_type>::type)   reference;
      //
      template <class U> struct rebind_pointer
      {
         typedef typename lslboost::intrusive::pointer_rebind<Ptr, U>::type  type;
      };

      #if !defined(BOOST_NO_CXX11_TEMPLATE_ALIASES)
         template <class U> using rebind = typename lslboost::intrusive::pointer_rebind<Ptr, U>::type;
      #endif
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = lslboost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, Ptr (*)(reference)>::value;
      lslboost::intrusive::detail::bool_<value> flag;
   ...
   static pointer static_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = lslboost::intrusive::detail::
         ...
         || lslboost::intrusive::detail::
               has_member_function_callable_with_static_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
      return pointer_traits::priv_static_cast_from(lslboost::intrusive::detail::bool_<value>(), uptr);
   }
   ...
   static pointer const_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = lslboost::intrusive::detail::
         ...
         || lslboost::intrusive::detail::
               has_member_function_callable_with_const_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
      return pointer_traits::priv_const_cast_from(lslboost::intrusive::detail::bool_<value>(), uptr);
   }
   ...
   static pointer dynamic_cast_from(const UPtr &uptr)
   {
      ...
      const bool value = lslboost::intrusive::detail::
         ...
         || lslboost::intrusive::detail::
               has_member_function_callable_with_dynamic_cast_from
                  <pointer, pointer(*)(UPtr)>::value;
      return pointer_traits::priv_dynamic_cast_from(lslboost::intrusive::detail::bool_<value>(), uptr);
   }
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(lslboost::intrusive::detail::true_, reference r)
   { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(lslboost::intrusive::detail::false_, reference r)
   { return pointer(lslboost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(lslboost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::static_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_static_cast_from(lslboost::intrusive::detail::false_, const UPtr &uptr)
   {  return pointer_to(*static_cast<element_type*>(to_raw_pointer(uptr)));  }

   //priv_const_cast_from
   template<class UPtr>
   static pointer priv_const_cast_from(lslboost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(lslboost::intrusive::detail::false_, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(lslboost::intrusive::detail::true_, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(lslboost::intrusive::detail::false_, const UPtr &uptr)
   {
...
struct pointer_traits<T*>
{
   ...
   //!
   static pointer pointer_to(reference r)
   { return lslboost::intrusive::detail::addressof(r); }
