...
struct pointer_traits
{
   ...
   static pointer pointer_to(reference r)
   {
      ...
      const bool value = lslboost::intrusive::detail::
         has_member_function_callable_with_pointer_to
            <Ptr, typename lslboost::intrusive::detail::unvoid<element_type &>::type>::value;
   ...
   //priv_pointer_to
   static pointer priv_pointer_to(lslboost::true_type, typename lslboost::intrusive::detail::unvoid<element_type>::type& r)
      { return Ptr::pointer_to(r); }

   static pointer priv_pointer_to(lslboost::false_type, typename lslboost::intrusive::detail::unvoid<element_type>::type& r)
      { return pointer(lslboost::intrusive::detail::addressof(r)); }

   //priv_static_cast_from
   template<class UPtr>
   static pointer priv_static_cast_from(lslboost::true_type, const UPtr &uptr)
   ...
   template<class UPtr>
   static pointer priv_const_cast_from(lslboost::true_type, const UPtr &uptr)
   { return Ptr::const_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_const_cast_from(lslboost::false_type, const UPtr &uptr)
   {  return pointer_to(const_cast<element_type&>(*uptr));  }

   //priv_dynamic_cast_from
   template<class UPtr>
   static pointer priv_dynamic_cast_from(lslboost::true_type, const UPtr &uptr)
   { return Ptr::dynamic_cast_from(uptr); }

   template<class UPtr>
   static pointer priv_dynamic_cast_from(lslboost::false_type, const UPtr &uptr)
