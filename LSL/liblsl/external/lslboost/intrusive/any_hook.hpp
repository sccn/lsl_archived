...
#include <lslboost/intrusive/detail/any_node_and_algorithms.hpp>
#include <lslboost/intrusive/options.hpp>
#include <lslboost/intrusive/detail/generic_hook.hpp>
...
{
   typedef typename pointer_traits<typename ValueTraits::lslboost_intrusive_tags::node_traits::node_ptr>::template
