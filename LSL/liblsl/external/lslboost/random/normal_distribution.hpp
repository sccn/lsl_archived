/* lslboost random/normal_distribution.hpp header file
 *
...
inline typename lslboost::make_unsigned<typename Engine::result_type>::type
...
std::pair<RealType, int> generate_int_float_pair(Engine& eng, lslboost::mpl::true_)
{
    typedef typename Engine::result_type base_result;
    typedef typename lslboost::make_unsigned<base_result>::type base_unsigned;
...
template<class RealType, std::size_t w, class Engine>
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng, lslboost::mpl::false_)
{
...
struct unit_normal_distribution
{
    ...
    RealType generate_tail(Engine& eng) {
        lslboost::random::exponential_distribution<RealType> exponential;
