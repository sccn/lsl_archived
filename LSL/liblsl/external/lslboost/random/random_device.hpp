/* lslboost random/random_device.hpp header file
 *
...
#include <lslboost/random/detail/auto_link.hpp>
#include <lslboost/system/config.hpp> // force autolink to find Boost.System
 ...
 * <b>Performance</b>
 *
 * The test program <a href="\lslboost/libs/random/performance/nondet_random_speed.cpp">
