/* lslboost random/linear_congruential.hpp header file
 *
...
{
public:
    typedef lslboost::uint32_t result_type;
    ...
    /** Advances the state of the generator by @c z. */
    void discard(lslboost::uintmax_t z) { lcf.discard(z); }
...
private:
    ...
    static lslboost::uint64_t cnv(lslboost::uint32_t x)
