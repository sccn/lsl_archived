/* lslboost random/lagged_fibonacci.hpp header file
 *
...
#include <iterator>
#include <lslboost/config/no_tr1/cmath.hpp>         // std::pow
...
#include <lslboost/random/detail/generator_seed_seq.hpp>
...
public:
    ...
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_engine,
        UIntType, value)
    {
        minstd_rand0 intgen(static_cast<lslboost::uint32_t>(value));
...
public:
    ...
    BOOST_STATIC_CONSTANT(lslboost::uint32_t, default_seed = 331u);
     ...
     */
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(lagged_fibonacci_01_engine, lslboost::uint32_t, value)
    {
...
template<class RealType, int w, unsigned int p, unsigned int q>
const lslboost::uint32_t lagged_fibonacci_01_engine<RealType,w,p,q>::default_seed;
#endif
...
public:
    lagged_fibonacci_01() {}
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(lagged_fibonacci_01, lslboost::uint32_t, val)
    { this->seed(val); }
...
/** @copydoc lslboost::random::detail::lagged_fibonacci_doc */
