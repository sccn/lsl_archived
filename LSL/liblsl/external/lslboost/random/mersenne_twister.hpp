/* lslboost random/mersenne_twister.hpp header file
 *
...
#include <lslboost/random/detail/ptr_helper.hpp>
...
#include <lslboost/random/detail/polynomial.hpp>
 ...
 *
 * @xmlnote
 * The lslboost variant has been implemented from scratch and does not
...
public:
    ...
    { return lslboost::low_bits_mask_t<w>::sig_bits; }
...
private:
     ...
     */
    void discard_many(lslboost::uintmax_t z)
    {
...
BOOST_RANDOM_PTR_HELPER_SPEC(lslboost::mt11213b)
BOOST_RANDOM_PTR_HELPER_SPEC(lslboost::mt19937)
BOOST_RANDOM_PTR_HELPER_SPEC(lslboost::mt19937_64)
