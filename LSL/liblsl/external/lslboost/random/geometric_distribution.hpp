/* lslboost random/geometric_distribution.hpp header file
 *
...
#include <lslboost/config/no_tr1/cmath.hpp>          // std::log
#include <iosfwd>
#include <ios>
 ...
 * lslboost::geometric_distribution.  A backwards compatible
 * wrapper is provided in namespace lslboost.
 * @endxmlwarning
 */
...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        using std::log;
        using std::floor;
        RealType x = RealType(1) - lslboost::uniform_01<RealType>()(eng);
