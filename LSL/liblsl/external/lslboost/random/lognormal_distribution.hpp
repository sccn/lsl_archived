/* lslboost random/lognormal_distribution.hpp header file
 *
...
#include <lslboost/config/no_tr1/cmath.hpp>      // std::exp, std::sqrt
#include <cassert>
#include <iosfwd>
#include <istream>
 ...
 * lslboost::lognormal_distribution.  A backwards compatible
 * version is provided in namespace lslboost.
 * @endxmlwarning
 */
