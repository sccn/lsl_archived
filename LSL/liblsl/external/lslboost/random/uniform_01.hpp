/* lslboost random/uniform_01.hpp header file
 *
 ...
 * (to-be-invented) @c lslboost::bigfloat class with random bits efficiently.
...
{
  typedef lslboost::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
public:
