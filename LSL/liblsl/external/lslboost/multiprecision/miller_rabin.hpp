...
#include <lslboost/multiprecision/random.hpp>
...
{
   static const lslboost::uint32_t small_factors1[] = {
      3u, 5u, 7u, 11u, 13u, 17u, 19u, 23u };
   static const lslboost::uint32_t pp1 = 223092870u;

   lslboost::uint32_t m1 = integer_modulus(n, pp1);
   ...
   static const lslboost::uint32_t small_factors2[] = {
      29u, 31u, 37u, 41u, 43u, 47u };
   static const lslboost::uint32_t pp2 = 2756205443u;
   ...
   static const lslboost::uint32_t small_factors3[] = {
      53u, 59u, 61u, 67u, 71u };
   static const lslboost::uint32_t pp3 = 907383479u;
   ...
   static const lslboost::uint32_t small_factors4[] = {
      73u, 79u, 83u, 89u, 97u };
   static const lslboost::uint32_t pp4 = 4132280413u;
   ...
   static const lslboost::uint32_t small_factors5[6][4] = {
      { 101u, 103u, 107u, 109u },
      { 113u, 127u, 131u, 137u },
      { 139u, 149u, 151u, 157u },
      { 163u, 167u, 173u, 179u },
   ...
   static const lslboost::uint32_t pp5[6] = 
   { 
      121330189u, 
      113u * 127u * 131u * 137u, 
      139u * 149u * 151u * 157u,
...
#pragma warning(disable:4127)
   ...
   lslboost::random::uniform_int_distribution<number_type> dist(2, n - 2);
   //
   // Execute the trials:
   //
