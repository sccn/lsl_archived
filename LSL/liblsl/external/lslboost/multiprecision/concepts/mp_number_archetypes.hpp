...
struct number_backend_float_architype
{
   ...
   number_backend_float_architype& operator = (lslboost::ulong_long_type i)
   {
      m_value = i;
      std::cout << "UInt Assignment (" << i << ")" << std::endl;
      return *this;
   }
   number_backend_float_architype& operator = (lslboost::long_long_type i)
   {
      m_value = i;
   ...
   number_backend_float_architype& operator = (const char* s)
   {
      try
      {
         m_value = lslboost::lexical_cast<long double>(s);
      }
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f)const
   {
      ...
      lslboost::intmax_t i = m_value;
      lslboost::uintmax_t u = m_value;
   ...
   int compare(lslboost::long_long_type i)const
   {
      std::cout << "Comparison with int" << std::endl;
      return m_value > i ? 1 : (m_value < i ? -1 : 0);
   }
   int compare(lslboost::ulong_long_type i)const
   {
...
inline void eval_convert_to(lslboost::ulong_long_type* result, const number_backend_float_architype& val)
{
   *result = static_cast<lslboost::ulong_long_type>(val.m_value);
}
inline void eval_convert_to(lslboost::long_long_type* result, const number_backend_float_architype& val)
{
   *result = static_cast<lslboost::long_long_type>(val.m_value);
}
...
{
   return (lslboost::math::fpclassify)(arg.m_value);
}

typedef lslboost::multiprecision::number<number_backend_float_architype> mp_number_float_architype;
...
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::concepts::number_backend_float_architype, ExpressionTemplates> > : public std::numeric_limits<long double>
{
   typedef std::numeric_limits<long double> base_type;
   typedef lslboost::multiprecision::number<lslboost::multiprecision::concepts::number_backend_float_architype, ExpressionTemplates> number_type;
public:
