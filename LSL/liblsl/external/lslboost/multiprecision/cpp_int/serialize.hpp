...
namespace mp = lslboost::multiprecision;

namespace cpp_int_detail{

using namespace lslboost::multiprecision;
using namespace lslboost::multiprecision::backends;

template <class T>
struct is_binary_archive : public mpl::false_ {};
template <>
struct is_binary_archive<lslboost::archive::binary_oarchive> : public mpl::true_ {};
template <>
struct is_binary_archive<lslboost::archive::binary_iarchive> : public mpl::true_ {};
