...
// [unsigned] lslboost::long_long_type, long, int, which has the specified number
// of bits.  Note that intN_t and lslboost::int_t<N> find the first
...
struct largest_signed_type
{
   typedef typename mpl::if_c<
      1 + std::numeric_limits<lslboost::long_long_type>::digits == N,
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            int,
            typename lslboost::int_t<N>::exact
         >::type
      >::type
   >::type type;
};
...
{
   typedef typename mpl::if_c<
      std::numeric_limits<lslboost::ulong_long_type>::digits == N,
      ...
      typename mpl::if_c<
         ...
         typename mpl::if_c<
            ...
            unsigned int,
            typename lslboost::uint_t<N>::exact
         >::type
      >::type
   >::type type;
};
...
typedef lslboost::uint128_type double_limb_type;
typedef lslboost::int128_type signed_double_limb_type;
