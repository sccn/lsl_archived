...
namespace lslboost{ namespace random{ namespace detail{
//
...
//
template<class Engine, class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
lslboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(Engine& eng, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& max_value);
...
template<class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct subtract<lslboost::multiprecision::number<Backend, ExpressionTemplates>, true> 
{ 
  typedef lslboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
  result_type operator()(result_type const& x, result_type const& y) { return x - y; }
};

}

template<class Engine, std::size_t w, class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
class independent_bits_engine<Engine, w, lslboost::multiprecision::number<Backend, ExpressionTemplates> >
{
public:
    ...
    {
        for(lslboost::uintmax_t i = 0; i < z; ++i) {
            (*this)();
        }
    }
...
template<class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
class uniform_smallint<lslboost::multiprecision::number<Backend, ExpressionTemplates> >
{
public:
    typedef lslboost::multiprecision::number<Backend, ExpressionTemplates> input_type;
    typedef lslboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
    ...
    result_type operator()(Engine& eng) const
    {
        ...
        return generate(eng, lslboost::is_integral<base_result>());
    }
...
private:
    ...
    // \cond show_private
    template<class Engine>
    result_type generate(Engine& eng, lslboost::mpl::true_) const
    {
        // equivalent to (eng() - eng.min()) % (_max - _min + 1) + _min,
        // but guarantees no overflow.
        typedef typename Engine::result_type base_result;
        typedef typename lslboost::make_unsigned<base_result>::type base_unsigned;
        ...
        if(range >= base_range) {
            return lslboost::random::detail::add<range_type, result_type>()(
    ...
    template<class Engine>
    result_type generate(Engine& eng, lslboost::mpl::false_) const
    {
        typedef typename Engine::result_type base_result;
        typedef result_type                  range_type;
        range_type range = random::detail::subtract<result_type>()(_max, _min);
        base_result val = lslboost::uniform_01<base_result>()(eng);
        ...
        return lslboost::random::detail::add<range_type, result_type>()(offset , _min);
    }
    // \endcond
...
template<class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct select_uniform_01<lslboost::multiprecision::number<Backend, ExpressionTemplates> >
{
  template<class RealType>
  struct apply
  {
    typedef new_uniform_01<lslboost::multiprecision::number<Backend, ExpressionTemplates> > type;
  };
};
...
lslboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(
    Engine& eng, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& max_value,
    lslboost::mpl::true_ /** is_integral<Engine::result_type> */)
{
    typedef lslboost::multiprecision::number<Backend, ExpressionTemplates> result_type;
...
template<class Engine, class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
inline lslboost::multiprecision::number<Backend, ExpressionTemplates> 
   generate_uniform_int(Engine& eng, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& max_value)
{
    typedef typename Engine::result_type base_result;
    typedef typename mpl::or_<lslboost::is_integral<base_result>, mpl::bool_<lslboost::multiprecision::number_category<Backend>::value == lslboost::multiprecision::number_kind_integer> >::type tag_type;
    return generate_uniform_int(eng, min_value, max_value,
        tag_type());
}

template<class Engine, class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates>
inline lslboost::multiprecision::number<Backend, ExpressionTemplates> generate_uniform_real(Engine& eng, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& min_value, const lslboost::multiprecision::number<Backend, ExpressionTemplates>& max_value)
{
   if(max_value / 2 - min_value / 2 > (std::numeric_limits<lslboost::multiprecision::number<Backend, ExpressionTemplates> >::max)() / 2)
      return 2 * generate_uniform_real(eng, lslboost::multiprecision::number<Backend, ExpressionTemplates>(min_value / 2), lslboost::multiprecision::number<Backend, ExpressionTemplates>(max_value / 2));
   typedef typename Engine::result_type base_result;
   return generate_uniform_real(eng, min_value, max_value,
      lslboost::is_integral<base_result>());
}
