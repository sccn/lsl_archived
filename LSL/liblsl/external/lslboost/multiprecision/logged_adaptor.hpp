...
#include <lslboost/multiprecision/traits/extract_exponent_type.hpp>
...
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> >
   : public std::numeric_limits<lslboost::multiprecision::number<Backend, ExpressionTemplates> >
{
   typedef std::numeric_limits<lslboost::multiprecision::number<Backend, ExpressionTemplates> > base_type;
   typedef lslboost::multiprecision::number<lslboost::multiprecision::backends::logged_adaptor<Backend>, ExpressionTemplates> number_type;
public:
...
template <class Backend, lslboost::multiprecision::expression_template_option ExpressionTemplates, class Policy>
struct precision< lslboost::multiprecision::number<lslboost::multiprecision::logged_adaptor<Backend>, ExpressionTemplates>, Policy>
   : public precision<lslboost::multiprecision::number<Backend, ExpressionTemplates>, Policy>
{};
