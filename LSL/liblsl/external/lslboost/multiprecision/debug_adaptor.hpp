...
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> >
   : public std::numeric_limits<lslboost::multiprecision::number<Backend, ExpressionTemplates> >
{
   ...
   typedef lslboost::multiprecision::number<lslboost::multiprecision::backends::debug_adaptor<Backend>, ExpressionTemplates> number_type;
public:
...
struct precision< lslboost::multiprecision::number<lslboost::multiprecision::debug_adaptor<Backend>, ExpressionTemplates>, Policy>
