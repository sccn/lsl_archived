...
#include <lslboost/multiprecision/mpfr.hpp>
...
struct mpfi_float_imp
{
   ...
   mpfi_float_imp& operator = (lslboost::ulong_long_type i)
   {
      if(m_data[0].left._mpfr_d == 0)
         mpfi_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : get_default_precision()));
   ...
   mpfi_float_imp& operator = (lslboost::long_long_type i)
   {
      if(m_data[0].left._mpfr_d == 0)
         mpfi_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : get_default_precision()));
   ...
   mpfi_float_imp& operator = (lslboost::ulong_long_type i)
   {
      if(m_data[0].left._mpfr_d == 0)
         mpfi_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : get_default_precision()));
      lslboost::ulong_long_type mask = (((1uLL << (std::numeric_limits<unsigned long>::digits - 1) - 1) << 1) | 1u);
      unsigned shift = 0;
      mpfi_t t;
      mpfi_init2(t, (std::max)(static_cast<unsigned long>(std::numeric_limits<lslboost::ulong_long_type>::digits), static_cast<unsigned long>(multiprecision::detail::digits10_2_2(digits10))));
...
inline void eval_add(mpfi_float_backend<digits10>& result, long i)
{
   if(i > 0)
      ...
      mpfi_sub_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i));
}
template <unsigned digits10>
inline void eval_subtract(mpfi_float_backend<digits10>& result, long i)
{
   if(i > 0)
      ...
      mpfi_add_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i));
}
template <unsigned digits10>
inline void eval_multiply(mpfi_float_backend<digits10>& result, long i)
{
   mpfi_mul_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i));
   if(i < 0)
...
{
   mpfi_div_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i));
   if(i < 0)
      mpfi_neg(result.data(), result.data());
}
//
...
{
   if(y < 0)
      mpfi_sub_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y));
   else
      mpfi_add_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_add(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if(x < 0)
   {
      mpfi_ui_sub(a.data(), lslboost::multiprecision::detail::unsigned_abs(x), y.data());
...
{
   if(y < 0)
      mpfi_add_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y));
   else
      mpfi_sub_ui(a.data(), x.data(), y);
}
template <unsigned D1, unsigned D2>
...
inline void eval_subtract(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if(x < 0)
   {
      mpfi_add_ui(a.data(), y.data(), lslboost::multiprecision::detail::unsigned_abs(x));
      mpfi_neg(a.data(), a.data());
   }
   else
      mpfi_ui_sub(a.data(), x, y.data());
...
inline void eval_multiply(mpfi_float_backend<D1>& a, const mpfi_float_backend<D2>& x, long y)
{
   if(y < 0)
   {
      mpfi_mul_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y));
      a.negate();
   }
   else
      mpfi_mul_ui(a.data(), x.data(), y);
...
inline void eval_multiply(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if(x < 0)
   {
      mpfi_mul_ui(a.data(), y.data(), lslboost::multiprecision::detail::unsigned_abs(x));
      mpfi_neg(a.data(), a.data());
   }
   else
      mpfi_mul_ui(a.data(), y.data(), x);
...
inline void eval_divide(mpfi_float_backend<D1>& a, const mpfi_float_backend<D2>& x, long y)
{
   if(y < 0)
   {
      mpfi_div_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y));
      a.negate();
   }
   else
      mpfi_div_ui(a.data(), x.data(), y);
...
inline void eval_divide(mpfi_float_backend<D1>& a, long x, const mpfi_float_backend<D2>& y)
{
   if(x < 0)
   {
      mpfi_ui_div(a.data(), lslboost::multiprecision::detail::unsigned_abs(x), y.data());
      mpfi_neg(a.data(), a.data());
   }
   else
      mpfi_ui_div(a.data(), x, y.data());
...
#ifdef _MPFR_H_HAVE_INTMAX_T
template <unsigned digits10>
inline void eval_convert_to(lslboost::ulong_long_type* result, const mpfi_float_backend<digits10>& val)
{
   mpfr_float_backend<digits10> t;
   mpfi_mid(t.data(), val.data());
   eval_convert_to(result, t);
...
template <unsigned digits10>
inline void eval_convert_to(lslboost::long_long_type* result, const mpfi_float_backend<digits10>& val)
{
   mpfr_float_backend<digits10> t;
   mpfi_mid(t.data(), val.data());
   eval_convert_to(result, t);
...
{
   typedef typename lslboost::multiprecision::detail::canonical<unsigned, mpfi_float_backend<Digits10> >::type ui_type;
   ...
   if(s < 0)
   {
      ...
      typename lslboost::multiprecision::detail::canonical<lslboost::uintmax_t, mpfi_float_backend<Digits10> >::type an;
      try
      {
...
using lslboost::multiprecision::backends::mpfi_float_backend;
...
template <>
inline int digits<lslboost::multiprecision::mpfi_float>()
{
   return lslboost::multiprecision::backends::detail::get_default_precision();
}
template <>
inline int digits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, lslboost::multiprecision::et_off> >()
{
   return lslboost::multiprecision::backends::detail::get_default_precision();
}
...
struct mpfi_initializer
{
   struct init
   {
      init()
      {
         lslboost::math::constants::pi<T>();
         lslboost::math::constants::ln_two<T>();
         lslboost::math::constants::euler<T>();
         lslboost::math::constants::catalan<T>();
      }
...
struct constant_pi<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template<int N>
...
template<unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_ln_two<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template<int N>
   static inline result_type const& get(const mpl::int_<N>&)
...
template<unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_euler<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template<int N>
   static inline result_type const& get(const mpl::int_<N>&)
...
template<unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_catalan<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> result_type;
   template<int N>
   static inline result_type const& get(const mpl::int_<N>&)
...
//
template<unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> number_type;
public:
   ...
   static number_type infinity()
   {
      ...
      if(!value.first)
      {
         lslboost::multiprecision::mpfr_float_backend<Digits10> t;
...
private:
   struct data_initializer
   {
      data_initializer()
      {
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<digits10> > >::epsilon();
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<digits10> > >::round_error();
         (std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<digits10> > >::min)();
         (std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<digits10> > >::max)();
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<digits10> > >::infinity();
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<digits10> > >::quiet_NaN();
      }
...
template<unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
const typename numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::data_initializer numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::initializer;

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::digits;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::radix;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::traps;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<Digits10>, ExpressionTemplates> >::round_style;

#endif


template<lslboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> number_type;
public:
...
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::digits;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::digits10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::max_digits10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_signed;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_integer;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_exact;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::radix;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::min_exponent;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::min_exponent10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::max_exponent;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::max_exponent10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_infinity;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_quiet_NaN;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_signaling_NaN;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_denorm;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::has_denorm_loss;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_iec559;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_bounded;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::is_modulo;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::traps;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::tinyness_before;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfi_float_backend<0>, ExpressionTemplates> >::round_style;
