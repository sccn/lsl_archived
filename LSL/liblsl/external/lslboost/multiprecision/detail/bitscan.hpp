...
BOOST_FORCEINLINE unsigned find_lsb(lslboost::ulong_long_type mask, mpl::int_<3> const&)
{
...
BOOST_FORCEINLINE unsigned find_msb(lslboost::ulong_long_type mask, mpl::int_<3> const&)
{
   return sizeof(lslboost::ulong_long_type) * CHAR_BIT - 1 - __builtin_clzll(mask);
}
...
BOOST_FORCEINLINE unsigned find_lsb(Unsigned mask)
{
   ...
   typedef typename mpl::if_c<
      ...
      typename mpl::if_c<
         ...
         mpl::int_<2>,
         typename mpl::if_c<
            sizeof(Unsigned) <= sizeof(lslboost::ulong_long_type),
            mpl::int_<3>,
            mpl::int_<0>
         >::type
      >::type
