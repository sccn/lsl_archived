...
namespace lslboost{ namespace multiprecision{ namespace default_ops{
...
inline void eval_convert_to(terminal<R>* result, const B& backend)
{
   ...
   //
   result->value = lslboost::lexical_cast<R>(backend.str(0, std::ios_base::fmtflags(0)));
}
...
{
   typedef typename lslboost::multiprecision::detail::canonical<A, T>::type canonical_type;
...
inline void eval_trunc(T& result, const T& a)
{
   ...
   {
      result = lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::trunc<%1%>(%1%)", 0, number<T>(a), number<T>(a), lslboost::math::policies::policy<>()).backend();
      return;
   }
   if(eval_get_sign(a) < 0)
      eval_ceil(result, a);
...
inline void eval_round(T& result, const T& a)
{
   ...
   typedef typename lslboost::multiprecision::detail::canonical<float, T>::type fp_type;
   int c = eval_fpclassify(a);
   if((c == (int)FP_NAN) || (c == (int)FP_INFINITE))
   {
      result = lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::round<%1%>(%1%)", 0, number<T>(a), number<T>(a), lslboost::math::policies::policy<>()).backend();
      return;
   }
   if(eval_get_sign(a) < 0)
   {
...
{
   typedef typename lslboost::multiprecision::detail::canonical<Arithmetic, T>::type si_type;
...
{
   typedef typename lslboost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
...
void eval_integer_sqrt(B& s, B& r, const B& x)
{
   ...
   // at some point.
   //
   typedef typename lslboost::multiprecision::detail::canonical<unsigned char, B>::type ui_type;
...
{
   typedef typename lslboost::mpl::if_c<lslboost::is_same<lslboost::intmax_t, long>::value, lslboost::long_long_type, lslboost::intmax_t>::type max_t;
...
//
#include <lslboost/multiprecision/detail/functions/constants.hpp>
#include <lslboost/multiprecision/detail/functions/pow.hpp>
#include <lslboost/multiprecision/detail/functions/trig.hpp>
...
inline int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::itrunc<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline int itrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return itrunc(v, lslboost::math::policies::policy<>());
}
template <class Backend, expression_template_option ExpressionTemplates, class Policy>
inline int itrunc(const number<Backend, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::itrunc<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
...
inline long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type r = trunc(v, pol);
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::ltrunc<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline long ltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return ltrunc(v, lslboost::math::policies::policy<>());
}
...
inline long ltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::ltrunc<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
...
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline lslboost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type r = trunc(v, pol);
   if((r > (std::numeric_limits<lslboost::long_long_type>::max)()) || r < (std::numeric_limits<lslboost::long_long_type>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::lltrunc<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<lslboost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline lslboost::long_long_type lltrunc(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lltrunc(v, lslboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline lslboost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r = trunc(v, pol);
   if((r > (std::numeric_limits<lslboost::long_long_type>::max)()) || r < (std::numeric_limits<lslboost::long_long_type>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::lltrunc<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<lslboost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline lslboost::long_long_type lltrunc(const number<T, ExpressionTemplates>& v)
{
   return lltrunc(v, lslboost::math::policies::policy<>());
}
#endif
...
inline int iround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0, pol);
   return r.template convert_to<int>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline int iround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return iround(v, lslboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline int iround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   ...
   if((r > (std::numeric_limits<int>::max)()) || r < (std::numeric_limits<int>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::iround<%1%>(%1%)", 0, v, 0, pol);
   return r.template convert_to<int>();
}
template <class T, expression_template_option ExpressionTemplates>
...
inline long lround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   ...
   number_type r = round(v, pol);
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::lround<%1%>(%1%)", 0, number_type(v), 0L, pol);
   return r.template convert_to<long>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline long lround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return lround(v, lslboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline long lround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r = round(v, pol);
   if((r > (std::numeric_limits<long>::max)()) || r < (std::numeric_limits<long>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::lround<%1%>(%1%)", 0, v, 0L, pol);
   return r.template convert_to<long>();
}
template <class T, expression_template_option ExpressionTemplates>
...
#ifndef BOOST_NO_LONG_LONG
template <class tag, class A1, class A2, class A3, class A4, class Policy>
inline lslboost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v, const Policy& pol)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   number_type r = round(v, pol);
   if((r > (std::numeric_limits<lslboost::long_long_type>::max)()) || r < (std::numeric_limits<lslboost::long_long_type>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::iround<%1%>(%1%)", 0, number_type(v), 0LL, pol);
   return r.template convert_to<lslboost::long_long_type>();
}
template <class tag, class A1, class A2, class A3, class A4>
inline lslboost::long_long_type llround(const detail::expression<tag, A1, A2, A3, A4>& v)
{
   return llround(v, lslboost::math::policies::policy<>());
}
template <class T, expression_template_option ExpressionTemplates, class Policy>
inline lslboost::long_long_type llround(const number<T, ExpressionTemplates>& v, const Policy& pol)
{
   number<T, ExpressionTemplates> r = round(v, pol);
   if((r > (std::numeric_limits<lslboost::long_long_type>::max)()) || r < (std::numeric_limits<lslboost::long_long_type>::min)() || !(lslboost::math::isfinite)(v))
      return lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::iround<%1%>(%1%)", 0, v, 0LL, pol);
   return r.template convert_to<lslboost::long_long_type>();
}
template <class T, expression_template_option ExpressionTemplates>
inline lslboost::long_long_type llround(const number<T, ExpressionTemplates>& v)
{
   return llround(v, lslboost::math::policies::policy<>());
}
#endif
...
template <class T, expression_template_option ExpressionTemplates>
inline typename enable_if_c<number_category<T>::value == number_kind_floating_point, number<T, ExpressionTemplates> >::type frexp(const number<T, ExpressionTemplates>& v, lslboost::long_long_type* pint)
{
   using default_ops::eval_frexp;
   number<T, ExpressionTemplates> result;
   eval_frexp(result.backend(), v.backend(), pint);
...
template <class tag, class A1, class A2, class A3, class A4>
inline typename enable_if_c<number_category<typename detail::expression<tag, A1, A2, A3, A4>::result_type>::value == number_kind_floating_point, typename detail::expression<tag, A1, A2, A3, A4>::result_type>::type
frexp(const detail::expression<tag, A1, A2, A3, A4>& v, lslboost::long_long_type* pint)
{
   typedef typename detail::expression<tag, A1, A2, A3, A4>::result_type number_type;
   return BOOST_MP_MOVE(frexp(static_cast<number_type>(v), pint));
}
...
template <class Backend> \
inline typename lslboost::enable_if_c<\
   lslboost::multiprecision::number_category<Backend>::value == category,\
...
HETERO_BINARY_OP_FUNCTOR_B(ldexp, lslboost::long_long_type, number_kind_floating_point)
//HETERO_BINARY_OP_FUNCTOR_B(frexp, lslboost::long_long_type*, number_kind_floating_point)
...
HETERO_BINARY_OP_FUNCTOR_B(scalbn, lslboost::long_long_type, number_kind_floating_point)
...
{
   return BOOST_MP_MOVE(lslboost::math::sinhc_pi(x));
}
...
//
#include <lslboost/multiprecision/detail/no_et_ops.hpp>
#include <lslboost/multiprecision/detail/et_ops.hpp>
