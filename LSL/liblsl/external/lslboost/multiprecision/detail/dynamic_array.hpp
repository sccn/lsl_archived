...
//
  ...
  #include <vector>
  #include <lslboost/multiprecision/detail/rebind.hpp>

  namespace lslboost { namespace multiprecision { namespace backends { namespace detail
  {
    template <class value_type, const lslboost::uint32_t elem_number, class my_allocator>
  ...
  } } } } // namespace lslboost::multiprecision::backends::detail
