...
#include <lslboost/multiprecision/gmp.hpp>
...
struct mpfr_float_imp<digits10, allocate_dynamic>
{
   ...
   mpfr_float_imp& operator = (lslboost::ulong_long_type i)
   {
      if(m_data[0]._mpfr_d == 0)
         mpfr_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : get_default_precision()));
   ...
   mpfr_float_imp& operator = (lslboost::long_long_type i)
   {
      if(m_data[0]._mpfr_d == 0)
         mpfr_init2(m_data, multiprecision::detail::digits10_2_2(digits10 ? digits10 : get_default_precision()));
   ...
   mpfr_float_imp& operator = (lslboost::ulong_long_type i)
   {
      ...
      unsigned shift = 0;
      mpfr_t t;
      mpfr_init2(t, (std::max)(static_cast<unsigned long>(std::numeric_limits<lslboost::ulong_long_type>::digits), static_cast<unsigned long>(multiprecision::detail::digits10_2_2(digits10))));
   ...
   std::string str(std::streamsize digits, std::ios_base::fmtflags f)const
   {
      ...
      lslboost::multiprecision::detail::format_float_string(result, e, org_digits, f, 0 != mpfr_zero_p(m_data));
      return result;
   }
...
struct mpfr_float_imp<digits10, allocate_stack>
{
   ...
   mpfr_float_imp& operator = (lslboost::ulong_long_type i)
   {
      lslboost::ulong_long_type mask = (((1uLL << (std::numeric_limits<unsigned long>::digits - 1) - 1) << 1) | 1uL);
      unsigned shift = 0;
      mpfr_t t;
...
inline void eval_add(mpfr_float_backend<digits10, AllocationType>& result, long i)
{
   if(i > 0)
      ...
      mpfr_sub_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
}
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_subtract(mpfr_float_backend<digits10, AllocationType>& result, long i)
{
   if(i > 0)
      ...
      mpfr_add_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
}
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_multiply(mpfr_float_backend<digits10, AllocationType>& result, long i)
{
   mpfr_mul_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
   if(i < 0)
...
{
   mpfr_div_ui(result.data(), result.data(), lslboost::multiprecision::detail::unsigned_abs(i), GMP_RNDN);
   if(i < 0)
      mpfr_neg(result.data(), result.data(), GMP_RNDN);
}
//
...
{
   if(y < 0)
      mpfr_sub_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
   else
      mpfr_add_ui(a.data(), x.data(), y, GMP_RNDN);
}
template <unsigned D1, unsigned D2, mpfr_allocation_type A1, mpfr_allocation_type A2>
...
inline void eval_add(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if(x < 0)
   {
      mpfr_ui_sub(a.data(), lslboost::multiprecision::detail::unsigned_abs(x), y.data(), GMP_RNDN);
...
{
   if(y < 0)
      mpfr_add_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
   else
      mpfr_sub_ui(a.data(), x.data(), y, GMP_RNDN);
}
template <unsigned D1, unsigned D2, mpfr_allocation_type A1, mpfr_allocation_type A2>
...
inline void eval_subtract(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if(x < 0)
   {
      mpfr_add_ui(a.data(), y.data(), lslboost::multiprecision::detail::unsigned_abs(x), GMP_RNDN);
      mpfr_neg(a.data(), a.data(), GMP_RNDN);
   }
   else
      mpfr_ui_sub(a.data(), x, y.data(), GMP_RNDN);
...
inline void eval_multiply(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y)
{
   if(y < 0)
   {
      mpfr_mul_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
      a.negate();
   }
   else
      mpfr_mul_ui(a.data(), x.data(), y, GMP_RNDN);
...
inline void eval_multiply(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if(x < 0)
   {
      mpfr_mul_ui(a.data(), y.data(), lslboost::multiprecision::detail::unsigned_abs(x), GMP_RNDN);
      mpfr_neg(a.data(), a.data(), GMP_RNDN);
   }
   else
      mpfr_mul_ui(a.data(), y.data(), x, GMP_RNDN);
...
inline void eval_divide(mpfr_float_backend<D1, A1>& a, const mpfr_float_backend<D2, A2>& x, long y)
{
   if(y < 0)
   {
      mpfr_div_ui(a.data(), x.data(), lslboost::multiprecision::detail::unsigned_abs(y), GMP_RNDN);
      a.negate();
   }
   else
      mpfr_div_ui(a.data(), x.data(), y, GMP_RNDN);
...
inline void eval_divide(mpfr_float_backend<D1, A1>& a, long x, const mpfr_float_backend<D2, A2>& y)
{
   if(x < 0)
   {
      mpfr_ui_div(a.data(), lslboost::multiprecision::detail::unsigned_abs(x), y.data(), GMP_RNDN);
      mpfr_neg(a.data(), a.data(), GMP_RNDN);
   }
   else
      mpfr_ui_div(a.data(), x, y.data(), GMP_RNDN);
...
#ifdef _MPFR_H_HAVE_INTMAX_T
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_convert_to(lslboost::ulong_long_type* result, const mpfr_float_backend<digits10, AllocationType>& val)
{
   if(mpfr_nan_p(val.data()))
   {
      BOOST_THROW_EXCEPTION(std::runtime_error("Could not convert NaN to integer."));
...
template <unsigned digits10, mpfr_allocation_type AllocationType>
inline void eval_convert_to(lslboost::long_long_type* result, const mpfr_float_backend<digits10, AllocationType>& val)
{
   if(mpfr_nan_p(val.data()))
   {
      BOOST_THROW_EXCEPTION(std::runtime_error("Could not convert NaN to integer."));
...
inline void eval_trunc(mpfr_float_backend<Digits10, AllocateType>& result, const mpfr_float_backend<Digits10, AllocateType>& val)
{
   ...
   {
      result = lslboost::math::policies::raise_rounding_error("lslboost::multiprecision::trunc<%1%>(%1%)", 0, number<mpfr_float_backend<Digits10, AllocateType> >(val), number<mpfr_float_backend<Digits10, AllocateType> >(val), lslboost::math::policies::policy<>()).backend();
      return;
   }
...
using lslboost::multiprecision::backends::mpfr_float_backend;
...
template <>
inline int digits<lslboost::multiprecision::mpfr_float>()
{
   return lslboost::multiprecision::backends::detail::get_default_precision();
}
template <>
inline int digits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, lslboost::multiprecision::et_off> >()
{
   return lslboost::multiprecision::backends::detail::get_default_precision();
}
...
template<unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_pi<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_pi<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
...
template<unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_ln_two<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_ln_two<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
...
template<unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_euler<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_euler<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool init = false;
      if(!init)
      {
...
template<unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
struct constant_catalan<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> result_type;
   template<int N>
   static inline const result_type& get(const mpl::int_<N>&)
   {
      detail::mpfr_constant_initializer<constant_catalan<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >, N>::force_instantiate();
      static result_type result;
      static bool init = false;
      if(!init)
      {
...
//
template<unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> number_type;
public:
...
private:
   struct data_initializer
   {
      data_initializer()
      {
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::epsilon();
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::round_error();
         (std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::min)();
         (std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::max)();
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::infinity();
         std::numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<digits10, AllocateType> > >::quiet_NaN();
      }
...
template<unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
const typename numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::data_initializer numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::initializer;

#ifndef BOOST_NO_INCLASS_MEMBER_INITIALIZATION

template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::digits;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::digits10;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_digits10;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_signed;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_integer;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_exact;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::radix;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::min_exponent;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::min_exponent10;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_exponent;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST long numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::max_exponent10;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_infinity;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_quiet_NaN;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_signaling_NaN;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_denorm;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::has_denorm_loss;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_iec559;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_bounded;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::is_modulo;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::traps;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::tinyness_before;
template <unsigned Digits10, lslboost::multiprecision::mpfr_allocation_type AllocateType, lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates> >::round_style;

#endif


template<lslboost::multiprecision::expression_template_option ExpressionTemplates>
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> number_type;
public:
...
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::digits;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::digits10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_digits10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_signed;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_integer;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_exact;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::radix;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::min_exponent;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::min_exponent10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_exponent;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::max_exponent10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_infinity;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_quiet_NaN;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_signaling_NaN;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_denorm;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::has_denorm_loss;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_iec559;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_bounded;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::is_modulo;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::traps;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::tinyness_before;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::mpfr_float_backend<0>, ExpressionTemplates> >::round_style;
