...
struct tommath_int
{
   typedef mpl::list<lslboost::int32_t, lslboost::long_long_type>             signed_types;
   typedef mpl::list<lslboost::uint32_t, lslboost::ulong_long_type>   unsigned_types;
   ...
   tommath_int& operator = (lslboost::ulong_long_type i)
   {
      if(m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
      lslboost::ulong_long_type mask = ((1uLL << std::numeric_limits<unsigned>::digits) - 1);
      unsigned shift = 0;
      ::mp_int t;
   ...
   tommath_int& operator = (lslboost::long_long_type i)
   {
      if(m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
      bool neg = i < 0;
   ...
   //
   tommath_int& operator = (lslboost::uint32_t i)
   {
      if(m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
   ...
   tommath_int& operator = (lslboost::int32_t i)
   {
      if(m_data.dp == 0)
         detail::check_tommath_result(mp_init(&m_data));
      bool neg = i < 0;
   ...
   tommath_int& operator = (const char* s)
   {
      ...
      *this = static_cast<lslboost::uint32_t>(0u);
      unsigned radix = 10;
      bool isneg = false;
      if(n && (*s == '-'))
      {
      ...
      if(n)
      {
         if(radix == 8 || radix == 16)
         {
            ...
            lslboost::ulong_long_type val, block;
            while(*s)
            {
               block = 0;
         ...
         else
         {
            ...
            lslboost::uint32_t block_mult = 1000000000;
            while(*s)
            {
               lslboost::uint32_t block = 0;
               for(unsigned i = 0; i < 9; ++i)
               {
                  lslboost::uint32_t val;
                  if(*s >= '0' && *s <= '9')
                     val = *s - '0';
                  else
                  ...
                  if(!*++s)
                  {
                     static const lslboost::uint32_t block_multiplier[9]  = { 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000 };
   ...
   std::string str(std::streamsize /*digits*/, std::ios_base::fmtflags f)const
   {
      ...
      lslboost::scoped_array<char> a(new char[s+1]);
...
inline void eval_complement(tommath_int& result, const tommath_int& u)
{
   ...
   tommath_int mask;
   mask = static_cast<lslboost::long_long_type>((1u << padding) - 1);
...
{
   *result = lslboost::lexical_cast<A>(val.str(0, std::ios_base::fmtflags(0)));
}
inline void eval_convert_to(char* result, const tommath_int& val)
{
   *result = static_cast<char>(lslboost::lexical_cast<int>(val.str(0, std::ios_base::fmtflags(0))));
}
inline void eval_convert_to(unsigned char* result, const tommath_int& val)
{
   *result = static_cast<unsigned char>(lslboost::lexical_cast<unsigned>(val.str(0, std::ios_base::fmtflags(0))));
}
inline void eval_convert_to(signed char* result, const tommath_int& val)
{
   *result = static_cast<signed char>(lslboost::lexical_cast<int>(val.str(0, std::ios_base::fmtflags(0))));
}
...
using lslboost::multiprecision::backends::tommath_int;
...
class numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >
{
   typedef lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> number_type;
public:
...
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::digits;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::digits10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::max_digits10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::is_signed;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::is_integer;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::is_exact;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::radix;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::min_exponent;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::min_exponent10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::max_exponent;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST int numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::max_exponent10;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::has_infinity;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::has_quiet_NaN;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::has_signaling_NaN;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_denorm_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::has_denorm;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::has_denorm_loss;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::is_iec559;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::is_bounded;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::is_modulo;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::traps;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST bool numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::tinyness_before;
template <lslboost::multiprecision::expression_template_option ExpressionTemplates>
BOOST_CONSTEXPR_OR_CONST float_round_style numeric_limits<lslboost::multiprecision::number<lslboost::multiprecision::tommath_int, ExpressionTemplates> >::round_style;
