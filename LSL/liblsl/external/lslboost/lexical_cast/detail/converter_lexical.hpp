...
#include <lslboost/lexical_cast/detail/widest_char.hpp>
#include <lslboost/lexical_cast/detail/is_character.hpp>
...
#include <lslboost/lexical_cast/detail/converter_lexical_streams.hpp>
...
namespace lslboost {
    ...
    namespace detail // extract_char_traits template
    {
        ...
        template < class Char, class Traits, class Alloc>
        struct extract_char_traits< Char, lslboost::container::basic_string< Char, Traits, Alloc > >
            : lslboost::true_type
        {
            typedef Traits trait_t;
        };
    ...
    namespace detail // lcast_src_length
    {
        ...
        struct lcast_src_length<
                    Source, BOOST_DEDUCED_TYPENAME lslboost::enable_if<lslboost::is_integral<Source> >::type
                >
        {
        ...
        template<class Source>
        struct lcast_src_length<
                Source, BOOST_DEDUCED_TYPENAME lslboost::enable_if<lslboost::is_float<Source> >::type
            >
        {
            BOOST_STATIC_ASSERT(
