...
namespace lslboost 
{
    namespace detail // lcast_to_unsigned
    {
        template<class T>
        inline
        BOOST_DEDUCED_TYPENAME lslboost::make_unsigned<T>::type lcast_to_unsigned(const T value) BOOST_NOEXCEPT {
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        class lcast_put_unsigned: lslboost::noncopyable {
    ...
    {
        template <class Traits, class T, class CharT>
        class lcast_ret_unsigned: lslboost::noncopyable {
