...
{
    inline bool operator() ( lslboost::numeric::range_check_result r ) const BOOST_NOEXCEPT {
        return (r == lslboost::numeric::cInRange);
    }
};
...
inline bool noexcept_numeric_convert(const Source& arg, Target& result) BOOST_NOEXCEPT {
    ...
    typedef BOOST_DEDUCED_TYPENAME lslboost::mpl::if_c<
        lslboost::is_base_of< detect_precision_loss<Source >, converter_orig_t >::value,
        converter_orig_t,
...
struct dynamic_num_converter_impl
{
    static inline bool try_convert(const Source &arg, Target& result) BOOST_NOEXCEPT {
        typedef BOOST_DEDUCED_TYPENAME lslboost::mpl::if_c<
        	...
        	(lslboost::is_signed<Source>::value || lslboost::is_float<Source>::value) &&
        ...
        typedef BOOST_DEDUCED_TYPENAME lslboost::mpl::if_<
            BOOST_DEDUCED_TYPENAME lslboost::mpl::and_<
                lslboost::is_unsigned<Target>,
                lslboost::mpl::or_<
                    lslboost::is_signed<Source>,
                    lslboost::is_float<Source>
                >,
                lslboost::mpl::not_<
                    lslboost::is_same<Source, bool>
                >,
                lslboost::mpl::not_<
                    lslboost::is_same<Target, bool>
                >
            >::type,
            lexical_cast_dynamic_num_ignoring_minus<Target, Source>,
            lexical_cast_dynamic_num_not_ignoring_minus<Target, Source>
