...
struct cast<void(T), Args>
{
    ...
    typedef typename lslboost::add_reference<
        typename lslboost::remove_const<type0>::type 
    >::type reference;
...
#  define BOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    lslboost::parameter::aux::cast<void predicate, args>::remove_const( \
        lslboost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
