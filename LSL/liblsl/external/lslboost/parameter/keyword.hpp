...
# define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                    \
    ...
    static ::lslboost::parameter::keyword<tag_namespace::name> const& name \
       = ::lslboost::parameter::keyword<tag_namespace::name>::instance;
...
#define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                 \
    ...
    namespace                                                       \
    {                                                               \
       ::lslboost::parameter::keyword<tag_namespace::name> const& name \
       = ::lslboost::parameter::keyword<tag_namespace::name>::instance;\
    }
