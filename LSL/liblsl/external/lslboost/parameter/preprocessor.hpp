...
# include <lslboost/parameter/parameters.hpp>
# include <lslboost/parameter/binding.hpp>
# include <lslboost/parameter/match.hpp>

# include <lslboost/parameter/aux_/parenthesized_type.hpp>
# include <lslboost/parameter/aux_/cast.hpp>
# include <lslboost/parameter/aux_/preprocessor/flatten.hpp>
...
# include <lslboost/preprocessor/seq/for_each_product.hpp>
...
# include <lslboost/preprocessor/seq/fold_left.hpp>
# include <lslboost/preprocessor/seq/push_back.hpp>
# include <lslboost/preprocessor/seq/size.hpp>
# include <lslboost/preprocessor/seq/enum.hpp>
# include <lslboost/preprocessor/seq/push_back.hpp>

# include <lslboost/preprocessor/detail/is_nullary.hpp>
...
template <
  ...
  , BOOST_PP_ENUM_BINARY_PARAMS(
        BOOST_PARAMETER_MAX_ARITY, class A, = lslboost::parameter::void_ BOOST_PP_INTERCEPT
    )
>
struct match
...
template <class T>
msvc_store_type<lslboost::is_convertible<mpl::_,T>,void*(*)(void*(T))>
msvc_store_predicate_type(void*(*)(void*(T)));
...
struct funptr_predicate
{
    ...
    struct apply
    {
        BOOST_STATIC_CONSTANT(bool, result = 
            sizeof(check_predicate(lslboost::type<T>(), (Args*)0, &p)) == 1
        );
...
#  define BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z(z, name, parameters, n) \
    , typename lslboost::parameter::aux::match< \
...
# define BOOST_PARAMETER_FUNCTION_RESULT_NAME(base) \
    BOOST_PP_CAT( \
        lslboost_param_result_ \
      , BOOST_PP_CAT(__LINE__,BOOST_PARAMETER_MEMBER_FUNCTION_NAME(base)) \
    )

// Can't do lslboost_param_impl_ ## basee because base might start with an underscore
...
# define BOOST_PARAMETER_IMPL(base) \
    BOOST_PP_CAT(lslboost_param_impl,BOOST_PARAMETER_MEMBER_FUNCTION_NAME(base))
...
# define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem) \
    ...
    BOOST_PP_EXPR_IF(n, typename) \
        ...
        BOOST_PP_EXPR_IF(n, typename) \
        lslboost::parameter::aux::argument_pack< \
...
// Builds lslboost::parameter::parameters<> specialization
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_deduced_optional(tag) \
    optional<lslboost::parameter::deduced<tag>

#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_QUALIFIER_deduced_required(tag) \
    required<lslboost::parameter::deduced<tag>
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    BOOST_PP_COMMA_IF(i) \
    lslboost::parameter::BOOST_PP_CAT( \
      ...
      , typename lslboost::parameter::aux::unwrap_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    lslboost::parameter::BOOST_PP_CAT( \
      ...
      , lslboost::parameter::aux::funptr_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    lslboost::parameter::BOOST_PP_CAT( \
      ...
      , lslboost::mpl::always<lslboost::mpl::true_> \
    >
# endif
...
# define BOOST_PARAMETER_FUNCTION_PARAMETERS(tag_namespace, base, args)             \
    ...
    struct BOOST_PP_CAT(                                                            \
            BOOST_PP_CAT(lslboost_param_params_, __LINE__)                             \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT(arg, tag_namespace) \
    lslboost::parameter::keyword< \
        tag_namespace::BOOST_PARAMETER_FN_ARG_KEYWORD(arg) \
    >::instance | lslboost::parameter::aux::use_default_tag()
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT(arg) \
    BOOST_PARAMETER_FUNCTION_CAST( \
        lslboost::parameter::aux::as_lvalue(BOOST_PARAMETER_FN_ARG_DEFAULT(arg), 0L) \
      , BOOST_PARAMETER_FN_ARG_PRED(arg) \
      , Args \
    )
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY(name, n, split_args, tag_ns, const_) \
    ...
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)( \
      ...
      , lslboost::parameter::aux::use_default_tag \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_GET_ARG(r, tag_ns, arg) \
    , BOOST_PARAMETER_FUNCTION_CAST( \
          args[ \
              lslboost::parameter::keyword<tag_ns::BOOST_PARAMETER_FN_ARG_KEYWORD(arg)>::instance \
          ] \
        , BOOST_PARAMETER_FN_ARG_PRED(arg) \
        , Args \
      )
