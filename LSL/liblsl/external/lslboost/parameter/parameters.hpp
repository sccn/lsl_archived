...
#include <lslboost/detail/is_xxx.hpp>
...
#include <lslboost/parameter/aux_/arg_list.hpp>
#include <lslboost/parameter/aux_/yesno.hpp>
#include <lslboost/parameter/aux_/void.hpp>
#include <lslboost/parameter/aux_/default.hpp>
#include <lslboost/parameter/aux_/unwrap_cv_reference.hpp>
#include <lslboost/parameter/aux_/tagged_argument.hpp>
#include <lslboost/parameter/aux_/tag.hpp>
#include <lslboost/parameter/aux_/template_keyword.hpp>
#include <lslboost/parameter/aux_/set.hpp>
#include <lslboost/parameter/config.hpp>
...
namespace parameter_
{
  ...
  {
      BOOST_MPL_ASSERT((lslboost::is_same<T,void>));
      typedef int type;
  }; 
} // namespace parameter_
...
#define BOOST_PP_ITERATION_PARAMS_1 (3,( \
        3,BOOST_PARAMETER_MAX_ARITY,<lslboost/parameter/aux_/overloads.hpp> \
    ))
