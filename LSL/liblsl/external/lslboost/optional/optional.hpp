...
#include <lslboost/core/explicit_operator_bool.hpp>
#include <lslboost/core/swap.hpp>
#include <lslboost/optional/bad_optional_access.hpp>
...
#include <lslboost/detail/reference_content.hpp>
#include <lslboost/move/utility.hpp>
#include <lslboost/none.hpp>
#include <lslboost/utility/compare_pointees.hpp>

#include <lslboost/optional/optional_fwd.hpp>
...
// namespace lslboost.
namespace lslboost_optional_detail
{
...
class aligned_storage
{
    ...
    dummy_u
    {
        ...
        BOOST_DEDUCED_TYPENAME type_with_alignment<
          ::lslboost::alignment_of<T>::value >::type aligner_;
    } dummy_ ;
...
#else
  static rval_reference_type move(reference_type r) { return lslboost::move(r); }
#endif
#endif
...
void prevent_binding_rvalue_ref_to_optional_lvalue_ref()
{
  ...
  BOOST_STATIC_ASSERT_MSG(
    !lslboost::is_lvalue_reference<To>::value || !lslboost::is_rvalue_reference<From>::value, 
...
class optional_base : public optional_tag
{
...
#endif
    ::lslboost::detail::make_reference_content<T>::type internal_type ;
  ...
  protected:
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value(lslboost::move(rhs.get_impl()), is_reference_predicate() );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( lslboost::move(val), is_reference_predicate() );
  ...
  protected :
    ...
    void emplace_assign ( Args&&... args )
     {
       destroy();
       ::new (m_storage.address()) internal_type( lslboost::forward<Args>(args)... );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       ::new (m_storage.address()) internal_type( lslboost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       BOOST_STATIC_ASSERT ( ::lslboost::mpl::not_<is_reference_predicate>::value ) ;
    ...
    {
      new (m_storage.address()) internal_type(lslboost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value(lslboost::forward<Expr>(expr), is_reference_predicate());
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
...
class optional : public optional_detail::optional_base<T>
{
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME lslboost::disable_if_c<
                        (lslboost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME lslboost::decay<Expr>::type>::value) || 
                        lslboost::is_same<BOOST_DEDUCED_TYPENAME lslboost::decay<Expr>::type, none_t>::value >::type* = 0 
  ) 
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME lslboost::disable_if_c<
      lslboost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME lslboost::decay<Expr>::type>::value || 
        lslboost::is_same<BOOST_DEDUCED_TYPENAME lslboost::decay<Expr>::type, none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output lslboost::optional, include header <lslboost/optional/optional_io.hpp>");
  return os;  
}
