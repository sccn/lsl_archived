...
// Intel compiler does not support __atomic* intrinsics properly, although defines them (tested with 13.0.1 and 13.1.1 on Linux)
    ...
    #include <lslboost/atomic/detail/gcc-atomic.hpp>

#elif defined(__GNUC__) && (defined(__i386__) || defined(__x86_64__))

    #include <lslboost/atomic/detail/gcc-x86.hpp>

#elif 0 && defined(__GNUC__) && defined(__alpha__) /* currently does not work correctly */

    #include <lslboost/atomic/detail/base.hpp>
    #include <lslboost/atomic/detail/gcc-alpha.hpp>

#elif defined(__GNUC__) && (defined(__POWERPC__) || defined(__PPC__))

    #include <lslboost/atomic/detail/gcc-ppc.hpp>
...
// I don't know how complete it is.
    ...
    #include <lslboost/atomic/detail/gcc-armv6plus.hpp>

#elif defined(__linux__) && defined(__arm__)

    #include <lslboost/atomic/detail/linux-arm.hpp>

#elif defined(__GNUC__) && defined(__sparc_v9__)

    #include <lslboost/atomic/detail/gcc-sparcv9.hpp>

#elif defined(BOOST_WINDOWS) || defined(_WIN32_CE)

    #include <lslboost/atomic/detail/windows.hpp>

#elif 0 && defined(__GNUC__) /* currently does not work correctly */

    #include <lslboost/atomic/detail/base.hpp>
    #include <lslboost/atomic/detail/gcc-cas.hpp>
