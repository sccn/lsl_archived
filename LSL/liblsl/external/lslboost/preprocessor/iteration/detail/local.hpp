...
#        include <lslboost/preprocessor/iteration/detail/start.hpp>
#        define BOOST_PP_VALUE BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_LOCAL_LIMITS)
#        include <lslboost/preprocessor/iteration/detail/finish.hpp>
...
#    include <lslboost/preprocessor/iteration/detail/rlocal.hpp>
# else
