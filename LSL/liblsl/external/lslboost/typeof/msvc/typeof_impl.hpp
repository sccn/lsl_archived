...
# define BOOST_TYPEOF_INDEX(T) (sizeof(*lslboost::type_of::encode_index((lslboost::type_of::encode_counter<1005>*)0)))
...
# define BOOST_TYPEOF(expr) \
    lslboost::type_of::msvc_typeid_wrapper<typeid(lslboost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
struct name {\
    enum {_typeof_register_value=sizeof(typeid(lslboost::type_of::typeof_register_type<name>(expr)))};\
    typedef typename lslboost::type_of::msvc_extract_type<name>::id2type id2type;\
...
struct name {\
    enum {_typeof_register_value=sizeof(typeid(lslboost::type_of::typeof_register_type<name>(expr)))};\
    typedef lslboost::type_of::msvc_extract_type<name>::id2type id2type;\
...
# define BOOST_TYPEOF(expr) \
    lslboost::type_of::msvc_typeid_wrapper<sizeof(*lslboost::type_of::encode_start(expr))>::type

# define BOOST_TYPEOF_TPL(expr) typename BOOST_TYPEOF(expr)

# define BOOST_TYPEOF_NESTED_TYPEDEF_TPL(name,expr) \
    struct name {\
        BOOST_STATIC_CONSTANT(int,_typeof_register_value=sizeof(lslboost::type_of::typeof_register_type<name>(expr)));\
        typedef typename lslboost::type_of::msvc_extract_type<name>::id2type id2type;\
        typedef typename id2type::type type;\
    };
