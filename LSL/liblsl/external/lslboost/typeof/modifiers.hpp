...
#define BOOST_TYPEOF_modifier_support(ID, Fun)\
    ...
    {\
        typedef\
            typename lslboost::type_of::encode_type<\
            typename lslboost::type_of::push_back<\
            V\
            , lslboost::mpl::size_t<ID> >::type\
            , T>::type\
            type;\
    };\
    template<class Iter> struct decode_type_impl<lslboost::mpl::size_t<ID>, Iter>\
    {\
        typedef lslboost::type_of::decode_type<Iter> d1;\
...
#define BOOST_TYPEOF_array_support(ID, Qualifier)\
    ...
    {\
        ...
        typedef lslboost::type_of::decode_type<typename Iter::next> d;\
