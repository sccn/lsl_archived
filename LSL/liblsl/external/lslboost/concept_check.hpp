...
//   01 April 2001: Modified to use new <lslboost/limits.hpp> header. (JMaddock)
//

// See http://www.lslboost.org/libs/concept_check for documentation.
...
# include <lslboost/type_traits/conversion_traits.hpp>
# include <utility>
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct Integer< ::lslboost::long_long_type> {};
  template <> struct Integer< ::lslboost::ulong_long_type> {};
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct SignedInteger< ::lslboost::long_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
# if defined(BOOST_HAS_LONG_LONG)
  template <> struct UnsignedInteger< ::lslboost::ulong_long_type> {};
# elif defined(BOOST_HAS_MS_INT64)
...
#define BOOST_DEFINE_BINARY_OPERATOR_CONSTRAINT(OP,NAME)    \
  ...
  BOOST_concept(UnaryFunction,(Func)(Return)(Arg))
  {
   ...
   private:
      ...
      // (warning: non-static reference "const double& lslboost::UnaryFunction<YourClassHere>::arg"
  ...
  BOOST_concept(BinaryFunction,(Func)(Return)(First)(Second))
  {
   ...
   private:
      ...
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& lslboost::BinaryFunction<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryFunction();
#endif
  ...
  BOOST_concept(UnaryPredicate,(Func)(Arg))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& lslboost::UnaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      UnaryPredicate();
#endif
  ...
  BOOST_concept(BinaryPredicate,(Func)(First)(Second))
  {
   ...
   private:
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& lslboost::BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
      BinaryPredicate();
#endif
    Func f;
    ...
    : BinaryPredicate<Func, First, Second>
  {
   ...
   private:
    void const_constraints(const Func& fun) {
      ...
      // Declare a dummy constructor to make gcc happy.
      // It seems the compiler can not generate a sensible constructor when this is instantiated with a refence type.
      // (warning: non-static reference "const double& lslboost::Const_BinaryPredicate<YourClassHere>::arg"
      // in class without a constructor [-Wuninitialized])
  ...
  {
      typedef typename lslboost::detail::iterator_traits<TT>::value_type value_type;
      typedef typename lslboost::detail::iterator_traits<TT>::difference_type difference_type;
      typedef typename lslboost::detail::iterator_traits<TT>::reference reference;
      typedef typename lslboost::detail::iterator_traits<TT>::pointer pointer;
      typedef typename lslboost::detail::iterator_traits<TT>::iterator_category iterator_category;
    ...
    , Comparable<TT>
  {
   ...
   private:
    TT a, b;
    TT i, j;
      typename lslboost::detail::iterator_traits<TT>::difference_type n;
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(SimpleAssociativeContainer)
      {
          typedef typename C::key_type key_type;
          typedef typename C::value_type value_type;
          BOOST_MPL_ASSERT((lslboost::is_same<key_type,value_type>));
      }
  };
    ...
    : AssociativeContainer<C>
  {
      BOOST_CONCEPT_USAGE(PairAssociativeContainer)
      {
          ...
          BOOST_MPL_ASSERT((lslboost::is_same<value_type,required_value_type>));
      }
  };
  ...
  BOOST_concept(Collection,(C))
  {
      ...
      {
        lslboost::function_requires<lslboost::InputIteratorConcept<iterator> >();
        lslboost::function_requires<lslboost::InputIteratorConcept<const_iterator> >();
        lslboost::function_requires<lslboost::CopyConstructibleConcept<value_type> >();
        const_constraints(c);
        i = c.begin();
        i = c.end();
        c.swap(c);
