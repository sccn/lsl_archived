...
struct for_each {
  ...
  struct sig { 
    typedef typename lslboost::remove_const<
        typename lslboost::tuples::element<3, Args>::type 
     >::type type; 
  };
...
struct transform {
  ...
  struct sig { 
    typedef typename lslboost::remove_const<
        typename lslboost::tuples::element<
          lslboost::tuples::length<Args>::value - 2, 
          Args
      >::type
     >::type type; 
  };
...
struct merge {
  ...
  struct sig { 
    typedef typename lslboost::remove_const<
        typename lslboost::tuples::element<5, Args>::type 
     >::type type; 
  };
