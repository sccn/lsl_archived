...
#include <lslboost/logic/tribool_fwd.hpp>
...
namespace lslboost { namespace logic {
...
} } // end namespace lslboost::logic

// Pull tribool and indeterminate into namespace "lslboost"
namespace lslboost {
  using logic::tribool;
...
inline bool                                                             \
Name(lslboost::logic::tribool x,                                           \
     lslboost::logic::detail::indeterminate_t =                            \
       lslboost::logic::detail::indeterminate_t())                         \
{ return x.value == lslboost::logic::tribool::indeterminate_value; }
