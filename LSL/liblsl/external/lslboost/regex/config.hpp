...
#  include <lslboost/regex/config/borland.hpp>
#endif
...
#     define BOOST_REGEX_USER_CONFIG <lslboost/regex/user.hpp>
#  endif
...
#  include <lslboost/config.hpp>
   ...
   /*
    * C build,
    * don't include <lslboost/config.hpp> because that may
...
#ifdef __cplusplus
#  include <lslboost/regex/config/cwchar.hpp>
#endif

#endif

/*
 * If Win32 support has been disabled for lslboost in general, then
...
#  define BOOST_LIB_NAME lslboost_regex
...
namespace lslboost{ namespace re_detail{
