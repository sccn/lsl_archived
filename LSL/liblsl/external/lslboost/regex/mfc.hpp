...
make_regex(const ATL::CSimpleStringT<B, b>& s, ::lslboost::regex_constants::syntax_option_type f = lslboost::regex_constants::normal)
{
...
make_regex_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, ::lslboost::regex_constants::match_flag_type f = lslboost::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
   make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, int sub = 0, ::lslboost::regex_constants::match_flag_type f = lslboost::regex_constants::match_default)
{
...
template <class B, bool b>
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, const std::vector<int>& subs, ::lslboost::regex_constants::match_flag_type f = lslboost::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, const int (& subs)[N], ::lslboost::regex_constants::match_flag_type f = lslboost::regex_constants::match_default)
{
   regex_token_iterator<B const*> result(s.GetString(), s.GetString() + s.GetLength(), e, subs, f);
   return result;
}
