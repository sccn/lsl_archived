...
#include <lslboost/regex/v4/iterator_category.hpp>
...
// error checking API:
//
BOOST_REGEX_DECL void BOOST_REGEX_CALL verify_options(lslboost::regex_constants::syntax_option_type ef, match_flag_type mf);
//
// function can_start:
//
...
{   
   ...
   const ::lslboost::regex_traits_wrapper<traits_type>& traits_inst = *(e.m_ptraits);
...
private:
   ...
   {
      return ::lslboost::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::lslboost::regex_traits_wrapper<traits>& traits_inst;
...
//
#ifdef BOOST_REGEX_RECURSIVE
#include <lslboost/regex/v4/perl_matcher_recursive.hpp>
#else
#include <lslboost/regex/v4/perl_matcher_non_recursive.hpp>
#endif
// this one has to be last:
#include <lslboost/regex/v4/perl_matcher_common.hpp>
