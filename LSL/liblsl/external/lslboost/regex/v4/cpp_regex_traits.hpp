...
#include <lslboost/regex/pattern_except.hpp>
#endif
#ifndef BOOST_REGEX_TRAITS_DEFAULTS_HPP_INCLUDED
#include <lslboost/regex/v4/regex_traits_defaults.hpp>
#endif
#ifdef BOOST_HAS_THREADS
#include <lslboost/regex/pending/static_mutex.hpp>
#endif
#ifndef BOOST_REGEX_PRIMARY_TRANSFORM
#include <lslboost/regex/v4/primary_transform.hpp>
#endif
#ifndef BOOST_REGEX_OBJECT_CACHE_HPP
#include <lslboost/regex/pending/object_cache.hpp>
#endif
...
void cpp_regex_traits_char_layer<charT>::init()
{
   ...
   if(cat_name.size() && (this->m_pmessages != 0))
   {
      ...
      if((int)cat < 0)
      {
         ...
         lslboost::re_detail::raise_runtime_error(err);
      }
   }
   //
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::lslboost::re_detail::char_class_alnum,
         ::lslboost::re_detail::char_class_alpha,
         ::lslboost::re_detail::char_class_cntrl,
         ::lslboost::re_detail::char_class_digit,
         ::lslboost::re_detail::char_class_graph,
         ::lslboost::re_detail::char_class_horizontal_space,
         ::lslboost::re_detail::char_class_lower,
         ::lslboost::re_detail::char_class_print,
         ::lslboost::re_detail::char_class_punct,
         ::lslboost::re_detail::char_class_space,
         ::lslboost::re_detail::char_class_upper,
         ::lslboost::re_detail::char_class_vertical_space,
         ::lslboost::re_detail::char_class_xdigit,
         ::lslboost::re_detail::char_class_blank,
         ::lslboost::re_detail::char_class_word,
         ::lslboost::re_detail::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::lslboost::re_detail::char_class_upper,
      ::lslboost::re_detail::char_class_vertical_space,
      ::lslboost::re_detail::char_class_alnum | ::lslboost::re_detail::char_class_word, 
      ::lslboost::re_detail::char_class_alnum | ::lslboost::re_detail::char_class_word, 
      ::lslboost::re_detail::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::lslboost::re_detail::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::lslboost::re_detail::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::lslboost::re_detail::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::lslboost::re_detail::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::lslboost::re_detail::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::lslboost::re_detail::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::lslboost::re_detail::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::lslboost::re_detail::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::lslboost::re_detail::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::lslboost::re_detail::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::lslboost::re_detail::is_separator(c))
      || ((mask & ::lslboost::re_detail::char_class_word) && (c == '_'))
      || ((mask & ::lslboost::re_detail::char_class_unicode) && ::lslboost::re_detail::is_extended(c))
      || ((mask & ::lslboost::re_detail::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::lslboost::re_detail::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline lslboost::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(charT))
{
...
public:
   ...
   bool isctype(charT c, char_class_type f) const
   {
      ...
      if((f & mask_base) 
         ...
         && (::lslboost::re_detail::is_separator(c) || (c == '\v')))
         return true;
   ...
   //
   // extension:
   // set the name of the message catalog in use (defaults to "lslboost_regex").
   //
   static std::string catalog_name(const std::string& name);
   static std::string get_catalog_name();

private:
   lslboost::shared_ptr<const re_detail::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
