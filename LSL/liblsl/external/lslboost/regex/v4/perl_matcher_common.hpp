...
void perl_matcher<BidiIterator, Allocator, traits>::estimate_max_state_count(std::random_access_iterator_tag*)
{
   ...
   std::ptrdiff_t dist = lslboost::re_detail::distance(base, last);
   if(dist == 0)
      dist = 1;
...
{
   ::lslboost::re_detail::concrete_protected_call
...
#pragma warning(disable:4127)
   ...
   {
      std::ptrdiff_t maxlen = ::lslboost::re_detail::distance(backstop, position);
