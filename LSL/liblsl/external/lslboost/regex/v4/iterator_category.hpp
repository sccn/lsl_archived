...
public:
   BOOST_STATIC_CONSTANT(bool, value = (::lslboost::is_convertible<cat*, std::random_access_iterator_tag*>::value));
#else
...
{
private:
   typedef detail::is_random_imp_selector< ::lslboost::is_pointer<I>::value> selector;
