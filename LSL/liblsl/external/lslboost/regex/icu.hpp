...
#include <lslboost/regex/pending/unicode_iterator.hpp>
...
class BOOST_REGEX_DECL icu_regex_traits_implementation
{
   ...
   typedef lslboost::uint_least32_t        char_class_type;
public:
...
private:
   ...
   lslboost::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_collator;          // The full collation object
   lslboost::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_primary_collator;  // The primary collation object
};

inline lslboost::shared_ptr<icu_regex_traits_implementation> get_icu_regex_traits_implementation(const U_NAMESPACE_QUALIFIER Locale& loc)
{
   return lslboost::shared_ptr<icu_regex_traits_implementation>(new icu_regex_traits_implementation(loc));
}
...
public:
...
#else
   typedef lslboost::uint64_t              char_class_type;
#endif

   struct lslboost_extensions_tag{};
   ...
   ::lslboost::regex_constants::syntax_type syntax_type(char_type c)const
   {
      return ((c < 0x7f) && (c > 0)) ? re_detail::get_default_syntax_type(static_cast<char>(c)) : regex_constants::syntax_char;
   }
   ::lslboost::regex_constants::escape_syntax_type escape_syntax_type(char_type c) const
   {
   ...
   std::string error_string(::lslboost::regex_constants::error_type n) const
   {
...
private:
   ...
   lslboost::shared_ptr< ::lslboost::re_detail::icu_regex_traits_implementation> m_pimpl;
};
...
#endif
#include <lslboost/regex/v4/instances.hpp>
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              lslboost::regex_constants::syntax_option_type opt, 
                              const lslboost::mpl::int_<1>*)
{
   typedef lslboost::u8_to_u32_iterator<InputIterator, UChar32> conv_type;
...
inline u32regex do_make_u32regex(InputIterator i, 
                              InputIterator j, 
                              lslboost::regex_constants::syntax_option_type opt, 
                              const lslboost::mpl::int_<2>*)
{
   typedef lslboost::u16_to_u32_iterator<InputIterator, UChar32> conv_type;
   return u32regex(conv_type(i, i, j), conv_type(j, i, j), opt);
}
...
inline u32regex make_u32regex(InputIterator i, 
                              ...
                              lslboost::regex_constants::syntax_option_type opt)
{
   return re_detail::do_make_u32regex(i, j, opt, static_cast<lslboost::mpl::int_<sizeof(*i)> const*>(0));
}
//
// construction from UTF-8 nul-terminated strings:
//
inline u32regex make_u32regex(const char* p, lslboost::regex_constants::syntax_option_type opt = lslboost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + std::strlen(p), opt, static_cast<lslboost::mpl::int_<1> const*>(0));
}
inline u32regex make_u32regex(const unsigned char* p, lslboost::regex_constants::syntax_option_type opt = lslboost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + std::strlen(reinterpret_cast<const char*>(p)), opt, static_cast<lslboost::mpl::int_<1> const*>(0));
}
//
// construction from UTF-16 nul-terminated strings:
//
#ifndef BOOST_NO_WREGEX
inline u32regex make_u32regex(const wchar_t* p, lslboost::regex_constants::syntax_option_type opt = lslboost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + std::wcslen(p), opt, static_cast<lslboost::mpl::int_<sizeof(wchar_t)> const*>(0));
}
#endif
#if !defined(U_WCHAR_IS_UTF16) && (U_SIZEOF_WCHAR_T != 2)
inline u32regex make_u32regex(const UChar* p, lslboost::regex_constants::syntax_option_type opt = lslboost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(p, p + u_strlen(p), opt, static_cast<lslboost::mpl::int_<2> const*>(0));
}
#endif
//
...
inline u32regex make_u32regex(const std::basic_string<C, T, A>& s, lslboost::regex_constants::syntax_option_type opt = lslboost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(s.begin(), s.end(), opt, static_cast<lslboost::mpl::int_<sizeof(C)> const*>(0));
}
//
// Construction from ICU string type:
//
inline u32regex make_u32regex(const U_NAMESPACE_QUALIFIER UnicodeString& s, lslboost::regex_constants::syntax_option_type opt = lslboost::regex_constants::perl)
{
   return re_detail::do_make_u32regex(s.getBuffer(), s.getBuffer() + s.length(), opt, static_cast<lslboost::mpl::int_<2> const*>(0));
}
...
inline bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 lslboost::mpl::int_<4> const*)
{
   return ::lslboost::regex_match(first, last, m, e, flags);
}
template <class BidiIterator, class Allocator>
bool do_regex_match(BidiIterator first, BidiIterator last, 
                 ...
                 const u32regex& e, 
                 match_flag_type flags,
                 lslboost::mpl::int_<2> const*)
{
   typedef u16_to_u32_iterator<BidiIterator, UChar32> conv_type;
   typedef match_results<conv_type>                   match_type;
   //typedef typename match_type::allocator_type        alloc_type;
   match_type what;
   bool result = ::lslboost::regex_match(conv_type(first, first, last), conv_type(last, first, last), what, e, flags);
...
inline bool do_regex_search(BidiIterator first, BidiIterator last, 
                 ...
                 lslboost::mpl::int_<4> const*)
{
   return ::lslboost::regex_search(first, last, m, e, flags, base);
}
template <class BidiIterator, class Allocator>
                 ...
                 lslboost::mpl::int_<2> const*)
{
   ...
   //typedef typename match_type::allocator_type        alloc_type;
   match_type what;
   bool result = ::lslboost::regex_search(conv_type(first, first, last), conv_type(last, first, last), what, e, flags, conv_type(base));
   // copy results across to m:
   if(result) copy_results(m, what);
   return result;
}
...
namespace re_detail{
template <class I>
inline std::pair< lslboost::u8_to_u32_iterator<I>, lslboost::u8_to_u32_iterator<I> >
   make_utf32_seq(I i, I j, mpl::int_<1> const*)
{
   return std::pair< lslboost::u8_to_u32_iterator<I>, lslboost::u8_to_u32_iterator<I> >(lslboost::u8_to_u32_iterator<I>(i, i, j), lslboost::u8_to_u32_iterator<I>(j, i, j));
}
template <class I>
inline std::pair< lslboost::u16_to_u32_iterator<I>, lslboost::u16_to_u32_iterator<I> >
   make_utf32_seq(I i, I j, mpl::int_<2> const*)
{
   return std::pair< lslboost::u16_to_u32_iterator<I>, lslboost::u16_to_u32_iterator<I> >(lslboost::u16_to_u32_iterator<I>(i, i, j), lslboost::u16_to_u32_iterator<I>(j, i, j));
}
template <class I>
inline std::pair< I, I >
...
inline std::pair< lslboost::u8_to_u32_iterator<const charT*>, lslboost::u8_to_u32_iterator<const charT*> >
   make_utf32_seq(const charT* p, mpl::int_<1> const*)
{
   std::size_t len = std::strlen((const char*)p);
   return std::pair< lslboost::u8_to_u32_iterator<const charT*>, lslboost::u8_to_u32_iterator<const charT*> >(lslboost::u8_to_u32_iterator<const charT*>(p, p, p+len), lslboost::u8_to_u32_iterator<const charT*>(p+len, p, p+len));
}
template <class charT>
inline std::pair< lslboost::u16_to_u32_iterator<const charT*>, lslboost::u16_to_u32_iterator<const charT*> >
   make_utf32_seq(const charT* p, mpl::int_<2> const*)
{
   std::size_t len = u_strlen((const UChar*)p);
   return std::pair< lslboost::u16_to_u32_iterator<const charT*>, lslboost::u16_to_u32_iterator<const charT*> >(lslboost::u16_to_u32_iterator<const charT*>(p, p, p + len), lslboost::u16_to_u32_iterator<const charT*>(p+len, p, p + len));
}
template <class charT>
                                 ...
                                 )
{
   ...
   else
   {
      ...
      while(i != j)
      {
         ...
         if(f.size())
            out = ::lslboost::re_detail::regex_format_imp(out, *i, &*f.begin(), &*f.begin() + f.size(), flags, e.get_traits());
         else
            out = ::lslboost::re_detail::regex_format_imp(out, *i, static_cast<UChar32 const*>(0), static_cast<UChar32 const*>(0), flags, e.get_traits());
         last_m = (*i)[0].second;
...
#include <lslboost/regex/v4/u32regex_iterator.hpp>
#include <lslboost/regex/v4/u32regex_token_iterator.hpp>
