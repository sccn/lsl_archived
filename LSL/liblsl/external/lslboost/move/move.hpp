...
//If lslboost dependencies are avoided include all machinery
   ...
   #define BOOST_MOVE_MPL_NS    ::lslboost::mpl
   #define BOOST_MOVE_BOOST_NS  ::lslboost
#else
   #define BOOST_MOVE_MPL_NS    ::lslboost::move_detail
   #define BOOST_MOVE_BOOST_NS  ::lslboost::move_detail
...
//Small meta-typetraits to support move
   ...
   {
      return ::lslboost::move_detail::addressof_impl<T>::f
         ( ::lslboost::move_detail::addr_impl_ref<T>( v ), 0 );
   }
...
/// @endcond
   ...
   struct has_move_emulation_enabled
      : BOOST_MOVE_BOOST_NS::is_convertible< T, ::lslboost::rv<T>& >
   {};
   ...
   template <class T>
   inline typename BOOST_MOVE_BOOST_NS::enable_if< ::lslboost::move_detail::is_rv<T>, T &>::type
   ...
   template <class T>
   inline typename BOOST_MOVE_BOOST_NS::disable_if< ::lslboost::move_detail::is_rv<T>, const T &>::type
      forward(const typename BOOST_MOVE_MPL_NS::identity<T>::type &x)
   {
      return x;
   }
   ...
   {};
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::lslboost::rv<T> &</i> so that move emulation is activated.
         template <class T>
...
class move_iterator
{
   ...
   typedef typename BOOST_MOVE_MPL_NS::if_
      < ::lslboost::has_move_emulation_enabled<value_type>
      , ::lslboost::rv<value_type>&
...
template <class I>
struct is_move_iterator< ::lslboost::move_iterator<I> >
   ...
   : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
   ...
   { container_m->push_back(lslboost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(lslboost::move(x)); return *this; }
   ...
   : public std::iterator<std::output_iterator_tag, void, void, void, void>
{
   ...
   {
      pos_ = container_m->insert(pos_, ::lslboost::move(x));
      ++pos_;
      return *this;
   }
...
//////////////////////////////////////////////////////////////////////////////
   ...
   //!   performs *(result + n) = ::lslboost::move (*(first + n)).
   //!
   ...
   //!   performs *(result - n) = ::lslboost::move(*(last - n)).
   //!
   //! <b>Requires</b>: result shall not be in the range [first,last).
   //!
...
//!         typename iterator_traits<ForwardIterator>::value_type(lslboost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
   ...
   )
{
   ...
   while (f != l) {
      ::new(static_cast<void*>(&*r)) input_value_type(lslboost::move(*f));
      ++f; ++r;
   }
   return r;
}
...
{
   return ::lslboost::uninitialized_move(f, l, r);
}
/*
template
<typename I,   // I models InputIterator
...
{
   return ::lslboost::move_detail::uninitialized_move_move_iterator(f, l, r);
}
...
inline F copy_or_move(I f, I l, F r,
                             typename BOOST_MOVE_BOOST_NS::enable_if< move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::lslboost::move_detail::move_move_iterator(f, l, r);
}
...
// Code from Jeffrey Lee Hellrung, many thanks
   ...
   template< class T>
   struct forward_type< lslboost::rv<T> >
   { typedef T type; };
...
template< class T > struct is_rvalue_reference : BOOST_MOVE_BOOST_NS::integral_constant<bool, false> { };
...
#else // #ifndef BOOST_NO_RVALUE_REFERENCES
   template< class T > struct is_rvalue_reference< lslboost::rv<T>& >
      :  BOOST_MOVE_BOOST_NS::integral_constant<bool, true>
   {};

   template< class T > struct is_rvalue_reference< const lslboost::rv<T>& >
      : BOOST_MOVE_BOOST_NS::integral_constant<bool, true>
   {};
#endif // #ifndef BOOST_NO_RVALUE_REFERENCES
   ...
   {
      template< class T
              , bool emulation = ::lslboost::has_move_emulation_enabled<T>::value
              , bool rv        = ::lslboost::move_detail::is_rv<T>::value  >
      ...
      struct add_rvalue_reference_impl< T, true, rv > { typedef ::lslboost::rv<T>& type; };
   } // namespace detail_add_rvalue_reference
