...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::lslboost::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::lslboost::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< lslboost::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const lslboost::rv<T>& >
{  static const bool value = true;  };
