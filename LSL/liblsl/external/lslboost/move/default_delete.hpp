...
namespace bmupmu = ::lslboost::move_upmu;
...
namespace bmupd = lslboost::move_upd;
namespace bmupmu = ::lslboost::move_upmu;
...
struct default_delete
{
      ...
      ) BOOST_NOEXCEPT
   {
      ...
      BOOST_STATIC_ASSERT(( !::lslboost::move_upmu::missing_virtual_destructor<default_delete, U>::value ));
   }
