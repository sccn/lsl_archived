...
#include <lslboost/static_assert.hpp>
         ...
         move_if_not_lvalue_reference(typename ::lslboost::move_detail::remove_reference<T>::type &x) BOOST_NOEXCEPT
   {
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline typename ::lslboost::move_detail::remove_reference<T>::type && move(T&& t) BOOST_NOEXCEPT
         {  return t;   }
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline T&& forward(typename ::lslboost::move_detail::identity<T>::type&& t) BOOST_NOEXCEPT
         {  return t;   }

      #else //Old move

         template <class T>
         inline T&& forward(typename ::lslboost::move_detail::remove_reference<T>::type& t) BOOST_NOEXCEPT
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         template <class T>
         inline T&& move_if_not_lvalue_reference(typename ::lslboost::move_detail::identity<T>::type&& t) BOOST_NOEXCEPT
         {  return t;   }

      #else //Old move

         template <class T>
         inline T&& move_if_not_lvalue_reference(typename ::lslboost::move_detail::remove_reference<T>::type& t) BOOST_NOEXCEPT
         {  return static_cast<T&&>(t);   }
