...
#include <lslboost/move/detail/meta_utils.hpp>
   ...
   template <class T>
   inline typename ::lslboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && ::lslboost::move_detail::is_rv<T>::value, T &>::type
   ...
   template <class T>
   inline typename ::lslboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && !::lslboost::move_detail::is_rv<T>::value, const T &>::type
      forward(const typename ::lslboost::move_detail::identity<T>::type &x) BOOST_NOEXCEPT
   {
      return x;
   }
