...
//! \file
//! This header includes core utilities from <tt><lslboost/move/utility_core.hpp></tt> and defines
...
#include <lslboost/move/traits.hpp>
   ...
   inline typename ::lslboost::move_detail::enable_if_c
      ...
      , typename ::lslboost::move_detail::add_const<T>::type &
      >::type
   ...
   inline typename ::lslboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && has_move_emulation_enabled<T>::value
            && ::lslboost::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value, rv<T>&>::type
         move_if_noexcept(T& x) BOOST_NOEXCEPT
   {
      return *static_cast<rv<T>* >(::lslboost::move_detail::addressof(x));
   }

   template <class T>
   inline typename ::lslboost::move_detail::enable_if_c
      < enable_move_utility_emulation<T>::value && has_move_emulation_enabled<T>::value
            && ::lslboost::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value
      , rv<T>&
      >::type
         ...
         move_if_noexcept(rv<T>& x) BOOST_NOEXCEPT
   {
      ...
      //////////////////////////////////////////////////////////////////////////////
         ...
         //! <i>::lslboost::rv<T> &</i> so that move emulation is activated. Reference
         ...
         typename ::lslboost::move_detail::enable_if_c
            < ::lslboost::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value, T&&>::type
               move_if_noexcept(T& x) BOOST_NOEXCEPT
         {  return ::lslboost::move(x);   }

         template <class T>
         typename ::lslboost::move_detail::enable_if_c
            < !::lslboost::move_detail::is_nothrow_move_constructible_or_uncopyable<T>::value, const T&>::type
               move_if_noexcept(T& x) BOOST_NOEXCEPT
         {  return x;  }
