//  lslboost utility/base_from_member.hpp header file  --------------------------//
...
//  See <http://www.lslboost.org/libs/utility/> for the library's home page.
...
{
    typedef typename ::lslboost::remove_cv<typename
     ::lslboost::remove_reference<T>::type>::type  type;

};  // lslboost::detail::remove_cv_ref
...
struct is_related
    : public ::lslboost::is_same<
     typename ::lslboost::detail::remove_cv_ref<T>::type,
     typename ::lslboost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::lslboost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::lslboost::disable_if< ::lslboost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::lslboost::detail::enable_if_unrelated<base_from_member, T...>::type>
