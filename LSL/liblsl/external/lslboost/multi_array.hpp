...
//           Jeremy Siek
//           Andrew Lumsdaine
//  See http://www.lslboost.org/libs/multi_array for documentation.
...
#include "lslboost/multi_array/base.hpp"
#include "lslboost/multi_array/collection_concept.hpp"
#include "lslboost/multi_array/copy_array.hpp"
#include "lslboost/multi_array/iterator.hpp"
#include "lslboost/multi_array/subarray.hpp"
#include "lslboost/multi_array/multi_array_ref.hpp"
#include "lslboost/multi_array/algorithm.hpp"
...
public:
  ...
  struct const_array_view {
    typedef lslboost::detail::multi_array::const_multi_array_view<T,NDims> type;
  };

  template <std::size_t NDims>
  struct array_view {
    typedef lslboost::detail::multi_array::multi_array_view<T,NDims> type;
  };
  ...
  super_type(rhs), allocator_(rhs.allocator_) {
    allocate_space();
    lslboost::detail::multi_array::copy_n(rhs.base_,rhs.num_elements(),base_);
  }
  ...
  multi_array& resize(const detail::multi_array
    ...
    lslboost::array<size_type,NumDims> min_extents;
    ...
    // typedef lslboost::array<index,NumDims> index_list;
...
private:
  ...
  typedef lslboost::array<size_type,NumDims> size_list;
  typedef lslboost::array<index,NumDims> index_list;
