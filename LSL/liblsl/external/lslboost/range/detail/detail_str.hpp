...
#include <lslboost/range/detail/begin.hpp>
#include <lslboost/range/detail/end.hpp>
#include <lslboost/range/detail/size_type.hpp>
#include <lslboost/range/detail/value_type.hpp>
...
namespace lslboost 
{
    ...
    namespace range_detail
    {
        ...
        struct range_end<char_ptr_>
        {
            static char* fun( char* s )
            {
                return lslboost::range_detail::str_end( s );
            }
        };
