...
#include <lslboost/range/detail/demote_iterator_traversal_tag.hpp>
...
public:
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_begin_tag)
        : m_section(lslboost::empty(r1) ? 1u : 0u)
        , m_it(lslboost::empty(r1) ? 1u : 0u, lslboost::begin(r1), lslboost::begin(r2))
        , m_link(link_t(lslboost::end(r1), lslboost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_begin_tag)
        : m_section(lslboost::empty(r1) ? 1u : 0u)
        , m_it(lslboost::empty(r1) ? 1u : 0u, lslboost::const_begin(r1), lslboost::const_begin(r2))
        , m_link(link_t(lslboost::const_end(r1), lslboost::const_begin(r2)))
    {
    }
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, lslboost::end(r1), lslboost::end(r2))
        , m_link(link_t(lslboost::end(r1), lslboost::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, lslboost::const_end(r1), lslboost::const_end(r2))
        , m_link(link_t(lslboost::const_end(r1), lslboost::const_begin(r2)))
    {
    }
...
private:
    ...
    void decrement()
    {
        if (m_section)
        {
            ...
            {
                m_it.it1() = lslboost::prior(m_link.last1);
                m_section = 0u;
            }
            else
                --m_it.it2();
