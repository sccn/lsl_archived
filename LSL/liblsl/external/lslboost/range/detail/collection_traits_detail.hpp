            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef BOOST_STRING_TYPENAME 
                    ::lslboost::mpl::if_< ::lslboost::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Array container traits ---------------------------------------------------------------
            ...
            */
            ...
            struct array_traits_cv_selector
            {
                typedef BOOST_STRING_TYPENAME 
                    ::lslboost::mpl::eval_if< 
                        ::lslboost::is_convertible<T,BaseT*>,
                        array_traits_impl_selector<T,BaseT>,
                        ::lslboost::mpl::eval_if< 
                            ::lslboost::is_convertible<T,const BaseT*>,
                                array_traits_impl_selector<T, const BaseT>,
                                ::lslboost::mpl::eval_if< 
                                    ::lslboost::is_convertible<T, volatile BaseT*>,
            ...
            struct array_traits_select
            {
                ...
                struct apply
                {
                    typedef BOOST_STRING_TYPENAME
                        ::lslboost::mpl::eval_if< 
                            ::lslboost::is_convertible<T,const volatile T2*>,
                            array_traits_cv_selector<T,T2>,
                            ::lslboost::mpl::identity<T1> >::type type;
                };
            };
            ...
            private:
                ...
                typedef BOOST_STRING_TYPENAME
                    ::lslboost::mpl::vector10<
                        wchar_t,
#else // BOOST_NO_INTRINSIC_WCHAR_T
                typedef BOOST_STRING_TYPENAME
                    ::lslboost::mpl::vector9<
            ...
            public:
                typedef BOOST_STRING_TYPENAME
                    ::lslboost::mpl::fold<
                        array_base_types,
                        ::lslboost::algorithm::detail::array_traits_void,
                        ::lslboost::algorithm::detail::array_traits_select<T> >::type type;
            };
            ...
            */
            ...
            public:
                ...
                typedef BOOST_STRING_TYPENAME
                    ::lslboost::mpl::if_< ::lslboost::is_const<T>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef BOOST_STRING_TYPENAME
                    ::lslboost::remove_cv<value_type>::type char_type;
                typedef BOOST_STRING_TYPENAME
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef BOOST_STRING_TYPENAME
                    ::lslboost::remove_pointer<T>::type value_type;
