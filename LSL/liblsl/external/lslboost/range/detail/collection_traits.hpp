...
// Implementation
#include <lslboost/range/detail/collection_traits_detail.hpp>
...
//  collection_traits template class -----------------------------------------//
        ...
        */
        ...
        {
        private:
            typedef BOOST_STRING_TYPENAME ::lslboost::mpl::eval_if< 
                    ::lslboost::algorithm::detail::is_pair<T>, 
                        detail::pair_container_traits_selector<T>,
                        BOOST_STRING_TYPENAME ::lslboost::mpl::eval_if< 
                        ::lslboost::is_array<T>, 
                            detail::array_container_traits_selector<T>,
                            BOOST_STRING_TYPENAME ::lslboost::mpl::eval_if<
                            ::lslboost::is_pointer<T>,
