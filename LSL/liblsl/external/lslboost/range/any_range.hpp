...
#include <lslboost/range/detail/any_iterator.hpp>
...
namespace lslboost
{
    namespace range_detail
    {
        ...
        // values when the user specified lslboost::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(lslboost::begin(wrapped_range),
                        lslboost::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(lslboost::begin(other), lslboost::end(other))
            {
            }
