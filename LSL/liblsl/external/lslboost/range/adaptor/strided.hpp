...
namespace lslboost
{
    namespace range_detail
    {
        ...
        public:
            ...
            typedef typename super_t::reference reference;
            typedef BaseIterator base_iterator;
            typedef typename lslboost::make_unsigned<difference_type>::type
                        size_type;
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(lslboost::begin(rng), lslboost::end(rng), stride);
        }
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(lslboost::end(rng), lslboost::end(rng), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            ...
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(lslboost::begin(rng), difference_type(), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(lslboost::end(rng), lslboost::size(rng), stride);
        }
            ...
            random_access_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                random_access_traversal_tag
            >(lslboost::begin(rng), lslboost::begin(rng), stride);
        }
