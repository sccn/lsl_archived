    ...
    namespace range_detail
    {
        ...
        public:
            ...
            strided_range(Difference stride, Rng& rng)
                : super_t(make_strided_iterator(lslboost::begin(rng), lslboost::begin(rng), lslboost::end(rng), stride),
                          make_strided_iterator(lslboost::begin(rng), lslboost::end(rng), lslboost::end(rng), stride))
            {
                BOOST_ASSERT( stride >= 0 );
            }
        };
