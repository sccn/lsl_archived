...
namespace lslboost
{
    namespace range_detail
    {
        ...
        {
            return operator|( r,
                lslboost::adaptors::transformed( select_first<StdPairRng>() ) );
        }
        ...
        {
            return operator|( r,
                lslboost::adaptors::transformed( select_second_mutable<StdPairRng>() ) );
        }
        ...
        {
            return operator|( r,
                lslboost::adaptors::transformed( select_second_const<StdPairRng>() ) );
        }
