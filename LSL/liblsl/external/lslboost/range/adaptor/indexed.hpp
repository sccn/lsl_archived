...
#include <lslboost/range/traversal.hpp>
...
//   ( see http://www.lslboost.org/doc/libs/1_44_0/doc/html/foreach/pitfalls.html )
...
public:
    ...
    index_type index()
    {
        return lslboost::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return lslboost::tuples::get<1>(*this);
    }
...
{
    typedef ::lslboost::range::index_value<
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        lslboost::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(lslboost::begin(r), i),
                 iterator(lslboost::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(lslboost::begin(r), i),
                 iterator(lslboost::end(r), i + lslboost::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        lslboost::SinglePassRangeConcept<const SinglePassRange>
    ));
