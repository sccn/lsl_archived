...
namespace lslboost
{
    ...
    namespace range_detail
    {
        ...
        class indexed_iterator
            : public lslboost::iterator_adaptor< indexed_iterator<Iter>, Iter >
        {
        private:
            typedef lslboost::iterator_adaptor< indexed_iterator<Iter>, Iter >
                  base;
        ...
        public:
            ...
            indexed_range( Index i, Rng& r )
              : base( iter_type(lslboost::begin(r), i), iter_type(lslboost::end(r),i) )
            { }
        };
