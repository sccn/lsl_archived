...
namespace lslboost
{
    namespace range_detail
    {
        ...
        public:
            ...
            : base_range(skip_iter(lslboost::begin(r), lslboost::end(r), p),
                         skip_iter(lslboost::end(r), lslboost::end(r), p))
            {
            }
        };
    ...
    // Bring adjacent_filter_range into the lslboost namespace so that users of
