...
#include <lslboost/range/detail/misc_concept.hpp>
 ...
 * \endcode
 *
 * \see http://www.lslboost.org/libs/range/doc/range.html for details
 * about range concepts.
 * \see http://www.lslboost.org/libs/iterator/doc/iterator_concepts.html
 * for details about iterator concepts.
 * \see http://www.lslboost.org/libs/concept_check/concept_check.htm for
...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the lslboost::adaptors::filtered
        // class with a lslboost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                lslboost::ignore_unused_variable_warning(i2);
                ...
                BOOST_DEDUCED_TYPENAME lslboost::detail::iterator_traits<Iterator>::reference r1(*i);
                lslboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME lslboost::detail::iterator_traits<Iterator>::reference r2(*(++i));
                lslboost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME lslboost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                lslboost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME lslboost::detail::iterator_traits<Iterator>::reference r(*(i++));
                lslboost::ignore_unused_variable_warning(r);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = lslboost::begin(*m_range);
            iterator i2 = lslboost::end(*m_range);

            lslboost::ignore_unused_variable_warning(i1);
            lslboost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = lslboost::begin(const_range);
            const_iterator ci2 = lslboost::end(const_range);

            lslboost::ignore_unused_variable_warning(ci1);
            lslboost::ignore_unused_variable_warning(ci2);
        }
