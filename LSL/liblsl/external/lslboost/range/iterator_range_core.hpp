...
#include <lslboost/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <lslboost/range/detail/safe_bool.hpp>
...
namespace lslboost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( lslboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( lslboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( lslboost::begin(l),
                                                 lslboost::end(l),
                                                 lslboost::begin(r),
                                                 lslboost::end(r) );
        }
        ...
        // This version is maintained since it is used in other lslboost libraries
        // such as Boost.Assign
        template< class Left, class Right >
        inline bool equal(const Left& l, const Right& r)
        {
            return lslboost::equal(l, r);
        }
...
incrementable_t test_traversal_tag(lslboost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(lslboost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(lslboost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef lslboost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef lslboost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef lslboost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *lslboost::prior(this->m_End);
    }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                lslboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME lslboost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME lslboost::enable_if<
            mpl::not_<lslboost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, lslboost::next(first, n));
        }
        ...
        */
        ...
        {
            return SeqT( lslboost::begin( r ), lslboost::end( r ) );
        }
