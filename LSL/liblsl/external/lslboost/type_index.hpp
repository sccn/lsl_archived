...
#       pragma detect_mismatch( "lslboost__type_index__abi", "user defined type_index class is used: " BOOST_STRINGIZE(BOOST_TYPE_INDEX_USER_TYPEINDEX))
#   endif
#elif (!defined(BOOST_NO_RTTI) && !defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(BOOST_MSVC)
#   include <lslboost/type_index/stl_type_index.hpp>
#   if defined(BOOST_NO_RTTI) || defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)
#       include <lslboost/type_index/detail/stl_register_class.hpp>
#       ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
#           pragma detect_mismatch( "lslboost__type_index__abi", "RTTI is off - typeid() is used only for templates")
#       endif
#   else
#       ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
#           pragma detect_mismatch( "lslboost__type_index__abi", "RTTI is used")
#       endif
#   endif
#else
#   include <lslboost/type_index/ctti_type_index.hpp>
#   include <lslboost/type_index/detail/ctti_register_class.hpp>
#   ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
#       pragma detect_mismatch( "lslboost__type_index__abi", "RTTI is off - using CTTI")
#   endif
#endif
...
namespace lslboost { namespace typeindex {

#if defined(BOOST_TYPE_INDEX_DOXYGEN_INVOKED)

/// \def BOOST_TYPE_INDEX_FUNCTION_SIGNATURE
/// BOOST_TYPE_INDEX_FUNCTION_SIGNATURE is used by lslboost::typeindex::ctti_type_index class to
/// deduce the name of a type. If your compiler is not recognized
/// by the TypeIndex library and you wish to work with lslboost::typeindex::ctti_type_index, you may
...
/// then a compile-time error will arise at any attempt to use lslboost::typeindex::ctti_type_index classes.
///
...
/// \code lslboost::typeindex::ctti_type_index::type_id<int>().pretty_name() \endcode
/// returns the following string:
/// \code "static const char *lslboost::detail::ctti<int>::n() [T = int]" \endcode
/// and \code lslboost::typeindex::ctti_type_index::type_id<short>().pretty_name() \endcode returns the following:
/// \code "static const char *lslboost::detail::ctti<short>::n() [T = short]" \endcode
///
/// As we may see first 39 characters are "static const char *lslboost::detail::ctti<" and they do not depend on
...
/// for `lslboost::typeindex::ctti_type_index::type_id<int>().pretty_name()` and \code "short>::n() [T = short" \endcode
/// for `lslboost::typeindex::ctti_type_index::type_id<short>().pretty_name()`.
///
...
///
/// See [RTTI emulation limitations](lslboost_typeindex/rtti_emulation_limitations.html) for more info.
#define BOOST_TYPE_INDEX_CTTI_USER_DEFINED_PARSING (0, 0, false, "")
    ...
    /// as a default lslboost::typeindex::type_index.
    ///
    /// Could be a lslboost::typeindex::stl_type_index, lslboost::typeindex::ctti_type_index or 
    /// user defined type_index class.
    ///
    /// \b See lslboost::typeindex::type_index_facade for a full description of type_index functions.
    typedef platform_specific type_index;
#elif defined(BOOST_TYPE_INDEX_USER_TYPEINDEX)
    // Nothing to do
#elif (!defined(BOOST_NO_RTTI) && !defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(BOOST_MSVC)
    typedef lslboost::typeindex::stl_type_index type_index;
#else 
    typedef lslboost::typeindex::ctti_type_index type_index;
#endif

/// Depending on a compiler flags, optimal implementation of type_info will be used 
/// as a default lslboost::typeindex::type_info.
///
/// Could be a std::type_info, lslboost::typeindex::detail::ctti_data or 
...
///
/// See [Making a custom type_index](lslboost_typeindex/making_a_custom_type_index.html) section
...
/// `virtual const type_info& lslboost_type_info_type_id_runtime_() const noexcept`.
///
/// \b Example:
/// \code
/// class A {
...
/// C c1;
/// A* pc1 = &c1;
/// assert(lslboost::typeindex::type_id<C>() == lslboost::typeindex::type_id_runtime(*pc1));
/// \endcode
...
/// [Mixing sources with RTTI on and RTTI off](lslboost_typeindex/mixing_sources_with_rtti_on_and_.html)
...
/// Function to get lslboost::typeindex::type_index for a type T.
...
/// \throw Nothing.
/// \return lslboost::typeindex::type_index with information about the specified type T.
template <class T>
inline type_index type_id() BOOST_NOEXCEPT {
    return type_index::type_id<T>();
}

/// Function for constructing lslboost::typeindex::type_index instance for type T. 
...
/// Function that works exactly like C++ typeid(rtti_val) call, but returns lslboost::type_index.
///
...
/// \throw Nothing.
/// \return lslboost::typeindex::type_index with information about the specified variable.
template <class T>
inline type_index type_id_runtime(const T& runtime_val) BOOST_NOEXCEPT {
    return type_index::type_id_runtime(runtime_val);
}

}} // namespace lslboost::typeindex
