...
#include <lslboost/bimap/container_adaptor/unordered_map_adaptor.hpp>
...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::lslboost::bimaps::views::unordered_map_view<Tag,BimapType> >
{
    private: typedef ::lslboost::bimaps::views::unordered_map_view<Tag,BimapType> map_view_;
    public : BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::lslboost::bimaps::views::unordered_map_view<Tag,BimapType> >
{
    private: typedef ::lslboost::bimaps::views::unordered_map_view<Tag,BimapType> map_view_;
