...
#include <lslboost/bimap/container_adaptor/list_map_adaptor.hpp>
#include <lslboost/bimap/relation/support/pair_by.hpp>
...
{
    typedef ::lslboost::bimaps::container_adaptor::list_map_adaptor
    <
        ...
        ::lslboost::bimaps::detail::      reverse_map_view_iterator<Tag,BimapType>,
        ::lslboost::bimaps::detail::const_reverse_map_view_iterator<Tag,BimapType>,
        ...
        BOOST_DEDUCED_TYPENAME ::lslboost::bimaps::relation::support::data_extractor
        <
            Tag,
...
template< class Tag, class BimapType >
struct left_map_view_extra_typedefs< ::lslboost::bimaps::views::list_map_view<Tag,BimapType> >
{
    private: typedef ::lslboost::bimaps::views::list_map_view<Tag,BimapType> map_view_;
    public : BOOST_BIMAP_MAP_VIEW_EXTRA_TYPEDEFS_BODY(map_view_,left)
};

template< class Tag, class BimapType >
struct right_map_view_extra_typedefs< ::lslboost::bimaps::views::list_map_view<Tag,BimapType> >
{
    private: typedef ::lslboost::bimaps::views::list_map_view<Tag,BimapType> map_view_;
