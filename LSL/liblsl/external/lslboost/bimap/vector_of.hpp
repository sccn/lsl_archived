...
#include <lslboost/multi_index/random_access_index.hpp>

#include <lslboost/bimap/views/vector_map_view.hpp>
#include <lslboost/bimap/views/vector_set_view.hpp>
...
template< class Type >
struct vector_of : public ::lslboost::bimaps::detail::set_type_of_tag
{
...
struct vector_of_relation : public ::lslboost::bimaps::detail::set_type_of_relation_tag
{
