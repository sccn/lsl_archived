...
#include <lslboost/bimap/container_adaptor/detail/functor_bag.hpp>
...
class container_adaptor
{
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::lslboost::mpl::is_na<IteratorToBaseConverter>,
        // {
                ::lslboost::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::lslboost::mpl::is_na<IteratorFromBaseConverter>,
        // {
                ::lslboost::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::lslboost::mpl::is_na<ValueToBaseConverter>,
        // {
                ::lslboost::bimaps::container_adaptor::detail::
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_< ::lslboost::mpl::is_na<ValueFromBaseConverter>,
        // {
                ::lslboost::bimaps::container_adaptor::detail::
    ...
    std::pair<iterator, bool> insert(
        BOOST_DEDUCED_TYPENAME ::lslboost::call_traits< value_type >::param_type x)
    {
    ...
    ::lslboost::bimaps::container_adaptor::detail::data_with_functor_bag
    <
        Base &,
