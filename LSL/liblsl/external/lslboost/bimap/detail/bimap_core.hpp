...
// Boost.MultiIndex
#include <lslboost/multi_index_container.hpp>
#include <lslboost/multi_index/member.hpp>
...
#include <lslboost/bimap/detail/manage_bimap_key.hpp>
#include <lslboost/bimap/detail/manage_additional_parameters.hpp>
#include <lslboost/bimap/detail/map_view_iterator.hpp>
#include <lslboost/bimap/detail/set_view_iterator.hpp>

#include <lslboost/bimap/set_of.hpp>
#include <lslboost/bimap/unconstrained_set_of.hpp>
...
class bimap_core
{
    ...
    typedef BOOST_DEDUCED_TYPENAME ::lslboost::bimaps::tags::support::default_tagged
    <
    ...
    typedef ::lslboost::bimaps::relation::mutant_relation
    <

        ::lslboost::bimaps::tags::tagged<
            ...
            // else
            // {
                    BOOST_DEDUCED_TYPENAME ::lslboost::add_const< left_key_type >::type
            // }
        ...
        ::lslboost::bimaps::tags::tagged<
            ...
            // else
            // {
                    BOOST_DEDUCED_TYPENAME ::lslboost::add_const< right_key_type >::type
            // }
        ...
        // It is ::lslboost::mpl::na if no info_hook was included
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_<
        ::lslboost::bimaps::detail::is_unconstrained_set_of< left_set_type >,
    // {
            mpl::vector<>,
    // }
    // else
    ...
    typedef BOOST_DEDUCED_TYPENAME mpl::if_<
        ::lslboost::bimaps::detail::is_unconstrained_set_of< right_set_type >,
    // {
            left_core_indices,
    // }
    // else
    ...
    // {
            ...
            <
                ...
                BOOST_NESTED_TEMPLATE index_bind
                <
                    ::lslboost::bimaps::relation::support::both_keys_extractor<relation>,
                    independent_index_tag
    ...
    typedef BOOST_DEDUCED_TYPENAME ::lslboost::multi_index::
    ...
    //@{
        ...
        typedef ::lslboost::bimaps::detail::map_view_iterator
        <
            left_tag,
            relation,
            left_core_iterator
    ...
    //@{
        ...
        typedef ::lslboost::bimaps::detail::const_map_view_iterator
        <
            left_tag,
            relation,
    ...
    typedef BOOST_DEDUCED_TYPENAME ::lslboost::multi_index::index
    <
