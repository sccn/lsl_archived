...
#include <lslboost/bimap/relation/support/get_pair_functor.hpp>
#include <lslboost/bimap/relation/detail/to_mutable_relation_functor.hpp>
#include <lslboost/bimap/container_adaptor/support/iterator_facade_converters.hpp>
#include <lslboost/bimap/relation/support/data_extractor.hpp>
#include <lslboost/bimap/relation/support/opposite_tag.hpp>
...
::lslboost::bimaps::container_adaptor::CONTAINER_ADAPTOR                         \
<                                                                             \
    BOOST_DEDUCED_TYPENAME BIMAP::core_type::                                 \
        BOOST_NESTED_TEMPLATE index<TAG>::type,                               \
    ::lslboost::bimaps::detail::      map_view_iterator<TAG,BIMAP>,              \
    ::lslboost::bimaps::detail::const_map_view_iterator<TAG,BIMAP>,              \
    ::lslboost::bimaps::detail::      OTHER_ITER<TAG,BIMAP>,                     \
    ::lslboost::bimaps::detail::CONST_OTHER_ITER<TAG,BIMAP>,                     \
    ::lslboost::bimaps::container_adaptor::support::iterator_facade_to_base      \
    <                                                                         \
        ::lslboost::bimaps::detail::      map_view_iterator<TAG,BIMAP>,          \
        ::lslboost::bimaps::detail::const_map_view_iterator<TAG,BIMAP>           \
    >,                                                                        \
    ...
    ::lslboost::bimaps::relation::support::                                      \
...
#define BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(TYPE,TAG,BIMAP)                      \
    typedef ::lslboost::bimaps::detail::map_view_base<                           \
...
/*===========================================================================*/
#define BOOST_BIMAP_MAP_VIEW_BASE_FRIEND(TYPE,TAG,BIMAP)                      \
    friend class ::lslboost::bimaps::detail::map_view_base<                      \
...
class map_view_base
{
    typedef ::lslboost::bimaps::container_adaptor::support::
        iterator_facade_to_base<
            ::lslboost::bimaps::detail::      map_view_iterator<Tag,BimapType>,
            ::lslboost::bimaps::detail::const_map_view_iterator<Tag,BimapType>
        > iterator_to_base_;
    ...
    typedef BOOST_DEDUCED_TYPENAME ::lslboost::bimaps::relation::support::
           pair_type_by<Tag,
              BOOST_DEDUCED_TYPENAME BimapType::relation>::type value_type_;

    typedef 
        ::lslboost::bimaps::detail::map_view_iterator<Tag,BimapType> iterator_;
    ...
    bool modify(iterator_ position, Modifier mod)
    {
        return derived().base().modify(
            ...
            ::lslboost::bimaps::detail::relation_modifier_adaptor
            <
                Modifier,
    ...
    */
    ...
    bool modify_data(iterator_ position, Modifier mod)
    {
        ...
        return derived().base().modify(
            ...
            // ::lslboost::bind( mod, ::lslboost::bind(data_extractor_(),_1) )

            ::lslboost::bimaps::detail::unary_modifier_adaptor
            <
                Modifier,
                BOOST_DEDUCED_TYPENAME BimapType::relation,
                data_extractor_
...
class mutable_data_unique_map_view_access
{
    ...
    {
        typedef ::lslboost::bimaps::detail::
