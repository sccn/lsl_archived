...
#include <lslboost/bimap/detail/is_set_type_of.hpp>
...
template< class Type >
struct is_with_info : ::lslboost::mpl::false_ {};

template< class ValueType >
struct is_with_info< with_info<ValueType> > : ::lslboost::mpl::true_ {};

/** \struct lslboost::bimaps::detail::manage_additional_parameters
\brief Utility class to extract the additional parameters from the template parameters.
...
struct manage_additional_parameters
{
    ...
    struct case_NNN
    {
        ...
        typedef ::lslboost::mpl::na additional_info;
    };
    ...
    <
        ::lslboost::mpl::is_na<AP1>,
        case_NNN, // (1)
        BOOST_DEDUCED_TYPENAME mpl::if_
        <
            ::lslboost::mpl::is_na<AP2>,
            BOOST_DEDUCED_TYPENAME mpl::if_
            <
