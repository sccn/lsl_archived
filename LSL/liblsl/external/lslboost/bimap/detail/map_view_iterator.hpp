...
// check
#include <lslboost/bimap/relation/detail/metadata_access_builder.hpp>
#include <lslboost/bimap/relation/detail/static_access_builder.hpp>
...
#define BOOST_BIMAP_MAP_VIEW_ITERATOR_SERIALIZATION_SUPPORT                   \
    ...
    {                                                                         \
        ar << ::lslboost::serialization::make_nvp("mi_iterator",this->base());   \
    }                                                                         \
                                                                              \
    template< class Archive >                                                 \
    ...
    {                                                                         \
        ...
        ar >> ::lslboost::serialization::make_nvp("mi_iterator",iter);           \
...
struct map_view_iterator_adaptor {
    typedef iterator_adaptor<
        ...
        BOOST_DEDUCED_TYPENAME 
            ::lslboost::bimaps::support::value_type_by<Tag,BimapCore>::type
    > type;
};
template< class Tag, class BimapCore >
    ...
    public map_view_iterator_adaptor<Tag,BimapCore>::type
{
    ...
    {
        return ::lslboost::bimaps::relation::support::pair_by<Tag>(
    ...
    public const_map_view_iterator_adaptor<Tag,BimapCore>::type
{
    ...
    BOOST_DEDUCED_TYPENAME base_::reference dereference() const
    {
        return ::lslboost::bimaps::relation::support::pair_by<Tag>(*this->base());
    }
    private:
    friend class iterator_core_access;
    BOOST_BIMAP_MAP_VIEW_ITERATOR_SERIALIZATION_SUPPORT
