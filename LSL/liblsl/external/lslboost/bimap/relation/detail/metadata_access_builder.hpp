...
#include <lslboost/bimap/relation/support/is_tag_of_member_at.hpp>
...
#define BOOST_BIMAP_SYMMETRIC_METADATA_ACCESS_BUILDER(                        \
    ...
    <                                                                         \
        ...
        <                                                                     \
            ::lslboost::bimaps::relation::support::is_tag_of_member_at_left      \
            <                                                                 \
                Tag,                                                          \
                SymmetricType                                                 \
            >                                                                 \
    ...
    <                                                                         \
        ...
        BOOST_DEDUCED_TYPENAME enable_if                                      \
        <                                                                     \
            ::lslboost::bimaps::relation::support::is_tag_of_member_at_right     \
            <                                                                 \
                Tag,                                                          \
                SymmetricType                                                 \
            >                                                                 \
