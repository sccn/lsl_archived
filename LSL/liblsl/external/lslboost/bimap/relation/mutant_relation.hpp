...
#include <lslboost/bimap/tags/support/default_tagged.hpp>
#include <lslboost/bimap/tags/support/tag_of.hpp>
#include <lslboost/bimap/tags/support/value_type_of.hpp>

#include <lslboost/bimap/relation/member_at.hpp>
#include <lslboost/bimap/relation/detail/mutant.hpp>
#include <lslboost/bimap/relation/structured_pair.hpp>
#include <lslboost/bimap/relation/symmetrical_base.hpp>
#include <lslboost/bimap/relation/support/get.hpp>
    ...
    public symmetrical_base<LeftType,RightType,force_mutable>
{
    ...
    relation_storage(BOOST_DEDUCED_TYPENAME ::lslboost::call_traits<
...
class relation_info_hook : public
 ::lslboost::bimaps::relation::detail::relation_storage<TA,TB,force_mutable>
{
    typedef ::lslboost::bimaps::relation::detail::
                relation_storage<TA,TB,force_mutable> base_;

    typedef BOOST_DEDUCED_TYPENAME ::lslboost::bimaps::tags::support::
    ...
    relation_info_hook( BOOST_DEDUCED_TYPENAME ::lslboost::call_traits<
                           BOOST_DEDUCED_TYPENAME base_::left_value_type
                        >::param_type l,
                        BOOST_DEDUCED_TYPENAME ::lslboost::call_traits<
                            BOOST_DEDUCED_TYPENAME base_::right_value_type
    ...
    {
        ar & ::lslboost::serialization::make_nvp("left" , base_::left );
        ar & ::lslboost::serialization::make_nvp("right", base_::right);
        ar & ::lslboost::serialization::make_nvp("info" , info        );
    }
    #endif // BOOST_BIMAP_DISABLE_SERIALIZATION
};

template< class TA, class TB, bool force_mutable>
class relation_info_hook<TA,TB,::lslboost::mpl::na,force_mutable> :
    public ::lslboost::bimaps::relation::detail::relation_storage<TA,TB,force_mutable>
{
    typedef ::lslboost::bimaps::relation::detail::
                relation_storage<TA,TB,force_mutable> base_;

    public:
    typedef ::lslboost::mpl::na info_type;
...
template< class TA, class TB, class Info = ::lslboost::mpl::na, bool force_mutable = false >
class mutant_relation : public
    ::lslboost::bimaps::relation::detail::
        relation_info_hook<TA,TB,Info,force_mutable>
{
    ...
    mutant_relation(BOOST_DEDUCED_TYPENAME ::lslboost::call_traits<
                        BOOST_DEDUCED_TYPENAME base_:: left_value_type
                    >::param_type l,
                    BOOST_DEDUCED_TYPENAME ::lslboost::call_traits<
                        BOOST_DEDUCED_TYPENAME base_::right_value_type
    ...
    {
        return ::lslboost::bimaps::relation::detail::mutate<left_pair>(*this);
    }
    ...
    {
        return ::lslboost::bimaps::relation::detail::mutate<right_pair>(*this);
    }
    ...
    above_view & get_view()
    {
        return ::lslboost::bimaps::relation::detail::mutate<above_view>(*this);
    }
    ...
    template< class Tag >
    const BOOST_DEDUCED_TYPENAME ::lslboost::bimaps::relation::support::
        result_of::get<Tag,const mutant_relation>::type
    get(BOOST_EXPLICIT_TEMPLATE_TYPE(Tag)) const
    {
        return ::lslboost::bimaps::relation::support::get<Tag>(*this);
    }

    template< class Tag >
    BOOST_DEDUCED_TYPENAME ::lslboost::bimaps::relation::support::
...
{
    std::size_t seed = 0;
    ::lslboost::hash_combine(seed, r. left );
    ::lslboost::hash_combine(seed, r.right );
...
mutant_relation<TA,TB,Info,force_mutable> 
    copy_with_left_replaced(mutant_relation<TA,TB,Info,force_mutable> const& rel,
        BOOST_DEDUCED_TYPENAME ::lslboost::call_traits< BOOST_DEDUCED_TYPENAME 
...
template< class TA, class TB, bool force_mutable>
mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable>
    copy_with_left_replaced(mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable> const& rel,
        BOOST_DEDUCED_TYPENAME ::lslboost::call_traits< BOOST_DEDUCED_TYPENAME 
            mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable>::left_value_type>
                ::param_type l)
{
    return mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable>(l,rel.right);  
}
...
template< class TA, class TB, bool force_mutable>
mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable>
    copy_with_right_replaced(mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable> const& rel,
        BOOST_DEDUCED_TYPENAME ::lslboost::call_traits< BOOST_DEDUCED_TYPENAME 
            mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable>::right_value_type>
                ::param_type r)
{
    return mutant_relation<TA,TB,::lslboost::mpl::na,force_mutable>(rel.left,r);  
}
