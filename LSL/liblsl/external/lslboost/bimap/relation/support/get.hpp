...
#include <lslboost/bimap/relation/support/value_type_of.hpp>

#include <lslboost/bimap/relation/detail/access_builder.hpp>
...
BOOST_DEDUCED_TYPENAME result_of::get<
    ::lslboost::bimaps::relation::member_at::info, SymmetricType >::type
get(::lslboost::bimaps::relation::member_at::info, SymmetricType & rel)
{
    return rel.info;
}
