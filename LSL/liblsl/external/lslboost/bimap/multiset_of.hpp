...
#include <lslboost/bimap/views/multimap_view.hpp>
#include <lslboost/bimap/views/multiset_view.hpp>
...
>
struct multiset_of : public ::lslboost::bimaps::detail::set_type_of_tag
{
...
struct multiset_of_relation : public ::lslboost::bimaps::detail::set_type_of_relation_tag
{
    /// Functor that compare two keys
    typedef KeyCompare key_compare;
