...
#include <lslboost/bimap/views/unordered_map_view.hpp>
#include <lslboost/bimap/views/unordered_set_view.hpp>
...
<
    ...
    class EqualKey      = std::equal_to< BOOST_DEDUCED_TYPENAME 
        ::lslboost::bimaps::tags::support::value_type_of<KeyType>::type >
>
struct unordered_set_of : public ::lslboost::bimaps::detail::set_type_of_tag
{
...
>
struct unordered_set_of_relation : public ::lslboost::bimaps::detail::set_type_of_relation_tag
{
    /// Hash Functor that takes value_type objects
    typedef HashFunctor     hasher;
