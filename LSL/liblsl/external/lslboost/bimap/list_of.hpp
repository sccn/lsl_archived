...
#include <lslboost/bimap/views/list_map_view.hpp>
#include <lslboost/bimap/views/list_set_view.hpp>
...
template< class Type >
struct list_of : public ::lslboost::bimaps::detail::set_type_of_tag
{
...
struct list_of_relation : public ::lslboost::bimaps::detail::set_type_of_relation_tag
{
