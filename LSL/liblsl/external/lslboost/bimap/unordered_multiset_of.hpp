...
#include <lslboost/bimap/detail/concept_tags.hpp>

#include <lslboost/bimap/tags/support/value_type_of.hpp>

#include <lslboost/bimap/detail/generate_index_binder.hpp>
#include <lslboost/bimap/detail/generate_view_binder.hpp>
#include <lslboost/bimap/detail/generate_relation_binder.hpp>

#include <lslboost/multi_index/hashed_index.hpp>

#include <lslboost/bimap/views/unordered_multimap_view.hpp>
#include <lslboost/bimap/views/unordered_multiset_view.hpp>
...
<
    ...
    class HashFunctor   = hash< BOOST_DEDUCED_TYPENAME 
        ::lslboost::bimaps::tags::support::value_type_of<KeyType>::type >,
    class EqualKey      = std::equal_to< BOOST_DEDUCED_TYPENAME 
        ::lslboost::bimaps::tags::support::value_type_of<KeyType>::type >
>
struct unordered_multiset_of : public ::lslboost::bimaps::detail::set_type_of_tag
{
...
>
struct unordered_multiset_of_relation : public ::lslboost::bimaps::detail::set_type_of_relation_tag
{
    /// Hash Functor that takes value_type objects
    typedef HashFunctor     hasher;
