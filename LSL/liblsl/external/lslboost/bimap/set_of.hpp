...
#include <lslboost/bimap/views/map_view.hpp>
#include <lslboost/bimap/views/set_view.hpp>
...
>
struct set_of : public ::lslboost::bimaps::detail::set_type_of_tag
{
...
struct set_of_relation : public ::lslboost::bimaps::detail::set_type_of_relation_tag
{
    /// Functor that compare two keys
    typedef KeyCompare key_compare;
