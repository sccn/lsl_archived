...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            lslboost::uint32_t dwLowDateTime;
            lslboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            lslboost::uint16_t wYear;
            lslboost::uint16_t wMonth;
            lslboost::uint16_t wDayOfWeek;
            lslboost::uint16_t wDay;
            lslboost::uint16_t wHour;
            lslboost::uint16_t wMinute;
            lslboost::uint16_t wSecond;
            lslboost::uint16_t wMilliseconds;
        };
    ...
    inline lslboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
...
TimeT time_from_ftime(const FileTimeT& ft)
{
    ...
    // https://svn.lslboost.org/trac/lslboost/ticket/2523
