...
namespace date_time {
  ...
  */
  ...
  public:
    ...
    typedef void _is_lslboost_date_time_time_point;
    typedef T time_type;
    ...
    //!Equality operator -- others generated by lslboost::equality_comparable
    bool operator==(const time_type& rhs) const
    {
      return time_system::is_equal(time_,rhs.time_);
    }
    //!Equality operator -- others generated by lslboost::less_than_comparable
    bool operator<(const time_type& rhs) const
    {
