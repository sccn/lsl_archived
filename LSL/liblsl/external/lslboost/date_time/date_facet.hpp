...
#include <lslboost/date_time/period.hpp>
...
#include <lslboost/date_time/date_generator_formatter.hpp>
#include <lslboost/date_time/date_generator_parser.hpp>
#include <lslboost/date_time/format_date_parser.hpp>

namespace lslboost { namespace date_time {
  ...
  public:
    ...
    typedef lslboost::date_time::period<date_type,duration_type> period_type;
    typedef std::basic_string<CharT> string_type;
    typedef CharT                    char_type;
    typedef lslboost::date_time::period_formatter<CharT>  period_formatter_type;
    typedef lslboost::date_time::special_values_formatter<CharT>  special_values_formatter_type;
  ...
  protected:
    virtual OutItrT do_put_special(OutItrT next,
                                   std::ios_base& /*a_ios*/,
                                   char_type /*fill_char*/,
                                   const lslboost::date_time::special_values sv) const
    {
                              ...
                              string_type a_format) const
    {
      ...
      if (m_weekday_long_names.size()) {
        lslboost::algorithm::replace_all(a_format,
                                      long_weekday_format,
  ...
  public:
    ...
    typedef std::basic_string<CharT> string_type;
    typedef CharT                    char_type;
    typedef lslboost::date_time::period_parser<date_type, CharT>  period_parser_type;
    typedef lslboost::date_time::special_values_parser<date_type,CharT> special_values_parser_type;
    typedef std::vector<std::basic_string<CharT> > input_collection_type;
               ...
               duration_type& dd) const
    {
      ...
      if(err & std::ios_base::failbit){
        ...
        if(mr.current_match == match_results::PARSE_ERROR) {
          lslboost::throw_exception(std::ios_base::failure("Parse failed. No match found for '" + mr.cache + "'"));
