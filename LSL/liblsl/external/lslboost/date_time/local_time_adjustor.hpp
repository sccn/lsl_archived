...
#include <lslboost/date_time/time_defs.hpp> // lslboost::date_time::dst_flags
#include <lslboost/date_time/special_defs.hpp> // not_a_date_time
  ...
  namespace date_time {
    ...
    public:
      ...
      static time_duration_type utc_to_local_offset(const time_type& t)
      {
        ...
        lslboost::throw_exception(std::out_of_range("Unreachable case"));
