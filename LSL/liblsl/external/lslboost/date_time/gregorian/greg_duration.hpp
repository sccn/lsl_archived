...
#include <lslboost/date_time/date_duration.hpp>
...
namespace gregorian {
  ...
  typedef lslboost::date_time::duration_traits_adapted date_duration_rep;

  //! Durations in days for gregorian system
  /*! \ingroup date_basics
   */
  class date_duration :
    public lslboost::date_time::date_duration< date_duration_rep >
  {
    typedef lslboost::date_time::date_duration< date_duration_rep > base_type;
...
#include <lslboost/date_time/date_duration_types.hpp>
#endif
