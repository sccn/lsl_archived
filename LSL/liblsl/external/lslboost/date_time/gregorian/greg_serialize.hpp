...
#include "lslboost/date_time/gregorian/parsers.hpp"
...
// NOTE: these macros define template functions in the lslboost::serialization namespace.
// They must be expanded *outside* of any namespace
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::date_duration)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::date_duration::duration_rep)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::date_period)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::greg_year)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::greg_month)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::greg_day)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::greg_weekday)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::partial_date)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::nth_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::first_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::last_kday_of_month)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::first_kday_before)
BOOST_SERIALIZATION_SPLIT_FREE(::lslboost::gregorian::first_kday_after)
...
void save(Archive & ar, 
          const ::lslboost::gregorian::date & d, 
          ...
          unsigned int /*version*/)
{
  ...
  ar & make_nvp("date", ds);
  try{
    d = ::lslboost::gregorian::from_undelimited_string(ds);
