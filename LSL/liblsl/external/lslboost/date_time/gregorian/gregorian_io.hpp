...
#include <lslboost/date_time/date_facet.hpp>
#include <lslboost/date_time/period_parser.hpp>
#include <lslboost/date_time/period_formatter.hpp>
#include <lslboost/date_time/special_values_parser.hpp>
#include <lslboost/date_time/special_values_formatter.hpp>
#include <lslboost/date_time/gregorian/gregorian_types.hpp>
#include <lslboost/date_time/gregorian/conversion.hpp> // to_tm will be needed in the facets

namespace lslboost {
namespace gregorian {


  typedef lslboost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef lslboost::date_time::period_formatter<char>    period_formatter;
  
  typedef lslboost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef lslboost::date_time::date_facet<date,char>    date_facet;

  typedef lslboost::date_time::period_parser<date,char>       period_parser;
  typedef lslboost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef lslboost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef lslboost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef lslboost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef lslboost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef lslboost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef lslboost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::date& d) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    lslboost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::date_duration& dd) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::date_period& dp) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::greg_month& gm) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::greg_weekday& gw) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::partial_date& pd) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::nth_day_of_the_week_in_month& nkd) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::first_day_of_the_week_in_month& fkd) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::last_day_of_the_week_in_month& lkd) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::first_day_of_the_week_after& fda) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const lslboost::gregorian::first_day_of_the_week_before& fdb) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
