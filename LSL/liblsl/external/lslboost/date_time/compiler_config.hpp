...
// With lslboost release 1.33, date_time will be using a different,
...
#include <lslboost/date_time/locale_config.hpp> //set up locale configurations
...
// uninitialized variables after calling to lslboost::throw_exception.
...
//
#define BOOST_LIB_NAME lslboost_date_time
//
