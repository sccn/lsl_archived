...
namespace date_time {
  ...
  class date_duration : private
              lslboost::less_than_comparable1< date_duration< duration_rep_traits >
            , lslboost::equality_comparable1< date_duration< duration_rep_traits >
            , lslboost::addable1< date_duration< duration_rep_traits >
            , lslboost::subtractable1< date_duration< duration_rep_traits >
            , lslboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef lslboost::date_time::int_adapter<long> impl_type;
