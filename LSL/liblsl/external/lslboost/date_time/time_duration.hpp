...
namespace date_time {
  ...
  */
  ...
  class time_duration : private
      lslboost::less_than_comparable<T
    , lslboost::equality_comparable<T
    > >
  ...
  public:
    ...
    typedef void _is_lslboost_date_time_duration;
   ...
   */
  template<class base_duration, lslboost::int64_t frac_of_second>
  ...
  private:
    ...
    BOOST_STATIC_CONSTANT(lslboost::int64_t, adjustment_ratio = (traits_type::ticks_per_second >= frac_of_second ? traits_type::ticks_per_second / frac_of_second : frac_of_second / traits_type::ticks_per_second));

  public:
    explicit subsecond_duration(lslboost::int64_t ss) :
