...
#include <sstream>
#include <stdexcept>
#include <lslboost/tokenizer.hpp>
#include <lslboost/throw_exception.hpp>
#include <lslboost/date_time/gregorian/gregorian.hpp>
#include <lslboost/date_time/time_zone_names.hpp>
#include <lslboost/date_time/time_zone_base.hpp>
#include <lslboost/date_time/local_time/dst_transition_day_rules.hpp>
#include <lslboost/date_time/posix_time/posix_time.hpp>
#include <lslboost/date_time/string_convert.hpp>
#include <lslboost/date_time/time_parsing.hpp>
...
namespace local_time{
  ...
  typedef lslboost::date_time::dst_adjustment_offsets<lslboost::posix_time::time_duration> dst_adjustment_offsets;
   ...
   * A lslboost::local_time::bad_offset exception will be thrown for:<br>
   ...
   * A lslboost::local_time::bad_adjustment exception will be thrown for:<br>
  ...
  public:
    typedef lslboost::posix_time::time_duration time_duration_type;
    ...
    typedef lslboost::char_separator<char_type, std::char_traits<char_type> > char_separator_type;
    ...
    virtual string_type to_posix_string() const
    {
      ...
      ss.fill('0');
      lslboost::shared_ptr<dst_calc_rule> no_rules;
      // std
      ss << std_zone_abbrev();
      // offset
  ...
  private:
    ...
    lslboost::shared_ptr<dst_calc_rule> dst_calc_rules_;
    ...
    void calc_zone(const string_type& obj){
      ...
      if(sit != obj_end){
        ...
        {
          lslboost::throw_exception(bad_offset(posix_time::to_simple_string(base_utc_offset_)));
        }
      }
      ...
      if(sit != obj_end){
        ...
        {
          lslboost::throw_exception(bad_adjustment(posix_time::to_simple_string(dst_offsets_.dst_adjust_)));
        }
      }
    ...
    void calc_rules(const string_type& start, const string_type& end){
      ...
      {
        lslboost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_start_offset_)));
      }
      ...
      {
        lslboost::throw_exception(bad_offset(posix_time::to_simple_string(dst_offsets_.dst_end_offset_)));
      }
    }
