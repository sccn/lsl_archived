...
#include "lslboost/date_time/time_iterator.hpp"
#include "lslboost/date_time/compiler_config.hpp"
#if defined(BOOST_DATE_TIME_OPTIONAL_GREGORIAN_TYPES)
#include "lslboost/date_time/local_time/date_duration_operators.hpp"
...
namespace local_time {
  ...
  typedef lslboost::date_time::period<local_date_time, 
                                   lslboost::posix_time::time_duration> local_time_period;
  ...
  typedef lslboost::shared_ptr<time_zone> time_zone_ptr;
  typedef lslboost::shared_ptr<wtime_zone> wtime_zone_ptr;
