...
namespace local_time {
  ...
  //typedef lslboost::date_time::time_zone_names time_zone_names;
  typedef lslboost::date_time::dst_adjustment_offsets<lslboost::posix_time::time_duration> dst_adjustment_offsets;
  //typedef lslboost::date_time::time_zone_base<lslboost::posix_time::ptime> time_zone;
  typedef lslboost::shared_ptr<dst_calc_rule> dst_calc_rule_ptr;
  ...
  public:
    ...
    custom_time_zone_base(const time_zone_names& zone_names,
                     ...
                     lslboost::shared_ptr<dst_calc_rule> calc_rule) :
