...
#include <lslboost/date_time/time_facet.hpp>
#include <lslboost/date_time/string_convert.hpp>
#include <lslboost/date_time/local_time/local_date_time.hpp>
#include <lslboost/date_time/local_time/posix_time_zone.hpp>
#include <lslboost/date_time/local_time/conversion.hpp> // to_tm will be needed in the facets

namespace lslboost {
namespace local_time {

  typedef lslboost::date_time::time_facet<local_date_time, wchar_t> wlocal_time_facet;
  typedef lslboost::date_time::time_facet<local_date_time, char>     local_time_facet;

  typedef lslboost::date_time::time_input_facet<local_date_time::utc_time_type,wchar_t> wlocal_time_input_facet;
  typedef lslboost::date_time::time_input_facet<local_date_time::utc_time_type,char>     local_time_input_facet;
  ...
  operator<<(std::basic_ostream<CharT, TraitsT>& os,
             const lslboost::local_time::local_time_period& p) {
    lslboost::io::ios_flags_saver iflags(os);
    typedef lslboost::date_time::time_facet<local_date_time, CharT> custom_facet;
    typedef std::time_put<CharT> std_time_facet;
    std::ostreambuf_iterator<CharT> oitr(os);
  ...
  inline
  std::basic_istream<CharT, Traits>&
  operator>>(std::basic_istream<CharT, Traits>& is, lslboost::local_time::local_time_period& tp)
  {
    lslboost::io::ios_flags_saver iflags(is);
    typename std::basic_istream<CharT, Traits>::sentry strm_sentry(is, false);
    if (strm_sentry) {
