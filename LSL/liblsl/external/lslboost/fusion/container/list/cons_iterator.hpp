...
#include <lslboost/fusion/container/list/detail/deref_impl.hpp>
#include <lslboost/fusion/container/list/detail/next_impl.hpp>
#include <lslboost/fusion/container/list/detail/value_of_impl.hpp>
#include <lslboost/fusion/container/list/detail/equal_to_impl.hpp>
...
{
    template <typename Cons>
    struct iterator_traits< ::lslboost::fusion::cons_iterator<Cons> >
    { };
}
#endif
