...
#include <lslboost/fusion/container/list/cons_fwd.hpp>
...
#include <lslboost/fusion/container/list/detail/begin_impl.hpp>
#include <lslboost/fusion/container/list/detail/end_impl.hpp>
#include <lslboost/fusion/container/list/detail/at_impl.hpp>
#include <lslboost/fusion/container/list/detail/value_at_impl.hpp>
#include <lslboost/fusion/container/list/detail/empty_impl.hpp>
...
namespace lslboost { namespace fusion
{
    ...
    struct cons : sequence_base<cons<Car, Cdr> >
    {
        ...
        template <typename Sequence>
        typename lslboost::disable_if<is_convertible<Sequence, Car>, cons&>::type
