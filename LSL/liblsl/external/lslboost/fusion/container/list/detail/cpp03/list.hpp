...
#include <lslboost/fusion/container/list/detail/cpp03/list_to_cons.hpp>
#include <lslboost/fusion/support/is_sequence.hpp>
#include <lslboost/core/enable_if.hpp>

#if !defined(BOOST_FUSION_DONT_USE_PREPROCESSED_FILES)
#include <lslboost/fusion/container/list/detail/cpp03/preprocessed/list.hpp>
#else
...
namespace lslboost { namespace fusion
{
    ...
    public:
        ...
        #include <lslboost/fusion/container/list/detail/cpp03/list_forward_ctor.hpp>
        ...
        template <typename Sequence>
        BOOST_CXX14_CONSTEXPR BOOST_FUSION_GPU_ENABLED
        typename lslboost::enable_if<traits::is_sequence<Sequence>, list&>::type
