...
#include <lslboost/fusion/container/set/detail/begin_impl.hpp>
#include <lslboost/fusion/container/set/detail/end_impl.hpp>
#include <lslboost/fusion/container/set/detail/value_of_impl.hpp>
#include <lslboost/fusion/container/set/detail/deref_data_impl.hpp>
#include <lslboost/fusion/container/set/detail/deref_impl.hpp>
#include <lslboost/fusion/container/set/detail/key_of_impl.hpp>
...
#include <lslboost/fusion/container/set/detail/cpp03/preprocessed/set.hpp>
#else
...
namespace lslboost { namespace fusion
{
    ...
    struct set : sequence_base<set<BOOST_PP_ENUM_PARAMS(FUSION_MAX_SET_SIZE, T)> >
    {
        ...
        set(Sequence const& rhs
            , typename lslboost::enable_if<traits::is_sequence<Sequence> >::type* = 0)
            : data(rhs) {}

        #include <lslboost/fusion/container/set/detail/cpp03/set_forward_ctor.hpp>
