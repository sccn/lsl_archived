...
#include <lslboost/fusion/container/generation/detail/preprocessed/make_map.hpp>
#else
...
#define BOOST_PP_FILENAME_1 <lslboost/fusion/container/generation/detail/pp_make_map.hpp>
