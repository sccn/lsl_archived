...
#include <lslboost/fusion/container/vector/detail/preprocessed/vector10_fwd.hpp>
#else
...
namespace lslboost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 <lslboost/fusion/container/vector/vector10_fwd.hpp>
