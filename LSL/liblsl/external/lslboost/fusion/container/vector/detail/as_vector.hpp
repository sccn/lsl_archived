...
#include <lslboost/fusion/container/vector/detail/preprocessed/as_vector.hpp>
#else
...
#define BOOST_PP_FILENAME_1 <lslboost/fusion/container/vector/detail/as_vector.hpp>
