...
#include <lslboost/fusion/container/vector/detail/cpp03/preprocessed/vector10_fwd.hpp>
#else
...
namespace lslboost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1 <lslboost/fusion/container/vector/detail/cpp03/vector10_fwd.hpp>
