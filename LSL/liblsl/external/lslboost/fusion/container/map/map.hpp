...
#include <lslboost/fusion/container/map/detail/at_impl.hpp>
#include <lslboost/fusion/container/map/detail/value_at_impl.hpp>
#include <lslboost/fusion/container/map/detail/begin_impl.hpp>
#include <lslboost/fusion/container/map/detail/end_impl.hpp>
#include <lslboost/fusion/container/map/detail/value_of_impl.hpp>
#include <lslboost/fusion/container/map/detail/deref_data_impl.hpp>
#include <lslboost/fusion/container/map/detail/deref_impl.hpp>
#include <lslboost/fusion/container/map/detail/key_of_impl.hpp>
#include <lslboost/fusion/container/map/detail/value_of_data_impl.hpp>
#include <lslboost/fusion/container/vector/vector.hpp>
#include <lslboost/mpl/identity.hpp>
#include <lslboost/mpl/bool.hpp>

#if !defined(BOOST_FUSION_DONT_USE_PREPROCESSED_FILES)
#include <lslboost/fusion/container/map/detail/preprocessed/map.hpp>
#else
...
namespace lslboost { namespace fusion
{
    ...
    struct map : sequence_base<map<BOOST_PP_ENUM_PARAMS(FUSION_MAX_MAP_SIZE, T)> >
    {
        ...
        #include <lslboost/fusion/container/map/detail/map_forward_ctor.hpp>
