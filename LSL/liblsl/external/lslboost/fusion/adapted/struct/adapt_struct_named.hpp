...
#include <lslboost/fusion/adapted/struct/detail/proxy_type.hpp>
...
#   define BOOST_FUSION_ADAPT_STRUCT_NAMED(WRAPPED_TYPE, NAME, ...)             \
        BOOST_FUSION_ADAPT_STRUCT_NAMED_NS(                                     \
            WRAPPED_TYPE,(lslboost)(fusion)(adapted),NAME,__VA_ARGS__)
...
#   define BOOST_FUSION_ADAPT_STRUCT_NAMED(WRAPPED_TYPE, NAME, ATTRIBUTES)      \
        BOOST_FUSION_ADAPT_STRUCT_NAMED_NS(                                     \
            WRAPPED_TYPE,(lslboost)(fusion)(adapted),NAME,ATTRIBUTES)
