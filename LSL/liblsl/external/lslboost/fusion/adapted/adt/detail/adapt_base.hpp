...
#include <lslboost/fusion/adapted/struct/detail/adapt_auto.hpp>
#include <lslboost/fusion/adapted/struct/detail/adapt_is_tpl.hpp>
...
#define BOOST_FUSION_ADAPT_ADT_GET_IDENTITY_NON_TEMPLATE_IMPL(                  \
    TEMPLATE_PARAMS_SEQ)                                                        \
                                                                                \
    lslboost::remove_const<lslboost::remove_reference<lvalue>::type>::type
...
#define BOOST_FUSION_ADAPT_ADT_C_BASE(                                          \
    ...
    {                                                                           \
        ...
        static void                                                             \
        lslboost_fusion_adapt_adt_impl_set(                                        \
        ...
        static type                                                             \
        lslboost_fusion_adapt_adt_impl_get(                                        \
            BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ)& obj)               \
        {                                                                       \
    ...
    {                                                                           \
        ...
        {                                                                       \
            return access::adt_attribute_access<                                \
                BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ)                 \
              , I                                                               \
            >::lslboost_fusion_adapt_adt_impl_get(*obj);                           \
        }                                                                       \
                                                                                \
        BOOST_FUSION_GPU_ENABLED                                                \
        operator type() const                                                   \
    ...
    {                                                                           \
        ...
        {                                                                       \
            access::adt_attribute_access<                                       \
                BOOST_FUSION_ADAPT_STRUCT_UNPACK_NAME(NAME_SEQ)                 \
              , I                                                               \
            >::lslboost_fusion_adapt_adt_impl_set(*obj, val);                      \
            return *this;                                                       \
        }                                                                       \
                                                                                \
        BOOST_FUSION_GPU_ENABLED                                                \
