...
#include <lslboost/fusion/tuple/detail/tuple_fwd.hpp>
...
namespace lslboost { namespace fusion
{
    ...
    struct tuple : vector<BOOST_PP_ENUM_PARAMS(FUSION_MAX_VECTOR_SIZE, T)>
    {
        ...
        #include <lslboost/fusion/tuple/detail/tuple_expand.hpp>
