...
#include <lslboost/fusion/view/filter_view/detail/deref_impl.hpp>
#include <lslboost/fusion/view/filter_view/detail/next_impl.hpp>
#include <lslboost/fusion/view/filter_view/detail/value_of_impl.hpp>
#include <lslboost/fusion/view/filter_view/detail/equal_to_impl.hpp>
#include <lslboost/fusion/view/filter_view/detail/deref_data_impl.hpp>
#include <lslboost/fusion/view/filter_view/detail/value_of_data_impl.hpp>
#include <lslboost/fusion/view/filter_view/detail/key_of_impl.hpp>
...
{
    template <typename Category, typename First, typename Last, typename Pred>
    struct iterator_traits< ::lslboost::fusion::filter_iterator<Category, First, Last, Pred> >
    { };
}
#endif
