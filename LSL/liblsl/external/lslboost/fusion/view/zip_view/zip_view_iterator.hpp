...
#include <lslboost/fusion/view/zip_view/detail/deref_impl.hpp>
#include <lslboost/fusion/view/zip_view/detail/next_impl.hpp>
#include <lslboost/fusion/view/zip_view/detail/prior_impl.hpp>
#include <lslboost/fusion/view/zip_view/detail/advance_impl.hpp>
#include <lslboost/fusion/view/zip_view/detail/distance_impl.hpp>
#include <lslboost/fusion/view/zip_view/detail/value_of_impl.hpp>
#include <lslboost/fusion/view/zip_view/detail/equal_to_impl.hpp>
...
namespace std
{
    ...
    struct iterator_traits< ::lslboost::fusion::zip_view_iterator<IteratorSequence, Traversal> >
    { };
}
#endif
