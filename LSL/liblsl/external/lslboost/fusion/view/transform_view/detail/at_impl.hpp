    ...
    namespace extension
    {
        ...
        struct at_impl<transform_view_tag>
        {
            ...
            struct apply
            {
                ...
                typedef typename lslboost::fusion::result_of::at<typename Seq::sequence_type, N>::type value_type;
                typedef typename mpl::apply<transform_type, value_type>::type type;

                static type call(Seq& seq)
                {
                    return seq.f(lslboost::fusion::at<N>(seq.seq));
                }
            };
        };
        ...
        struct at_impl<transform_view2_tag>
        {
            ...
            struct apply
            {
                typedef typename Seq::transform_type F;
                typedef detail::apply_transform_result<F> transform_type;
                typedef typename lslboost::fusion::result_of::at<typename Seq::sequence1_type, N>::type value1_type;
                typedef typename lslboost::fusion::result_of::at<typename Seq::sequence2_type, N>::type value2_type;
                typedef typename mpl::apply<transform_type, value1_type, value2_type>::type type;

                static type call(Seq& seq)
                {
                    return seq.f(lslboost::fusion::at<N>(seq.seq1), lslboost::fusion::at<N>(seq.seq2));
                }
            };
        };
    }
