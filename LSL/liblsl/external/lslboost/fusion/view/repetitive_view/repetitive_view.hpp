...
#include <lslboost/fusion/view/repetitive_view/detail/begin_impl.hpp>
#include <lslboost/fusion/view/repetitive_view/detail/end_impl.hpp>
...
namespace lslboost { namespace fusion
{
        ...
        : sequence_base< repetitive_view<Sequence> >
    {
        ...
        typedef typename lslboost::remove_reference<Sequence>::type sequence_type;
        typedef typename 
