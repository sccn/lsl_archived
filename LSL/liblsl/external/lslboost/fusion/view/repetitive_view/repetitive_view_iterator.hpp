...
#include <lslboost/fusion/view/repetitive_view/detail/deref_impl.hpp>
#include <lslboost/fusion/view/repetitive_view/detail/next_impl.hpp>
#include <lslboost/fusion/view/repetitive_view/detail/value_of_impl.hpp>
...
{
    template <typename Sequence, typename Pos>
    struct iterator_traits< ::lslboost::fusion::repetitive_view_iterator<Sequence, Pos> >
    { };
}
#endif
