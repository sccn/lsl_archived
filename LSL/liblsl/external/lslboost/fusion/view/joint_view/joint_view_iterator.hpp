...
#include <lslboost/fusion/view/joint_view/detail/deref_impl.hpp>
#include <lslboost/fusion/view/joint_view/detail/next_impl.hpp>
#include <lslboost/fusion/view/joint_view/detail/value_of_impl.hpp>
#include <lslboost/fusion/view/joint_view/detail/deref_data_impl.hpp>
#include <lslboost/fusion/view/joint_view/detail/value_of_data_impl.hpp>
#include <lslboost/fusion/view/joint_view/detail/key_of_impl.hpp>
...
{
    template <typename Category, typename First, typename Last, typename Concat>
    struct iterator_traits< ::lslboost::fusion::joint_view_iterator<Category, First, Last, Concat> >
    { };
}
#endif
