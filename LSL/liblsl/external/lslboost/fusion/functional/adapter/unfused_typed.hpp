...
namespace lslboost { namespace fusion
{
    ...
    #define  BOOST_PP_FILENAME_1 <lslboost/fusion/functional/adapter/unfused_typed.hpp>
...
#define M(z,i,s)                                                                \
    typename call_param<typename result_of::value_at_c<s,i>::type>::type a##i
            ...
            inline typename lslboost::result_of< 
...
#undef M
            ...
            struct result< Self const (BOOST_PP_ENUM_PARAMS(N,T)) >
                : lslboost::result_of< function_c(arg_vector_t &) > 
            { };

            template <class Self BOOST_PP_ENUM_TRAILING_PARAMS(N,typename T)>
            struct result< Self (BOOST_PP_ENUM_PARAMS(N,T)) >
                : lslboost::result_of< function(arg_vector_t &) >
            { };
        };
