...
namespace lslboost
{
    ...
    ///
    /// Deployment of lslboost::make_default() eliminates the Default Constructibility requirement with
    /// @code
    ///    Type result = lslboost::make_default<Type>();
    ///    ...
    ///    istream >> result;
    /// @endcode
    /// Classes with no default constructor can now be included via a lslboost::make_default() specialization:
    /// @code
    /// namespace lslboost
    /// {
