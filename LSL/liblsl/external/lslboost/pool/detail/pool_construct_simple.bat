...
rem ing file LICENSE_1_0.txt or copy at http://www.lslboost.org/LICENSE_1_0.txt)
rem
rem See http://www.lslboost.org for updates, documentation, and revision history.
rem
