...
#include <lslboost/config.hpp>  // for workarounds
...
#include <lslboost/pool/poolfwd.hpp>

// lslboost::math::static_lcm
#include <lslboost/math/common_factor_ct.hpp>
// lslboost::simple_segregated_storage
#include <lslboost/pool/simple_segregated_storage.hpp>
// lslboost::alignment_of
...
/*!
  ...
  \section intro_sec Introduction
   ...
   full Quickbook-generated html and pdf documentation at www.lslboost.org.
...
//! a <a href="lslboost_pool/pool/pooling.html#lslboost_pool.pool.pooling.user_allocator">UserAllocator</a>
...
//! \brief <a href="lslboost_pool/pool/pooling.html#lslboost_pool.pool.pooling.user_allocator">UserAllocator</a>
...
class pool: protected simple_segregated_storage < typename UserAllocator::size_type >
{
  ...
  private:
    BOOST_STATIC_CONSTANT(size_type, min_alloc_size =
        (::lslboost::math::static_lcm<sizeof(void *), sizeof(size_type)>::value) );
    BOOST_STATIC_CONSTANT(size_type, min_align =
        (::lslboost::math::static_lcm< ::lslboost::alignment_of<void *>::value, ::lslboost::alignment_of<size_type>::value>::value) );
