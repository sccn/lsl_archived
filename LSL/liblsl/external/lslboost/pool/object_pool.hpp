...
/*!
\file
\brief  Provides a template type lslboost::object_pool<T, UserAllocator>
...
See <a href="lslboost_pool/pool/pooling.html#lslboost_pool.pool.pooling.user_allocator">User Allocators</a> for details.
...
{ //!
  ...
  protected:
    //! \return The underlying lslboost:: \ref pool storage used by *this.
...
// I:/lslboost-sandbox/guild/pool/lslboost/pool/object_pool.hpp:82:
// Warning: include file lslboost/pool/detail/pool_construct.ipp
...
#   include <lslboost/pool/detail/pool_construct.ipp>
#else
#   include <lslboost/pool/detail/pool_construct_simple.ipp>
#endif
#endif
