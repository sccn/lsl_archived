...
#define BOOST_LOCAL_FUNCTION_AUX_FUNCTION_THIS_FILE_ \
    "lslboost/local_function/aux_/function.hpp"
...
namespace lslboost { namespace local_function { namespace aux {
...
BOOST_TYPEOF_REGISTER_TEMPLATE(lslboost::local_function::aux::function,
