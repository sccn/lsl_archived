...
#include <lslboost/local_function/config.hpp>
#include <lslboost/local_function/aux_/symbol.hpp>
#include <lslboost/local_function/aux_/function.hpp>
#include <lslboost/local_function/aux_/add_pointed_const.hpp>
#include <lslboost/local_function/aux_/member.hpp>
#include <lslboost/local_function/aux_/nobind.hpp>
#include <lslboost/local_function/aux_/macro/decl.hpp>
#include <lslboost/local_function/aux_/macro/typeof.hpp>
#include <lslboost/local_function/aux_/macro/code_/result.hpp>
#include <lslboost/local_function/aux_/macro/code_/bind.hpp>
#include <lslboost/local_function/aux_/preprocessor/traits/decl_params.hpp>
...
#include <lslboost/local_function/detail/preprocessor/keyword/auto.hpp>
#include <lslboost/local_function/detail/preprocessor/keyword/register.hpp>
#include <lslboost/local_function/detail/preprocessor/keyword/thisunderscore.hpp>
#include <lslboost/utility/identity_type.hpp>
...
#include <lslboost/preprocessor/facilities/expand.hpp>
...
#include <lslboost/preprocessor/list/first_n.hpp>
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_( \
    ...
    , BOOST_PP_IIF( \
        ...
        BOOST_PP_IDENTITY( ::lslboost::local_function::aux::add_pointed_const< ) \
    , \
        BOOST_PP_EXPR_IIF(BOOST_PP_TUPLE_ELEM(4, 1, id_typename_offset_const), \
            typename \
        ) \
        BOOST_PP_IDENTITY( ::lslboost::add_const< ) /* outer type const */ \
    ))() \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_DECL_( \
    ...
    ::lslboost::local_function::aux::member_type< \
        BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_DECL_TYPE_( \
                r, id_typename_offset_const, i, bind_var_without_type) \
    >::reference \
    BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_MAYBECONST_BIND_MEMBER_VAR_( \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_BIND_TYPEOF_TYPEDEFS_( \
    ...
    BOOST_PP_EXPR_IIF(has_const_bind_this, \
        typedef BOOST_LOCAL_FUNCTION_AUX_TYPEOF_TYPE( \
            BOOST_PP_EXPR_IIF(typename01, typename) \
            ::lslboost::local_function::aux::add_pointed_const< \
                BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_THIS_TYPE(id, typename01) \
            >::type \
            this_ \
        ) ; /* close typedef */ \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_( \
    ...
    public: \
        typedef BOOST_PP_EXPR_IIF(typename01, typename) \
            BOOST_IDENTITY_TYPE(( /* IDENTITY for template param comma */ \
                ::lslboost::local_function::aux::function< \
                      BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_F_TYPE_ \
                    , default_count \
                    BOOST_PP_IIF(BOOST_LOCAL_FUNCTION_CONFIG_LOCALS_AS_TPARAMS,\
                        BOOST_PP_TUPLE_EAT(6) \
    ...
    public: \
        ...
        enum { arity = ::lslboost::function_traits< /* can't use static data */ \
  ...
  BOOST_LOCAL_FUNCTION_AUX_CODE_FUNCTOR_STATIC_CALL_COMMA_FUNC_ADDR_, \
    ...
    private: \
        ...
        lslboost::scope_exit::detail::undeclared \
