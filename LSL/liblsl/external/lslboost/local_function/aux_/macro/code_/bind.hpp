...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND_CAPTURE_DECL_TYPED_( \
    ...
    typedef BOOST_PP_EXPR_IIF(typename01, typename) \
        ...
        ::lslboost::remove_reference< BOOST_PP_EXPR_IIF(typename01, typename) \
...
#define BOOST_LOCAL_FUNCTION_AUX_CODE_BIND(id, typename01, decl_traits) \
    ...
    /*  (declared<(resolve<sizeof(lslboost_local_auxXargs)>::cmp1<0)>::cmp2> */ \
    /*      ...Xargs); */ \
    /* which is a no-op */ \
    ::lslboost::scope_exit::detail::declared< lslboost::scope_exit::detail::resolve< \
