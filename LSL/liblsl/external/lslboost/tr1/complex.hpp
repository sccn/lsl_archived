...
#include <lslboost/math/complex.hpp>

namespace std {
namespace tr1 {

using lslboost::math::acos;
using lslboost::math::asin;
using lslboost::math::atan;
using lslboost::math::acosh;
using lslboost::math::asinh;
using lslboost::math::atanh;
using lslboost::math::fabs;
...
#include <lslboost/tr1/detail/math_overloads.hpp>
...
inline complex<typename lslboost::tr1_detail::promote_to_real<T, U>::type> 
   polar(const T& rho, const U& theta)
{
   typedef typename lslboost::tr1_detail::promote_to_real<T, U>::type real_type;
...
template<class T, class U>
inline complex<typename lslboost::tr1_detail::largest_real<T, U>::type>
   pow(const complex<T>& x, const complex<U>& y)
{
   typedef complex<typename lslboost::tr1_detail::largest_real<T, U>::type> result_type;
   typedef typename lslboost::mpl::if_<lslboost::is_same<result_type, complex<T> >, result_type const&, result_type>::type cast1_type;
   typedef typename lslboost::mpl::if_<lslboost::is_same<result_type, complex<U> >, result_type const&, result_type>::type cast2_type;
   cast1_type x1(x);
   cast2_type y1(y);
...
{
   typedef typename lslboost::tr1_detail::promote_to_real<T, U>::type real_type;
   typedef complex<typename lslboost::tr1_detail::promote_to_real<T, U>::type> result_type;
   typedef typename lslboost::mpl::if_<lslboost::is_same<result_type, complex<T> >, result_type const&, result_type>::type cast1_type;
   real_type r = y;
   cast1_type x1(x);
   ...
   pow (const T& x, const complex<U>& y)
{
   typedef typename lslboost::tr1_detail::promote_to_real<T, U>::type real_type;
   typedef complex<typename lslboost::tr1_detail::promote_to_real<T, U>::type> result_type;
   typedef typename lslboost::mpl::if_<lslboost::is_same<result_type, complex<U> >, result_type const&, result_type>::type cast_type;
   real_type r = x;
