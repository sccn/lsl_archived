...
struct tuple_size< ::lslboost::array<T, N> >
   : public ::lslboost::integral_constant< ::std::size_t, N>{};


template <int I, class T, size_t N>
struct tuple_element<I, ::lslboost::array<T, N> >
{
