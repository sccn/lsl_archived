...
class offset_ptr
{
   ...
   union internal_type{
    ...
    typename ::lslboost::aligned_storage
         < sizeof(OffsetType)
         , (OffsetAlignment == offset_type_alignment) ?
            ::lslboost::alignment_of<OffsetType>::value : OffsetAlignment
...
struct has_trivial_constructor< lslboost::interprocess::offset_ptr<T, P, O, A> >
{
