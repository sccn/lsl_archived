...
//!std::vector, lslboost::interprocess::vector or lslboost::interprocess::basic_string
...
//!contiguous storage, like std::vector, lslboost::interprocess::vector or
//!lslboost::interprocess::basic_string
template <class CharVector, class CharTraits>
