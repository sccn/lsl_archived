...
#include <lslboost/interprocess/sync/interprocess_condition.hpp>
...
class message_queue_t
{
   ...
   bool timed_send    (const void *buffer,     size_type buffer_size,
                           unsigned int priority,  const lslboost::posix_time::ptime& abs_time);
   ...
   #if !defined(BOOST_INTERPROCESS_DOXYGEN_INVOKED)
   private:
   typedef lslboost::posix_time::ptime ptime;
   ...
   : public ipcdetail::priority_functor<VoidPointer>
{
   ...
   {
      const size_type
       msg_hdr_align  = ::lslboost::container::container_detail::alignment_of<msg_header>::value,
       index_align    = ::lslboost::container::container_detail::alignment_of<msg_hdr_ptr_t>::value,
...
class msg_queue_initialization_func_t
{
   ...
   typedef typename lslboost::intrusive::
      pointer_traits<VoidPointer>::template
         rebind_pointer<char>::type                               char_ptr;
   typedef typename lslboost::intrusive::pointer_traits<char_ptr>::
