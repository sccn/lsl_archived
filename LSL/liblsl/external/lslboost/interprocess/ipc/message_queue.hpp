...
{  
   ...
   {
      const size_type
		 msg_hdr_align  = ::lslboost::alignment_of<msg_header>::value,
		 index_align    = ::lslboost::alignment_of<msg_hdr_ptr_t>::value,
                                ...
                                unsigned int priority,   const lslboost::posix_time::ptime &abs_time)
{
   ...
   //---------------------------------------------
   {
      ...
      if (free_msg == 0) {
         throw interprocess_exception("lslboost::interprocess::message_queue corrupted");
      }
