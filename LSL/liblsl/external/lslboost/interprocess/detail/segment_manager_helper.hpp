...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
			   ...
			   , size_type(::lslboost::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::lslboost::alignment_of<T>::value);  }
   ...
   { 
      block_header<size_type> * hdr =
		 ...
		 get_rounded_size(size_type(sizeof(Header)), size_type(::lslboost::alignment_of<block_header<size_type> >::value)));
      //Some sanity checks
      return hdr;
   }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::lslboost::alignment_of<block_header<size_type> >::value  };
