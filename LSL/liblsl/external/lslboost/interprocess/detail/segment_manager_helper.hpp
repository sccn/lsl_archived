...
#include <lslboost/interprocess/detail/in_place_interface.hpp>
// container/detail
#include <lslboost/container/detail/type_traits.hpp> //alignment_of
#include <lslboost/container/detail/minimal_char_traits_header.hpp>
// intrusive
#include <lslboost/intrusive/pointer_traits.hpp>
// move/detail
#include <lslboost/move/detail/type_traits.hpp> //make_unsigned
// other lslboost
...
struct block_header
{
   ...
   size_type total_size_with_header() const
   {
      return get_rounded_size
            ...
            , size_type(::lslboost::container::container_detail::alignment_of<block_header<size_type> >::value))
           + total_size();
   }
   ...
   {  return block_header_from_value(value, sizeof(T), ::lslboost::container::container_detail::alignment_of<T>::value);  }
   ...
   :  public Hook
{
   ...
   enum  {  BlockHdrAlignment = ::lslboost::container::container_detail::alignment_of<block_header<size_type> >::value  };
...
struct index_key
{
   ...
   typedef CharT                                         char_type;
   typedef typename lslboost::intrusive::pointer_traits<const_char_ptr_t>::difference_type difference_type;
   typedef typename lslboost::move_detail::make_unsigned<difference_type>::type size_type;
