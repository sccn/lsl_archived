...
#include <lslboost/interprocess/containers/flat_map.hpp>
#include <lslboost/interprocess/containers/vector.hpp>   //vector
#include <lslboost/interprocess/containers/set.hpp>      //set
#include <lslboost/detail/no_exceptions_support.hpp>
#include <lslboost/interprocess/detail/mpl.hpp>
#include <climits>
#include <iterator>
#include <lslboost/static_assert.hpp>  //BOOST_STATIC_ASSERT
#include <climits>   //CHAR_BIT
#include <lslboost/integer/static_log2.hpp>
#include <lslboost/assert.hpp>   //BOOST_ASSERT
   ...
   :  public intersegment_base
{
   ...
   typedef lslboost::interprocess::flat_map
      <const void *
      ,segment_info_t
   ...
   {
      //------------------------------------------------------------------
      lslboost::interprocess::scoped_lock<typename mappings_t::mutex_type> lock(s_map);
      //------------------------------------------------------------------
      base = 0;
...
//! swap specialization
template<class T> inline
void swap (lslboost::interprocess::intersegment_ptr<T> &pt,
           lslboost::interprocess::intersegment_ptr<T> &pt2)
{  pt.swap(pt2);  }

//!to_raw_pointer() enables lslboost::mem_fn to recognize intersegment_ptr.
//!Never throws.
template<class T> inline
T * to_raw_pointer(lslboost::interprocess::intersegment_ptr<T> const & p)
{  return p.get();   }

//!Simulation of static_cast between pointers.
//!Never throws.
template<class T, class U> inline
lslboost::interprocess::intersegment_ptr<T> static_pointer_cast(const lslboost::interprocess::intersegment_ptr<U> &r)
{  return lslboost::interprocess::intersegment_ptr<T>(r, lslboost::interprocess::ipcdetail::static_cast_tag());  }

//!Simulation of const_cast between pointers.
//!Never throws.
template<class T, class U> inline
lslboost::interprocess::intersegment_ptr<T> const_pointer_cast(const lslboost::interprocess::intersegment_ptr<U> &r)
{  return lslboost::interprocess::intersegment_ptr<T>(r, lslboost::interprocess::ipcdetail::const_cast_tag());  }

//!Simulation of dynamic_cast between pointers.
//!Never throws.
template<class T, class U> inline
lslboost::interprocess::intersegment_ptr<T> dynamic_pointer_cast(const lslboost::interprocess::intersegment_ptr<U> &r)
{  return lslboost::interprocess::intersegment_ptr<T>(r, lslboost::interprocess::ipcdetail::dynamic_cast_tag());  }

//!Simulation of reinterpret_cast between pointers.
//!Never throws.
template<class T, class U> inline
lslboost::interprocess::intersegment_ptr<T> reinterpret_pointer_cast(const lslboost::interprocess::intersegment_ptr<U> &r)
{  return lslboost::interprocess::intersegment_ptr<T>(r, lslboost::interprocess::ipcdetail::reinterpret_cast_tag());  }

//!Trait class to detect if an smart pointer has
//!multi-segment addressing capabilities.
template <class T>
struct is_multisegment_ptr
   <lslboost::interprocess::intersegment_ptr<T> >
{
