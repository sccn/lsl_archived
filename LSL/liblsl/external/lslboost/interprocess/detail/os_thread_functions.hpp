...
//Thread launching functions are adapted from lslboost/detail/lightweight_thread.hpp
//
//  lslboost/detail/lightweight_thread.hpp
//
...
#include <lslboost/interprocess/streams/bufferstream.hpp>
