...
#include <lslboost/interprocess/detail/managed_memory_impl.hpp>
...
#include <lslboost/interprocess/containers/list.hpp>//list
#include <lslboost/interprocess/mapped_region.hpp> //mapped_region
#include <lslboost/interprocess/shared_memory_object.hpp>
#include <lslboost/interprocess/permissions.hpp>
#include <lslboost/interprocess/detail/managed_open_or_create_impl.hpp> //managed_open_or_create_impl
#include <new>
#include <lslboost/interprocess/containers/string.hpp>
#include <lslboost/interprocess/streams/vectorstream.hpp>
#include <memory>
#include <lslboost/assert.hpp>
//These includes needed to fulfill default template parameters of
//predeclarations in interprocess_fwd.hpp
#include <lslboost/interprocess/mem_algo/rbtree_best_fit.hpp> 
#include <lslboost/interprocess/sync/mutex_family.hpp>
 ...
 public:
                          ...
                          const permissions &perm)
   {
      BOOST_TRY{
         ...
         lslboost::interprocess::basic_ovectorstream<lslboost::interprocess::string> formatter;
         ...
         //This can throw.
         m_shmem_list.push_back(lslboost::move(mshm));
         return true;
      }
      BOOST_CATCH(const std::bad_alloc&){
      }
