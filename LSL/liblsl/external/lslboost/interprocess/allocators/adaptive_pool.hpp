...
#include <lslboost/interprocess/allocators/detail/adaptive_node_pool.hpp>
   ...
   >
{
   ...
   typedef lslboost::interprocess::version_type<adaptive_pool_base, Version>   version;
   ...
   {  lslboost::adl_move_swap(alloc1.mp_node_pool, alloc2.mp_node_pool);  }
   ...
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   public:
   typedef lslboost::interprocess::version_type<adaptive_pool, 2>   version;
