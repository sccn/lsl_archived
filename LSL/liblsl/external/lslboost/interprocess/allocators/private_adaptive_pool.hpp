   ...
   >
{
   ...
   typedef lslboost::interprocess::version_type
   ...
   {  lslboost::adl_move_swap(alloc1.m_node_pool, alloc2.m_node_pool);  }
   ...
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   public:
   typedef lslboost::interprocess::version_type<private_adaptive_pool, 2>   version;
