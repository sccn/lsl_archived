...
#include <lslboost/interprocess/allocators/detail/node_pool.hpp>
   ...
   >
{
   ...
   typedef lslboost::interprocess::version_type<node_allocator_base, Version>   version;
   ...
   #endif   //#ifndef BOOST_INTERPROCESS_DOXYGEN_INVOKED
{
   ...
   public:
   typedef lslboost::interprocess::version_type<node_allocator, 2>   version;
