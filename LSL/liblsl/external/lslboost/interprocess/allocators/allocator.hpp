...
#include <lslboost/interprocess/containers/version_type.hpp>
...
class allocator
{
   ...
   typedef lslboost::interprocess::version_type<allocator, 2>   version;
   ...
   {  lslboost::adl_move_swap(alloc1.mp_mngr, alloc2.mp_mngr);   }
...
template<class T, class SegmentManager>
struct has_trivial_destructor
   <lslboost::interprocess::allocator <T, SegmentManager> >
{
