...
class cache_impl
{
   ...
   {
      ::lslboost::adl_move_swap(mp_node_pool, other.mp_node_pool);
      ::lslboost::adl_move_swap(m_cached_nodes, other.m_cached_nodes);
      ::lslboost::adl_move_swap(m_max_cached_nodes, other.m_max_cached_nodes);
   }
};
...
class array_allocation_impl
{
   ...
   pointer allocation_command(lslboost::interprocess::allocation_type command,
   ...
   {  ::new((void*)ipcdetail::to_raw_pointer(ptr), lslboost_container_new_t()) value_type(::lslboost::forward<P>(p));  }
         ...
         <cached_allocator_impl<T, NodePool, Version>, T, typename NodePool::segment_manager>
{
   ...
   {  ::lslboost::adl_move_swap(alloc1.m_cache, alloc2.m_cache);   }
