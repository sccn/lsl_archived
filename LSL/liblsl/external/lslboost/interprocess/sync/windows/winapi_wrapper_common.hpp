...
inline bool winapi_wrapper_timed_wait_for_single_object(void *handle, const lslboost::posix_time::ptime &abs_time)
{
   ...
   const lslboost::posix_time::ptime cur_time = microsec_clock::universal_time();
