...
#include <lslboost/interprocess/sync/windows/named_sync.hpp>
...
class windows_named_condition
{
   ...
   template <class InterprocessMutex>
   bool do_timed_wait(const lslboost::posix_time::ptime &abs_time, InterprocessMutex& lock);
...
{  algorithm_type::wait(m_condition_data, false, lslboost::posix_time::ptime(), mut);  }
