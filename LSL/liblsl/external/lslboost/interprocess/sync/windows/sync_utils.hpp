...
#include <lslboost/interprocess/detail/config_external_begin.hpp>
   #include <lslboost/unordered/unordered_map.hpp>
#include <lslboost/interprocess/detail/config_external_end.hpp>
...
class sync_id
{
   ...
   {  return lslboost::hash_value(m.rand_);  }
...
class sync_handles
{
   ...
   typedef lslboost::unordered_map<sync_id, void*> umap_type;
   typedef lslboost::container::map<const sync_id*, umap_type::iterator, address_less> map_type;
