...
class upgradable_lock
{
   ...
   upgradable_lock(mutex_type& m, const lslboost::posix_time::ptime& abs_time)
      : mp_mutex(&m), m_locked(false)
   ...
   //!   expression: "lslboost::move(lock);". This constructor does not alter the
