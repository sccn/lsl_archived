...
#include <lslboost/assert.hpp>
   ...
   #include <lslboost/interprocess/sync/posix/recursive_mutex.hpp>
   #define BOOST_INTERPROCESS_USE_POSIX
//Experimental...
#elif !defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (BOOST_INTERPROCESS_WINDOWS)
   #include <lslboost/interprocess/sync/windows/recursive_mutex.hpp>
   #define BOOST_INTERPROCESS_USE_WINDOWS
#elif !defined(BOOST_INTERPROCESS_DOXYGEN_INVOKED)
   #include <lslboost/interprocess/sync/spin/recursive_mutex.hpp>
...
inline void interprocess_recursive_mutex::lock()
{
      ...
      lslboost::posix_time::ptime wait_time
         = lslboost::posix_time::microsec_clock::universal_time()
         + lslboost::posix_time::milliseconds(BOOST_INTERPROCESS_TIMEOUT_WHEN_LOCKING_DURATION_MS);
...
inline bool interprocess_recursive_mutex::timed_lock(const lslboost::posix_time::ptime &abs_time)
