...
#include <lslboost/interprocess/permissions.hpp>
   ...
   #include <lslboost/interprocess/sync/posix/named_mutex.hpp>
...
#else
#include <lslboost/interprocess/sync/shm/named_mutex.hpp>
#endif
...
inline bool named_mutex::timed_lock(const lslboost::posix_time::ptime &abs_time)
