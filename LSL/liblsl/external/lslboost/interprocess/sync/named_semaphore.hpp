...
//Experimental...
   ...
   #include <lslboost/interprocess/sync/windows/named_semaphore.hpp>
   #define BOOST_INTERPROCESS_USE_WINDOWS
#else
#include <lslboost/interprocess/sync/shm/named_semaphore.hpp>
#endif
...
inline bool named_semaphore::timed_wait(const lslboost::posix_time::ptime &abs_time)
{
