...
#include <lslboost/interprocess/sync/interprocess_upgradable_mutex.hpp>
...
class named_upgradable_mutex
{
   ...
   //!Throws: interprocess_exception on error.
   bool timed_lock_upgradable(const lslboost::posix_time::ptime &abs_time);
   ...
   //!Returns: If acquires exclusive ownership, returns true. Otherwise returns false.
   //!Throws: An exception derived from interprocess_exception on error.
   bool timed_unlock_upgradable_and_lock(const lslboost::posix_time::ptime &abs_time);
