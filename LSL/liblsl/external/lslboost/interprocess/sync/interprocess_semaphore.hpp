...
#include <lslboost/interprocess/detail/posix_time_types_wrk.hpp>
   ...
   #include <lslboost/interprocess/sync/posix/semaphore.hpp>
...
//Experimental...
   ...
   #include <lslboost/interprocess/sync/spin/semaphore.hpp>
...
inline bool interprocess_semaphore::timed_wait(const lslboost::posix_time::ptime &abs_time)
