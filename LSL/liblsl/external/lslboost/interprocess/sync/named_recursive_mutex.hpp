...
#include <lslboost/interprocess/permissions.hpp>
   ...
   #include <lslboost/interprocess/sync/windows/named_recursive_mutex.hpp>
   #define BOOST_INTERPROCESS_USE_WINDOWS
#else
   #include <lslboost/interprocess/sync/shm/named_recursive_mutex.hpp>
#endif
...
inline bool named_recursive_mutex::timed_lock(const lslboost::posix_time::ptime &abs_time)
{
