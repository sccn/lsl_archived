...
class condition_algorithm_8a
{
   ...
   static bool wait  (ConditionMembers &data, bool timeout_enabled, const lslboost::posix_time::ptime &abs_time, InterprocessMutex &mut);
...
inline bool condition_algorithm_8a<ConditionMembers>::wait
   (ConditionMembers &data, bool tout_enabled, const lslboost::posix_time::ptime &abs_time, InterprocessMutex &mtxExternal)
{
