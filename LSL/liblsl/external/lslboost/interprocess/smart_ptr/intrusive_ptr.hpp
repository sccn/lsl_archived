//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of lslboost/intrusive_ptr.hpp
//
...
class intrusive_ptr
{
   ...
   {  ::lslboost::adl_move_swap(m_ptr, rhs.m_ptr);  }
...
inline typename lslboost::interprocess::intrusive_ptr<T, VP>::pointer
...
inline lslboost::interprocess::intrusive_ptr<T, VP> static_pointer_cast
   (lslboost::interprocess::intrusive_ptr<U, VP> const & p)
{  return do_static_cast<U>(p.get());  }
*/
/*Emulates const cast operator. Does not throw*/
/*
template<class T, class U, class VP>
inline lslboost::interprocess::intrusive_ptr<T, VP> const_pointer_cast
   (lslboost::interprocess::intrusive_ptr<U, VP> const & p)
...
/*
template<class T, class U, class VP>
inline lslboost::interprocess::intrusive_ptr<T, VP> dynamic_pointer_cast
   (lslboost::interprocess::intrusive_ptr<U, VP> const & p)
...
/*
template<class T, class U, class VP>
inline lslboost::interprocess::intrusive_ptr<T, VP>reinterpret_pointer_cast
   (lslboost::interprocess::intrusive_ptr<U, VP> const & p)
...
//!Does not throw
template<class T, class VP>
inline T *to_raw_pointer(lslboost::interprocess::intrusive_ptr<T, VP> p)
{  return p.get();   }
#endif
