//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of lslboost/shared_ptr.hpp
//
...
#include <lslboost/interprocess/smart_ptr/detail/shared_count.hpp>
...
// to_raw_pointer() enables lslboost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
...
//!of type T with the allocator lslboost::interprocess::allocator allocator
//!and lslboost::interprocess::deleter deleter
...
// to_raw_pointer() enables lslboost::mem_fn to recognize shared_ptr
template<class T, class VoidAllocator, class Deleter> inline
T * to_raw_pointer(lslboost::interprocess::shared_ptr<T, VoidAllocator, Deleter> const & p)
{  return p.get();   }
#endif
