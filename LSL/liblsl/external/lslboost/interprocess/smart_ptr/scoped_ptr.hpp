//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of lslboost/scoped_ptr.hpp
//
   ...
   : private Deleter
{
   ...
   {
      ::lslboost::adl_move_swap(static_cast<Deleter&>(*this), static_cast<Deleter&>(b));
      ::lslboost::adl_move_swap(m_ptr, b.m_ptr);
   }
...
template<class T, class D> inline
T *to_raw_pointer(lslboost::interprocess::scoped_ptr<T, D> const & p)
{  return p.get();   }
#endif
