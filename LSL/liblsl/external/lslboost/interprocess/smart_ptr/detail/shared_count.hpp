//////////////////////////////////////////////////////////////////////////////
//
// This file is the adaptation for Interprocess of lslboost/detail/shared_count.hpp
//
...
#include <lslboost/interprocess/smart_ptr/detail/bad_weak_ptr.hpp>
#include <lslboost/interprocess/smart_ptr/detail/sp_counted_impl.hpp>
...
class shared_count
{
   ...
   typedef lslboost::container::allocator_traits<VoidAllocator>         vallocator_traits;
      ...
      :  m_px(p), m_pi(0)
   {
      BOOST_TRY{
         if(p){
            ...
            ::new(ipcdetail::to_raw_pointer(m_pi), lslboost_container_new_t())counted_impl(p, a, d);
            deallocator.release();
         }
      }
      BOOST_CATCH (...){
...
/*
      ...
      : m_pi( r.m_pi )
   {
      if( m_pi == 0 || !m_pi->add_ref_lock() ){
         lslboost::throw_exception( lslboost::interprocess::bad_weak_ptr() );
      }
   }
*/
   template<class Y>
   ...
   {
      if( m_pi == 0 || !m_pi->add_ref_lock() ){
         throw( lslboost::interprocess::bad_weak_ptr() );
      }
   }
   ...
   {  ::lslboost::adl_move_swap(m_px, r.m_px);  ::lslboost::adl_move_swap(m_pi, r.m_pi);   }
