   ...
   ,  public iunordered_set_index_aux<MapConfig>::index_t
{
      ...
      , allocator_type &alloc, size_type new_size)
   {
      ...
      if(!alloc.allocation_command
         (lslboost::interprocess::try_shrink_in_place | lslboost::interprocess::nothrow_allocation, old_size, new_size, received_size, buckets).first){
         return old_size;
      }
      ...
      bucket_ptr shunk_p = alloc.allocation_command
         (lslboost::interprocess::shrink_in_place | lslboost::interprocess::nothrow_allocation, received_size, received_size, received_size, buckets).first;
      ...
      , allocator_type &alloc,  const size_type new_num)
   {
      ...
      std::pair<bucket_ptr, bool> ret =
         alloc.allocation_command
            (lslboost::interprocess::expand_fwd | lslboost::interprocess::allocate_new, new_num, new_num, received_size, old_buckets);
