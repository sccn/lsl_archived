...
// For more information, see http://www.lslboost.org or http://lambda.cs.utu.fi
...
// forward declaration of cons
   ...
   struct cons
   {
    ...
    private:
       typedef typename lslboost::add_reference<head_type>::type head_ref;
       typedef typename lslboost::add_reference<tail_type>::type tail_ref;
