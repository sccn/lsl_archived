//  lslboost/endian/arithmetic.hpp  -------------------------------------------------------//
...
#include <lslboost/endian/buffers.hpp>
#define  BOOST_ENDIAN_MINIMAL_COVER_OPERATORS
#include <lslboost/endian/detail/cover_operators.hpp>
...
#       endif
          this->m_value = ::lslboost::endian::native_to_big(val);
        }
...
#       endif
          this->m_value = ::lslboost::endian::native_to_little(val);
        }
#     endif  
        endian_arithmetic& operator=(T val) BOOST_NOEXCEPT
        {
