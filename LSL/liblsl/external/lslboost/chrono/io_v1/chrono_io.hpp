...
#include <lslboost/integer/common_factor_rt.hpp>
#include <lslboost/chrono/detail/scan_keyword.hpp>
#include <lslboost/utility/enable_if.hpp>
#include <lslboost/chrono/detail/no_warning/signed_unsigned_cmp.hpp>
...
private:
    ...
    template <class Period>
        string_type short_name(Period) const
            {return ::lslboost::ratio_string<Period, CharT>::short_name() + short_seconds_;}
    ...
    template <class Period>
        string_type long_name(Period) const
            {return ::lslboost::ratio_string<Period, CharT>::long_name() + long_seconds_;}
