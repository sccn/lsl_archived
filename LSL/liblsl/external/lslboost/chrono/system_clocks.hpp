//  lslboost/chrono/system_clocks.hpp  --------------------------------------------------------------//
...
# define BOOST_SYSTEM_CLOCK_DURATION lslboost::chrono::duration<lslboost::int_least64_t, ratio<BOOST_RATIO_INTMAX_C(1), BOOST_RATIO_INTMAX_C(10000000)> >
#else
