//  lslboost/chrono/process_cpu_clocks.hpp  -----------------------------------------------------------//
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef lslboost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<lslboost::chrono::process_times<Rep> >
    {
        typedef lslboost::chrono::process_times<Rep> Res;
...
#else
#include <lslboost/chrono/detail/inlined/process_cpu_clocks.hpp>
#endif
#endif
