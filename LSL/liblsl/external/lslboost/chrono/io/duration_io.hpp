...
#include <lslboost/ratio/ratio_io.hpp>
#include <lslboost/chrono/io/duration_style.hpp>
#include <lslboost/chrono/io/ios_base_state.hpp>
#include <lslboost/chrono/io/duration_put.hpp>
#include <lslboost/chrono/io/duration_get.hpp>
#include <lslboost/chrono/io/utility/manip_base.hpp>
...
namespace lslboost
{
  namespace chrono
  {
    ...
    typename lslboost::enable_if_c< ! duration_put_enabled<Rep>::value, std::basic_ostream<CharT, Traits>& >::type
