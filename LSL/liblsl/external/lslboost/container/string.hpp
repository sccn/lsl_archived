 ...
 public:
      ...
      :  public A
   {
      ...
      explicit members_holder(BOOST_FWD_REF(AllocatorConvertible) a)
         :  A(lslboost::forward<AllocatorConvertible>(a))
      {}
...
{
   typedef typename basic_string<CharT,Traits,A>::size_type size_type;
   return lslboost::move(my.replace(size_type(0), size_type(0), s));
}
...
{
   typedef typename basic_string<CharT,Traits,A>::size_type size_type;
   return lslboost::move(my.replace(size_type(0), size_type(0), &c, &c + 1));
}
...
struct has_trivial_destructor_after_move<lslboost::container::basic_string<C, T, A> >
{
