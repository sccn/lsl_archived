...
class flat_map
{
   ...
   {  m_flat_tree = lslboost::move(mx.m_flat_tree);   return *this;  }
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_unique(container_detail::force_copy<impl_const_iterator>(position), lslboost::move(x)));
   }
...
struct has_trivial_destructor_after_move<lslboost::container::flat_map<K, T, C, Allocator> >
{
...
class flat_multimap
{
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_equal(container_detail::force_copy<impl_const_iterator>(position), lslboost::move(x)));
   }
...
//!specialization for optimizations
template <class K, class T, class C, class Allocator>
struct has_trivial_destructor_after_move< lslboost::container::flat_multimap<K, T, C, Allocator> >
{
   static const bool value = has_trivial_destructor_after_move<Allocator>::value && has_trivial_destructor_after_move<C>::value;
};
