...
class flat_map
{
   ...
   flat_map(BOOST_RV_REF(flat_map) x)
      : m_flat_tree(lslboost::move(x.m_flat_tree))
   {
      //A type must be std::pair<Key, T>
      BOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   }
   ...
   flat_map(BOOST_RV_REF(flat_map) x, const allocator_type &a)
      : m_flat_tree(lslboost::move(x.m_flat_tree), a)
   {
      //A type must be std::pair<Key, T>
      BOOST_STATIC_ASSERT((container_detail::is_same<std::pair<Key, T>, typename Allocator::value_type>::value));
   }
   ...
   {  m_flat_tree = lslboost::move(x.m_flat_tree);   return *this;  }
   ...
   {  return container_detail::force_copy< std::pair<iterator, bool> >(m_flat_tree.emplace_unique(lslboost::forward<Args>(args)...)); }
   ...
   {  return container_detail::force_copy<std::pair<iterator,bool> >(
      m_flat_tree.insert_unique(lslboost::move(container_detail::force<impl_value_type>(x)))); }
   ...
   {
      return container_detail::force_copy<std::pair<iterator,bool> >
      (m_flat_tree.insert_unique(lslboost::move(x)));
   }
   ...
   iterator insert(const_iterator p, BOOST_RV_REF(value_type) x)
   {
      return container_detail::force_copy<iterator>
         (m_flat_tree.insert_unique( container_detail::force_copy<impl_const_iterator>(p)
                                   , lslboost::move(container_detail::force<impl_value_type>(x))));
   }
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_unique(container_detail::force_copy<impl_const_iterator>(p), lslboost::move(x)));
   }
   ...
   mapped_type &priv_subscript(const key_type& k)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         ...
         i = insert(i, impl_value_type(k, ::lslboost::move(m.m_t)));
      }
      return (*i).second;
   }
   mapped_type &priv_subscript(BOOST_RV_REF(key_type) mk)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         container_detail::value_init<mapped_type> m;
         i = insert(i, impl_value_type(lslboost::move(k), ::lslboost::move(m.m_t)));
      }
      return (*i).second;
   }
   #endif   //#ifndef BOOST_CONTAINER_DOXYGEN_INVOKED
...
template <class Key, class T, class Compare, class Allocator>
struct has_trivial_destructor_after_move<lslboost::container::flat_map<Key, T, Compare, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
...
class flat_multimap
{
   ...
   {  return container_detail::force_copy<iterator>(m_flat_tree.emplace_equal(lslboost::forward<Args>(args)...)); }
   ...
   iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
   {
      return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_equal
         (container_detail::force_copy<impl_const_iterator>(hint), lslboost::forward<Args>(args)...));
   }
   ...
   { return container_detail::force_copy<iterator>(m_flat_tree.insert_equal(lslboost::move(x))); }
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_equal(container_detail::force_copy<impl_const_iterator>(p), lslboost::move(x)));
   }
...
//!specialization for optimizations
template <class Key, class T, class Compare, class Allocator>
struct has_trivial_destructor_after_move< lslboost::container::flat_multimap<Key, T, Compare, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::lslboost::has_trivial_destructor_after_move<pointer>::value &&
