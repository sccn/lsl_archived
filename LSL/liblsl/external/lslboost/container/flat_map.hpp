...
class flat_map
{
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_unique(container_detail::force<impl_const_iterator>(position), lslboost::move(x)));
   }
   ...
   {  return container_detail::force_copy<iterator>
      (m_flat_tree.emplace_hint_unique(container_detail::force<impl_const_iterator>(hint), lslboost::forward<Args>(args)...)); }
...
struct has_trivial_destructor_after_move<lslboost::container::flat_map<K, T, C, A> >
{
...
class flat_multimap
{
   ...
   {
      return container_detail::force_copy<iterator>(
         m_flat_tree.insert_equal(container_detail::force<impl_const_iterator>(position), lslboost::move(x)));
   }
   ...
   iterator emplace_hint(const_iterator hint, Args&&... args)
   {
      return container_detail::force_copy<iterator>(m_flat_tree.emplace_hint_equal
         (container_detail::force<impl_const_iterator>(hint), lslboost::forward<Args>(args)...));
   }
...
//!specialization for optimizations
template <class K, class T, class C, class A>
struct has_trivial_destructor_after_move< lslboost::container::flat_multimap<K, T, C, A> >
{
   static const bool value = has_trivial_destructor<A>::value && has_trivial_destructor<C>::value;
};
*/
