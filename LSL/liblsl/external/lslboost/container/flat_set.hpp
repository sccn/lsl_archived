...
class flat_set
{
   ...
   {  return m_flat_tree.insert_unique(::lslboost::forward<KeyType>(x));  }

   template<class KeyType>
   iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return m_flat_tree.insert_unique(p, ::lslboost::forward<KeyType>(x)); }
   /// @endcond
};
...
struct has_trivial_destructor_after_move<lslboost::container::flat_set<Key, C, Allocator> >
{
...
class flat_multiset
{
   ...
   {  return m_flat_tree.insert_equal(::lslboost::forward<KeyType>(x));  }

   template <class KeyType>
   iterator priv_insert(const_iterator p, BOOST_FWD_REF(KeyType) x)
   {  return m_flat_tree.insert_equal(p, ::lslboost::forward<KeyType>(x)); }
   /// @endcond
};
