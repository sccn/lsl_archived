...
// container/detail
#include <lslboost/container/detail/flat_tree.hpp>
...
// intrusive/detail
#include <lslboost/intrusive/detail/minimal_pair_header.hpp>      //pair
#include <lslboost/intrusive/detail/minimal_less_equal_header.hpp>//less, equal
// std
   ...
   ///@endcond
{
   ...
   //! @copydoc ::lslboost::container::flat_set::flat_set(ordered_unique_range_t, std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   ...
   //! @copydoc ::lslboost::container::flat_set(const flat_set &, const allocator_type &)
