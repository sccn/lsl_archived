...
#include <lslboost/container/detail/tree.hpp>
...
//! \tparam SetOptions is an packed option type generated using using lslboost::container::tree_assoc_options.
...
struct has_trivial_destructor_after_move<lslboost::container::set<Key, Compare, Allocator, SetOptions> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
...
//! \tparam Compare is the comparison functor used to order keys
//! \tparam Allocator is the allocator to be used to allocate memory for this container
//! \tparam MultiSetOptions is an packed option type generated using using lslboost::container::tree_assoc_options.
   ...
   /// @endcond
{
   ...
   //! @copydoc ::lslboost::container::set::set()
   multiset()
      : base_t()
   {}

   //! @copydoc ::lslboost::container::set::set(const Compare&, const allocator_type&)
   explicit multiset(const Compare& comp,
                     const allocator_type& a = allocator_type())
      : base_t(comp, a)
   {}

   //! @copydoc ::lslboost::container::set::set(const allocator_type&)
   explicit multiset(const allocator_type& a)
      : base_t(a)
   {}

   //! @copydoc ::lslboost::container::set::set(InputIterator, InputIterator, const Compare& comp, const allocator_type&)
   template <class InputIterator>
   ...
   //! @copydoc ::lslboost::container::set::set(InputIterator, InputIterator, const allocator_type&)
   template <class InputIterator>
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::lslboost::container::set::set(std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   multiset(std::initializer_list<value_type> il, const Compare& comp = Compare(), const allocator_type& a = allocator_type())
      : base_t(false, il.begin(), il.end(), comp, a)
   {}

   //! @copydoc ::lslboost::container::set::set(std::initializer_list<value_type>, const allocator_type&)
   multiset(std::initializer_list<value_type> il, const allocator_type& a)
      : base_t(false, il.begin(), il.end(), Compare(), a)
   {}

   //! @copydoc ::lslboost::container::set::set(ordered_unique_range_t, std::initializer_list<value_type>, const Compare& comp, const allocator_type&)
   ...
   //! @copydoc ::lslboost::container::set::set(const set &)
   ...
   //! @copydoc ::lslboost::container::set(const set &, const allocator_type &)
   ...
   //! @copydoc ::lslboost::container::set::operator=(const set &)
   ...
   //! @copydoc ::lslboost::container::set::operator=(set &&)
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::lslboost::container::set::operator=(std::initializer_list<value_type>)
   ...
   //! @copydoc ::lslboost::container::set::get_allocator()
   allocator_type get_allocator() const;

   //! @copydoc ::lslboost::container::set::get_stored_allocator()
   stored_allocator_type &get_stored_allocator();

   //! @copydoc ::lslboost::container::set::get_stored_allocator() const
   const stored_allocator_type &get_stored_allocator() const;

   //! @copydoc ::lslboost::container::set::begin()
   iterator begin();

   //! @copydoc ::lslboost::container::set::begin() const
   const_iterator begin() const;

   //! @copydoc ::lslboost::container::set::cbegin() const
   const_iterator cbegin() const;

   //! @copydoc ::lslboost::container::set::end()
   iterator end() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::end() const
   const_iterator end() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::cend() const
   const_iterator cend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::rbegin()
   reverse_iterator rbegin() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::rbegin() const
   const_reverse_iterator rbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::crbegin() const
   const_reverse_iterator crbegin() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::rend()
   reverse_iterator rend() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::rend() const
   const_reverse_iterator rend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::crend() const
   const_reverse_iterator crend() const BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::empty() const
   bool empty() const;

   //! @copydoc ::lslboost::container::set::size() const
   size_type size() const;

   //! @copydoc ::lslboost::container::set::max_size() const
   size_type max_size() const;
...
#if !defined(BOOST_NO_CXX11_HDR_INITIALIZER_LIST)
   //! @copydoc ::lslboost::container::set::insert(std::initializer_list<value_type>)
   void insert(std::initializer_list<value_type> il)
   ...
   //! @copydoc ::lslboost::container::set::erase(const_iterator)
   iterator erase(const_iterator p);

   //! @copydoc ::lslboost::container::set::erase(const key_type&)
   size_type erase(const key_type& x);

   //! @copydoc ::lslboost::container::set::erase(const_iterator,const_iterator)
   iterator erase(const_iterator first, const_iterator last);

   //! @copydoc ::lslboost::container::set::swap
   void swap(multiset& x)
      BOOST_NOEXCEPT_IF(  allocator_traits_type::is_always_equal::value
                                 && lslboost::container::container_detail::is_nothrow_swappable<Compare>::value );

   //! @copydoc ::lslboost::container::set::clear
   void clear() BOOST_NOEXCEPT_OR_NOTHROW;

   //! @copydoc ::lslboost::container::set::key_comp
   key_compare key_comp() const;

   //! @copydoc ::lslboost::container::set::value_comp
   value_compare value_comp() const;

   //! @copydoc ::lslboost::container::set::find(const key_type& )
   iterator find(const key_type& x);

   //! @copydoc ::lslboost::container::set::find(const key_type& ) const
   const_iterator find(const key_type& x) const;

   //! @copydoc ::lslboost::container::set::count(const key_type& ) const
   size_type count(const key_type& x) const;

   //! @copydoc ::lslboost::container::set::lower_bound(const key_type& )
   iterator lower_bound(const key_type& x);

   //! @copydoc ::lslboost::container::set::lower_bound(const key_type& ) const
   const_iterator lower_bound(const key_type& x) const;

   //! @copydoc ::lslboost::container::set::upper_bound(const key_type& )
   iterator upper_bound(const key_type& x);

   //! @copydoc ::lslboost::container::set::upper_bound(const key_type& ) const
   const_iterator upper_bound(const key_type& x) const;

   //! @copydoc ::lslboost::container::set::equal_range(const key_type& ) const
   std::pair<const_iterator, const_iterator> equal_range(const key_type& x) const;

   //! @copydoc ::lslboost::container::set::equal_range(const key_type& )
   std::pair<iterator,iterator> equal_range(const key_type& x);

   //! @copydoc ::lslboost::container::set::rebalance()
   void rebalance();
...
//!specialization for optimizations
template <class Key, class Compare, class Allocator, class MultiSetOptions>
struct has_trivial_destructor_after_move<lslboost::container::multiset<Key, Compare, Allocator, MultiSetOptions> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
   static const bool value = ::lslboost::has_trivial_destructor_after_move<Allocator>::value &&
                             ::lslboost::has_trivial_destructor_after_move<pointer>::value &&
