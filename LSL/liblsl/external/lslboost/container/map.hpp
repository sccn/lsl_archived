...
class map
{
   ...
   mapped_type& priv_subscript(const key_type &k)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         ...
         nonconst_impl_value_type val(k, lslboost::move(m.m_t));
   ...
   mapped_type& priv_subscript(BOOST_RV_REF(key_type) mk)
   {
      ...
      if (i == end() || key_comp()(k, (*i).first)){
         container_detail::value_init<mapped_type> m;
         nonconst_impl_value_type val(lslboost::move(k), lslboost::move(m.m_t));
         i = insert(i, lslboost::move(val));
      }
      return (*i).second;
   }
...
struct has_trivial_destructor_after_move<lslboost::container::map<K, T, C, A> >
{
...
//!specialization for optimizations
template <class K, class T, class C, class A>
struct has_trivial_destructor_after_move<lslboost::container::multimap<K, T, C, A> >
{
   static const bool value = has_trivial_destructor<A>::value && has_trivial_destructor<C>::value;
};
*/
