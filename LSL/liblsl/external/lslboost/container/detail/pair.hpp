...
#include <lslboost/container/detail/mpl.hpp>
#include <lslboost/container/detail/type_traits.hpp>
#include <lslboost/move/adl_move_swap.hpp> //swap
...
template <class T>
inline typename ::lslboost::move_detail::enable_if_and
   < T &
   , lslboost::container::container_detail::is_std_pair<T>
...
struct is_enum< ::lslboost::container::container_detail::pair<T, U> >
{
   static const bool value = false;
};
