...
/*
   ...
   pair(U &&u, V &&v)
      : first(::lslboost::forward<U>(u))
      , second(::lslboost::forward<V>(v), ::lslboost::forward<Args>(args)...)
   {}
...
*/
   ...
   typename ::lslboost::container::container_detail::enable_if_c
      < !(::lslboost::container::container_detail::is_same<T1, D>::value &&
          ::lslboost::container::container_detail::is_same<T2, S>::value)
      , pair &>::type
