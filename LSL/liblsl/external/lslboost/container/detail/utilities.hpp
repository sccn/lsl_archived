...
enum {
   ...
   && !::lslboost::is_fundamental<_TypeT>::value
};
...
struct move_const_ref_type
   : if_c
//   < ::lslboost::is_fundamental<T>::value || ::lslboost::is_pointer<T>::value || ::lslboost::is_member_pointer<T>::value || ::lslboost::is_enum<T>::value
...
//!      allocator_traits::construct(a, &*result, lslboost::move(*first));
//!   \endcode
//!
//! <b>Returns</b>: result
template
...
F uninitialized_copy_or_move_alloc
   (A &a, I f, I l, F r
   ,typename lslboost::container::container_detail::enable_if
      < lslboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::lslboost::container::uninitialized_move_alloc(a, f, l, r);
}
...
F uninitialized_copy_or_move_alloc
   (A &a, I f, I l, F r
   ,typename lslboost::container::container_detail::disable_if
      < lslboost::move_detail::is_move_iterator<I> >::type* = 0)
{
   return ::lslboost::container::uninitialized_copy_alloc(a, f, l, r);
}
