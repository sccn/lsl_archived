...
struct lslboost_container_new_t{};

//avoid including <new>
inline void *operator new(std::size_t, void *p, lslboost_container_new_t)
{  return p;  }

inline void operator delete(void *, void *, lslboost_container_new_t)
{}
