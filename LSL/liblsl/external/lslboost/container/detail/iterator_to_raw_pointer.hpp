...
inline typename lslboost::container::iterator_traits<Iterator>::pointer
...
{
   typedef typename lslboost::container::iterator_traits<Iterator>::pointer      pointer;
   typedef typename lslboost::intrusive::pointer_traits<pointer>::element_type   element_type;
...
{
   return ::lslboost::intrusive::detail::to_raw_pointer
      (  ::lslboost::container::container_detail::iterator_to_pointer(i)   );
}
