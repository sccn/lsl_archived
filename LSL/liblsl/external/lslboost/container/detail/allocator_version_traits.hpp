...
#include <lslboost/container/allocator_traits.hpp>             //allocator_traits
#include <lslboost/container/throw_exception.hpp>
#include <lslboost/container/detail/multiallocation_chain.hpp> //multiallocation_chain
#include <lslboost/container/detail/version_type.hpp>          //version_type
#include <lslboost/container/detail/allocation_type.hpp>       //allocation_type
#include <lslboost/container/detail/mpl.hpp>                   //integral_constant
#include <lslboost/intrusive/pointer_traits.hpp>               //pointer_traits
#include <utility>                                          //pair
#include <lslboost/detail/no_exceptions_support.hpp>           //BOOST_TRY

namespace lslboost {
namespace container {
namespace container_detail {

template<class Allocator, unsigned Version = lslboost::container::container_detail::version<Allocator>::value>
...
struct allocator_version_traits<Allocator, 1>
{
   ...
   static void deallocate_individual(Allocator &a, multiallocation_chain &holder)
   {
      ...
      while(n--){
         pointer p = lslboost::intrusive::pointer_traits<pointer>::pointer_to(*it);
         ++it;
         a.deallocate(p, 1);
      }
   }
