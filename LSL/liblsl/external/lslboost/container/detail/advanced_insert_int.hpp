...
struct insert_move_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1);  (void)n;
      alloc_traits::construct( a, iterator_to_raw_pointer(p), ::lslboost::move(v_) );
   }
...
struct insert_nonmovable_emplace_proxy
{
   ...
   {
      BOOST_ASSERT(n == 1); (void)n;
      alloc_traits::construct( a, iterator_to_raw_pointer(p), ::lslboost::forward<Args>(get<IdxPack>(this->args_))... );
   }
