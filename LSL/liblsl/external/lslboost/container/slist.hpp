      ...
      <A, typename container_detail::intrusive_slist_type<A>::type>
{
   ...
   {  this->icont().push_front(*this->create_node(lslboost::move(x)));  }
   ...
   {  return iterator(this->icont().insert_after(prev_pos.get(), *this->create_node(lslboost::move(x)))); }
   ...
   {  return this->insert_after(previous(p), lslboost::move(x)); }
...
template <class T, class A>
struct has_trivial_destructor_after_move<lslboost::container::slist<T, A> >
{
...
template <class T, class A>
class insert_iterator<lslboost::container::slist<T, A> >
{
 protected:
   typedef lslboost::container::slist<T, A> Container;
   Container* container;
