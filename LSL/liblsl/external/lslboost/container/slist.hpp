      ...
      <Allocator, typename container_detail::intrusive_slist_type<Allocator>::type>
{
   ...
   typedef lslboost::container::equal_to_value<Allocator>      equal_to_value_type;
      ...
      : AllocHolder(a)
   {
      if(this->node_alloc() == x.node_alloc()){
         ...
         this->insert_after(this->cbefore_begin(), lslboost::make_move_iterator(x.begin()), lslboost::make_move_iterator(x.end()));
      }
   }
   ...
   {  this->emplace_after(this->cbefore_begin(), lslboost::forward<Args>(args)...); }
   ...
   {
      NodePtr pnode(AllocHolder::create_node(lslboost::forward<Args>(args)...));
      ...
      )
   {
      ...
      this->allocate_many_and_construct(first, lslboost::container::iterator_distance(first, last), func);
   ...
   {  return this->emplace_after(this->previous(p), lslboost::forward<Args>(args)...);  }
   ...
   {  this->insert_after(this->cbefore_begin(), ::lslboost::move(x));  }
   ...
   {  return this->insert_after(previous(p), ::lslboost::forward<U>(x)); }

   template<class U>
   iterator priv_insert_after(const_iterator prev_p, BOOST_FWD_REF(U) x)
   {  return iterator(this->icont().insert_after(prev_p.get(), *this->create_node(::lslboost::forward<U>(x)))); }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<lslboost::container::slist<T, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
...
template <class T, class Allocator>
class insert_iterator<lslboost::container::slist<T, Allocator> >
{
 protected:
   typedef lslboost::container::slist<T, Allocator> Container;
   Container* container;
