...
// container/detail
#include <lslboost/container/detail/algorithm.hpp>
      ...
      <Allocator, typename container_detail::intrusive_list_type<Allocator>::type>
{
      ...
      : AllocHolder(a)
   {
      if(this->node_alloc() == x.node_alloc()){
         ...
         this->insert(this->cbegin(), lslboost::make_move_iterator(x.begin()), lslboost::make_move_iterator(x.end()));
      }
   }
   ...
   {  this->emplace(this->cend(), lslboost::forward<Args>(args)...); }
   ...
   {  this->emplace(this->cbegin(), lslboost::forward<Args>(args)...);  }
   ...
   {
      NodePtr tmp = AllocHolder::create_node(lslboost::move(x));
      return iterator(this->icont().insert(p.get(), *tmp));
   }
   ...
   {  this->insert(this->cend(), lslboost::move(x));    }

   void priv_push_front (const T &x)
   {  this->insert(this->cbegin(), x);  }

   void priv_push_front (BOOST_RV_REF(T) x)
   {  this->insert(this->cbegin(), lslboost::move(x));  }
...
template <class T, class Allocator>
struct has_trivial_destructor_after_move<lslboost::container::list<T, Allocator> >
{
   typedef typename ::lslboost::container::allocator_traits<Allocator>::pointer pointer;
