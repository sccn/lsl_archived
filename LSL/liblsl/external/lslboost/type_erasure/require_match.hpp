...
void require_match_impl(
    ...
    U&&... arg)
{
    if(!::lslboost::type_erasure::check_match(table, op, std::forward<U>(arg)...)) {
...
void require_match_impl(
    ::lslboost::mpl::false_,
    const ::lslboost::type_erasure::binding<Concept>&,
    const Op&,
    U&&...)
{}
...
void require_match_impl(
    ...
    U&&... arg)
{
    if(!::lslboost::type_erasure::check_match(op, ::std::forward<U>(arg)...)) {
        BOOST_THROW_EXCEPTION(::lslboost::type_erasure::bad_function_call());
    }
}
...
void require_match(
    ...
    U&&... arg)
{
    ::lslboost::type_erasure::is_relaxed<Concept> cond;
    ::lslboost::type_erasure::detail::require_match_impl(cond, table, op, ::std::forward<U>(arg)...);
}
    ...
    U&&... arg)
{
    ::lslboost::type_erasure::is_relaxed<
        typename ::lslboost::type_erasure::detail::extract_concept<
            ...
            U...>::type
    > cond;
    ::lslboost::type_erasure::detail::require_match_impl(cond, op, ::std::forward<U>(arg)...);
}

#else

#define BOOST_PP_FILENAME_1 <lslboost/type_erasure/require_match.hpp>
...
{
    if(!::lslboost::type_erasure::check_match
...
{
    ::lslboost::type_erasure::is_relaxed<Concept> cond;
    ::lslboost::type_erasure::detail::require_match_impl
