...
#define BOOST_PP_FILENAME_1 <lslboost/type_erasure/detail/construct.hpp>
...
#define BOOST_TYPE_ERASURE_FORWARD(n) BOOST_PP_ENUM(n, BOOST_TYPE_ERASURE_FORWARD_I, ~)
    ...
    const table_type& _lslboost_type_erasure_extract_table(
        ::lslboost::type_erasure::constructible<R(BOOST_PP_ENUM_PARAMS(N, A))>*
        BOOST_PP_ENUM_TRAILING_BINARY_PARAMS(N, U, &u))
    {
        return *::lslboost::type_erasure::detail::BOOST_PP_CAT(extract_table, N)(
    ...
    any(BOOST_PP_ENUM_BINARY_PARAMS(N, U, &&u))
      : table(
            _lslboost_type_erasure_extract_table(
                false? this->_lslboost_type_erasure_deduce_constructor(BOOST_TYPE_ERASURE_FORWARD(N)) : 0
...
#undef BOOST_TYPE_ERASURE_FORWARD_I
    ...
    any(BOOST_PP_ENUM_BINARY_PARAMS(N, const U, &u))
      : table(
            _lslboost_type_erasure_extract_table(
                false? this->_lslboost_type_erasure_deduce_constructor(BOOST_PP_ENUM_PARAMS(N, u)) : 0
                BOOST_PP_ENUM_TRAILING_PARAMS(N, u)
            )
        ),
        data(::lslboost::type_erasure::call(
