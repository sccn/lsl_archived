...
/** The maximum number of functions that an @ref lslboost::type_erasure::any "any" can have. */
...
/** The maximum number of elements in a @ref lslboost::type_erasure::tuple "tuple". */
