...
#include <lslboost/fusion/include/category_of.hpp>
#include <lslboost/fusion/include/iterator_facade.hpp>
#include <lslboost/fusion/include/sequence_facade.hpp>
...
struct make_map<T0, T...>
{
    typedef typename ::lslboost::mpl::insert<
        typename ::lslboost::type_erasure::detail::make_map<T...>::type,
        T0
    >::type type;
};
...
struct make_map<>
{
    typedef ::lslboost::mpl::map0<> type;
};
...
class tuple_iterator :
    public ::lslboost::fusion::iterator_facade<
...
public:
    ...
    template<class It>
    struct next : advance<It, ::lslboost::mpl::int_<1> > {};
    template<class It>
    struct prior : advance<It, ::lslboost::mpl::int_<-1> > {};
...
template<class Concept, class... T>
class tuple :
    public ::lslboost::fusion::sequence_facade<
        ::lslboost::type_erasure::tuple<Concept, T...>,
        ::lslboost::fusion::forward_traversal_tag
    >
{
public:
    template<class... U>
    explicit tuple(U&&... args)
      : impl(
            ::lslboost::type_erasure::make_binding<
                typename ::lslboost::type_erasure::detail::make_map<
                    ::lslboost::mpl::pair<
    ...
    struct begin
    {
        typedef ::lslboost::type_erasure::tuple_iterator<
            Seq,
            0
        > type;
    ...
    struct size
    {
        typedef ::lslboost::mpl::int_<sizeof...(T)> type;
        static type call(Seq& seq) { return type(); }
    };
    template<class Seq>
    struct empty
    {
        typedef ::lslboost::mpl::bool_<sizeof...(T) == 0> type;
        static type call(Seq& seq) { return type(); }
    };
    template<class Seq, class N>
    struct at
    {
        typedef typename ::lslboost::type_erasure::detail::cons_advance<
            N::value,
            ::lslboost::type_erasure::cons<Concept, T...>
        >::type::value_type value_type;
        typedef typename ::lslboost::mpl::if_< ::lslboost::is_const<Seq>,
            const value_type&,
            value_type&
        >::type type;
        static type call(Seq& seq)
        {
            return const_cast<type>(
                ::lslboost::type_erasure::detail::cons_advance<
                    N::value,
                    ::lslboost::type_erasure::cons<Concept, T...>
                >::call(seq.impl).value
            );
    ...
    ::lslboost::type_erasure::cons<Concept, T...> impl;
};

template<int N, class Concept, class... T>
typename ::lslboost::type_erasure::detail::cons_advance<
    N,
    ::lslboost::type_erasure::cons<Concept, T...>
>::type::value_type& get(::lslboost::type_erasure::tuple<Concept, T...>& t)
{
    return const_cast<
        typename ::lslboost::type_erasure::detail::cons_advance<
            N,
        ...
        >::type::value_type&
    >(
        ::lslboost::type_erasure::detail::cons_advance<N,
            ::lslboost::type_erasure::cons<Concept, T...>
        >::call(t.impl).value
    );
}
...
template<int N, class Concept, class... T>
const typename ::lslboost::type_erasure::detail::cons_advance<
    N,
    ::lslboost::type_erasure::cons<Concept, T...>
>::type::value_type& get(const ::lslboost::type_erasure::tuple<Concept, T...>& t)
{
    return ::lslboost::type_erasure::detail::cons_advance<
        N,
        ::lslboost::type_erasure::cons<Concept, T...>
    >::call(t.impl).value;
}
...
template<class Concept,
    BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
        BOOST_TYPE_ERASURE_MAX_TUPLE_SIZE, class T, ::lslboost::type_erasure::na)>
...
public:
    ...
    struct value_of
    {
        typedef typename ::lslboost::type_erasure::detail::get_impl<
            It::index::value,
            Tuple
        >::value_type type;
    };
    template<class It>
    struct deref :
        ::lslboost::type_erasure::detail::get_impl<It::index::value, Tuple>
    {
        typedef typename ::lslboost::type_erasure::detail::get_impl<
            It::index::value,
            Tuple
        ...
        static type call(It it)
        {
            return ::lslboost::type_erasure::detail::get_impl<
                It::index::value,
                Tuple
            >::call(*it.t);
        }
...
struct tuple_base :
    ::lslboost::fusion::sequence_facade<
        Derived,
        ::lslboost::fusion::random_access_traversal_tag
    >
{
    ...
    struct begin
    {
        typedef ::lslboost::type_erasure::tuple_iterator<Seq, 0> type;
        static type call(Seq& seq) { return type(seq); }
    };
    template<class Seq>
    struct end
    ...
    struct empty
    {
        typedef typename lslboost::mpl::equal_to<
    ...
    template<class Seq, class N>
    struct at : ::lslboost::type_erasure::detail::get_impl<N::value, Seq> {};
    template<class Seq, class N>
    struct value_at
    {
        typedef typename ::lslboost::type_erasure::detail::get_impl<
...
/** INTERNAL ONLY */
#define BOOST_PP_FILENAME_1 <lslboost/type_erasure/tuple.hpp>
/** INTERNAL ONLY */
...
#define BOOST_TYPE_ERASURE_TAG_TYPEDEF(z, n, data)                          \
    ...
    typedef typename ::lslboost::remove_reference<BOOST_PP_CAT(T, n)>::type    \
        BOOST_PP_CAT(tag, n);

#define BOOST_TYPE_ERASURE_PAIR(z, n, data) \
    ::lslboost::mpl::pair<BOOST_PP_CAT(tag, n), BOOST_PP_CAT(U, n)>
...
#define BOOST_TYPE_ERASURE_TUPLE_MEMBER(z, n, data)\
    ::lslboost::type_erasure::any<Concept, BOOST_PP_CAT(T, n)> BOOST_PP_CAT(t, n);
...
public:
    typedef ::lslboost::mpl::int_<N> tuple_size;
#if N
...
private:
    ...
    friend struct ::lslboost::type_erasure::detail::get_impl;
    ::lslboost::type_erasure::detail::tuple_storage<
        Concept
