...
struct compute_bases
{
    typedef typename ::lslboost::mpl::fold<
        typename ::lslboost::type_erasure::detail::collect_concepts<
            Concept
        >::type,
        ::lslboost::type_erasure::any_base<Derived>,
        ::lslboost::type_erasure::concept_interface<
            ::lslboost::mpl::_2,
            ::lslboost::mpl::_1,
            T
        >
...
template<class T>
fallback make_fallback(const T&, lslboost::mpl::false_)
{
    return fallback();
}

template<class T>
const T& make_fallback(const T& arg, lslboost::mpl::true_)
{
    return arg;
}

template<class T>
struct is_any : ::lslboost::mpl::false_ {};

template<class Concept, class T>
struct is_any<any<Concept, T> > : ::lslboost::mpl::true_ {};
...
class any :
    public ::lslboost::type_erasure::detail::compute_bases<
        ::lslboost::type_erasure::any<Concept, T>,
        Concept,
        T
    >::type
{
    typedef ::lslboost::type_erasure::binding<Concept> table_type;
public:
    /** INTERNAL ONLY */
    typedef Concept _lslboost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::lslboost::type_erasure::detail::storage& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    /** INTERNAL ONLY */
    any(::lslboost::type_erasure::detail::storage&& data_arg, const table_type& table_arg)
      : table(table_arg),
        data(data_arg)
    {}
#endif
    ...
    any()
    {
        BOOST_MPL_ASSERT((::lslboost::type_erasure::is_relaxed<Concept>));
        data.data = 0;
    }
    ...
    any(const U& data_arg)
      : table((
            ...
            ::lslboost::type_erasure::make_binding<
                ::lslboost::mpl::map< ::lslboost::mpl::pair<T, U> >
            >()
        )),
        data(data_arg)
    {}
    ...
    any(const U& data_arg, const static_binding<Map>& binding_arg)
      : table((
        ...
        data(data_arg)
    {
        BOOST_MPL_ASSERT((::lslboost::is_same<
            typename ::lslboost::mpl::at<Map, T>::type, U>));
    }
    ...
    any(U&& data_arg)
      : table((
            BOOST_TYPE_ERASURE_INSTANTIATE1(Concept, T, typename ::lslboost::remove_cv<typename ::lslboost::remove_reference<U>::type>::type),
            ::lslboost::type_erasure::make_binding<
                ::lslboost::mpl::map< ::lslboost::mpl::pair<T, typename ::lslboost::remove_cv<typename ::lslboost::remove_reference<U>::type>::type> >
            >()
        )),
    ...
    {
        BOOST_MPL_ASSERT((::lslboost::is_same<
            typename ::lslboost::mpl::at<Map, T>::type, typename ::lslboost::remove_cv<typename ::lslboost::remove_reference<U>::type>::type>));
    }
    ...
    any(const any& other)
      : table(other.table),
        data(::lslboost::type_erasure::call(constructible<T(const T&)>(), other))
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other)
      : table(
            ::lslboost::type_erasure::detail::access::table(other),
            ::lslboost::mpl::map<
                ::lslboost::mpl::pair<
                    T,
                    typename ::lslboost::remove_const<
                        typename ::lslboost::remove_reference<Tag2>::type
                    >::type
                >
            >()
        ),
        data(::lslboost::type_erasure::call(
            constructible<
                typename ::lslboost::remove_const<
                    typename lslboost::remove_reference<Tag2>::type
                >::type(const typename lslboost::remove_reference<Tag2>::type&)
            >(), other)
        )
    {}
    /**
    ...
    any(const any<Concept2, Tag2>& other, const static_binding<Map>& binding_arg)
      : table(::lslboost::type_erasure::detail::access::table(other), binding_arg),
        data(::lslboost::type_erasure::call(
            constructible<
                typename ::lslboost::remove_const<
                    typename lslboost::remove_reference<Tag2>::type
    ...
    explicit any(const binding<Concept>& binding_arg, U&&... arg)
      : table(binding_arg),
        data(
            ::lslboost::type_erasure::detail::make(
                false? this->_lslboost_type_erasure_deduce_constructor(arg...) : 0
            )(arg...)
        )
    {}
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    any(any&& other)
      : table(::lslboost::type_erasure::detail::access::table(other)),
        data(::lslboost::type_erasure::call(
            ::lslboost::type_erasure::detail::make(
                false? this->_lslboost_type_erasure_deduce_constructor(std::move(other)) : 0
            ), std::move(other))
        )
    {}
    any(any& other)
      : table(::lslboost::type_erasure::detail::access::table(other)),
        data(::lslboost::type_erasure::call(
            ::lslboost::type_erasure::detail::make(
                false? this->_lslboost_type_erasure_deduce_constructor(other) : 0
            ), other)
        )
    {}
    template<class Concept2, class Tag2>
    any(any<Concept2, Tag2>& other)
      : table(
        ...
        data(::lslboost::type_erasure::call(
            ::lslboost::type_erasure::detail::make(
                false? other._lslboost_type_erasure_deduce_constructor(other) : 0
            ), other)
        )
    {}
    template<class Concept2, class Tag2>
    any(any<Concept2, Tag2>&& other)
      : table(
        ...
        data(::lslboost::type_erasure::call(
            ::lslboost::type_erasure::detail::make(
                false? other._lslboost_type_erasure_deduce_constructor(std::move(other)) : 0
            ), std::move(other))
        )
    {}
#endif
    ...
    explicit any(const binding<Concept>& binding_arg)
      : table(binding_arg),
        data(
            ::lslboost::type_erasure::call(
                binding_arg,
                ::lslboost::type_erasure::constructible<T()>()
            )
        )
    {}
    ...
    const table_type& _lslboost_type_erasure_extract_table(
        ::lslboost::type_erasure::constructible<R(A...)>*,
        U&&... u)
    {
        return *::lslboost::type_erasure::detail::extract_table(static_cast<void(*)(A...)>(0), u...);
    }

    template<class U0, class U1, class... U>
    any(U0&& u0, U1&& u1, U&&... u)
      : table(
            _lslboost_type_erasure_extract_table(
                false? this->_lslboost_type_erasure_deduce_constructor(std::forward<U0>(u0), std::forward<U1>(u1), std::forward<U>(u)...) : 0,
      ...
      : table(binding_arg),
        data(
            ::lslboost::type_erasure::call(
                binding_arg,
                ::lslboost::type_erasure::detail::make(
                    false? this->_lslboost_type_erasure_deduce_constructor(std::forward<U0>(u0), std::forward<U>(u)...) : 0
                ),
...
#include <lslboost/type_erasure/detail/construct.hpp>
    ...
    {
        _lslboost_type_erasure_resolve_assign(other);
        return *this;
    }
    /**
     * Assigns to an @ref any.
...
private:
    /** INTERNAL ONLY */
    void _lslboost_type_erasure_swap(any& other)
    {
    ...
    void _lslboost_type_erasure_resolve_assign(const Other& other)
    {
        _lslboost_type_erasure_assign_impl(
            other,
            false? this->_lslboost_type_erasure_deduce_assign(
                ::lslboost::type_erasure::detail::make_fallback(
                    other,
                    ::lslboost::mpl::bool_<
                        sizeof(
                            ::lslboost::type_erasure::detail::check_overload(
                                ::lslboost::declval<any&>().
                                    _lslboost_type_erasure_deduce_assign(other)
                            )
                        ) == sizeof(::lslboost::type_erasure::detail::yes)
                    >()
                )
            ) : 0,
    ...
    void _lslboost_type_erasure_assign_impl(
        const Other& other,
        const assignable<T, U>*,
        ::lslboost::mpl::false_)
    {
        ::lslboost::type_erasure::call(assignable<T, U>(), *this, other);
    }
    /** INTERNAL ONLY */
    template<class Other, class U>
    void _lslboost_type_erasure_assign_impl(
    ...
    {
        any temp(other);
        _lslboost_type_erasure_swap(temp);
    }
    /** INTERNAL ONLY */
    template<class Concept2, class Tag2>
    void _lslboost_type_erasure_resolve_assign(const any<Concept2, Tag2>& other)
    {
        _lslboost_type_erasure_assign_impl(
            other,
            false? this->_lslboost_type_erasure_deduce_assign(
            ...
            false? this->_lslboost_type_erasure_deduce_constructor(
                ::lslboost::type_erasure::detail::make_fallback(
                    other,
                    ::lslboost::mpl::bool_<
                        sizeof(
                            ::lslboost::type_erasure::detail::check_overload(
                                ::lslboost::declval<any&>().
                                    _lslboost_type_erasure_deduce_constructor(other)
                            )
                        ) == sizeof(::lslboost::type_erasure::detail::yes)
                    >()
                )
    ...
    void _lslboost_type_erasure_assign_impl(
        ...
        ::lslboost::mpl::true_)
    {
        if(::lslboost::type_erasure::check_match(assignable<T, U>(), *this, other))
        {
            ::lslboost::type_erasure::unchecked_call(assignable<T, U>(), *this, other);
        }
        else
        {
            any temp(other);
    ...
    table_type table;
    ::lslboost::type_erasure::detail::storage data;
};
...
public:
    ...
    typedef Concept _lslboost_type_erasure_concept_type;
    /** INTERNAL ONLY */
    any(const ::lslboost::type_erasure::detail::storage& data_arg,
    ...
    any(U& arg
        ...
        ,  typename ::lslboost::disable_if<
            ::lslboost::mpl::or_<
                ::lslboost::is_const<U>,
                ::lslboost::type_erasure::detail::is_any<U>
            >
        >::type* = 0
#endif
        )
    ...
    {
        data.data = ::lslboost::addressof(arg);
    }
    /**
     * Constructs an @ref any from a reference.
     *
     ...
     */
    any(any<Concept, T>& other)
      : data(::lslboost::type_erasure::detail::access::data(other)),
        table(::lslboost::type_erasure::detail::access::table(other))
    {}
    /**
     * Constructs an @ref any from another reference.
    ...
    any(const any<Concept2, Tag2&>& other
        ...
        , typename ::lslboost::disable_if<
            ::lslboost::mpl::or_<
                ::lslboost::is_same<Concept, Concept2>,
                ::lslboost::is_const<Tag2>
            >
        >::type* = 0
#endif
        )
    ...
    any(any<Concept2, Tag2>& other
        ...
        , typename ::lslboost::disable_if<
            ::lslboost::mpl::or_<
                ::lslboost::is_same<Concept, Concept2>,
                ::lslboost::is_const<typename ::lslboost::remove_reference<Tag2>::type>
            >
        >::type* = 0
#endif
        )
    ...
    any(const any<Concept2, Tag2&>& other, const static_binding<Map>& binding_arg
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::lslboost::disable_if< ::lslboost::is_const<Tag2> >::type* = 0
#endif
        )
      : data(::lslboost::type_erasure::detail::access::data(other)),
        table(::lslboost::type_erasure::detail::access::table(other), binding_arg)
...
private:
    ...
    /** INTERNAL ONLY */
    template<class Other>
    void _lslboost_type_erasure_resolve_assign(Other& other)
    {
        _lslboost_type_erasure_assign_impl(
            other,
            false? this->_lslboost_type_erasure_deduce_assign(
...
class any<Concept, const T&> :
    public ::lslboost::type_erasure::detail::compute_bases<
        ::lslboost::type_erasure::any<Concept, const T&>,
        Concept,
        T
    >::type
{
...
public:
    ...
    {
        data.data = const_cast<void*>(static_cast<const void*>(::lslboost::addressof(arg)));
    }
    /**
     * Constructs an @ref any from a reference.
     *
    ...
    any(const any<Concept2, Tag2>& other
#ifndef BOOST_TYPE_ERASURE_DOXYGEN
        , typename ::lslboost::disable_if< ::lslboost::is_same<Concept, Concept2> >::type* = 0
#endif
        )
      : data(::lslboost::type_erasure::detail::access::data(other)),
        table(
...
public:
    ...
    any(any<Concept, T>&& other)
      : data(::lslboost::type_erasure::detail::access::data(other)),
        table(std::move(::lslboost::type_erasure::detail::access::table(other)))
    {}
    /**
     * Constructs an @ref any from another rvalue reference.
     *
    ...
    any(any<Concept2, Tag2&&>&& other
      ...
      : data(::lslboost::type_erasure::detail::access::data(other)),
        table(
            std::move(::lslboost::type_erasure::detail::access::table(other)),
            ::lslboost::mpl::map<
                ::lslboost::mpl::pair<
                    T,
                    Tag2
    ...
    any(const any<Concept2, Tag2&&>& other, const static_binding<Map>& binding_arg
      ...
      : data(::lslboost::type_erasure::detail::access::data(other)),
        table(std::move(::lslboost::type_erasure::detail::access::table(other)), binding_arg)
    {}
    /**
     * Constructs an @ref any from another @ref any.
     *
