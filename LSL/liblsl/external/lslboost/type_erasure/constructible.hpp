...
struct concept_interface<
    ::lslboost::type_erasure::constructible<Tag(T...)>,
    Base,
    Tag
> : Base
{
    using Base::_lslboost_type_erasure_deduce_constructor;
    ::lslboost::type_erasure::constructible<Tag(T...)>*
    _lslboost_type_erasure_deduce_constructor(
...
#define BOOST_PP_FILENAME_1 <lslboost/type_erasure/constructible.hpp>
...
#define BOOST_TYPE_ERASURE_ARG_DECL(z, n, data)     \
    typename ::lslboost::type_erasure::as_param<          \
        Base,                                       \
        BOOST_PP_CAT(T, n)                          \
    >::type
...
struct concept_interface<
    ::lslboost::type_erasure::constructible<Tag(BOOST_PP_ENUM_PARAMS(N, T))>,
    Base,
    Tag
> : Base
{
