...
#else
    typedef typename ::lslboost::type_erasure::placeholder_of<
        typename T::_lslboost_type_erasure_derived_type
    >::type type;
#endif
};
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct placeholder_of< ::lslboost::type_erasure::any<Concept, T> >
{
    typedef T type;
};
...
/** INTERNAL ONLY */
template<class Concept, class T>
struct placeholder_of< ::lslboost::type_erasure::param<Concept, T> >
{
    typedef T type;
};
