...
#include <lslboost/preprocessor/seq/elem.hpp>
...
#define BOOST_TYPE_ERASURE_MEMBER_ARG(z, n, data)  \
    typename ::lslboost::type_erasure::as_param<Base, BOOST_PP_CAT(A, n)>::type BOOST_PP_CAT(a, n)
...
/** INTERNAL ONLY*/
#define BOOST_TYPE_ERASURE_FORWARD_REBIND1(z, n, data) ::std::forward<typename ::lslboost::type_erasure::as_param<Base, BOOST_PP_CAT(A, n)>::type>(BOOST_PP_CAT(a, n))
/** INTERNAL ONLY*/
 ...
 *
 * \code
 * BOOST_TYPE_ERASURE_MEMBER((lslboost)(has_push_back), push_back, 1)
 * typedef lslboost::has_push_back<void(int), _self> push_back_concept;
 * \endcode
 *
...
#define BOOST_TYPE_ERASURE_MEMBER_FORWARD_REBIND(N) , ::std::forward<typename ::lslboost::type_erasure::as_param<Base, A>::type>(a)...
#define BOOST_TYPE_ERASURE_MEMBER_ENUM_TRAILING_BINARY_PARAMS(N, X, x) , X... x
#define BOOST_TYPE_ERASURE_MEMBER_ENUM_ARGS(N) typename ::lslboost::type_erasure::as_param<Base, A>::type... a
...
#define BOOST_TYPE_ERASURE_MEMBER_II(qual_name, concept_name, member, N)                        \
    ...
    template<class Sig, class T = ::lslboost::type_erasure::_self>                                 \
    struct concept_name;                                                                        \
    ...
    struct concept_interface<                                                                   \
        ...
        typename ::lslboost::enable_if<                                                            \
            ...
            typename ::lslboost::remove_const<T>::type                                             \
        >::type,                                                                                \
        Enable                                                                                  \
    > : Base                                                                                    \
    {                                                                                           \
        typedef void BOOST_PP_CAT(_lslboost_type_erasure_has_member, member);                      \
    ...
    struct concept_interface<                                                                   \
        ...
        typename ::lslboost::enable_if<                                                            \
            ...
            typename ::lslboost::remove_const<T>::type                                             \
        >::type,                                                                                \
        typename Base::BOOST_PP_CAT(_lslboost_type_erasure_has_member, member)> : Base             \
    {                                                                                           \
        using Base::member;                                                                     \
        typename rebind_any<Base, R>::type member(                                              \
            BOOST_TYPE_ERASURE_MEMBER_ENUM_ARGS(N))                                             \
