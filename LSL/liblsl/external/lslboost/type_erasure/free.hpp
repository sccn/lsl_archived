...
#include <lslboost/type_erasure/detail/macro.hpp>
...
struct first_placeholder {
    typedef typename ::lslboost::mpl::eval_if<is_placeholder<T0>,
        ::lslboost::mpl::identity<T0>,
...
struct first_placeholder_index :
    ::lslboost::mpl::eval_if<is_placeholder<T0>,
        ::lslboost::mpl::int_<0>,
        ::lslboost::mpl::next<first_placeholder_index<BOOST_PP_ENUM_SHIFTED_PARAMS(BOOST_TYPE_ERASURE_MAX_ARITY, T)> >
    >::type
{};
...
#define BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE(z, n, data) \
    typename ::lslboost::remove_cv<typename ::lslboost::remove_reference<BOOST_PP_CAT(T, n)>::type>::type

/** INTERNAL ONLY */
#define BOOST_TYPE_ERASURE_FREE_PARAM_TYPE(z, n, data)                      \
    typename ::lslboost::mpl::eval_if_c<(_lslboost_type_erasure_free_p_idx::value == n), \
        ::lslboost::type_erasure::detail::maybe_const_this_param<BOOST_PP_CAT(T, n), Base>,    \
        ::lslboost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>           \
...
#define BOOST_TYPE_ERASURE_FREE_FORWARD_PARAM_I(z, n, data) \
    ::std::forward<typename ::lslboost::mpl::eval_if_c<(_lslboost_type_erasure_free_p_idx::value == n), \
        ::lslboost::type_erasure::detail::maybe_const_this_param<BOOST_PP_CAT(T, n), Base>,    \
        ::lslboost::type_erasure::as_param<Base, BOOST_PP_CAT(T, n)>           \
    >::type>(BOOST_PP_CAT(t, n))
...
#define BOOST_TYPE_ERASURE_FREE_II(qual_name, concept_name, function_name, N)  \
    ...
    struct concept_interface<                                           \
        ...
        Base,                                                           \
        typename ::lslboost::type_erasure::detail::first_placeholder<      \
            BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE, ~)>::type  \
    > : Base {                                                          \
        typedef typename ::lslboost::type_erasure::detail::first_placeholder_index<    \
            BOOST_PP_ENUM(N, BOOST_TYPE_ERASURE_FREE_UNQUALIFIED_PARAM_TYPE, ~)>::type  \
            _lslboost_type_erasure_free_p_idx;                             \
        friend typename ::lslboost::type_erasure::rebind_any<Base, R>::type function_name(  \
...
struct first_placeholder_index<T0, T...> :
    ::lslboost::mpl::eval_if<is_placeholder<T0>,
        ::lslboost::mpl::int_<0>,
        ::lslboost::mpl::next<first_placeholder_index<T...> >
    >::type
{};
...
#define BOOST_TYPE_ERASURE_FREE_II(qual_name, concept_name, function_name, N)  \
    ...
    struct inject ## concept_name<R(T...), Base, index_list<I...> > : Base {\
        typedef typename ::lslboost::type_erasure::detail::first_placeholder_index<    \
            ...
            >::type...                                                  \
        >::type _lslboost_type_erasure_free_p_idx;                         \
        friend typename ::lslboost::type_erasure::rebind_any<Base, R>::type\
        function_name(                                                  \
            typename ::lslboost::mpl::eval_if_c<(_lslboost_type_erasure_free_p_idx::value == I), \
                ::lslboost::type_erasure::detail::maybe_const_this_param<T, Base>, \
                ::lslboost::type_erasure::as_param<Base, T>                \
            >::type... t)                                               \
       {                                                                \
            return ::lslboost::type_erasure::call(                         \
                BOOST_TYPE_ERASURE_QUALIFIED_NAME(qual_name)<R(T...)>(),\
                std::forward<typename ::lslboost::mpl::eval_if_c<(_lslboost_type_erasure_free_p_idx::value == I), \
                    ::lslboost::type_erasure::detail::maybe_const_this_param<T, Base>, \
                    ::lslboost::type_erasure::as_param<Base, T>            \
                >::type>(t)...);                                        \
        }                                                               \
    ...
    struct concept_interface<                                           \
        ...
        Base,                                                           \
        typename ::lslboost::type_erasure::detail::first_placeholder<      \
            typename ::lslboost::remove_cv<typename ::lslboost::remove_reference<T>::type>::type...>::type  \
    > :  inject ## concept_name<R(T...), Base, typename ::lslboost::type_erasure::detail::make_index_list<sizeof...(T)>::type>\
    {};                                                                 \
                                                                        \
    }                                                                   \
    }
 ...
 *
 * \code
 * BOOST_TYPE_ERASURE_FREE((lslboost)(has_to_string), to_string, 1)
 * \endcode
 */
