...
#include <lslboost/tti/gen/member_type_gen.hpp>
#include <lslboost/tti/gen/namespace_gen.hpp>
#include <lslboost/tti/detail/dmem_type.hpp>
#include <lslboost/tti/detail/dnotype.hpp>
...
/**
    ...
    generates a metafunction called "trait" where 'trait' is the macro parameter.
              ...
              template<class BOOST_TTI_TP_T,class BOOST_TTI_TP_MARKER_TYPE = lslboost::tti::detail::notype>
              struct trait
                {
                typedef unspecified type;
                
                typedef BOOST_TTI_TP_MARKER_TYPE lslboost_tti_marker_type;
                };
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_MARKER_TYPE = (optional) a type to use as the marker type.
                                  defaults to the internal lslboost::tti::detail::notype.
                ...
                returns         = 'type' is the inner type of 'name' if the inner type exists
                                  ...
                                  an internal lslboost::tti::detail::notype marker type is used.
                          
                The metafunction also encapsulates the type of the marker type as
                a nested 'lslboost_tti_marker_type'.
...
#define BOOST_TTI_TRAIT_MEMBER_TYPE(trait,name) \
    ...
    struct trait : \
      lslboost::mpl::eval_if \
        ...
        lslboost::mpl::identity<BOOST_TTI_TP_MARKER_TYPE> \
        > \
      { \
      typedef BOOST_TTI_TP_MARKER_TYPE lslboost_tti_marker_type; \
      }; \
  ...
  namespace tti
    ...
    */
    ...
    struct valid_member_type :
      lslboost::mpl::not_
        <
        lslboost::is_same<BOOST_TTI_TP_T,BOOST_TTI_TP_MARKER_TYPE>
        >
      {
      };
    ...
    */
    ...
    struct valid_member_metafunction :
      lslboost::mpl::not_
        <
        lslboost::is_same<typename TTI_METAFUNCTION::type,typename TTI_METAFUNCTION::lslboost_tti_marker_type>
        >
      {
      };
    }
