...
#include <lslboost/tti/gen/has_member_function_gen.hpp>
...
/**
    ...
    generates a metafunction called "trait" where 'trait' is the macro parameter.<br />
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_FS  = (optional) the parameters of the member function as a lslboost::mpl forward sequence
                          if the first parameter is the enclosing type and the member function parameters
                          are not empty.
                
                BOOST_TTI_TP_TAG = (optional) a lslboost::function_types tag to apply to the member function
...
#define BOOST_TTI_TRAIT_HAS_MEMBER_FUNCTION(trait,name) \
  ...
  template<class BOOST_TTI_TP_T,class BOOST_TTI_TP_R = BOOST_TTI_NAMESPACE::detail::deftype,class BOOST_TTI_TP_FS = lslboost::mpl::vector<>,class BOOST_TTI_TP_TAG = lslboost::function_types::null_tag> \
  struct trait \
    { \
    typedef typename \
