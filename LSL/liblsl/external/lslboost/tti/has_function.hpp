...
#include <lslboost/tti/detail/dfunction.hpp>
#include <lslboost/tti/gen/has_function_gen.hpp>
...
/**
    ...
    generates a metafunction called "trait" where 'trait' is the macro parameter.
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_FS  = (optional) the parameters of the function as a lslboost::mpl forward sequence
                          if function parameters are not empty.
                
                BOOST_TTI_TP_TAG = (optional) a lslboost::function_types tag to apply to the function
