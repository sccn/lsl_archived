...
#include <lslboost/tti/gen/has_type_gen.hpp>
#include <lslboost/tti/gen/namespace_gen.hpp>
#include <lslboost/tti/detail/dtype.hpp>
...
/**
  ...
  LookFor<EnclosingType,lslboost::is_same<_,SomeOtherType> >::value is true if MyType is an inner type
...
/**
  ...
  has_type_MyType<EnclosingType,lslboost::is_same<_,SomeOtherType> >::value is true if MyType is an inner type
    of EnclosingType and is the same type as SomeOtherType.
