...
#include <lslboost/tti/detail/dstatic_mem_fun.hpp>
#include <lslboost/tti/gen/has_static_member_function_gen.hpp>
...
/**
    ...
    generates a metafunction called "trait" where 'trait' is the macro parameter.
              ...
              The metafunction types and return:
                ...
                BOOST_TTI_TP_FS  = (optional) the parameters of the static member function as a lslboost::mpl forward sequence
                          if the second parameter is a return type and the function parameters exist.
                
                BOOST_TTI_TP_TAG = (optional) a lslboost::function_types tag to apply to the static member function
...
#define BOOST_TTI_TRAIT_HAS_STATIC_MEMBER_FUNCTION(trait,name) \
  ...
  template<class BOOST_TTI_TP_T,class BOOST_TTI_TP_R,class BOOST_TTI_TP_FS = lslboost::mpl::vector<>,class BOOST_TTI_TP_TAG = lslboost::function_types::null_tag> \
  struct trait \
    { \
    typedef typename \
