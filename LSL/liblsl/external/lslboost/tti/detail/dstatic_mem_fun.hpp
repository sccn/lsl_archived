...
#include <lslboost/tti/detail/dtfunction.hpp>
...
#define BOOST_TTI_DETAIL_TRAIT_IMPL_HAS_STATIC_MEMBER_FUNCTION(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_ihsmf) \
    ...
    \
    typedef lslboost::mpl::bool_<sizeof(chkt<BOOST_TTI_DETAIL_TP_T>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::lslboost::type_traits::yes_type)> type; \
    }; \
/**/
  ...
  struct BOOST_PP_CAT(trait,_detail_hsmf_op) : \
    BOOST_PP_CAT(trait,_detail_ihsmf) \
      ...
      lslboost::mpl::eval_if \
        ...
        lslboost::mpl::and_ \
          < \
          lslboost::function_types::is_function<BOOST_TTI_DETAIL_TP_R>, \
          ...
          >, \
        lslboost::mpl::identity<BOOST_TTI_DETAIL_TP_R>, \
