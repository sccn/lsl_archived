...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_MEMBER_DATA_OP(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hsd_op) \
    ...
    static ::lslboost::type_traits::yes_type check2(BOOST_TTI_DETAIL_TP_V *); \
    \
    template<typename BOOST_TTI_DETAIL_TP_U,typename BOOST_TTI_DETAIL_TP_V> \
    ...
    struct ttc_sd \
      { \
      typedef lslboost::mpl::bool_<sizeof(has_matching_member<BOOST_TTI_DETAIL_TP_V,BOOST_TTI_DETAIL_TP_U>(0))==sizeof(::lslboost::type_traits::yes_type)> type; \
      }; \
    \
...
#define BOOST_TTI_DETAIL_TRAIT_HAS_STATIC_MEMBER_DATA_OP(trait,name) \
  ...
  struct BOOST_PP_CAT(trait,_detail_hsd_op) \
    ...
    \
    typedef lslboost::mpl::bool_<(!lslboost::function_types::is_function<BOOST_TTI_DETAIL_TP_TYPE>::value) && (sizeof(chkt<BOOST_TTI_DETAIL_TP_T>(BOOST_TTI_DETAIL_NULLPTR))==sizeof(::lslboost::type_traits::yes_type))> type; \
    }; \
/**/
