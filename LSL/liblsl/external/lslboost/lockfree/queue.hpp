...
typedef parameter::parameters<lslboost::parameter::optional<tag::allocator>,
                              lslboost::parameter::optional<tag::capacity>
                             > queue_signature;
 ...
 *
 *  \b Policies:
 *  - \ref lslboost::lockfree::fixed_sized, defaults to \c lslboost::lockfree::fixed_sized<false> \n
 ...
 *
 *  - \ref lslboost::lockfree::capacity, optional \n
 ...
 *
 *  - \ref lslboost::lockfree::allocator, defaults to \c lslboost::lockfree::allocator<std::allocator<void>> \n
...
private:
    ...
    BOOST_STATIC_ASSERT((lslboost::has_trivial_destructor<T>::value));
#endif

#ifdef BOOST_HAS_TRIVIAL_ASSIGN
    BOOST_STATIC_ASSERT((lslboost::has_trivial_assign<T>::value));
#endif
...
public:
    ...
    /** \copydoc lslboost::lockfree::stack::reserve
     * */
    ...
    /** \copydoc lslboost::lockfree::stack::reserve_unsafe
     * */
...
public:
    ...
    /// \copydoc lslboost::lockfree::queue::consume_one(Functor & rhs)
    template <typename Functor>
    ...
    /// \copydoc lslboost::lockfree::queue::consume_all(Functor & rhs)
    template <typename Functor>
