 ...
 *  \b Policies:
 *
 *  - \c lslboost::lockfree::fixed_sized<>, defaults to \c lslboost::lockfree::fixed_sized<false> <br>
 ...
 *
 *  - \c lslboost::lockfree::allocator<>, defaults to \c lslboost::lockfree::allocator<std::allocator<void>> <br>
...
private:
    ...
    BOOST_STATIC_ASSERT((mpl::if_c<has_capacity,
                                   mpl::bool_<capacity - 1 < lslboost::integer_traits<lslboost::uint16_t>::const_max>,
                                   mpl::true_
                                  >::type::value));
...
public:
    ...
    /// \copydoc lslboost::lockfree::stack::consume_one(Functor & rhs)
    template <typename Functor>
    ...
    /// \copydoc lslboost::lockfree::stack::consume_all(Functor & rhs)
    template <typename Functor>
