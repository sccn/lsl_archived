...
struct fixed_sized:
    lslboost::parameter::template_keyword<tag::fixed_sized, lslboost::mpl::bool_<IsFixedSized> >
{};
...
struct capacity:
    lslboost::parameter::template_keyword<tag::capacity, lslboost::mpl::size_t<Size> >
{};
...
struct allocator:
    lslboost::parameter::template_keyword<tag::allocator, Alloc>
{};
