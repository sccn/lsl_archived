...
#include <lslboost/locale/config.hpp>
#ifdef BOOST_MSVC
#  pragma warning(push)
#  pragma warning(disable : 4275 4251 4231 4660)
#endif
#include <lslboost/locale/info.hpp>
#include <lslboost/locale/encoding_errors.hpp>
#include <lslboost/locale/encoding_utf.hpp>
    ...
    namespace locale {
        ...
        namespace conv {
                                ...
                                method_type how=default_method)
            {
                ...
                return lslboost::locale::conv::between(text,end,to_encoding,from_encoding,how);
            }
            ...
            std::string between(std::string const &text,
                                ...
                                method_type how=default_method)
            {
                return lslboost::locale::conv::between(text.c_str(),text.c_str()+text.size(),to_encoding,from_encoding,how);
            }
