...
#include <lslboost/config.hpp> // BOOST_STATIC_CONSTANT.
...
namespace lslboost { namespace ptr_container_detail { namespace move_ptrs {
...
} } }         // End namespaces ptr_container_detail, move_ptrs, lslboost.
