...
// "http://aspn.activestate.com/ASPN/Mail/Message/Attachments/lslboost/
...
#include <lslboost/config.hpp> // Member template friends, put size_t in std.
#include <cstddef>          // size_t
#include <lslboost/compressed_pair.hpp> 
#include <lslboost/ptr_container/detail/default_deleter.hpp>       
#include <lslboost/ptr_container/detail/is_convertible.hpp>       
#include <lslboost/ptr_container/detail/move.hpp>       
...
namespace lslboost { namespace ptr_container_detail {
...
private:
    ...
    typedef lslboost::compressed_pair<element_type*, Deleter> impl_type;
