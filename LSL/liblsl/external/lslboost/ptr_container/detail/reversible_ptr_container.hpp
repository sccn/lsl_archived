...
#include <lslboost/ptr_container/detail/throw_exception.hpp>
#include <lslboost/ptr_container/detail/scoped_deleter.hpp>
#include <lslboost/ptr_container/detail/static_move_ptr.hpp>
#include <lslboost/ptr_container/exception.hpp>
#include <lslboost/ptr_container/clone_allocator.hpp>
#include <lslboost/ptr_container/nullable.hpp>
...
namespace ptr_container_detail
{
    ...
    public: // typedefs
        ...
        typedef  BOOST_DEDUCED_TYPENAME Config::const_iterator
                                   const_iterator;
        typedef  lslboost::reverse_iterator< iterator > 
                                   reverse_iterator;  
        typedef  lslboost::reverse_iterator< const_iterator >     
    ...
    public: // modifiers
        ...
        {
            return erase( lslboost::begin(r), lslboost::end(r) );
        }
    ...
    public: // access interface
        ...
        { 
            ...
            return lslboost::ptr_container_detail::move( ptr ); 
        }
        ...
        { 
            ...
            return lslboost::ptr_container_detail::move( old );
        }
...
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    ...
    {                                               \
        return lslboost::ptr_container_detail::move(base_type::release(i)); \
    }                                               
#else
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
