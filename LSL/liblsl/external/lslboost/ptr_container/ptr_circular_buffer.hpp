...
#include <lslboost/ptr_container/ptr_sequence_adapter.hpp>
...
namespace lslboost
{
    ...
    class ptr_circular_buffer : public 
        ptr_sequence_adapter< T, 
                              lslboost::circular_buffer<void*,Allocator>, 
                              CloneAllocator >
    {  
        ...
        typedef lslboost::circular_buffer<void*,Allocator>         circular_buffer_type;
    ...
    public: // circular buffer functions
        ...
        {
            rinsert( before, lslboost::begin(r), lslboost::end(r) );
        }
        ...
        {
            return rerase( lslboost::begin(r), lslboost::end(r) );
        }
