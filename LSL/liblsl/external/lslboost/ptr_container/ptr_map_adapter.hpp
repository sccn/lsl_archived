...
#include <lslboost/ptr_container/detail/map_iterator.hpp>
#include <lslboost/ptr_container/detail/associative_ptr_container.hpp>
#include <lslboost/ptr_container/detail/meta_functions.hpp>
...
namespace ptr_container_detail
{
    ...
    public:
        ...
        { 
            ...
            return lslboost::ptr_container::move( old );
        }
            ...
            {                                            
                if( this->find( first->first ) == this->end() )
                {
                    ...
                    this->safe_insert( p.first, 
                                       lslboost::ptr_container::move( ptr ) );
                                                           // strong, commit 
                }
                ++first;                                                      
            }                                                                 
    ...
    public:
        ...
        {
            insert( lslboost::begin(r), lslboost::end(r) );
        }
    ...
    public:
        ...
        {
            return transfer( lslboost::begin(r), lslboost::end(r), from );
        }
