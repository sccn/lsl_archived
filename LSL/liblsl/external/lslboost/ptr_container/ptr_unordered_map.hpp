...
namespace lslboost
{
    ...
    < 
        class Key, 
        class T, 
        class Hash           = lslboost::hash<Key>,
        class Pred           = std::equal_to<Key>,
        class CloneAllocator = heap_clone_allocator,
        class Allocator      = std::allocator< std::pair<const Key,void*> >
    >
    class ptr_unordered_map : 
        public ptr_map_adapter<T,lslboost::unordered_map<Key,void*,Hash,Pred,Allocator>,
                               CloneAllocator,false>
    {
        typedef ptr_map_adapter<T,lslboost::unordered_map<Key,void*,Hash,Pred,Allocator>,
                               CloneAllocator,false>
            base_type;
    ...
    class ptr_unordered_multimap : 
        public ptr_multimap_adapter<T,lslboost::unordered_multimap<Key,void*,Hash,Pred,Allocator>,
                                    CloneAllocator,false>
    {
        typedef ptr_multimap_adapter<T,lslboost::unordered_multimap<Key,void*,Hash,Pred,Allocator>,
                                     CloneAllocator,false>
            base_type;
