...
#include <lslboost/ptr_container/ptr_set_adapter.hpp>
...
namespace lslboost
{
    ...
    class ptr_unordered_set : 
        public ptr_set_adapter< Key, 
                                lslboost::unordered_set<void*,void_ptr_indirect_fun<Hash,Key>,
    ...
    class ptr_unordered_multiset : 
          public ptr_multiset_adapter< Key, 
                                lslboost::unordered_multiset<void*,void_ptr_indirect_fun<Hash,Key>,
                                                                void_ptr_indirect_fun<Pred,Key>,Allocator>,
                                            CloneAllocator, false >
    {
