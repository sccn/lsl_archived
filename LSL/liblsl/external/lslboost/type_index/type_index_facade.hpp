...
// Forward declaration from #include <lslboost/functional/hash_fwd.hpp>
namespace lslboost {
...
public:
    ...
    /// \note <lslboost/functional/hash.hpp> has to be included if this function is used.
    inline std::size_t hash_code() const BOOST_NOEXCEPT {
        const char* const name_raw = derived().raw_name();
        return lslboost::hash_range(name_raw, name_raw + std::strlen(name_raw));
    }
...
protected:
    ...
    /// lslboost::typeindex::type_id() will call this method, if Derived has same type as lslboost::typeindex::type_index.
    ///
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// lslboost::typeindex::type_id_with_cvr() will call this method, if Derived has same type as lslboost::typeindex::type_index.
    ///
    /// \b Override: This function \b may be redefined and made public in Derived class. Overrides \b must not throw. 
    ...
    /// This is a factory method that is used to create instances of Derived classes.
    /// lslboost::typeindex::type_id_runtime(const T&) will call this method, if Derived has same type as lslboost::typeindex::type_index.
    ///
