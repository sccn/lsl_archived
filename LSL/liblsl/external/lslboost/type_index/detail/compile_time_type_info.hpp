...
/// @endcond
    ...
    /* Nothing to document. All the macro docs are moved to <lslboost/type_index.hpp> */
...
namespace lslboost { namespace typeindex { namespace detail { 
    ...
    inline const char* skip_begining_runtime(const char* begin, lslboost::mpl::false_) BOOST_NOEXCEPT {
        return begin;
    }

    template <std::size_t ArrayLength>
    inline const char* skip_begining_runtime(const char* begin, lslboost::mpl::true_) BOOST_NOEXCEPT {
