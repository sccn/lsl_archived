...
/// \brief Contains BOOST_TYPE_INDEX_REGISTER_CLASS macro implementation that uses lslboost::typeindex::stl_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CLASS                                                                                     \
    virtual const lslboost::typeindex::stl_type_index::type_info_t& lslboost_type_index_type_id_runtime_() const BOOST_NOEXCEPT { \
        return lslboost::typeindex::detail::stl_construct_typeid_ref(this);                                                    \
    }                                                                                                                       \
/**/
/// @endcond
