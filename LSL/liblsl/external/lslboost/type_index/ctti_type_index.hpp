...
/// \brief Contains lslboost::typeindex::ctti_type_index class.
///
...
#include <lslboost/type_index/detail/compile_time_type_info.hpp>
...
inline ctti_type_index ctti_type_index::type_id_runtime(const T& variable) BOOST_NOEXCEPT {
    return variable.lslboost_type_index_type_id_runtime_();
}
