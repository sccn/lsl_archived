...
#   include <lslboost/mpl/advance.hpp>
...
#   include <lslboost/function_types/detail/classifier.hpp>
#endif
...
#     include <lslboost/mpl/vector/vector30.hpp>
...
#include <lslboost/function_types/detail/class_transform.hpp>
...
#   define BOOST_FT_variations BOOST_FT_pointer
    ...
    struct components_impl<T C::*, L>
      : detail::retagged_if
        < detail::components_impl<typename lslboost::remove_cv<T>::type *, L>
    ...
    template<typename T> struct cv_tag_mfp
      : detail::cv_tag_mfp_impl
        < ::lslboost::function_types::detail::encode_mfp_cv<T>::value >
    { };
    ...
    template<typename T, typename D, typename L> struct bcc_class_transform 
      : bcc_class_transform_impl
        < typename decode_cv
          < T
          , ::lslboost::function_types::detail::encode_mfp_cv<D>::value 
          >::type
        , L
        > 
    { };
...
#define BOOST_FT_al_path lslboost/function_types/detail/components_impl
...
#include <lslboost/function_types/detail/components_as_mpl_sequence.hpp>
#include <lslboost/function_types/detail/retag_default_cc.hpp>
