...
#   include <lslboost/preprocessor/iteration/self.hpp>

#   include <lslboost/function_types/detail/encoding/def.hpp>
#   include <lslboost/function_types/detail/encoding/aliases_def.hpp>
...
#   include BOOST_PP_ASSIGN_SLOT(1)
    ...
    BOOST_STATIC_CONSTANT(bits_t, value = (
        (::lslboost::function_types::detail::bits<Tag>::value & BOOST_FT_default_cc) 
      | (::lslboost::function_types::detail::bits<RefTag>::value & BOOST_PP_SLOT(1))
    ));
  };
  ...
  template<class Tag, class RefTag> struct retag_default_cc
    : detail::compound_tag
      < Tag, detail::default_cc_tag< 
          ::lslboost::function_types::detail::selector_bits<Tag,RefTag>::value > >
  { };
...
#   define BOOST_FT_self \
      <lslboost/function_types/detail/pp_retag_default_cc/master.hpp>
...
#   include <lslboost/function_types/detail/encoding/aliases_undef.hpp>
#   include <lslboost/function_types/detail/encoding/undef.hpp>
