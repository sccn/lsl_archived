...
struct cv_code
{
  ...
  BOOST_STATIC_CONSTANT(std::size_t, value = 
      sizeof(::lslboost::function_types::detail::switch_cv(
         ::lslboost::function_types::detail::ref_to_ptr(_t) ) ));
};

template<typename T> struct cv_traits 
{
  typedef typename lslboost::function_types::detail::cv_tag_impl< 
    ::lslboost::function_types::detail::cv_code<T>::value >::type
  tag;
