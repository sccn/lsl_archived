...
#include <lslboost/function_types/detail/cv_traits.hpp>
...
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::lslboost::function_types::detail::decode_bits<Bits>::flags
    , ::lslboost::function_types::detail::decode_bits<Bits>::cc_id
    , ::lslboost::mpl::size<Seq>::value
    >
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::lslboost::function_types::detail::bits
...
#define BOOST_FT_al_path lslboost/function_types/detail/synthesize_impl
