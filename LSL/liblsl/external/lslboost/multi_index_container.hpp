...
#include <lslboost/multi_index/detail/adl_swap.hpp>
#include <lslboost/multi_index/detail/base_type.hpp>
#include <lslboost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <lslboost/multi_index/detail/converter.hpp>
#include <lslboost/multi_index/detail/header_holder.hpp>
#include <lslboost/multi_index/detail/has_tag.hpp>
...
#include <lslboost/multi_index/detail/archive_constructed.hpp>
#include <lslboost/multi_index/detail/serialization_version.hpp>
...
#include <lslboost/multi_index/detail/invariant_assert.hpp>
...
class multi_index_container:
  private ::lslboost::base_from_member<
...
private:
  ...
  typedef typename
  lslboost::detail::allocator::rebind_to<
      Allocator,
      typename super::node_type
  >::type                                         node_allocator;
  typedef ::lslboost::base_from_member<
...
public:
  ...
  /* As per http://www.lslboost.org/doc/html/move/emulation_limitations.html
    ...
    BOOST_TRY{
      ...
      BOOST_TRY{
        ...
        if(res==x){
          ...
          lslboost::detail::allocator::destroy(&x->value());
          deallocate_node(x);
          return std::pair<node_type*,bool>(res,false);
        }
      }
...
>
typename ::lslboost::multi_index::index<
  ...
  BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Tag))
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::lslboost::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::lslboost::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
  BOOST_APPEND_EXPLICIT_TEMPLATE_TYPE(Tag))
 ...
 * lslboost::serialization::collection_size_type.
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  lslboost::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
...
/* Associated global functions are promoted to namespace lslboost, except
