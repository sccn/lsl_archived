...
#include <lslboost/exception/to_string_stub.hpp>
#include <lslboost/exception/detail/error_info_impl.hpp>
...
lslboost
    ...
    exception_detail
        ...
        error_info_container_impl:
            ...
            friend class lslboost::exception;
        ...
        template <class T>
        struct
        derives_lslboost_exception
            {
            enum e { value = (sizeof(dispatch_lslboost_exception((T*)0))==sizeof(large_size)) };
            };
        }

    template <class E,class Tag,class T>
    inline
    typename enable_if<exception_detail::derives_lslboost_exception<E>,E const &>::type
