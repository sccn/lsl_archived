...
lslboost
    ...
    exception_detail
        {
        std::string diagnostic_information_impl( lslboost::exception const *, std::exception const *, bool );
        }
...
lslboost
    ...
    exception_detail
        ...
        inline
        std::string
        diagnostic_information_impl( lslboost::exception const * be, std::exception const * se, bool with_what )
            {
            if( !be && !se )
    ...
    diagnostic_information( T const & e )
        {
        return exception_detail::diagnostic_information_impl(exception_detail::get_lslboost_exception(&e),exception_detail::get_std_exception(&e),true);
        }
