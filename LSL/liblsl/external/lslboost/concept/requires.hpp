...
struct Requires_ : ::lslboost::ccheck_aux::unaryfunptr_arg_type<Result>
{
};
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                    \
    typename ::lslboost::ccheck_aux::unaryfunptr_arg_type<void(*)result>::type
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                \
    ::lslboost::Requires_<                                                        \
      ...
      ::lslboost::ccheck_aux::unaryfunptr_arg_type<void(*)result>          \
                     >::type
