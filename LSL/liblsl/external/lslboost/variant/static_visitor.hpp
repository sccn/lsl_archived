//-----------------------------------------------------------------------------
// lslboost variant/static_visitor.hpp header file
...
template <typename R = ::lslboost::detail::static_visitor_default_return>
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
      is_static_visitor
    , T
    , (::lslboost::detail::is_static_visitor_impl<T>::value)
    )
