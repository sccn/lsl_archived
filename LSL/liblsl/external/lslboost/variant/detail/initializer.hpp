//-----------------------------------------------------------------------------
// lslboost variant/detail/initializer.hpp header file
...
struct make_initializer_node
{
    ...
    private: // helpers, for metafunction result (below)
        ...
        public: // static functions
            ...
            {
                typedef typename lslboost::detail::make_reference_content<
                      recursive_enabled_T
                    >::type internal_T;
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::lslboost::mpl::iter_fold< \
          mpl_seq \
        , ::lslboost::mpl::pair< \
              ::lslboost::detail::variant::initializer_root \
            , ::lslboost::mpl::int_<0> \
            > \
        , ::lslboost::mpl::protect< \
              ::lslboost::detail::variant::make_initializer_node \
            > \
        >::type::first \
    /**/
...
#   else // MSVC7 and below
    ...
    #define BOOST_VARIANT_AUX_PP_INITIALIZER_ENUM_PARAM_TYPE(z,N,T) \
        ::lslboost::call_traits< \
              ::lslboost::unwrap_recursive<BOOST_PP_CAT(T,N)>::type \
            >::param_type \
        /**/
...
#define BOOST_VARIANT_AUX_INITIALIZER_T( mpl_seq, typename_base ) \
    ::lslboost::detail::variant::preprocessor_list_initializer< \
