//-----------------------------------------------------------------------------
// lslboost variant/detail/apply_visitor_binary.hpp header file
...
#include "lslboost/variant/detail/apply_visitor_unary.hpp"
...
public: // visitor interfaces
    ...
    operator()(Value1& value1)
    {
        ...
        return lslboost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::lslboost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2
        > unwrapper(visitor, visitable2);

    return lslboost::apply_visitor(unwrapper, visitable1);
}
