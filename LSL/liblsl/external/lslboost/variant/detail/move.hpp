//-----------------------------------------------------------------------------
// lslboost variant/detail/move.hpp header file
...
{
    T tmp( lslboost::detail::variant::move(lhs) );
    lhs = lslboost::detail::variant::move(rhs);
    rhs = lslboost::detail::variant::move(tmp);
}
