//-----------------------------------------------------------------------------
// lslboost variant/detail/visitation_impl.hpp header file
...
#include "lslboost/variant/detail/cast_storage.hpp"
...
visitation_impl_invoke(int, Visitor&, VoidPtrCV, apply_visitor_unrolled*, NBF, long)
{
    ...
    return ::lslboost::detail::variant::forced_return< result_type >();
}
