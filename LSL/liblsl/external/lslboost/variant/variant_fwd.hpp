//-----------------------------------------------------------------------------
// lslboost variant/variant_fwd.hpp header file
...
#include "lslboost/blank_fwd.hpp"
...
//
// Exposes a lslboost::variant with recursive_variant_ tags (below) substituted
// with the variant itself (wrapped as needed with lslboost::recursive_wrapper).
//
