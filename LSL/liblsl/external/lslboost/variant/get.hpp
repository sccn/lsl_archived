//-----------------------------------------------------------------------------
// lslboost variant/get.hpp header file
...
public: // std::exception implementation
    ...
    {
        return "lslboost::bad_get: "
               "failed value get using lslboost::get";
    }
...
public: // visitor interfaces
    ...
    {
        return lslboost::addressof(operand);
    }
...
get(
      lslboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
...
get(
      const lslboost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
      BOOST_VARIANT_AUX_GET_EXPLICIT_TEMPLATE_TYPE(U)
    )
{
