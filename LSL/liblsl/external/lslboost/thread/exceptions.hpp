...
namespace lslboost
{
    ...
    public:
          ...
          : base_type(system::errc::resource_unavailable_try_again, "lslboost::thread_resource_error")
          {}
    ...
    public:
          ...
          : base_type(system::errc::invalid_argument, "lslboost::unsupported_thread_option")
          {}
    ...
    public:
        ...
        : base_type(system::errc::invalid_argument, "lslboost::invalid_thread_argument")
        {}
    ...
    public:
          ...
          : base_type(system::errc::permission_denied, "lslboost::thread_permission_error")
          {}
