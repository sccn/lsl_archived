...
#include <lslboost/thread/lock_traits.hpp>
#include <lslboost/thread/lock_options.hpp>
#include <lslboost/thread/lockable_concepts.hpp>
...
namespace lslboost
{
  ...
  private:
    ...
    mutex_type& mtx;
    lslboost::chrono::system_clock::time_point t;
    lslboost::chrono::system_clock::duration d;
  };
