...
namespace detail {
  ...
  public:
      ...
      {
          _elements.push_back(lslboost::move(element));
          std::push_heap(_elements.begin(), _elements.end(), _compare);
      }
      ...
      Type pull()
      {
          Type result = lslboost::move(_elements.front());
          pop();
...
namespace concurrent
{
  ...
  class sync_priority_queue
    : public detail::sync_queue_base<ValueType, lslboost::detail::priority_queue<ValueType,Container,Compare> >
  {
    typedef detail::sync_queue_base<ValueType, lslboost::detail::priority_queue<ValueType,Container,Compare> >  super;
  ...
  {
    super::throw_if_closed(lk);
    super::data_.push(lslboost::move(elem));
    super::notify_not_empty_if_needed(lk);
  }
  template <class T, class Container,class Cmp>
