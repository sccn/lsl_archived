    ...
    public:
        ...
        bool try_lock()
        {
            ...
            if(res && (res!=EBUSY))
            {
                ...
                //lslboost::throw_exception(lock_error(res,"lslboost: mutex try_lock failed in pthread_mutex_trylock"));
                BOOST_ASSERT_MSG(false ,"lslboost: mutex try_lock failed in pthread_mutex_trylock");
                return false;
            }
