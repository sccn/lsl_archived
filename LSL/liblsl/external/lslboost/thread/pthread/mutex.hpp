  ...
  namespace posix {
    ...
    public:
        ...
        void lock()
        {
            ...
            if (res)
            {
                lslboost::throw_exception(lock_error(res,"lslboost: mutex lock failed in pthread_mutex_lock"));
            }
        }
...
//            if (res)
//            {
//                lslboost::throw_exception(lock_error(res,"lslboost: mutex unlock failed in pthread_mutex_unlock"));
//            }
        }
...
//            }
    ...
    public:
        ...
        {
            struct timespec const ts=lslboost::detail::to_timespec(abs_time);
