...
namespace lslboost
{
    ...
    private:
        ...
        state_data state;
        lslboost::mutex state_change;
        lslboost::condition_variable shared_cond;
        lslboost::condition_variable exclusive_cond;
        lslboost::condition_variable upgrade_cond;
    ...
    public:
        ...
        {
#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            lslboost::this_thread::disable_interruption do_not_disturb;
#endif
            lslboost::unique_lock<lslboost::mutex> lk(state_change);
