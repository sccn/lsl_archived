...
//#include <lslboost/detail/winapi/synchronization.hpp>
#include <algorithm>
...
#define _InterlockedCompareExchange InterlockedCompareExchange
...
#else
                    ::lslboost::detail::win32::Sleep(0);
#endif
                }
                else
                {
#if BOOST_PLAT_WINDOWS_RUNTIME
                    ::lslboost::detail::win32::WaitForSingleObjectEx(::lslboost::detail::win32::GetCurrentThread(), milliseconds, 0); 
#else
                    ::lslboost::detail::win32::Sleep(milliseconds);
#endif
                }
            }
            ...
            public:
                ...
                {
                    BOOST_ASSERT(m_completionHandle != ::lslboost::detail::win32::invalid_handle_value);
