    ...
    public:
        ...
        bool timed_lock_shared(lslboost::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                unsigned long const res=detail::win32::WaitForSingleObject(semaphores[unlock_sem],::lslboost::detail::get_milliseconds_until(wait_until));
        ...
        bool timed_lock(lslboost::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                #endif
                unsigned long const wait_res=detail::win32::WaitForMultipleObjects(2,semaphores,wait_all,::lslboost::detail::get_milliseconds_until(wait_until));
