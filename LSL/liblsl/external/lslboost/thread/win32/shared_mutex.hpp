    ...
    public:
            ...
            for(;;)
            {
                ...
                for(;;)
                {
                    ...
                    if(new_state.exclusive || new_state.exclusive_waiting_blocked)
                    {
                        ...
                        {
                            lslboost::throw_exception(lslboost::lock_error());
                        }
                    }
                    else
                    {
                ...
                unsigned long const res=detail::win32::WaitForSingleObjectEx(semaphores[unlock_sem],::lslboost::detail::get_milliseconds_until(wait_until), 0);
        ...
        bool timed_lock(lslboost::system_time const& wait_until)
        {
            for(;;)
            {
                ...
                #endif
                unsigned long const wait_res=detail::win32::WaitForMultipleObjectsEx(2,semaphores,wait_all,::lslboost::detail::get_milliseconds_until(wait_until), 0);
