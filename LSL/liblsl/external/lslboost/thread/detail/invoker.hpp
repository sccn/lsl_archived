...
#include <lslboost/thread/detail/variadic_header.hpp>
...
namespace lslboost
{
  namespace detail
  {
    ...
    public:
      ...
      : f_(lslboost::forward<F>(f), lslboost::forward<As>(args)...)
      {}

      BOOST_SYMBOL_VISIBLE
      invoker(BOOST_THREAD_RV_REF(invoker) f) : f_(lslboost::move(BOOST_THREAD_RV(f).f_))
      {}
      ...
      {
        f_ = lslboost::move(BOOST_THREAD_RV(f).f_);
      }
    ...
    private:
      ...
      {
        return invoke(lslboost::move(csbl::get<0>(f_)), lslboost::move(csbl::get<Indices>(f_))...);
      }
    };
    ...
    public:
      ...
      BOOST_SYMBOL_VISIBLE
      invoker_ret(BOOST_THREAD_RV_REF(invoker_ret) f) : f_(lslboost::move(BOOST_THREAD_RV(f).f_))
      {}
    ...
    private:
      ...
      execute(tuple_indices<Indices...>)
      {
        return invoke<R>(lslboost::move(csbl::get<0>(f_)), lslboost::move(csbl::get<Indices>(f_))...);
      }
    };
...
#define BOOST_THREAD_FWD_PARAM(z, n, unused) , lslboost::forward<Arg##n>(arg##n)
#define BOOST_THREAD_FWD_PARAM_A(z, n, unused) , lslboost::forward<A##n>(arg##n)
#define BOOST_THREAD_DCL(z, n, unused) Arg##n v##n;
#define BOOST_THREAD_MOVE_PARAM(z, n, unused) , v##n(lslboost::move(arg##n))
#define BOOST_THREAD_FORWARD_PARAM_A(z, n, unused) , v##n(lslboost::forward<A##n>(arg##n))
#define BOOST_THREAD_MOVE_RHS_PARAM(z, n, unused) , v##n(lslboost::move(x.v##n))
#define BOOST_THREAD_MOVE_DCL(z, n, unused) , lslboost::move(v##n)
#define BOOST_THREAD_MOVE_DCL_T(z, n, unused) BOOST_PP_COMMA_IF(n) lslboost::move(v##n)
...
#define BOOST_THREAD_ASYNC_FUNCT(z, n, unused) \
    ...
    public:
      ...
      : fp_(lslboost::move(BOOST_THREAD_RV(f).fp))
      , v0_(lslboost::move(BOOST_THREAD_RV(f).v0_))
      , v1_(lslboost::move(BOOST_THREAD_RV(f).v1_))
      , v2_(lslboost::move(BOOST_THREAD_RV(f).v2_))
      , v3_(lslboost::move(BOOST_THREAD_RV(f).v3_))
      , v4_(lslboost::move(BOOST_THREAD_RV(f).v4_))
      , v5_(lslboost::move(BOOST_THREAD_RV(f).v5_))
      , v6_(lslboost::move(BOOST_THREAD_RV(f).v6_))
      , v7_(lslboost::move(BOOST_THREAD_RV(f).v7_))
      , v8_(lslboost::move(BOOST_THREAD_RV(f).v8_))
      {}
...
#include <lslboost/thread/detail/variadic_footer.hpp>
