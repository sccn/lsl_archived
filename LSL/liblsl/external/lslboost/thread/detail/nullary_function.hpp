...
#include <lslboost/thread/csbl/memory/shared_ptr.hpp>
...
namespace lslboost
{
  namespace detail
  {
    ...
    public:
      ...
      impl(new impl_type<typename decay<F>::type>(thread_detail::decay_copy(lslboost::forward<F>(f))))
      {}
