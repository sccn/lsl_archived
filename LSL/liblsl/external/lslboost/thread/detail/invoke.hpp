...
#define BOOST_THREAD_PROVIDES_INVOKE
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1)
        -> decltype((lslboost::forward<A0>(a0).*f)(lslboost::forward<Args>(a1)))
    {
        return (lslboost::forward<A0>(a0).*f)(lslboost::forward<Args>(a1));
    }
    ...
    invoke(BOOST_THREAD_RV_REF(Fp) f, BOOST_THREAD_RV_REF(A0) a0, BOOST_THREAD_RV_REF(A1) a1, BOOST_THREAD_RV_REF(A2) a2)
        -> decltype((lslboost::forward<A0>(a0).*f)(lslboost::forward<Args>(a1), lslboost::forward<Args>(a2)))
    {
        return (lslboost::forward<A0>(a0).*f)(lslboost::forward<Args>(a1), lslboost::forward<Args>(a2));
    }
