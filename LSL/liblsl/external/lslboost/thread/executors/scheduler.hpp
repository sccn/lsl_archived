...
namespace lslboost
{
  namespace executors
  {
    ...
    resubmit(Executor& ex, BOOST_THREAD_FWD_REF(Function) funct) {
      return resubmitter<Executor, typename decay<Function>::type >(ex, lslboost::move(funct));
    }
    ...
    public:
      ...
      void submit(BOOST_THREAD_FWD_REF(Work) w)
      {
        ...
        sch.submit_at(resubmit(ex,lslboost::forward<Work>(w)), tp);
      }
    ...
    public:
      ...
      void submit(BOOST_THREAD_FWD_REF(Work) w)
      {
        ...
        sch.submit_at(lslboost::forward<Work>(w), tp);
      }
