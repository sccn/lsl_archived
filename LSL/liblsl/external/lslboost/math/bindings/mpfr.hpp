...
{
   return lslboost::math::tools::real_cast<int>(lslboost::math::round(x, pol));
}

template <class Policy>
inline long lround(mpfr_class const& x, const Policy& pol)
{
   return lslboost::math::tools::real_cast<long>(lslboost::math::round(x, pol));
}

template <class Policy>
inline long long llround(mpfr_class const& x, const Policy& pol)
{
   return lslboost::math::tools::real_cast<long long>(lslboost::math::round(x, pol));
}

template <class Policy>
inline int itrunc(mpfr_class const& x, const Policy& pol)
{
   return lslboost::math::tools::real_cast<int>(lslboost::math::trunc(x, pol));
}

template <class Policy>
inline long ltrunc(mpfr_class const& x, const Policy& pol)
{
   return lslboost::math::tools::real_cast<long>(lslboost::math::trunc(x, pol));
}

template <class Policy>
inline long long lltrunc(mpfr_class const& x, const Policy& pol)
{
   return lslboost::math::tools::real_cast<long long>(lslboost::math::trunc(x, pol));
}
