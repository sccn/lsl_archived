...
public:
   ...
   RR(lslboost::ulong_long_type c)
   {
      assign_large_int(c);
   }
   RR(lslboost::long_long_type c)
   {
      assign_large_int(c);
   }
#endif
...
#ifdef BOOST_HAS_LONG_LONG
   RR& operator=(lslboost::long_long_type c) { assign_large_int(c); return *this; }
   RR& operator=(lslboost::ulong_long_type c) { assign_large_int(c); return *this; }
#endif
...
template<>
inline int digits<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
   return ::NTL::RR::precision();
}

template <>
inline float real_cast<float, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   double r;
   conv(r, t.value());
...
template <>
inline double real_cast<double, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   double r;
   conv(r, t.value());
   return r;
...
template <>
inline long double real_cast<long double, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
...
template <>
inline lslboost::math::ntl::RR real_cast<lslboost::math::ntl::RR, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   return t;
}
template <>
inline unsigned real_cast<unsigned, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   unsigned result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline int real_cast<int, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   int result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline long real_cast<long, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   long result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline long long real_cast<long long, lslboost::math::ntl::RR>(lslboost::math::ntl::RR t)
{
   long long result;
   detail::convert_to_long_result(t.value(), result);
   return result;
...
template <>
inline lslboost::math::ntl::RR max_value<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
...
template <>
inline lslboost::math::ntl::RR min_value<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline lslboost::math::ntl::RR log_max_value<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline lslboost::math::ntl::RR log_min_value<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
   static bool has_init = false;
   static NTL::RR val;
   if(!has_init)
...
template <>
inline lslboost::math::ntl::RR epsilon<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
   return ldexp(lslboost::math::ntl::RR(1), 1-lslboost::math::policies::digits<lslboost::math::ntl::RR, lslboost::math::policies::policy<> >());
}
...
template<> inline lslboost::math::ntl::RR pi<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
    NTL::RR result;
    ComputePi(result);
    return result;
}
template<> inline lslboost::math::ntl::RR e<lslboost::math::ntl::RR>(BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(lslboost::math::ntl::RR))
{
    NTL::RR result;
    result = 1;
    return exp(result);
...
namespace ntl{
   ...
   struct asin_root
   {
      ...
      lslboost::math::tuple<RR, RR, RR> operator()(RR const& p)
      {
         RR f0 = sin(p);
         RR f1 = cos(p);
         RR f2 = -f0;
         f0 -= t;
         return lslboost::math::make_tuple(f0, f1, f2);
      }
   private:
      RR t;
   };
   ...
   inline RR asin(RR z)
   {
      double r;
      conv(r, z.value());
      return lslboost::math::tools::halley_iterate(
         asin_root(z), 
         RR(std::asin(r)), 
         RR(-lslboost::math::constants::pi<RR>()/2),
         RR(lslboost::math::constants::pi<RR>()/2),
         NTL::RR::precision());
   }
   ...
   inline RR atan(RR z)
   {
      ...
      return lslboost::math::tools::halley_iterate(
         atan_root(z), 
         RR(std::atan(r)), 
         -lslboost::math::constants::pi<RR>()/2,
         lslboost::math::constants::pi<RR>()/2,
         NTL::RR::precision());
   }
   ...
   inline RR atan2(RR y, RR x)
   {
      ...
      if(x < 0)
      {
         return y < 0 ? atan(y / x) - lslboost::math::constants::pi<RR>() : atan(y / x) + lslboost::math::constants::pi<RR>();
      }
      return y < 0 ? -lslboost::math::constants::half_pi<RR>() : lslboost::math::constants::half_pi<RR>() ;
   }
...
ntl::RR digamma_imp(ntl::RR x, const mpl::int_<0>* , const Policy& pol)
{
   ...
   if(x < 0)
   {
      ...
      if(remainder == 0)
      {
         return policies::raise_pole_error<ntl::RR>("lslboost::math::digamma<%1%>(%1%)", 0, (1-x), pol);
      }
