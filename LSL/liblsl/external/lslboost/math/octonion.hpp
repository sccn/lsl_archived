//    lslboost octonion.hpp header file
...
#include <lslboost/math/quaternion.hpp>
...
#define    BOOST_OCTONION_ACCESSOR_GENERATOR(type)                      \
            ...
            {                                                           \
                return(::std::complex<type>(g,h));                      \
                                                                        ...
                                                                        \
            ::lslboost::math::quaternion<type>    H_component_1() const    \
            {                                                           \
                return(::lslboost::math::quaternion<type>(a,b,c,d));       \
            }                                                           \
                                                                        \
            ::lslboost::math::quaternion<type>    H_component_2() const    \
            {                                                           \
                return(::lslboost::math::quaternion<type>(e,f,g,h));       \
            }
...
#define    BOOST_OCTONION_MEMBER_ASSIGNMENT_GENERATOR(type)                                         \
            ...
            {                                                                                       \
                ...
                return(*this);                                                                      \
                                                                                                    ...
                                                                                                    \
            octonion<type> &        operator = (::lslboost::math::quaternion<type> const & a_affecter) \
            {                                                                                       \
...
#define    BOOST_OCTONION_MEMBER_DATA_GENERATOR(type) \
        ...
        public:
            ...
            explicit                octonion(   ::lslboost::math::quaternion<T> const & q0,
                                                ::lslboost::math::quaternion<T> const & q1 = ::lslboost::math::quaternion<T>())
            :   a(q0.R_component_1()),
                b(q0.R_component_2()),
                c(q0.R_component_3()),
                d(q0.R_component_4()),
            ...
            octonion<T> &            operator += (::lslboost::math::quaternion<T> const & rhs)
            {
...
#define    BOOST_OCTONION_CONSTRUCTOR_GENERATOR(type)                                                                               \
            ...
            {                                                                                                                       \
                                                                                                                                    ...
                                                                                                                                    \
            explicit                    octonion(   ::lslboost::math::quaternion<type> const & q0,                                     \
                                                    ::lslboost::math::quaternion<type> const & q1 = ::lslboost::math::quaternion<type>()) \
            :   a(q0.R_component_1()),                                                                                              \
                b(q0.R_component_2()),                                                                                              \
                c(q0.R_component_3()),                                                                                              \
                d(q0.R_component_4()),                                                                                              \
...
#define    BOOST_OCTONION_MEMBER_ADD_GENERATOR_3(type)                                              \
            octonion<type> &            operator += (::lslboost::math::quaternion<type> const & rhs)   \
            {                                                                                       \
                a += rhs.R_component_1();                                                           \
                b += rhs.R_component_2();                                                           \
                c += rhs.R_component_3();                                                           \
...
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_L(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (::lslboost::math::quaternion<T> const & lhs, octonion<T> const & rhs) \
        BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
        
#define    BOOST_OCTONION_OPERATOR_GENERATOR_3_R(op)                                                                              \
        template<typename T>                                                                                                      \
        inline octonion<T>                        operator op (octonion<T> const & lhs, ::lslboost::math::quaternion<T> const & rhs) \
        BOOST_OCTONION_OPERATOR_GENERATOR_BODY(op)
...
#undef    BOOST_OCTONION_OPERATOR_GENERATOR_BODY
        ...
        template<typename T>
        inline bool                                operator == (::lslboost::math::quaternion<T> const & lhs, octonion<T> const & rhs)
        {
            return(
        ...
        template<typename T>
        inline bool                                operator == (octonion<T> const & lhs, ::lslboost::math::quaternion<T> const & rhs)
        {
            return(
...
#define    BOOST_OCTONION_NOT_EQUAL_GENERATOR \
    ...
    #undef    BOOST_OCTONION_NOT_EQUAL_GENERATOR
...
#endif /* BOOST_WORKAROUND(__GNUC__, < 3) */
        {
            ...
            ::lslboost::math::quaternion<T>    p = ::lslboost::math::quaternion<T>();
            ::lslboost::math::quaternion<T>    q = ::lslboost::math::quaternion<T>();
                ...
                if    (cc == '(')                                // read "(("
                {
                    ...
                    if    (cc == '(')                                // read "((("
                    {
                        ...
                        if        (cc == ')')                        // read "((u)"
                        {
                            ...
                            {
                                p = ::lslboost::math::quaternion<T>(u);
                        ...
                        else if    (cc ==',')                        // read "((u,"
                        {
                            ...
                            if        (cc == ')')                        // read "((u,v)"
                            {
                                p = ::lslboost::math::quaternion<T>(u,v);
                            ...
                            else if    (cc == ',')                            // read "((a),"
                            {
                                ...
                                if        (cc == '(')                            // read "((a),("
                                {
                                    ...
                                    if        (cc == '(')                            // read "((a),(("
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a),q)"
                                        {
                                            p = ::lslboost::math::quaternion<T>(a);
                                    ...
                                    else                                        // read "((a),(c" or "((a),(e"
                                    {
                                        ...
                                        else if    (cc == ',')                            // read "((a),(c," or "((a),(e,"
                                        {
                                            ...
                                            if        (cc == '(')                        // read "((a),(e,(" (ambiguity resolution)
                                            {
                                                ...
                                                if        (cc == ')')                        // read "((a),(e,y)"
                                                {
                                                    q = ::lslboost::math::quaternion<T>(x,y);
                                            ...
                                            else                                    // read "((a),(c,d" or "((a),(e,f"
                                            {
                                                ...
                                                else if    (cc == ',')                        // read "((a),(e,f," (ambiguity resolution)
                                                {
                                                    ...
                                                    if        (cc == ')')                        // read "((a),(e,f,g)"
                                                    {
                                                        q = ::lslboost::math::quaternion<T>(c,d,g);        // "c" was actually "e", and "d" was actually "f"
                                                    ...
                                                    else if    (cc == ',')                        // read "((a),(e,f,g,"
                                                    {
                                                        ...
                                                        {
                                                            q = ::lslboost::math::quaternion<T>(c,d,g,h);    // "c" was actually "e", and "d" was actually "f"
                            ...
                            else
                            {
                                ...
                                if        (cc == ')')                            // read "((a,b)"
                                {
                                    ...
                                    else if    (cc == ',')                            // read "((a,b),"
                                    {
                                        ...
                                        if        (cc == '(')                            // read "((a,b),("
                                        {
                                            ...
                                            if        (cc == '(')                            // read "((a,b),(("
                                            {
                                                p = ::lslboost::math::quaternion<T>(a,b);
                                            ...
                                            else                                        // read "((a,b),(c" or "((a,b),(e"
                                            {
                                                ...
                                                else if    (cc == ',')                            // read "((a,b),(c," or "((a,b),(e,"
                                                {
                                                    ...
                                                    else                                        // read "((a,b),(c,d" or "((a,b),(e,f"
                                                    {
                                                        ...
                                                        {
                                                            p = ::lslboost::math::quaternion<T>(a,b);                // too late to backtrack
                                                            ...
                                                            if        (cc == ')')                            // read "((a,b),(e,f,g)"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g))"
                                                                {
                                                                    q = ::lslboost::math::quaternion<T>(c,d,g);            // "c" is actually "e" and "d" is actually "f"
                                                            ...
                                                            else if    (cc == ',')                            // read "((a,b),(e,f,g,"
                                                            {
                                                                ...
                                                                if        (cc == ')')                            // read "((a,b),(e,f,g,h)"
                                                                {
                                                                    ...
                                                                    if        (cc == ')')                            // read ((a,b),(e,f,g,h))"
                                                                    {
                                                                        q = ::lslboost::math::quaternion<T>(c,d,g,h);            // "c" is actually "e" and "d" is actually "f"
                                ...
                                else if    (cc == ',')                            // read "((a,b,"
                                {
                                    ...
                                    if        (cc == ')')                            // read "((a,b,c)"
                                    {
                                        ...
                                        {
                                            p = ::lslboost::math::quaternion<T>(a,b,c);
                                    ...
                                    else if    (cc == ',')                            // read "((a,b,c,"
                                    {
                                        ...
                                        if        (cc == ')')                            // read "((a,b,c,d)"
                                        {
                                            ...
                                            {
                                                p = ::lslboost::math::quaternion<T>(a,b,c,d);
