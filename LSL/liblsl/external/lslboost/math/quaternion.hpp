//  lslboost quaternion.hpp header file
...
#include <lslboost/config.hpp> // for BOOST_NO_STD_LOCALE
...
#include <lslboost/math/special_functions/sinc.hpp>    // for the Sinus cardinal
#include <lslboost/math/special_functions/sinhc.hpp>    // for the Hyperbolic Sinus cardinal
