...
#ifdef BOOST_MATH_USE_FLOAT128
               typename mpl::if_<
                  mpl::and_<lslboost::is_convertible<__float128, Real>, mpl::bool_< t1::value <= t5::value>, mpl::bool_<0 != t1::value> >,
...
#  define BOOST_MATH_FLOAT128_CONSTANT_OVERLOAD(x)
   ...
   {\
      static const T result = convert_from_string<T>(y, lslboost::is_convertible<const char*, T>());\
      return result;\
   }\
