    ...
    */
    ...
    private:
        ...
        CharType fill, ValType val) const
      {
        ...
        switch((lslboost::math::fpclassify)(val))
        {
        ...
        case FP_INFINITE:
          ...
          else if((lslboost::math::signbit)(val))
          { // negative infinity.
        ...
        case FP_ZERO:
          if((flags_ & signed_zero) && ((lslboost::math::signbit)(val)))
    ...
    private:
      ...
      ) const
      {
        ...
        if(negative)
        {
          val = (lslboost::math::changesign)(val);
        }
      } // void get_signed
...
// https://svn.lslboost.org/trac/lslboost/ticket/5467
