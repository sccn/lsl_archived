...
#include <lslboost/math/special_functions/detail/bessel_k0.hpp>
#include <lslboost/math/special_functions/detail/bessel_k1.hpp>
...
T bessel_kn(int n, T x, const Policy& pol)
{
    ...
    static const char* function = "lslboost::math::bessel_kn<%1%>(%1%,%1%)";
