...
T ellint_pi_imp(T v, T phi, T k, T vc, const Policy& pol)
{
    ...
    static const char* function = "lslboost::math::ellint_3<%1%>(%1%,%1%,%1%)";
    ...
    if(k == 0)
    {
       ...
       else
       {
          ...
          T vcr = sqrt(-vc);
          T arg = vcr * tan(phi);
          return (lslboost::math::log1p(arg, pol) - lslboost::math::log1p(-arg, pol)) / (2 * vcr);
       }
    }
...
T ellint_pi_imp(T v, T k, T vc, const Policy& pol)
{
    ...
    static const char* function = "lslboost::math::ellint_pi<%1%>(%1%,%1%)";
    ...
    if(v == 0)
    {
       return (k == 0) ? lslboost::math::constants::pi<T>() / 2 : ellint_k_imp(k, pol);
    }
    ...
    if(v < 0)
    {
       ...
       T result = lslboost::math::detail::ellint_pi_imp(N, k, Nm1, pol);
...
{
   return lslboost::math::ellint_3(k, v, phi, policies::policy<>());
}
...
inline typename tools::promote_args<T1, T2>::type ellint_3(T1 k, T2 v, const Policy& pol, const mpl::true_&)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_pi_imp(
         ...
         pol), "lslboost::math::ellint_3<%1%>(%1%,%1%)");
}
...
inline typename tools::promote_args<T1, T2, T3>::type ellint_3(T1 k, T2 v, T3 phi, const Policy& pol)
{
   ...
   return policies::checked_narrowing_cast<result_type, Policy>(
      detail::ellint_pi_imp(
         ...
         static_cast<value_type>(k),
         static_cast<value_type>(1-v),
         pol), "lslboost::math::ellint_3<%1%>(%1%,%1%,%1%)");
}
