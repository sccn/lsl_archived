...
#include <lslboost/math/special_functions/detail/fp_traits.hpp>
/*!
  \file fpclassify.hpp
...
//
// This must not be located in any namespace under lslboost::math
...
{
   return lslboost::math::detail::fpclassify_imp(t, generic_tag<true>());
}
#endif
...
{
   return lslboost::math::detail::isfinite_impl(t, generic_tag<true>());
}
#endif
...
{ //!< \brief return true if floating-point type t is finite.
   typedef typename detail::fp_traits<T>::type traits;
   typedef typename traits::method method;
   // typedef typename lslboost::is_floating_point<T>::type fp_tag;
   typedef typename tools::promote_args_permissive<T>::type value_type;
...
{ //!< \brief return true if floating-point type t is finite.
   typedef detail::fp_traits<long double>::type traits;
   typedef traits::method method;
   typedef lslboost::is_floating_point<long double>::type fp_tag;
   typedef long double value_type;
   return detail::isfinite_impl(static_cast<value_type>(x), method());
}
#endif
...
{
   return lslboost::math::detail::isnormal_impl(t, generic_tag<true>());
}
#endif
...
{
   return lslboost::math::detail::isinf_impl(t, generic_tag<true>());
}
#endif
