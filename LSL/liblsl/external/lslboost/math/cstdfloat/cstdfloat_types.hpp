...
// Implement the types for floating-point typedefs having specified widths.
  ...
  // Ensure that the compiler has a radix-2 floating-point representation.
    ...
    #error The compiler does not support any radix-2 floating-point types required for <lslboost/cstdfloat.hpp>.
  #endif
  ...
  // <lslboost/math/tools/config.hpp>.
    ...
    #else
      #error "Sorry, the compiler is neither GCC, nor Intel, I don't know how to configure <lslboost/cstdfloat.hpp>."
    #endif
    } } } } // lslboost::math::cstdfloat::detail

    #define BOOST_CSTDFLOAT_FLOAT128_NATIVE_TYPE lslboost::math::cstdfloat::detail::float_internal128_t
    #undef  BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH
    #define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 128
    #undef  BOOST_CSTDFLOAT_HAS_FLOAT128_NATIVE_TYPE
    #define BOOST_CSTDFLOAT_HAS_FLOAT128_NATIVE_TYPE  1
  ...
  // Make sure that the compiler has any floating-point type(s) whatsoever.
    ...
    #error The compiler does not support any of the floating-point types required for <lslboost/cstdfloat.hpp>.
  #endif
  ...
  #else
    #error The maximum available floating-point width for <lslboost/cstdfloat.hpp> is undefined.
  #endif

  // And finally..., we define the floating-point typedefs having
  // specified widths. The types are defined in the namespace lslboost.
  ...
  namespace lslboost
  {
      ...
      typedef lslboost::float16_t float_fast16_t;
      typedef lslboost::float16_t float_least16_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float16_t>::is_iec559    == true, "lslboost::float16_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float16_t>::radix        ==    2, "lslboost::float16_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float16_t>::digits       ==   11, "lslboost::float16_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float16_t>::max_exponent ==   16, "lslboost::float16_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef lslboost::float32_t float_fast32_t;
      typedef lslboost::float32_t float_least32_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float32_t>::is_iec559    == true, "lslboost::float32_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float32_t>::radix        ==    2, "lslboost::float32_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float32_t>::digits       ==   24, "lslboost::float32_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float32_t>::max_exponent ==  128, "lslboost::float32_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
...
#define BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH 64
      ...
      typedef lslboost::float64_t float_fast64_t;
      typedef lslboost::float64_t float_least64_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float64_t>::is_iec559    == true, "lslboost::float64_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float64_t>::radix        ==    2, "lslboost::float64_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float64_t>::digits       ==   53, "lslboost::float64_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float64_t>::max_exponent == 1024, "lslboost::float64_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef lslboost::float80_t float_fast80_t;
      typedef lslboost::float80_t float_least80_t;

      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float80_t>::is_iec559    ==  true, "lslboost::float80_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float80_t>::radix        ==     2, "lslboost::float80_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float80_t>::digits       ==    64, "lslboost::float80_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float80_t>::max_exponent == 16384, "lslboost::float80_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      ...
      typedef lslboost::float128_t float_fast128_t;
      typedef lslboost::float128_t float_least128_t;

      #if defined(BOOST_CSTDFLOAT_HAS_INTERNAL_FLOAT128_T) && defined(BOOST_MATH_USE_FLOAT128) && !defined(BOOST_CSTDFLOAT_NO_LIBQUADMATH_SUPPORT)
      // This configuration does not *yet* support std::numeric_limits<lslboost::float128_t>.
      // Support for std::numeric_limits<lslboost::float128_t> is added in the detail
      // file <lslboost/math/cstdfloat/cstdfloat_limits.hpp>.
      #else
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float128_t>::is_iec559    ==  true, "lslboost::float128_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float128_t>::radix        ==     2, "lslboost::float128_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float128_t>::digits       ==   113, "lslboost::float128_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      BOOST_STATIC_ASSERT_MSG(std::numeric_limits<lslboost::float128_t>::max_exponent == 16384, "lslboost::float128_t has been detected in <lslboost/cstdfloat>, but verification with std::numeric_limits fails");
      #endif
    ...
    #if  (BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  16)
      typedef lslboost::float16_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  32)
      typedef lslboost::float32_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  64)
      typedef lslboost::float64_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH ==  80)
      typedef lslboost::float80_t  floatmax_t;
    #elif(BOOST_CSTDFLOAT_MAXIMUM_AVAILABLE_WIDTH == 128)
      typedef lslboost::float128_t floatmax_t;
    #else
      #error The maximum available floating-point width for <lslboost/cstdfloat.hpp> is undefined.
    #endif
