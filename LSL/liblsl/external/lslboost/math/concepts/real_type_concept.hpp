...
struct RealTypeConcept
{
   ...
   void constraints()
   {
      ...
      r2 = ldexp(r, i);
      r2 = frexp(r, &i);
      i = lslboost::math::tools::digits<RealType>();
      r2 = lslboost::math::tools::max_value<RealType>();
      r2 = lslboost::math::tools::min_value<RealType>();
      r2 = lslboost::math::tools::log_max_value<RealType>();
      r2 = lslboost::math::tools::log_min_value<RealType>();
      r2 = lslboost::math::tools::epsilon<RealType>();
   }
