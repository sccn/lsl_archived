...
public:
   ...
   std_real_concept(lslboost::ulong_long_type c) : m_value(static_cast<std_real_concept_base_type>(c)){}
   std_real_concept(lslboost::long_long_type c) : m_value(static_cast<std_real_concept_base_type>(c)){}
#endif
...
#elif defined(BOOST_HAS_LONG_LONG)
   std_real_concept& operator=(lslboost::long_long_type c) { m_value = static_cast<std_real_concept_base_type>(c); return *this; }
   std_real_concept& operator=(lslboost::ulong_long_type c) { m_value = static_cast<std_real_concept_base_type>(c); return *this; }
#endif
...
inline lslboost::math::concepts::std_real_concept acos(lslboost::math::concepts::std_real_concept a)
{ return std::acos(a.value()); }
inline lslboost::math::concepts::std_real_concept cos(lslboost::math::concepts::std_real_concept a)
{ return std::cos(a.value()); }
inline lslboost::math::concepts::std_real_concept asin(lslboost::math::concepts::std_real_concept a)
{ return std::asin(a.value()); }
inline lslboost::math::concepts::std_real_concept atan(lslboost::math::concepts::std_real_concept a)
{ return std::atan(a.value()); }
inline lslboost::math::concepts::std_real_concept atan2(lslboost::math::concepts::std_real_concept a, lslboost::math::concepts::std_real_concept b)
{ return std::atan2(a.value(), b.value()); }
inline lslboost::math::concepts::std_real_concept ceil(lslboost::math::concepts::std_real_concept a)
{ return std::ceil(a.value()); }
#ifndef BOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
inline lslboost::math::concepts::std_real_concept fmod(lslboost::math::concepts::std_real_concept a, lslboost::math::concepts::std_real_concept b)
{ return fmodl(a.value(), b.value()); }
#else
inline lslboost::math::concepts::std_real_concept fmod(lslboost::math::concepts::std_real_concept a, lslboost::math::concepts::std_real_concept b)
{ return std::fmod(a.value(), b.value()); }
#endif
inline lslboost::math::concepts::std_real_concept cosh(lslboost::math::concepts::std_real_concept a)
{ return std::cosh(a.value()); }
inline lslboost::math::concepts::std_real_concept exp(lslboost::math::concepts::std_real_concept a)
{ return std::exp(a.value()); }
inline lslboost::math::concepts::std_real_concept fabs(lslboost::math::concepts::std_real_concept a)
{ return std::fabs(a.value()); }
inline lslboost::math::concepts::std_real_concept abs(lslboost::math::concepts::std_real_concept a)
{ return std::abs(a.value()); }
inline lslboost::math::concepts::std_real_concept floor(lslboost::math::concepts::std_real_concept a)
{ return std::floor(a.value()); }
inline lslboost::math::concepts::std_real_concept modf(lslboost::math::concepts::std_real_concept a, lslboost::math::concepts::std_real_concept* ipart)
{
   lslboost::math::concepts::std_real_concept_base_type ip;
   lslboost::math::concepts::std_real_concept_base_type result = std::modf(a.value(), &ip);
   *ipart = ip;
   return result;
}
inline lslboost::math::concepts::std_real_concept frexp(lslboost::math::concepts::std_real_concept a, int* expon)
{ return std::frexp(a.value(), expon); }
inline lslboost::math::concepts::std_real_concept ldexp(lslboost::math::concepts::std_real_concept a, int expon)
{ return std::ldexp(a.value(), expon); }
inline lslboost::math::concepts::std_real_concept log(lslboost::math::concepts::std_real_concept a)
{ return std::log(a.value()); }
inline lslboost::math::concepts::std_real_concept log10(lslboost::math::concepts::std_real_concept a)
{ return std::log10(a.value()); }
inline lslboost::math::concepts::std_real_concept tan(lslboost::math::concepts::std_real_concept a)
{ return std::tan(a.value()); }
inline lslboost::math::concepts::std_real_concept pow(lslboost::math::concepts::std_real_concept a, lslboost::math::concepts::std_real_concept b)
{ return std::pow(a.value(), b.value()); }
#if !defined(__SUNPRO_CC)
inline lslboost::math::concepts::std_real_concept pow(lslboost::math::concepts::std_real_concept a, int b)
{ return std::pow(a.value(), b); }
#else
inline lslboost::math::concepts::std_real_concept pow(lslboost::math::concepts::std_real_concept a, int b)
{ return std::pow(a.value(), static_cast<long double>(b)); }
#endif
inline lslboost::math::concepts::std_real_concept sin(lslboost::math::concepts::std_real_concept a)
{ return std::sin(a.value()); }
inline lslboost::math::concepts::std_real_concept sinh(lslboost::math::concepts::std_real_concept a)
{ return std::sinh(a.value()); }
inline lslboost::math::concepts::std_real_concept sqrt(lslboost::math::concepts::std_real_concept a)
{ return std::sqrt(a.value()); }
inline lslboost::math::concepts::std_real_concept tanh(lslboost::math::concepts::std_real_concept a)
...
namespace lslboost{ namespace math{ namespace concepts{
...
{
   return lslboost::math::iround(v.value(), pol);
}
inline int iround(const concepts::std_real_concept& v)
{
   return lslboost::math::iround(v.value(), policies::policy<>());
}
...
template <class Policy>
inline lslboost::long_long_type llround(const concepts::std_real_concept& v, const Policy& pol)
{
   return lslboost::math::llround(v.value(), pol);
}
inline lslboost::long_long_type llround(const concepts::std_real_concept& v)
{
   return lslboost::math::llround(v.value(), policies::policy<>());
}
...
{
   return lslboost::math::ltrunc(v.value(), pol);
}
inline long ltrunc(const concepts::std_real_concept& v)
{
   return lslboost::math::ltrunc(v.value(), policies::policy<>());
}
...
template <>
inline concepts::std_real_concept make_big_value<concepts::std_real_concept>(lslboost::math::tools::largest_float val, const char*, mpl::false_ const&, mpl::false_ const&)
{
