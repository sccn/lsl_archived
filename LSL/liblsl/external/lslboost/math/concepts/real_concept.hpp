...
//   test_spots(lslboost::math::concepts::real_concept(0.));
...
public:
   ...
   real_concept(lslboost::ulong_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   real_concept(lslboost::long_long_type c) : m_value(static_cast<real_concept_base_type>(c)){}
   ...
   real_concept& operator=(lslboost::long_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
   real_concept& operator=(lslboost::ulong_long_type c) { m_value = static_cast<real_concept_base_type>(c); return *this; }
#endif
...
#ifdef BOOST_HAS_LONG_LONG
template <class Policy>
inline lslboost::long_long_type llround(const concepts::real_concept& v, const Policy& pol)
{ return lslboost::math::llround(v.value(), pol); }
inline lslboost::long_long_type llround(const concepts::real_concept& v)
...
template <>
inline concepts::real_concept make_big_value<concepts::real_concept>(lslboost::math::tools::largest_float val, const char* , mpl::false_ const&, mpl::false_ const&)
{
