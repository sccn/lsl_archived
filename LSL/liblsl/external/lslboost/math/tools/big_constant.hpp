...
#define BOOST_MATH_BIG_CONSTANT(T, D, x)\
   lslboost::math::tools::make_big_value<T>(\
      BOOST_MATH_LARGEST_FLOAT_C(x), \
      BOOST_STRINGIZE(x), \
      mpl::bool_< (is_convertible<lslboost::math::tools::largest_float, T>::value) && \
      ((D <= lslboost::math::tools::numeric_traits<lslboost::math::tools::largest_float>::digits) \
          || is_floating_point<T>::value \
          || (lslboost::math::tools::numeric_traits<T>::is_specialized && \
          (lslboost::math::tools::numeric_traits<T>::digits10 <= lslboost::math::tools::numeric_traits<lslboost::math::tools::largest_float>::digits10))) >(), \
...
#define BOOST_MATH_HUGE_CONSTANT(T, D, x)\
   ...
   mpl::bool_<is_floating_point<T>::value || (lslboost::math::tools::numeric_traits<T>::is_specialized && lslboost::math::tools::numeric_traits<T>::max_exponent <= lslboost::math::tools::numeric_traits<lslboost::math::tools::largest_float>::max_exponent && lslboost::math::tools::numeric_traits<T>::digits <= lslboost::math::tools::numeric_traits<lslboost::math::tools::largest_float>::digits)>(), \
   lslboost::is_convertible<const char*, T>())
