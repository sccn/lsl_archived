...
#include <lslboost/math/tools/stats.hpp>
...
{
private:
   lslboost::math::tools::stats<T> stat;   // Statistics for the test.
...
public:
   ...
   lslboost::uintmax_t count()const{ return stat.count(); }
...
//
// Function test accepts an matrix of input values (probably a 2D lslboost::array)
