...
#include <lslboost/cstdint.hpp> // for lslboost::uintmax_t
...
#include <lslboost/math/tools/user.hpp>
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         lslboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    lslboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  lslboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  lslboost::non_type<t, v>*
...
{
   static const bool value = lslboost::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
// Much more information in this message thread: https://groups.google.com/forum/#!topic/lslboost-list/ZT99wtIFlb4
//

   #include <lslboost/detail/fenv.hpp>
...
#    define BOOST_FPU_EXCEPTION_GUARD lslboost::math::detail::fpu_guard local_guard_object;
