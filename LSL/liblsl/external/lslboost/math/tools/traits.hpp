...
/*
This header defines two traits classes, both in namespace lslboost::math::tools.
...
{
   BOOST_STATIC_CONSTANT(bool, value = (::lslboost::math::tools::detail::is_scaled_distribution_helper<D, ::lslboost::math::tools::detail::is_distribution_imp<D>::value>::value));
};

} // namespace detail

BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_distribution,T,::lslboost::math::tools::detail::is_distribution_imp<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_scaled_distribution,T,::lslboost::math::tools::detail::is_scaled_distribution_imp<T>::value)
