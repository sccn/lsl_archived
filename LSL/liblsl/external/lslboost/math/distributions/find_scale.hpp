...
#include <lslboost/math/distributions/fwd.hpp> // for all distribution signatures.
...
#include <lslboost/math/tools/traits.hpp>
...
// using lslboost::math::complement; // will be needed by users who want complement,
...
#endif
      static const char* function = "lslboost::math::find_scale<Dist, Policy>(%1%, %1%, %1%, Policy)";
