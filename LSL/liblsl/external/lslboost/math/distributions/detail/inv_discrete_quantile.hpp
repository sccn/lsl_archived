      ...
      lslboost::uintmax_t& max_iter)
{
   ...
   static const char* function = "lslboost::math::do_inverse_discrete_quantile<%1%>";
   ...
   lslboost::math::tie(min_bound, max_bound) = support(dist);
   ...
   //
   if((lslboost::math::sign)(fb) == (lslboost::math::sign)(fa))
   {
      if(fa < 0)
      {
         //
         ...
         // until we find it:
         //
         while(((lslboost::math::sign)(fb) == (lslboost::math::sign)(fa)) && (a != b))
         {
            if(count == 0)
