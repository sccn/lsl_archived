...
#include <lslboost/math/distributions/fwd.hpp> // TODO add skew_normal distribution to fwd.hpp!
#include <lslboost/math/special_functions/owens_t.hpp> // Owen's T function
...
#include <lslboost/math/tools/roots.hpp> // Newton-Raphson
#include <lslboost/assert.hpp>
#include <lslboost/math/distributions/detail/generic_mode.hpp> // pdf max finder.
...
namespace lslboost{ namespace math{
  ...
  namespace detail
  {
    ...
    inline bool check_skew_normal_shape(
      ...
      const Policy& pol)
    {
      if(!(lslboost::math::isfinite)(shape))
      {
        *result =
  ...
  public:
    ...
    { // Default is a 'standard' normal distribution N01. (shape=0 results in the normal distribution with no skew)
      static const char* function = "lslboost::math::skew_normal_distribution<%1%>::skew_normal_distribution";
  ...
  inline RealType pdf(const skew_normal_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    static const char* function = "lslboost::math::pdf(const skew_normal_distribution<%1%>&, %1%)";
  ...
  inline RealType cdf(const skew_normal_distribution<RealType, Policy>& dist, const RealType& x)
  {
    ...
    static const char* function = "lslboost::math::cdf(const skew_normal_distribution<%1%>&, %1%)";
    RealType result = 0;
    if(false == detail::check_scale(function, scale, &result, Policy()))
    {
      return result;
  ...
  inline RealType cdf(const complemented2_type<skew_normal_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    static const char* function = "lslboost::math::cdf(const complement(skew_normal_distribution<%1%>&), %1%)";
  ...
  namespace detail
  {
    ...
    */
    ...
    { 
      skew_normal_mode_functor(const lslboost::math::skew_normal_distribution<RealType, Policy> dist)
        : distribution(dist)
      {
      }
    ...
    private:
      const lslboost::math::skew_normal_distribution<RealType, Policy> distribution;
    };
  ...
  inline RealType mode(const skew_normal_distribution<RealType, Policy>& dist)
  {
    ...
    static const char* function = "lslboost::math::mode(const skew_normal_distribution<%1%>&, %1%)";
  ...
  namespace detail
  {
    ...
    { 
      skew_normal_quantile_functor(const lslboost::math::skew_normal_distribution<RealType, Policy> dist, RealType const& p)
  ...
  inline RealType quantile(const skew_normal_distribution<RealType, Policy>& dist, const RealType& p)
  {
    ...
    static const char* function = "lslboost::math::quantile(const skew_normal_distribution<%1%>&, %1%)";
    ...
    RealType x = -lslboost::math::erfc_inv(2 * p, Policy()) * constants::root_two<RealType>();
  ...
  inline RealType quantile(const complemented2_type<skew_normal_distribution<RealType, Policy>, RealType>& c)
  {
    ...
    static const char* function = "lslboost::math::quantile(const complement(skew_normal_distribution<%1%>&), %1%)";
    RealType result = 0;
    if(false == detail::check_scale(function, scale, &result, Policy()))
      return result;
    if(false == detail::check_location(function, location, &result, Policy()))
