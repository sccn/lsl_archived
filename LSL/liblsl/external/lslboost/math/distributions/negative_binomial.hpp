// lslboost\math\special_functions\negative_binomial.hpp
...
#include <lslboost/math/special_functions/beta.hpp> // for ibeta(a, b, x) == Ix(a, b).
#include <lslboost/math/distributions/complement.hpp> // complement.
#include <lslboost/math/distributions/detail/common_error_handling.hpp> // error checks domain_error & logic_error.
#include <lslboost/math/special_functions/fpclassify.hpp> // isnan.
#include <lslboost/math/tools/roots.hpp> // for root finding.
#include <lslboost/math/distributions/detail/inv_discrete_quantile.hpp>
...
namespace lslboost
{
  namespace math
  {
    namespace negative_binomial_detail
    {
      ...
      {
        if( !(lslboost::math::isfinite)(r) || (r <= 0) )
        {
    ...
    public:
      ...
      {
        static const char* function = "lslboost::math::negative_binomial<%1%>::find_lower_bound_on_p";
      ...
      static RealType find_upper_bound_on_p(
        ...
        RealType alpha) // alpha 0.05 equivalent to 95% for one-sided test.
      {
        static const char* function = "lslboost::math::negative_binomial<%1%>::find_upper_bound_on_p";
        RealType result = 0;  // of error checks.
        RealType failures = trials - successes;
      ...
      {
        static const char* function = "lslboost::math::negative_binomial<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == negative_binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
        ...
        RealType alpha) // risk level threshold 0 <= alpha <= 1.
      {
        static const char* function = "lslboost::math::negative_binomial<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == negative_binomial_detail::check_dist_and_k(
          function, RealType(1), p, k, &result, Policy())
    ...
    { // Probability Density/Mass Function.
      ...
      static const char* function = "lslboost::math::pdf(const negative_binomial_distribution<%1%>&, %1%)";
    ...
    { // Cumulative Distribution Function of Negative Binomial.
      static const char* function = "lslboost::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using lslboost::math::ibeta; // Regularized incomplete beta function.
      ...
      static const char* function = "lslboost::math::cdf(const negative_binomial_distribution<%1%>&, %1%)";
      using lslboost::math::ibetac; // Regularized incomplete beta function complement.
      // k argument may be integral, signed, or unsigned, or floating point.
      // If necessary, it has already been promoted from an integral type.
    ...
    { // Quantile, percentile/100 or Percent Point Negative Binomial function.
      ...
      static const char* function = "lslboost::math::quantile(const negative_binomial_distribution<%1%>&, %1%)";
      BOOST_MATH_STD_USING // ADL of std functions.
      ...
      using lslboost::math::ibeta_invb;
    ...
    {  // Quantile or Percent Point Binomial function.
       ...
       if (-Q <= lslboost::math::powm1(dist.success_fraction(), dist.successes(), Policy()))
