...
#include <lslboost/math/distributions/detail/hypergeometric_pdf.hpp>
#include <lslboost/math/distributions/detail/hypergeometric_cdf.hpp>
#include <lslboost/math/distributions/detail/hypergeometric_quantile.hpp>
...
namespace lslboost { namespace math {
   ...
   public:
      ...
      hypergeometric_distribution(unsigned r, unsigned n, unsigned N) // Constructor.
         : m_n(n), m_N(N), m_r(r)
      {
         static const char* function = "lslboost::math::hypergeometric_distribution<%1%>::hypergeometric_distribution";
         RealType ret;
      ...
      bool check_params(const char* function, RealType* result)const
      {
         if(m_r > m_N)
         {
            *result = lslboost::math::policies::raise_domain_error<RealType>(
...
#  pragma warning(pop)
   ...
   inline RealType pdf(const hypergeometric_distribution<RealType, Policy>& dist, const unsigned& x)
   {
      ...
      return lslboost::math::detail::hypergeometric_pdf<RealType>(
   ...
   inline RealType cdf(const hypergeometric_distribution<RealType, Policy>& dist, const unsigned& x)
   {
      ...
      return lslboost::math::detail::hypergeometric_cdf<RealType>(
   ...
   inline RealType quantile(const hypergeometric_distribution<RealType, Policy>& dist, const RealType& p)
   {
      BOOST_MATH_STD_USING // for ADL of std functions
         ...
         RealType result = 0;
      const char* function = "lslboost::math::quantile(const hypergeometric_distribution<%1%>&, %1%)";
