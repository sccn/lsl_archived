...
{
   if((shape <= 0) || !(lslboost::math::isfinite)(shape))
   {
...
inline bool check_weibull_x(
      ...
      RealType* result, const Policy& pol)
{
   if((x < 0) || !(lslboost::math::isfinite)(x))
   {
      *result = policies::raise_domain_error<RealType>(
         function,
...
public:
   ...
   {
      RealType result;
      detail::check_weibull("lslboost::math::weibull_distribution<%1%>::weibull_distribution", l_scale, l_shape, &result, Policy());
   }
...
{ // Range of supported values for random variable x.
   ...
   using lslboost::math::tools::max_value;
   using lslboost::math::tools::min_value;
...
inline RealType pdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::pdf(const weibull_distribution<%1%>, %1%)";
...
inline RealType cdf(const weibull_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::cdf(const weibull_distribution<%1%>, %1%)";
   ...
   result = -lslboost::math::expm1(-pow(x / scale, shape), Policy());
...
inline RealType quantile(const weibull_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "lslboost::math::quantile(const weibull_distribution<%1%>, %1%)";
   ...
   result = scale * pow(-lslboost::math::log1p(-p, Policy()), 1 / shape);
...
inline RealType mean(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::mean(const weibull_distribution<%1%>)";
   ...
   result = scale * lslboost::math::tgamma(1 + 1 / shape, Policy());
   return result;
}
...
inline RealType variance(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::variance(const weibull_distribution<%1%>)";
   ...
   result = lslboost::math::tgamma(1 + 1 / shape, Policy());
   result *= -result;
   result += lslboost::math::tgamma(1 + 2 / shape, Policy());
   result *= scale * scale;
   return result;
}
...
inline RealType mode(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::mode(const weibull_distribution<%1%>)";
...
inline RealType median(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::median(const weibull_distribution<%1%>)";
   ...
   using lslboost::math::constants::ln_two;
...
inline RealType skewness(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::skewness(const weibull_distribution<%1%>)";
   ...
   g1 = lslboost::math::tgamma(1 + 1 / shape, Policy());
   g2 = lslboost::math::tgamma(1 + 2 / shape, Policy());
   g3 = lslboost::math::tgamma(1 + 3 / shape, Policy());
...
inline RealType kurtosis_excess(const weibull_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::kurtosis_excess(const weibull_distribution<%1%>)";
   ...
   g2 = lslboost::math::tgamma(1 + 2 / shape, Policy());
   g3 = lslboost::math::tgamma(1 + 3 / shape, Policy());
   g4 = lslboost::math::tgamma(1 + 4 / shape, Policy());
   g1_2 = g1 * g1;
   g1_4 = g1_2 * g1_2;
   d = g2 - g1_2;
   d *= d;
