...
public:
   ...
   {
      RealType result;
      detail::check_scale("lslboost::math::lognormal_distribution<%1%>::lognormal_distribution", l_scale, &result, Policy());
      detail::check_location("lslboost::math::lognormal_distribution<%1%>::lognormal_distribution", l_location, &result, Policy());
   }
...
RealType pdf(const lognormal_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::pdf(const lognormal_distribution<%1%>&, %1%)";
...
inline RealType mean(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("lslboost::math::mean(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("lslboost::math::mean(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType variance(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("lslboost::math::variance(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("lslboost::math::variance(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;

   return lslboost::math::expm1(sigma * sigma, Policy()) * exp(2 * mu + sigma * sigma);
}
...
inline RealType mode(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   if(0 == detail::check_scale("lslboost::math::mode(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("lslboost::math::mode(const lognormal_distribution<%1%>&)", mu, &result, Policy()))
      return result;
...
inline RealType skewness(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   if(0 == detail::check_scale("lslboost::math::skewness(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("lslboost::math::skewness(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
...
inline RealType kurtosis(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   RealType result = 0;
   if(0 == detail::check_scale("lslboost::math::kurtosis(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("lslboost::math::kurtosis(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
...
inline RealType kurtosis_excess(const lognormal_distribution<RealType, Policy>& dist)
{
   ...
   if(0 == detail::check_scale("lslboost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", sigma, &result, Policy()))
      return result;
   if(0 == detail::check_location("lslboost::math::kurtosis_excess(const lognormal_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
