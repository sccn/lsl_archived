...
public:
   ...
   {
      RealType result;
      detail::check_gamma("lslboost::math::gamma_distribution<%1%>::gamma_distribution", l_scale, l_shape, &result, Policy());
   }
...
inline RealType pdf(const gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::pdf(const gamma_distribution<%1%>&, %1%)";
...
inline RealType mean(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::mean(const gamma_distribution<%1%>&)";
...
inline RealType variance(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::variance(const gamma_distribution<%1%>&)";
...
inline RealType skewness(const gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::skewness(const gamma_distribution<%1%>&)";
