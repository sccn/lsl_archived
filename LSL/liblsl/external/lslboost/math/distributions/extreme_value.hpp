...
inline RealType pdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType result = 0;
   if(0 == detail::verify_scale_b("lslboost::math::pdf(const extreme_value_distribution<%1%>&, %1%)", b, &result, Policy()))
      return result;
...
inline RealType cdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("lslboost::math::cdf(const extreme_value_distribution<%1%>&, %1%)", b, &result, Policy()))
      return result;
