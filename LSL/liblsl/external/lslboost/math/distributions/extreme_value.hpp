...
{
   if((b <= 0) || !(lslboost::math::isfinite)(b))
   {
...
public:
   ...
   {
      RealType err;
      detail::verify_scale_b("lslboost::math::extreme_value_distribution<%1%>::extreme_value_distribution", b, &err, Policy());
      detail::check_finite("lslboost::math::extreme_value_distribution<%1%>::extreme_value_distribution", a, &err, Policy());
...
inline RealType pdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::pdf(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const extreme_value_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::cdf(const extreme_value_distribution<%1%>&, %1%)";
   ...
   if(0 == detail::check_finite(function, a, &result, Policy()))
      return result;
   if(0 == detail::check_x("lslboost::math::cdf(const extreme_value_distribution<%1%>&, %1%)", x, &result, Policy()))
      return result;
...
RealType quantile(const extreme_value_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "lslboost::math::quantile(const extreme_value_distribution<%1%>&, %1%)";
...
inline RealType cdf(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   if((lslboost::math::isinf)(c.param))
   ...
   result = -lslboost::math::expm1(-exp((a-c.param)/b), Policy());
...
RealType quantile(const complemented2_type<extreme_value_distribution<RealType, Policy>, RealType>& c)
{
   ...
   result = a - log(-lslboost::math::log1p(-q, Policy())) * b;
...
inline RealType mean(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("lslboost::math::mean(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
   if(0 == detail::check_scale("lslboost::math::mean(const extreme_value_distribution<%1%>&)", a, &result, Policy()))
      return result;
...
inline RealType standard_deviation(const extreme_value_distribution<RealType, Policy>& dist)
{
   ...
   RealType b = dist.scale();
   RealType result = 0;
   if(0 == detail::verify_scale_b("lslboost::math::standard_deviation(const extreme_value_distribution<%1%>&)", b, &result, Policy()))
      return result;
   if(0 == detail::check_scale("lslboost::math::standard_deviation(const extreme_value_distribution<%1%>&)", dist.location(), &result, Policy()))
      return result;
