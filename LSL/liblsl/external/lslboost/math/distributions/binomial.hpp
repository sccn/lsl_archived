// lslboost\math\distributions\binomial.hpp
...
#include <lslboost/math/special_functions/beta.hpp> // for incomplete beta.
...
#include <lslboost/math/distributions/detail/inv_discrete_quantile.hpp> // error checks
...
namespace lslboost
{
  namespace math
  {
     ...
     namespace binomial_detail{
        ...
        {
           if((N < 0) || !(lslboost::math::isfinite)(N))
           {
        ...
        {
           if((p < 0) || (p > 1) || !(lslboost::math::isfinite)(p))
           {
               *result = policies::raise_domain_error<RealType>(
                  function,
        ...
        inline bool check_dist_and_prob(const char* function, const RealType& N, RealType p, RealType prob, RealType* result, const Policy& pol)
        {
         ...
         T inverse_binomial_cornish_fisher(T n, T sf, T p, T q, const Policy& pol)
         {
            ...
            T x = lslboost::math::erfc_inv(p > q ? 2 * q : 2 * p, pol) * constants::root_two<T>();
            // Set the sign:
            if(p < 0.5)
               x = -x;
            T x2 = x * x;
      ...
      { // Quantile or Percent Point Binomial function.
        ...
        if(false == binomial_detail::check_dist_and_prob(
           "lslboost::math::quantile(binomial_distribution<%1%> const&, %1%)",
           trials,
           success_fraction,
           p,
           &result, Policy()))
    ...
    public:
      ...
      { // Default n = 1 is the Bernoulli distribution
        // with equal probability of 'heads' or 'tails.
         ...
         binomial_detail::check_dist(
            "lslboost::math::binomial_distribution<%1%>::binomial_distribution",
            m_n,
            m_p,
            &r, Policy());
      ...
      {
        static const char* function = "lslboost::math::binomial_distribution<%1%>::find_lower_bound_on_p";
        // Error checks:
        RealType result = 0;
      ...
      static RealType find_upper_bound_on_p(
         ...
         interval_type t = clopper_pearson_exact_interval)
      {
        static const char* function = "lslboost::math::binomial_distribution<%1%>::find_upper_bound_on_p";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           function, trials, RealType(0), successes, &result, Policy())
      ...
      {
        static const char* function = "lslboost::math::binomial_distribution<%1%>::find_minimum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
      ...
      static RealType find_maximum_number_of_trials(
         ...
         RealType alpha) // risk level
      {
        static const char* function = "lslboost::math::binomial_distribution<%1%>::find_maximum_number_of_trials";
        // Error checks:
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           function, k, p, k, &result, Policy())
    ...
    private:
      ...
      { // Probability Density/Mass Function.
        ...
        if(false == binomial_detail::check_dist_and_k(
           "lslboost::math::pdf(binomial_distribution<%1%> const&, %1%)",
           n,
        ...
        //
        using lslboost::math::ibeta_derivative; // a, b, x
      ...
      { // Cumulative Distribution Function Binomial.
        ...
        RealType result = 0;
        if(false == binomial_detail::check_dist_and_k(
           "lslboost::math::cdf(binomial_distribution<%1%> const&, %1%)",
           n,
           p,
           k,
           &result, Policy()))
