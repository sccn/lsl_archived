// lslboost/math/distributions/arcsine.hpp
  ...
  namespace math
  {
      ...
      { // Check x finite and x_min < x < x_max.
        ...
        if ((x < x_min) || (x > x_max))
        {
          ...
          *result = policies::raise_domain_error<RealType>(
          ...
          // For example:
          // Error in function lslboost::math::pdf(arcsine_distribution<double> const&, double) : x argument is -1.01, but must be x_min < x < x_max !
    ...
    public:
      ...
      { // Default beta (alpha = beta = 0.5) is standard arcsine with x_min = 0, x_max = 1.
        ...
        arcsine_detail::check_dist(
          "lslboost::math::arcsine_distribution<%1%>::arcsine_distribution",
          m_x_min,
          m_x_max,
          &result, Policy());
    ...
    { // Mean of arcsine distribution .
      ...
      if (false == arcsine_detail::check_dist(
        "lslboost::math::mean(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    { // Variance of standard arcsine distribution = (1-0)/8 = 0.125.
      ...
      RealType x_max = dist.x_max();
      if (false == arcsine_detail::check_dist(
        "lslboost::math::variance(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    { //There are always [*two] values for the mode, at ['x_min] and at ['x_max], default 0 and 1,
      ...
      return policies::raise_domain_error<RealType>(
        "lslboost::math::mode(arcsine_distribution<%1%>&)",
    ...
    { // Median of arcsine distribution (a + b) / 2 == mean.
      ...
      RealType result;
      if (false == arcsine_detail::check_dist(
        "lslboost::math::median(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    inline RealType skewness(const arcsine_distribution<RealType, Policy>& dist)
    {
      ...
      if (false == arcsine_detail::check_dist(
        "lslboost::math::skewness(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    inline RealType kurtosis_excess(const arcsine_distribution<RealType, Policy>& dist)
    {
      ...
      if (false == arcsine_detail::check_dist(
        "lslboost::math::kurtosis_excess(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    inline RealType kurtosis(const arcsine_distribution<RealType, Policy>& dist)
    {
      ...
      if (false == arcsine_detail::check_dist(
        "lslboost::math::kurtosis(arcsine_distribution<%1%> const&, %1% )",
        x_min,
        x_max,
        &result, Policy())
        )
    ...
    { // Probability Density/Mass Function arcsine.
      ...
      static const char* function = "lslboost::math::pdf(arcsine_distribution<%1%> const&, %1%)";
      ...
      using lslboost::math::constants::pi;
    ...
    { // Cumulative Distribution Function arcsine.
      ...
      static const char* function = "lslboost::math::cdf(arcsine_distribution<%1%> const&, %1%)";
    ...
    { 
      ...
      using lslboost::math::constants::half_pi;

      static const char* function = "lslboost::math::quantile(arcsine_distribution<%1%> const&, %1%)";
