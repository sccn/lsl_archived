...
{ 
  ...
  inverse_gaussian_quantile_functor(const lslboost::math::inverse_gaussian_distribution<RealType> dist, RealType const& p)
  ...
  private:
  const lslboost::math::inverse_gaussian_distribution<RealType> distribution;
  RealType prob; 
};
...
{ 
    inverse_gaussian_quantile_complement_functor(const lslboost::math::inverse_gaussian_distribution<RealType> dist, RealType const& p)
    : distribution(dist), prob(p)
  {
  }
  lslboost::math::tuple<RealType, RealType> operator()(RealType const& x)
