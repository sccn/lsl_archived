...
public:
      ...
      : m_shape(l_shape), m_scale(l_scale)
   {
      ...
      detail::check_inverse_gamma(
        "lslboost::math::inverse_gamma_distribution<%1%>::inverse_gamma_distribution",
...
inline RealType pdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::pdf(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType cdf(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& x)
{
   ...
   static const char* function = "lslboost::math::cdf(const inverse_gamma_distribution<%1%>&, %1%)";
   ...
   result = lslboost::math::gamma_q(shape, scale / x, Policy());
...
inline RealType quantile(const inverse_gamma_distribution<RealType, Policy>& dist, const RealType& p)
{
   ...
   static const char* function = "lslboost::math::quantile(const inverse_gamma_distribution<%1%>&, %1%)";
...
inline RealType mean(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::mean(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 1) || !(lslboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType variance(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::variance(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 2) || !(lslboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType mode(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::mode(const inverse_gamma_distribution<%1%>&)";
...
inline RealType skewness(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::skewness(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 3) || !(lslboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
inline RealType kurtosis_excess(const inverse_gamma_distribution<RealType, Policy>& dist)
{
   ...
   static const char* function = "lslboost::math::kurtosis_excess(const inverse_gamma_distribution<%1%>&)";
   ...
   if((shape <= 4) || !(lslboost::math::isfinite)(shape))
   {
     result = policies::raise_domain_error<RealType>(
       function,
...
{
  static const char* function = "lslboost::math::kurtosis(const inverse_gamma_distribution<%1%>&)";
   RealType shape = dist.shape();
   RealType scale = dist.scale();
