...
#  elif defined(BOOST_NO_IS_CONVERTIBLE) || defined(BOOST_NO_SFINAE)
  ...
  struct enable_if_convertible
  {
      typedef lslboost::detail::enable_type type;
  };
...
# ifdef BOOST_ITERATOR_REF_CONSTNESS_KILLS_WRITABILITY
          , typename lslboost::detail::ia_dflt_help<
                Value
              , mpl::eval_if<
...
# endif
  ...
  class iterator_adaptor
    : public lslboost::detail::iterator_adaptor_base<
      ...
      >::type
  {
   ...
   protected:
      typedef typename lslboost::detail::iterator_adaptor_base<
          Derived, Base, Value, Traversal, Reference, Difference
      >::type super_t;
   public:
      iterator_adaptor() {}
...
# define BOOST_ITERATOR_ADAPTOR_ASSERT_TRAVERSAL(cat) \
      lslboost::detail::iterator_adaptor_assert_traversal<my_traversal, cat>();
