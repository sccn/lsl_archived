...
# include <lslboost/mpl/or.hpp>  // used in iterator_tag inheritance logic
...
# include <lslboost/iterator/detail/config_def.hpp> // try to keep this last
...
# ifdef BOOST_ITERATOR_REF_CONSTNESS_KILLS_WRITABILITY // Adding Thomas' logic?
  : mpl::or_<
        is_const<Reference>
      , lslboost::detail::indirect_traits::is_reference_to_const<Reference>
      , is_const<ValueParam>
    >
# else
  : is_const<ValueParam>
...
//
// Change at: https://svn.lslboost.org/trac/lslboost/changeset/21683
