...
// works with the new lslboost return and traversal category
// types. The exact lslboost _types_ are required. No derived types
// will work. 
//
//
...
# endif 
        ::lslboost::is_convertible<T1,T2>::value
      , ::lslboost::is_convertible<T2,T1>::value
# if BOOST_WORKAROUND(BOOST_MSVC, < 1300) // ETI workaround
