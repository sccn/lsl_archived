...
namespace lslboost
{
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public lslboost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    lslboost::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;
