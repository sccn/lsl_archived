...
// Use lslboost/limits to work around missing limits headers on some compilers
...
namespace lslboost_concepts
{
  // Used a different namespace here (instead of "lslboost") so that the
...

  {
      ...
      BOOST_CONCEPT_USAGE(ReadableIterator)
      {
          ...
          value_type v = *i;
          lslboost::ignore_unused_variable_warning(v);
      }
  private:
      Iterator i;
  };
  ...
  BOOST_concept(IncrementableIterator,(Iterator))
    ...
    , lslboost::CopyConstructible<Iterator>
  {
      typedef typename lslboost::iterator_traversal<Iterator>::type traversal_category;

      BOOST_CONCEPT_ASSERT((
        lslboost::Convertible<
            traversal_category
          , lslboost::incrementable_traversal_tag
        >));
  ...
  BOOST_concept(SinglePassIterator,(Iterator))
    ...
    , lslboost::EqualityComparable<Iterator>
    ...
    : BidirectionalTraversal<Iterator>
  {
      BOOST_CONCEPT_ASSERT((
          lslboost::Convertible<
           ...
           , lslboost::random_access_traversal_tag
          > ));
  ...
  namespace detail
  {
    ...
    void interop_single_pass_constraints(Iterator1 const& i1, Iterator2 const& i2)
    {
        ...
        b = i2 == i1;
        b = i2 != i1;
        lslboost::ignore_unused_variable_warning(b);
    }
        ...
        lslboost::random_access_traversal_tag, lslboost::random_access_traversal_tag)
    {
        ...
        n = i2 -  i1;
        lslboost::ignore_unused_variable_warning(b);
        lslboost::ignore_unused_variable_warning(n);
    }

    template <typename Iterator1, typename Iterator2>
    void interop_rand_access_constraints(
        Iterator1 const&, Iterator2 const&,
        lslboost::single_pass_traversal_tag, lslboost::single_pass_traversal_tag)
    { }
