...
#undef BOOST_LVALUE_PRESERVER
  ...
  {
      template <class It>
      struct rebind : lslboost::mpl::false_
      {};
  };
  ...
  struct is_readable_lvalue_iterator_impl
    : is_lvalue_iterator_impl<
          BOOST_DEDUCED_TYPENAME lslboost::detail::iterator_traits<It>::value_type const
      >::template rebind<It>
  {};
  ...
  struct is_non_const_lvalue_iterator_impl
    : is_lvalue_iterator_impl<
          BOOST_DEDUCED_TYPENAME lslboost::detail::iterator_traits<It>::value_type
      >::template rebind<It>
  {};
} // namespace detail

template< typename T > struct is_lvalue_iterator
: public ::lslboost::integral_constant<bool,::lslboost::iterators::detail::is_readable_lvalue_iterator_impl<T>::value>
{
public:
...
: public ::lslboost::integral_constant<bool,::lslboost::iterators::detail::is_non_const_lvalue_iterator_impl<T>::value>
{
public:
