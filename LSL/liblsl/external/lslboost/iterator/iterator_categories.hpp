...
struct iterator_category_to_traversal
  : mpl::eval_if< // if already convertible to a traversal tag, we're done.
      ...
      , mpl::identity<Cat>
      , lslboost::iterators::detail::old_category_to_traversal<Cat>
    >
{};
...
struct iterator_traversal
  : iterator_category_to_traversal<
        typename lslboost::detail::iterator_traits<Iterator>::iterator_category
    >
{};
...
// lslboost/range/detail/demote_iterator_traversal_tag.hpp
