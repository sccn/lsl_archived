...
#include <lslboost/iterator/iterator_adaptor.hpp> // for enable_if_convertible
...
namespace iterators {
  ...
  namespace detail
  {
    ...
    struct dereference_iterator
    {
      ...
      {
        typedef typename
          lslboost::detail::iterator_traits<Iterator>::reference
        type;
      };
    ...
    namespace tuple_impl_specific
    {
      ...
      struct tuple_meta_transform
        : mpl::eval_if<
              lslboost::is_same<Tuple, tuples::null_type>
...
# define BOOST_TUPLE_ALGO_RECURSE
      ...
      )
      {
        ...
        >(
            f(lslboost::tuples::get<0>(t)), tuple_transform(t.get_tail(), f)
        );
      }
...
# endif
    ...
    struct zip_iterator_base
    {
     private:
        ...
        typedef typename lslboost::detail::iterator_traits<
  ...
  private:
    ...
    {
        return lslboost::tuples::get<0>(other.get_iterator_tuple()) -
            lslboost::tuples::get<0>(this->get_iterator_tuple());
    }
