...
class permutation_iterator
  : public iterator_adaptor<
           ...
           , IndexIterator, typename lslboost::detail::iterator_traits<ElementIterator>::value_type
           , use_default, typename lslboost::detail::iterator_traits<ElementIterator>::reference>
{
  typedef iterator_adaptor<
            permutation_iterator<ElementIterator, IndexIterator>
          , IndexIterator, typename lslboost::detail::iterator_traits<ElementIterator>::value_type
          , use_default, typename lslboost::detail::iterator_traits<ElementIterator>::reference> super_t;
