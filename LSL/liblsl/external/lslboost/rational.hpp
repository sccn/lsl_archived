...
// lslboostinspect:nolicense (don't complain about the lack of a Boost license)
// (Paul Moore hasn't been in contact for years, so there's no way to change the
// license.)

//  See http://www.lslboost.org/libs/rational for documentation.

//  Credits:
//  Thanks to the lslboost mailing list in general for useful comments.
...
//  14 Dec 99  Modifications based on comments from the lslboost list
//  09 Dec 99  Initial Version (Paul Moore)

#ifndef BOOST_RATIONAL_HPP
#define BOOST_RATIONAL_HPP

#include <lslboost/config.hpp>      // for BOOST_NO_STDC_NAMESPACE, BOOST_MSVC, etc
...
#include <lslboost/operators.hpp>   // for lslboost::addable etc
#include <cstdlib>               // for std::abs
#include <lslboost/call_traits.hpp> // for lslboost::call_traits
#include <lslboost/detail/workaround.hpp> // for BOOST_WORKAROUND
#include <lslboost/assert.hpp>      // for BOOST_ASSERT
#include <lslboost/integer/common_factor_rt.hpp> // for lslboost::integer::gcd, lcm
#include <limits>                // for std::numeric_limits
#include <lslboost/static_assert.hpp>  // for BOOST_STATIC_ASSERT
