 ...
 *
 * which fill the extra args with lslboost::multi_index::detail::noarg's.
 * lslboost::multi_index::detail::vartempl_placement_new works the opposite
...
lslboost::forward<BOOST_PP_CAT(T,n)>(BOOST_PP_CAT(t,n))
...
namespace lslboost{namespace multi_index{namespace detail{
struct noarg{};
}}}
...
BOOST_PP_ENUM_PARAMS(                                                \
  BOOST_MULTI_INDEX_LIMIT_VARTEMPL_ARGS,                             \
  lslboost::multi_index::detail::noarg() BOOST_PP_INTERCEPT)
