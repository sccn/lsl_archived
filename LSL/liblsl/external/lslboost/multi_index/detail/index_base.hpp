...
#include <lslboost/multi_index/detail/copy_map.hpp>
#include <lslboost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <lslboost/multi_index/detail/node_type.hpp>
...
#include <lslboost/multi_index/detail/index_loader.hpp>
#include <lslboost/multi_index/detail/index_saver.hpp>
#endif
...
protected:
  ...
  {
    lslboost::detail::allocator::construct(&x->value(),v);
    return x;
  }
  ...
  node_type* insert_(const value_type& v,node_type* x,rvalue_tag)
  {
     ...
     * lslboost::detail::allocator::construct, but 
     * <lslboost/detail/allocator_utilities.hpp> is too old and venerable to mess
    ...
    new (&x->value()) value_type(lslboost::move(const_cast<value_type&>(v)));
    return x;
  }
  ...
  {
    x->value()=lslboost::move(const_cast<value_type&>(v));
    return true;
  }
