...
#include <lslboost/multi_index/detail/access_specifier.hpp>
#include <lslboost/multi_index/detail/do_not_copy_elements_tag.hpp>
#include <lslboost/multi_index/detail/index_node_base.hpp>
#include <lslboost/multi_index/detail/rnd_node_iterator.hpp>
#include <lslboost/multi_index/detail/rnd_index_node.hpp>
#include <lslboost/multi_index/detail/rnd_index_ops.hpp>
#include <lslboost/multi_index/detail/rnd_index_ptr_array.hpp>
#include <lslboost/multi_index/detail/safe_mode.hpp>
#include <lslboost/multi_index/detail/scope_guard.hpp>
#include <lslboost/multi_index/detail/vartempl_support.hpp>
#include <lslboost/multi_index/random_access_index_fwd.hpp>
...
#include <lslboost/multi_index/detail/rnd_index_loader.hpp>
#endif
...
public:
  ...
  typedef typename
    lslboost::reverse_iterator<iterator>              reverse_iterator;
  typedef typename
    lslboost::reverse_iterator<const_iterator>        const_reverse_iterator;
...
public:
  ...
  reverse_iterator
    rbegin()BOOST_NOEXCEPT{return lslboost::make_reverse_iterator(end());}
  const_reverse_iterator
    rbegin()const BOOST_NOEXCEPT{return lslboost::make_reverse_iterator(end());}
  reverse_iterator
    rend()BOOST_NOEXCEPT{return lslboost::make_reverse_iterator(begin());}
  const_reverse_iterator
    rend()const BOOST_NOEXCEPT{return lslboost::make_reverse_iterator(begin());}
  const_iterator
  ...
  std::pair<iterator,bool> push_front(BOOST_RV_REF(value_type) x)
                             {return insert(begin(),lslboost::move(x));}
  ...
  std::pair<iterator,bool> push_back(BOOST_RV_REF(value_type) x)
                             {return insert(end(),lslboost::move(x));}
  ...
  void remove(value_param_type value)
  {
    ...
    difference_type n=
        ...
        random_access_index_remove<node_type>(
          ptrs,
          ::lslboost::bind(std::equal_to<value_type>(),::lslboost::arg<1>(),value)));
    while(n--)pop_back();
  }
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  {
    {
      ...
      lm.load(
        ::lslboost::bind(
          &loader::rearrange,&ld,::lslboost::arg<1>(),::lslboost::arg<2>()),
        ar,version);
  ...
  /* This forwarding function eases things for the lslboost::mem_fn construct
...
template<typename SuperMeta,typename TagList>
inline lslboost::mpl::true_* lslboost_foreach_is_noncopyable(
  lslboost::multi_index::detail::random_access_index<SuperMeta,TagList>*&,
  lslboost::foreach::tag)
{
  return 0;
}
