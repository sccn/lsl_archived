...
#include <lslboost/multi_index/detail/bidir_node_iterator.hpp>
...
#include <lslboost/multi_index/detail/seq_index_node.hpp>
#include <lslboost/multi_index/detail/seq_index_ops.hpp>
#include <lslboost/multi_index/detail/vartempl_support.hpp>
#include <lslboost/multi_index/sequenced_index_fwd.hpp>
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
    ...
    Archive& ar,const unsigned int version,const index_loader_type& lm)
  {
    lm.load(
      ::lslboost::bind(
        &sequenced_index::rearranger,this,::lslboost::arg<1>(),::lslboost::arg<2>()),
      ar,version);
...
inline lslboost::mpl::true_* lslboost_foreach_is_noncopyable(
  lslboost::multi_index::detail::sequenced_index<SuperMeta,TagList>*&,
