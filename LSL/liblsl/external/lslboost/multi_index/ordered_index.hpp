...
#include <lslboost/multi_index/detail/safe_ctr_proxy.hpp>
...
#include <lslboost/multi_index/ordered_index_fwd.hpp>
...
private:
  ...
  {
    lm.load(
      ::lslboost::bind(&ordered_index::rearranger,this,_1,_2),
      ar,version);
    super::load_(ar,version,lm);
  }
