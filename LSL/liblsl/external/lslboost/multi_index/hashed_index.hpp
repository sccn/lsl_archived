...
#include <lslboost/multi_index/hashed_index_fwd.hpp>
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  bool equals(const hashed_index& x,hashed_non_unique_tag)const
  {
    ...
    for(const_iterator it=begin(),it_end=end();it!=it_end;){
      ...
      lslboost::tie(it2,it2_last)=x.equal_range(key(*it));
...
inline lslboost::mpl::true_* lslboost_foreach_is_noncopyable(
  lslboost::multi_index::detail::hashed_index<
