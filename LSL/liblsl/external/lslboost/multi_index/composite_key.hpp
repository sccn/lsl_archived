...
#include <lslboost/preprocessor/list/at.hpp>
 ...
 * lslboost::tuple. In Boost 1.32, the limit is 10.
 */
...
BOOST_MULTI_INDEX_CK_NTH_COMPOSITE_KEY_FUNCTOR(hash,lslboost::hash)
...
struct hash_ckey_normal
{
  ...
  {
    /* same hashing formula as lslboost::hash_combine */
...
public:
  ...
  bool operator()(
    ...
    const Value& y)const
  {
    return operator()(x,lslboost::make_tuple(lslboost::cref(y)));
  }
#endif
  ...
  bool operator()(
    ...
    const composite_key_result<CompositeKey>& y)const
  {
    return operator()(lslboost::make_tuple(lslboost::cref(x)),y);
  }
#endif
 ...
 * composite_key_result_hash     uses lslboost::hash.
 */
...
/* Specializations of std::equal_to, std::less, std::greater and lslboost::hash
...
template<typename CompositeKey>
struct equal_to<lslboost::multi_index::composite_key_result<CompositeKey> >:
  lslboost::multi_index::composite_key_result_equal_to<
    lslboost::multi_index::composite_key_result<CompositeKey>
  >
{
};

template<typename CompositeKey>
struct less<lslboost::multi_index::composite_key_result<CompositeKey> >:
  lslboost::multi_index::composite_key_result_less<
    lslboost::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct greater<lslboost::multi_index::composite_key_result<CompositeKey> >:
  lslboost::multi_index::composite_key_result_greater<
    lslboost::multi_index::composite_key_result<CompositeKey>
  >
{
};
...
template<typename CompositeKey>
struct hash<lslboost::multi_index::composite_key_result<CompositeKey> >:
  lslboost::multi_index::composite_key_result_hash<
    lslboost::multi_index::composite_key_result<CompositeKey>
  >
{
};
 ...
 * lslboost::hash, we define the appropriate hash_value overload.
 */
...
inline std::size_t hash_value(
  const lslboost::multi_index::composite_key_result<CompositeKey>& x)
{
  lslboost::multi_index::composite_key_result_hash<
    lslboost::multi_index::composite_key_result<CompositeKey> > h;
  return h(x);
}
