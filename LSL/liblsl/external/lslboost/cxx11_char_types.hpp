...
//                                                                                      //
//  The emulation names are placed in namespace lslboost, as is usual for Boost C++11      //
//  emulation names such as those in header <lslboost/cstdint.hpp>.                        //
//                                                                                      //
...
//   Boost               C++11            C++03                                         //
//   ----------------    --------------   --------------------------------              //
//   lslboost::char16       char16_t         uint16_t                                      //
//   lslboost::char32       char32_t         uint32_t                                      //
//   lslboost::u16string    std::u16string   std::basic_string<lslboost::char16>              //
//   lslboost::u32string    std::u32string   std::basic_string<lslboost::char32>              //
//                                                                                      //
...
# if defined(BOOST_NO_CHAR16_T) && (!defined(_MSC_VER) || _MSC_VER < 1600)  // 1600 == VC++10 
    typedef lslboost::uint_least16_t             char16;
    typedef std::basic_string<lslboost::char16>  u16string;
# else
...
# if defined(BOOST_NO_CHAR32_T) && (!defined(_MSC_VER) || _MSC_VER < 1600)  // 1600 == VC++10 
    typedef  lslboost::uint_least32_t            char32;
    typedef std::basic_string<lslboost::char32>  u32string;
# else
