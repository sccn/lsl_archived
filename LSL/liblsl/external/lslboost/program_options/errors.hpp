...
#   pragma warning (push)
#   pragma warning (disable:4275) // non dll-interface class 'std::logic_error' used as base for dll-interface class 'lslboost::program_options::error'
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'lslboost::program_options::ambiguous_option'
#endif
...
namespace lslboost { namespace program_options {
    ...
    */
     ...
     *      Poor man's version of lslboost::format
     *  
