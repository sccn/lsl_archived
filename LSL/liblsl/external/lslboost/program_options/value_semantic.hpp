...
#include <lslboost/program_options/errors.hpp>

#include <lslboost/any.hpp>
...
namespace lslboost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        */
        virtual void parse(lslboost::any& value_store, 
        ...
        /** Called to assign default value to 'value_store'. Returns
            ...
            value exists. */
        virtual bool apply_default(lslboost::any& value_store) const = 0;
                                   
        /** Called when final value of an option is determined. 
        */
        virtual void notify(const lslboost::any& value_store) const = 0;
    ...
    */
    ...
    private: // base overrides
        void parse(lslboost::any& value_store, 
                   const std::vector<std::string>& new_tokens,
                   bool utf8) const;
    protected: // interface for derived classes.
        virtual void xparse(lslboost::any& value_store, 
                            const std::vector<std::string>& new_tokens) 
            const = 0;
    };
    ...
    */
    ...
    public:
        ...
        /** If 'value_store' is already initialized, or new_tokens
            ...
            any modifications.
         */
        void xparse(lslboost::any& value_store,
                    const std::vector<std::string>& new_tokens) const;

        /** Does nothing. */
        bool apply_default(lslboost::any&) const { return false; }

        /** Does nothing. */
        void notify(const lslboost::any&) const {}        
    private:
        bool m_zero_tokens;
    };
    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            m_default_value = lslboost::any(v);
            m_default_value_as_text = lslboost::lexical_cast<std::string>(v);
            return this;
        }
        ...
        */
        ...
        {
            m_implicit_value = lslboost::any(v);
            m_implicit_value_as_text =
                lslboost::lexical_cast<std::string>(v);
            return this;
        }
    ...
    public: // value semantic overrides
        ...
        */
        virtual bool apply_default(lslboost::any& value_store) const
        {
        ...
        /** If an address of variable to store value was specified
            ...
            does nothing. */
        void notify(const lslboost::any& value_store) const;
    ...
    private:
        ...
        // Default value is stored as lslboost::any and not
        // as lslboost::optional to avoid unnecessary instantiations.
        std::string m_value_name;
        lslboost::any m_default_value;
        std::string m_default_value_as_text;
        lslboost::any m_implicit_value;
        std::string m_implicit_value_as_text;
        bool m_composing, m_implicit, m_multitoken, m_zero_tokens, m_required;
        lslboost::function1<void, const T&> m_notifier;
    };
...
#include "lslboost/program_options/detail/value_semantic.hpp"
