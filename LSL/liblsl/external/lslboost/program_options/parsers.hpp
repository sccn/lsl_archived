...
#include <lslboost/program_options/detail/cmdline.hpp>
...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'lslboost::program_options::basic_parsed_options<wchar_t>'
#endif
...
#include "lslboost/program_options/detail/parsers.hpp"
