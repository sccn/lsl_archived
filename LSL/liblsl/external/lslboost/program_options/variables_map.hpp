...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'lslboost::program_options::variable_value::v' : class 'lslboost::any' needs to have dll-interface to be used by clients of class 'lslboost::program_options::variable_value
#endif
...
namespace lslboost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const lslboost::any& xv, bool xdefaulted) 
        : v(xv), m_defaulted(xdefaulted) 
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws lslboost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return lslboost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return lslboost::any_cast<T&>(v);
       }
        ...
        const lslboost::any& value() const;
