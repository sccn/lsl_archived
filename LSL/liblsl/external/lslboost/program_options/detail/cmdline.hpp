...
#include <lslboost/program_options/cmdline.hpp>
#include <lslboost/program_options/option.hpp>
#include <lslboost/program_options/options_description.hpp>
#include <lslboost/program_options/positional_options.hpp>
...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'lslboost::program_options::positional_options_description'
#endif
...
namespace lslboost { namespace program_options { namespace detail {
    ...
    */
    ...
    public:
        ...
        typedef ::lslboost::program_options::command_line_style::style_t style_t;
