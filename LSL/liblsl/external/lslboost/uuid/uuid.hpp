...
//  25 Feb 2008 - moved to namespace lslboost::uuids
...
#include <lslboost/uuid/detail/config.hpp>
...
// This is equivalent to lslboost::hash_range(u.begin(), u.end());
...
#include <lslboost/uuid/detail/uuid_x86.hpp>
#else
#include <lslboost/uuid/detail/uuid_generic.hpp>
#endif
