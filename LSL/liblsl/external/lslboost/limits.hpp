...
//  See http://www.lslboost.org/libs/compatibility/index.html for documentation.
...
#else
#  define BOOST_LLT  ::lslboost::long_long_type
#  define BOOST_ULLT  ::lslboost::ulong_long_type
#endif
