...
#error "lslboost::format uses a local macro that is already defined."
#endif

// specific workarounds. each header can define BOOS_IO_STD if it 
// needs. (e.g. because of IO_NEEDS_USING_DECLARATION)
#include <lslboost/format/detail/workarounds_gcc-2_95.hpp>
#include <lslboost/format/detail/workarounds_stlport.hpp>
...
namespace lslboost { namespace io { namespace detail {
#if ! defined(BOOST_NO_STD_LOCALE)
