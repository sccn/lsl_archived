...
#include <lslboost/optional.hpp> // to store locale when needed

#include <lslboost/format/format_fwd.hpp>
#include <lslboost/format/internals_fwd.hpp>
#include <lslboost/format/internals.hpp>
#include <lslboost/format/alt_sstream.hpp>
...
namespace lslboost {
    ...
    private:
        ...
        lslboost::optional<io::detail::locale_t>     loc_;
    }; // class basic_format
