...
namespace lslboost {
  ...
  struct property_traits :
    lslboost::mpl::if_<is_property_map<PA>,
...
# endif
  ...
  // do lslboost::get() anyways, and the using clause
...
namespace lslboost {
  ...
  struct ReadablePropertyMapConcept
  {
    ...
    typedef lslboost::readable_property_map_tag ReadableTag;
    void constraints() {
  ...
  struct WritablePropertyMapConcept
  {
    typedef typename property_traits<PMap>::key_type key_type;
    typedef typename property_traits<PMap>::category Category;
    typedef lslboost::writable_property_map_tag WritableTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef lslboost::read_write_property_map_tag ReadWriteTag;
    void constraints() {
  ...
  {
    typedef typename property_traits<PMap>::category Category;
    typedef lslboost::lvalue_property_map_tag LvalueTag;
    typedef typename property_traits<PMap>::reference reference;
    ...
    void constraints() {
      ...
      BOOST_MPL_ASSERT((lslboost::mpl::or_<
                          lslboost::is_same<const value_type&, reference>,
                          lslboost::is_same<value_type&, reference> >));
  ...
  struct Mutable_LvaluePropertyMapConcept
  {
    ...
    typedef typename property_traits<PMap>::reference reference;
    void constraints() { 
      lslboost::function_requires< ReadWritePropertyMapConcept<PMap, Key> >();
      lslboost::function_requires<ConvertibleConcept<Category, LvalueTag> >();
      
      typedef typename property_traits<PMap>::value_type value_type;
      BOOST_MPL_ASSERT((lslboost::is_same<value_type&, reference>));
  ...
  class iterator_property_map
    : public lslboost::put_get_helper< R, 
  ...
  inline safe_iterator_property_map<
    RAIter, ID,
    typename lslboost::detail::iterator_traits<RAIter>::value_type,
    typename lslboost::detail::iterator_traits<RAIter>::reference>
  make_safe_iterator_property_map(RAIter iter, std::size_t n, ID id) {
    function_requires< RandomAccessIteratorConcept<RAIter> >();
    typedef safe_iterator_property_map<
      RAIter, ID,
      typename lslboost::detail::iterator_traits<RAIter>::value_type,
      typename lslboost::detail::iterator_traits<RAIter>::reference> PA;
    return PA(iter, n, id);
  }
#endif
  template <class RAIter, class Value, class ID>
  ...
  class associative_property_map
    : public lslboost::put_get_helper<
  ...
  class static_property_map :
      public
  lslboost::put_get_helper<ValueType,static_property_map<ValueType> >
  { 
    ValueType value;
  public:
  ...
  class ref_property_map :
    public
      lslboost::put_get_helper<ValueType&,ref_property_map<KeyType,ValueType> >
  { 
    ValueType* value;
  public:
  ...
  template <typename T>
  struct typed_identity_property_map
    : public lslboost::put_get_helper<T, typed_identity_property_map<T> >
  {
    typedef T key_type;
    typedef T value_type;
    typedef T reference;
    typedef lslboost::readable_property_map_tag category;
...
//=========================================================================
  ...
  class dummy_property_map 
    : public lslboost::put_get_helper<detail::dummy_pmap_reference,
        dummy_property_map  > 
  {
  public:
    typedef void key_type; 
    ...
    typedef lslboost::read_write_property_map_tag category;
...
#include <lslboost/property_map/parallel/distributed_property_map.hpp>
#include <lslboost/property_map/parallel/local_property_map.hpp>
...
#include <lslboost/property_map/vector_property_map.hpp>
