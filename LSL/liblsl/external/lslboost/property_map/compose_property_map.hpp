...
{
public:
    typedef typename lslboost::property_traits<FPMap>::category category;
    typedef typename lslboost::property_traits<GPMap>::key_type key_type; 
    typedef typename lslboost::property_traits<FPMap>::value_type value_type;
    typedef typename lslboost::property_traits<FPMap>::reference reference;
    ...
    // else
    //     const value_type&
    inline friend typename lslboost::mpl::if_<
        lslboost::mpl::not_< lslboost::is_reference<reference> >,
        value_type,
        typename lslboost::mpl::if_<
            lslboost::is_const<reference>,
            reference,
            const value_type&
            >::type
        >::type
