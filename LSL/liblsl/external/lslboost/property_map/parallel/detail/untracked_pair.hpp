...
namespace lslboost { namespace parallel { namespace detail {
...
} } } // end namespace lslboost::parallel::detail

namespace lslboost { namespace mpi {

template<typename T, typename U>
struct is_mpi_datatype<lslboost::parallel::detail::untracked_pair<T, U> >
...
inline void serialize(
    Archive & ar,
    lslboost::parallel::detail::untracked_pair<F, S> & p,
    const unsigned int /* file_version */
){
    ar & lslboost::serialization::make_nvp("first", p.first);
    ar & lslboost::serialization::make_nvp("second", p.second);
}

template<typename T, typename U>
struct is_bitwise_serializable<
        lslboost::parallel::detail::untracked_pair<T, U> >
  : is_bitwise_serializable<std::pair<T, U> > {};

template<typename T, typename U>
struct implementation_level<lslboost::parallel::detail::untracked_pair<T, U> >
 : mpl::int_<object_serializable> {} ;

template<typename T, typename U>
struct tracking_level<lslboost::parallel::detail::untracked_pair<T, U> >
