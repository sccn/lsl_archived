...
namespace detail {
  ...
  { return lslboost::lexical_cast<Value>(value); }
...
public:
  ...
  virtual lslboost::any get(const any& key) = 0;
...
typename lslboost::property_traits<PMap>::reference
...
public:
  ...
  virtual lslboost::any get(const any& key_)
  {
    return get_wrapper_xxx(property_map_, any_cast<typename lslboost::property_traits<PropertyMap>::key_type>(key_));
  }

  virtual std::string get_string(const any& key_)
  {
    std::ostringstream out;
    out << get_wrapper_xxx(property_map_, any_cast<typename lslboost::property_traits<PropertyMap>::key_type>(key_));
    return out.str();
  }
...
{
  typedef std::multimap<std::string, lslboost::shared_ptr<dynamic_property_map> >
    property_maps_type;
  typedef lslboost::function3<lslboost::shared_ptr<dynamic_property_map>,
                           const std::string&,
                           const lslboost::any&,
                           const lslboost::any&> generate_fn_type;
public:
  ...
  void
  insert(const std::string& name, lslboost::shared_ptr<dynamic_property_map> pm)
  {
    property_maps.insert(property_maps_type::value_type(name, pm));
  }

  template<typename Key, typename Value>
  lslboost::shared_ptr<dynamic_property_map>
    ...
    const Value& value)
{
  ...
  lslboost::shared_ptr<dynamic_property_map> new_map = dp.generate(name, key, value);
  if (new_map.get()) {
...
inline
lslboost::shared_ptr<lslboost::dynamic_property_map>
ignore_other_properties(const std::string&,
                        const lslboost::any&,
                        const lslboost::any&) {
  return lslboost::shared_ptr<lslboost::dynamic_property_map>();
}
