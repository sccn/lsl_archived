...
#include <lslboost/config.hpp>  // for BOOST_NESTED_TEMPLATE, etc.
...
};  // lslboost::integer::gcd_evaluator
...
};  // lslboost::integer::lcm_evaluator
...
#define BOOST_PRIVATE_GCD_UF( Ut )                  \
    ...
    BOOST_PRIVATE_GCD_UF( lslboost::ulong_long_type );
...
#ifdef BOOST_HAS_LONG_LONG
    BOOST_PRIVATE_GCD_SF( lslboost::long_long_type, lslboost::ulong_long_type );
#elif defined(BOOST_HAS_MS_INT64)
