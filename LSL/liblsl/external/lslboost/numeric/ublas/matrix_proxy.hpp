...
#include <lslboost/numeric/ublas/detail/vector_assign.hpp>
#include <lslboost/numeric/ublas/detail/matrix_assign.hpp>
#include <lslboost/numeric/ublas/detail/temporary.hpp>
...
namespace lslboost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename lslboost::mpl::if_<lslboost::is_const<M>,
    ...
    public:
        ...
        public:
            ...
            BOOST_STATIC_ASSERT ((lslboost::is_same<typename M::const_iterator1::iterator_category, typename M::const_iterator2::iterator_category>::value ));
     ...
     * - \c lslboost::numeric::ublas::indirect_array<A> where \c A can be \c int, \c size_t, \c long, etc...
     * - \c lslboost::numeric::ublas::matrix<int> can work too (\c int can be replaced by another integer type)
     * - etc...
     *
