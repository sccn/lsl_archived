...
#include <lslboost/numeric/ublas/storage.hpp>
...
namespace lslboost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        typedef typename lslboost::remove_cv<typename vector_view_traits<JA>::value_type>::type index_type;
    ...
    private:
        ...
        const_pointer find_element (index_type i, index_type j) const {
            ...
            const_subiterator_type it_start = lslboost::next(vector_view_traits<index_array_type>::begin(index2_data_),itv);
            const_subiterator_type it_end = lslboost::next(vector_view_traits<index_array_type>::begin(index2_data_),itv_next);
