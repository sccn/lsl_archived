...
#include <lslboost/numeric/ublas/matrix_proxy.hpp>//for matrix_row, matrix_column and matrix_expression
...
class matrix_vector_iterator: public lslboost::iterator_facade<
...
public:
    ...
    typedef typename lslboost::iterator_difference<iterator>::type difference_type;
