...
#include <lslboost/core/ignore_unused.hpp>

#include <lslboost/numeric/ublas/traits.hpp>
#ifdef BOOST_UBLAS_USE_DUFF_DEVICE
#include <lslboost/numeric/ublas/detail/duff.hpp>
#endif
#ifdef BOOST_UBLAS_USE_SIMD
#include <lslboost/numeric/ublas/detail/raw.hpp>
#else
namespace lslboost { namespace numeric { namespace ublas { namespace raw {
}}}}
#endif
#ifdef BOOST_UBLAS_HAVE_BINDINGS
#include <lslboost/numeric/bindings/traits/std_vector.hpp>
#include <lslboost/numeric/bindings/traits/ublas_vector.hpp>
#include <lslboost/numeric/bindings/traits/ublas_matrix.hpp>
#include <lslboost/numeric/bindings/atlas/cblas.hpp>
#endif

#include <lslboost/numeric/ublas/detail/definitions.hpp>
...
namespace lslboost { namespace numeric { namespace ublas {
    ...
    struct scalar_binary_assign_functor {
        ...
        typedef typename type_traits<typename lslboost::remove_reference<T1>::type>::reference argument1_type;
        typedef typename type_traits<T2>::const_reference argument2_type;
    };
    ...
    struct scalar_binary_swap_functor {
        typedef typename type_traits<typename lslboost::remove_reference<T1>::type>::reference argument1_type;
        typedef typename type_traits<typename lslboost::remove_reference<T2>::type>::reference argument2_type;
    };
    ...
    struct vector_inner_prod:
        ...
        result_type apply (const vector_container<C1> &c1,
            ...
            return lslboost::numeric::bindings::atlas::dot (c1 (), c2 ());
#else
    ...
    struct matrix_vector_prod1:
        ...
        result_type apply (const matrix_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return lslboost::numeric::bindings::atlas::dot (c1 ().row (i), c2 ());
#else
    ...
    struct matrix_vector_prod2:
        ...
        result_type apply (const vector_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return lslboost::numeric::bindings::atlas::dot (c1 (), c2 ().column (i));
#else
    ...
    struct matrix_matrix_prod:
        ...
        result_type apply (const matrix_container<C1> &c1,
            ...
            return t;
#elif defined(BOOST_UBLAS_HAVE_BINDINGS)
            return lslboost::numeric::bindings::atlas::dot (c1 ().row (i), c2 ().column (j));
#else
            lslboost::ignore_unused(j);
