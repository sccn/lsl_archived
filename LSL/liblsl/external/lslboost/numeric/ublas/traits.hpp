...
#include <lslboost/numeric/ublas/detail/iterator.hpp>
#include <lslboost/numeric/ublas/detail/returntype_deduction.hpp>
...
namespace {
  template<class T> T lslboost_numeric_ublas_sqrt (const T& t) {
    using namespace std;
    // we'll find either std::sqrt or else another version via ADL:
    return sqrt (t);
  }
  template<class T> T lslboost_numeric_ublas_abs (const T& t) {
    using namespace std;
...
namespace lslboost { namespace numeric { namespace ublas {
    ...
    struct scalar_traits {
        ...
        real_type type_abs (const_reference t) {
            return lslboost_numeric_ublas_abs (t);
        }
        static
        BOOST_UBLAS_INLINE
        value_type type_sqrt (const_reference t) {
            // force a type conversion back to value_type for intgral types
            return value_type (lslboost_numeric_ublas_sqrt (t));
        }
    ...
    template<>
    struct type_traits<lslboost::numeric::interval<float> > : scalar_traits<lslboost::numeric::interval<float> > {
        typedef type_traits<lslboost::numeric::interval<float> > self_type;
        typedef lslboost::numeric::interval<float> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef lslboost::numeric::interval<double> precision_type;

    };
    template<>
    struct type_traits<lslboost::numeric::interval<double> > : scalar_traits<lslboost::numeric::interval<double> > {
        typedef type_traits<lslboost::numeric::interval<double> > self_type;
        typedef lslboost::numeric::interval<double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef lslboost::numeric::interval<long double> precision_type;
    };
    template<>
    struct type_traits<lslboost::numeric::interval<long double> > : scalar_traits<lslboost::numeric::interval<long double> > {
        typedef type_traits<lslboost::numeric::interval<long double> > self_type;
        typedef lslboost::numeric::interval<long double> value_type;
        typedef const value_type &const_reference;
        typedef value_type &reference;
        typedef value_type real_type;
        typedef value_type precision_type;
    ...
    namespace detail {
        ...
        template<typename T>
        struct has_trivial_constructor : public lslboost::has_trivial_constructor<T> {};

        template<typename T>
        struct has_trivial_destructor : public lslboost::has_trivial_destructor<T> {};

        template<typename FLT>
        struct has_trivial_constructor<std::complex<FLT> > : public lslboost::true_type {};
        
        template<typename FLT>
        struct has_trivial_destructor<std::complex<FLT> > : public lslboost::true_type {};
