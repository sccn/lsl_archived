...
#include <lslboost/numeric/ublas/storage_sparse.hpp>
#include <lslboost/numeric/ublas/matrix_sparse.hpp>
...
namespace lslboost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        const_pointer find_element (size_type i, size_type j) const {
            ...
            if (lslboost::is_convertible<typename array_type::storage_category, packed_tag>::value) {
