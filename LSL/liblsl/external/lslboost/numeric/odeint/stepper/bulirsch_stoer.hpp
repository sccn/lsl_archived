/*
  [auto_generated]
  lslboost/numeric/odeint/stepper/bulirsch_stoer.hpp
...
#include <lslboost/config.hpp> // for min/max guidelines

#include <lslboost/numeric/odeint/util/bind.hpp>
#include <lslboost/numeric/odeint/util/unwrap_reference.hpp>

#include <lslboost/numeric/odeint/stepper/controlled_runge_kutta.hpp>
#include <lslboost/numeric/odeint/stepper/modified_midpoint.hpp>
#include <lslboost/numeric/odeint/stepper/controlled_step_result.hpp>
...
#include <lslboost/numeric/odeint/util/unit_helper.hpp>
#include <lslboost/numeric/odeint/util/detail/less_with_sign.hpp>
...
public:
    ...
    typedef std::vector< inv_time_type > inv_time_vector;  //should be 1/time_type for lslboost.units
     ...
     *
     * this version does not solve the forwarding problem, lslboost.range can not be used
     */
    ...
    controlled_step_result try_step( System system , StateInOut &x , const DerivIn &dxdt , time_type &t , time_type &dt )
    {
        ...
        if( res == success )
        {
            lslboost::numeric::odeint::copy( m_xnew.m_v , x );
        }
        return res;
    }
    ...
    typename lslboost::disable_if< lslboost::is_same< StateIn , time_type > , controlled_step_result >::type
    ...
    controlled_step_result try_step( System system , const StateIn &in , const DerivIn &dxdt , time_type &t , StateOut &out , time_type &dt )
    {
        ...
        if( !m_last_step_rejected || lslboost::numeric::odeint::detail::less_with_sign(new_h, dt, dt) )
        {
            m_dt_last = new_h;
            dt = new_h;
        }
