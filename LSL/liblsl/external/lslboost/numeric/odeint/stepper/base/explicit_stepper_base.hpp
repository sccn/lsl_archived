/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/base/explicit_stepper_base.hpp
...
public:
    ...
    typename lslboost::disable_if< lslboost::is_same< DerivIn , time_type > , void >::type
 ...
 *
 * \note The system is always passed as value, which might result in poor performance if it contains data. In this case it can be used with `lslboost::ref`
 * or `std::ref`, for example `stepper.do_step( lslboost::ref( sys ) , x , t , dt );`
 *
