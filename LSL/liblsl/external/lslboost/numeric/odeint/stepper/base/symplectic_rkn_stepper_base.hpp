/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/base/symplectic_rkn_stepper_base.hpp
...
#include <lslboost/numeric/odeint/util/is_pair.hpp>
...
#include <lslboost/numeric/odeint/stepper/base/algebra_stepper_base.hpp>
...
public:
    ...
    typedef lslboost::array< value_type , num_of_stages > coef_type;
...
private:
    ...
    template< class System , class StateIn , class StateOut >
    void do_step_impl( System system , const StateIn &in , time_type /* t */ , StateOut &out , time_type dt , lslboost::mpl::true_ )
    {
        typedef typename odeint::unwrap_reference< System >::type system_type;
    ...
    template< class System , class StateIn , class StateOut >
    void do_step_impl( System system , const StateIn &in , time_type  /* t */ , StateOut &out , time_type dt , lslboost::mpl::false_ )
    {
 ...
 */
     ...
     * is updated in-place.
     *
     * \note lslboost::ref or std::ref can be used for the system as well as for the state. So, it is correct
     ...
     * is updated in-place.
     *
     * \note lslboost::ref or std::ref can be used for the system. So, it is correct
