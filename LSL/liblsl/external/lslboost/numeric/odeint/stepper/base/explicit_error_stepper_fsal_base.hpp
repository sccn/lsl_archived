/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/base/explicit_error_stepper_fsal_base.hpp
...
public:
    ...
    typename lslboost::disable_if< lslboost::is_same< StateInOut , time_type > , void >::type
     ...
     *
     * this version does not solve the forwarding problem, lslboost.range can not
     * be used.
     *
    ...
    typename lslboost::disable_if< lslboost::is_same< StateIn , time_type > , void >::type
    ...
    {
        lslboost::numeric::odeint::copy( deriv , m_dxdt.m_v );
        m_first_call = false;
    }
 ...
 *      case it can be used with `lslboost::ref` or `std::ref`, for example `stepper.do_step( lslboost::ref( sys ) , x , t , dt );`
 *
