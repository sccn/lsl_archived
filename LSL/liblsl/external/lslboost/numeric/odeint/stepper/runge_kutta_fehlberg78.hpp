/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/runge_kutta_fehlberg87.hpp
...
#include <lslboost/numeric/odeint/stepper/explicit_error_generic_rk.hpp>
...
#include <lslboost/numeric/odeint/algebra/operations_dispatcher.hpp>
...
#include <lslboost/numeric/odeint/util/resizer.hpp>
...
struct rk78_coefficients_a1 : lslboost::array< Value , 1 >
{
...
template< class Value = double >
struct rk78_coefficients_a2 : lslboost::array< Value , 2 >
{
...
template< class Value = double >
struct rk78_coefficients_a3 : lslboost::array< Value , 3 >
{
...
template< class Value = double >
struct rk78_coefficients_a4 : lslboost::array< Value , 4 >
{
...
template< class Value = double >
struct rk78_coefficients_a5 : lslboost::array< Value , 5 >
{
...
template< class Value = double >
struct rk78_coefficients_a6 : lslboost::array< Value , 6 >
{
...
template< class Value = double >
struct rk78_coefficients_a7 : lslboost::array< Value , 7 >
{
...
template< class Value = double >
struct rk78_coefficients_a8 : lslboost::array< Value , 8 >
{
...
template< class Value = double >
struct rk78_coefficients_a9 : lslboost::array< Value , 9 >
{
...
template< class Value = double >
struct rk78_coefficients_a10 : lslboost::array< Value , 10 >
{
...
template< class Value = double >
struct rk78_coefficients_a11 : lslboost::array< Value , 11 >
{
...
template< class Value = double >
struct rk78_coefficients_a12 : lslboost::array< Value , 12 >
{
...
template< class Value = double >
struct rk78_coefficients_b : lslboost::array< Value , 13 >
{
...
template< class Value = double >
struct rk78_coefficients_db : lslboost::array< Value , 13 >
{
...
template< class Value = double >
struct rk78_coefficients_c : lslboost::array< Value , 13 >
{
...
public:
    ...
    runge_kutta_fehlberg78( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
            lslboost::fusion::make_vector( rk78_coefficients_a1<Value>() , rk78_coefficients_a2<Value>() , rk78_coefficients_a3<Value>() ,
