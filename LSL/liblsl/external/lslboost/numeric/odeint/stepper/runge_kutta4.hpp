/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/runge_kutta4.hpp
...
#include <lslboost/numeric/odeint/stepper/explicit_generic_rk.hpp>
...
struct rk4_coefficients_a1 : lslboost::array< Value , 1 >
{
...
template< class Value = double >
struct rk4_coefficients_a2 : lslboost::array< Value , 2 >
{
...
template< class Value = double >
struct rk4_coefficients_a3 : lslboost::array< Value , 3 >
{
...
template< class Value = double >
struct rk4_coefficients_b : lslboost::array< Value , 4 >
{
...
template< class Value = double >
struct rk4_coefficients_c : lslboost::array< Value , 4 >
{
...
public:
    ...
    runge_kutta4( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
            lslboost::fusion::make_vector( rk4_coefficients_a1<Value>() , rk4_coefficients_a2<Value>() , rk4_coefficients_a3<Value>() ) ,
