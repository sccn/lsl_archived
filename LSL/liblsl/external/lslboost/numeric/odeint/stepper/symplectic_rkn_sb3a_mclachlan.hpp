/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/symplectic_rkn_sb3a_mclachlan.hpp
...
#include <lslboost/numeric/odeint/stepper/base/symplectic_rkn_stepper_base.hpp>
...
namespace symplectic_rkn_sb3a_mclachlan {
    ...
    */
    ...
    struct coef_a_type : public lslboost::array< Value , 6 >
    {
        coef_a_type( void )
        {
    ...
    template< class Value >
    struct coef_b_type : public lslboost::array< Value , 6 >
    {
        coef_b_type( void )
        {
