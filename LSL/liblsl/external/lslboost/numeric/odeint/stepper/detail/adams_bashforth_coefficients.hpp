/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/detail/adams_bashforth_coefficients.hpp
...
class adams_bashforth_coefficients< Value , 1 > : public lslboost::array< Value , 1 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 1 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 2 > : public lslboost::array< Value , 2 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 2 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 3 > : public lslboost::array< Value , 3 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 3 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 4 > : public lslboost::array< Value , 4 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 4 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 5 > : public lslboost::array< Value , 5 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 5 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 6 > : public lslboost::array< Value , 6 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 6 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 7 > : public lslboost::array< Value , 7 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 7 >()
      {
...
template< class Value >
class adams_bashforth_coefficients< Value , 8 > : public lslboost::array< Value , 8 >
{
public:
    adams_bashforth_coefficients( void )
    : lslboost::array< Value , 8 >()
      {
