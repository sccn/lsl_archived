/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/detail/generic_rk_operations.hpp
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,1> &a , Time dt ) : Operations::template scale_sum2< Fac , Time >( 1.0 , a[0]*dt )
                { }
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,2> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,3> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,4> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,5> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,6> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,7> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,8> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,9> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,10> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,11> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,12> &a , Time dt )
...
{
    generic_rk_scale_sum( const lslboost::array<Fac,13> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,1> &a , Time dt ) : Operations::template scale_sum1< Time >( a[0]*dt )
                { }
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,2> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,3> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,4> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,5> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,6> &a , Time dt )
...
{
    generic_rk_scale_sum_err( const lslboost::array<Fac,13> &a , Time dt )
