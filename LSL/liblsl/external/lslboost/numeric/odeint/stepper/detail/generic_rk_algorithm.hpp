/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/detail/generic_rk_algorithm.hpp
...
#include <lslboost/mpl/for_each.hpp>
#include <lslboost/mpl/range_c.hpp>
#include <lslboost/mpl/copy.hpp>
#include <lslboost/mpl/size_t.hpp>

#include <lslboost/fusion/algorithm.hpp>
#include <lslboost/fusion/iterator.hpp>
#include <lslboost/fusion/mpl.hpp>
#include <lslboost/fusion/sequence.hpp>

#include <lslboost/array.hpp>

#include <lslboost/numeric/odeint/algebra/range_algebra.hpp>
#include <lslboost/numeric/odeint/algebra/default_operations.hpp>
#include <lslboost/numeric/odeint/stepper/detail/generic_rk_call_algebra.hpp>
#include <lslboost/numeric/odeint/stepper/detail/generic_rk_operations.hpp>
#include <lslboost/numeric/odeint/util/bind.hpp>
...
{
    typedef const typename lslboost::array< T , Constant::value > type;
};
...
public:
    ...
    typedef typename lslboost::fusion::result_of::as_vector
            <
            typename lslboost::mpl::copy
            <
            stage_indices ,
            lslboost::mpl::inserter
            <
            lslboost::mpl::vector0< > ,
            lslboost::mpl::push_back< lslboost::mpl::_1 , array_wrapper< Value , lslboost::mpl::_2 > >
    >
    >::type
    >::type coef_a_type;

    typedef lslboost::array< Value , StageCount > coef_b_type;
    typedef lslboost::array< Value , StageCount > coef_c_type;

    typedef typename lslboost::fusion::result_of::as_vector
            <
            typename lslboost::mpl::push_back
            <
            typename lslboost::mpl::copy
            <
            stage_indices,
            ...
            <
            lslboost::mpl::vector0<> ,
            lslboost::mpl::push_back< lslboost::mpl::_1 , stage_wrapper< Value , lslboost::mpl::_2 > >
    >
    >::type ,
    ...
    struct stage_vector : public stage_vector_base
    {
        struct do_insertion
        {
            ...
            {
                //lslboost::fusion::at< Index >( m_base ) = stage< double , Index::value+1 , intermediate_stage >( m_c[ Index::value ] , lslboost::fusion::at< Index >( m_a ) );
                lslboost::fusion::at< Index >( m_base ).c  = m_c[ Index::value ];
                lslboost::fusion::at< Index >( m_base ).a = lslboost::fusion::at< Index >( m_a );
            }
        };
        ...
        struct print_butcher
        {
            ...
            template<class Index>
            void operator()(Index) const {
                m_os << lslboost::fusion::at<Index>(m_base).c << " | ";
                for( size_t i=0 ; i<Index::value ; ++i )
                    m_os << lslboost::fusion::at<Index>(m_base).a[i] << " ";
                m_os << std::endl;
            }
        };
        ...
        {
            typedef lslboost::mpl::range_c< size_t , 0 , StageCount-1 > indices;
            lslboost::mpl::for_each< indices >( do_insertion( *this , a , c ) );
            lslboost::fusion::at_c< StageCount - 1 >( *this ).c = c[ StageCount - 1 ];
            lslboost::fusion::at_c< StageCount - 1 >( *this ).a = b;
        }

        void print( std::ostream &os ) const
        {
            typedef lslboost::mpl::range_c< size_t , 0 , StageCount > indices;
            lslboost::mpl::for_each< indices >( print_butcher( *this , os ) );
        }
    };
...
#pragma warning( default : 4307 34 )
            ...
            StateTemp &x_tmp , Deriv F[StageCount-1] ) const
    {
        ...
        lslboost::fusion::for_each( m_stages , calculate_stage<
