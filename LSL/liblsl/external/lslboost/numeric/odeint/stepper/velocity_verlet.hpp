/*
  [auto_generated]
  lslboost/numeric/odeint/stepper/velocity_verlet.hpp
...
public:
    ...
    void initialize( const AccelerationIn & ain )
    {
        ...
        lslboost::numeric::odeint::copy( ain , get_current_acc() );
        m_first_call = false;
    }
...
private:
    ...
    void do_step_v1( System system , StateInOut & x , time_type t , time_type dt )
    {
        ...
        typedef typename lslboost::remove_reference< coor_in_type >::type xyz_type;
