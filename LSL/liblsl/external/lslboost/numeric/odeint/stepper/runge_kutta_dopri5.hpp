/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/runge_kutta_dopri5.hpp
...
#include <lslboost/numeric/odeint/stepper/base/explicit_error_stepper_fsal_base.hpp>
...
#include <lslboost/numeric/odeint/util/same_instance.hpp>
...
public :
            ...
            StateOut &out , DerivOut &dxdt_out , time_type dt , Err &xerr )
    {
        ...
        if( same_instance( dxdt_in , dxdt_out ) )
        {
            ...
            lslboost::numeric::odeint::copy( dxdt_in , m_dxdt_tmp.m_v );
