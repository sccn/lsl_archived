/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/runge_kutta_cash_karp54.hpp
...
struct rk54_ck_coefficients_a1 : lslboost::array< Value , 1 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a2 : lslboost::array< Value , 2 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a3 : lslboost::array< Value , 3 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a4 : lslboost::array< Value , 4 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_a5 : lslboost::array< Value , 5 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_b : lslboost::array< Value , 6 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_db : lslboost::array< Value , 6 >
{
...
template< class Value = double >
struct rk54_ck_coefficients_c : lslboost::array< Value , 6 >
{
...
public:
    ...
    runge_kutta_cash_karp54( const algebra_type &algebra = algebra_type() ) : stepper_base_type(
        lslboost::fusion::make_vector( rk54_ck_coefficients_a1<Value>() ,
