/*
 [auto_generated]
 lslboost/numeric/odeint/stepper/rosenbrock4_controller.hpp
...
public:
    ...
    lslboost::numeric::odeint::controlled_step_result
    try_step( System sys , state_type &x , time_type &t , time_type &dt )
    {
        ...
        lslboost::numeric::odeint::controlled_step_result res = try_step( sys , x , t , m_xnew.m_v , dt );
        if( res == success )
        {
