/*
  [auto_generated]
  lslboost/numeric/odeint/stepper/symplectic_rkn_sb3a_m4_mclachlan.hpp
...
namespace symplectic_rkn_sb3a_m4_mclachlan {
    ...
    */
    ...
    struct coef_a_type : public lslboost::array< Value , 5 >
    {
        coef_a_type( void )
        {
            using std::sqrt;
    ...
    template< class Value >
    struct coef_b_type : public lslboost::array< Value , 5 >
    {
        coef_b_type( void )
        {
