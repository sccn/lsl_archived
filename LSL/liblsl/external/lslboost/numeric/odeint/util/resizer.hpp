/*
 [auto_generated]
 lslboost/numeric/odeint/util/resizer.hpp
...
bool adjust_size_by_resizeability( ResizeWrappedState &x , const State &y , lslboost::true_type )
{
...
template< class ResizeWrappedState , class State >
bool adjust_size_by_resizeability( ResizeWrappedState & /* x */ , const State & /* y */ , lslboost::false_type )
{
    return false;
}
