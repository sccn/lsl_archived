/*
 [auto_generated]
 lslboost/numeric/odeint/util/copy.hpp
...
#include <lslboost/numeric/odeint/util/detail/is_range.hpp>
...
namespace detail {
    ...
    void do_copying( const Container1 &from , Container2 &to , lslboost::mpl::true_ )
    {
        lslboost::range::copy( from , lslboost::begin( to ) );
    }

    template< class Container1 , class Container2 >
    void do_copying( const Container1 &from , Container2 &to , lslboost::mpl::false_ )
    {
        to = from;
    }
...
struct copy_impl_sfinae
{
    ...
    {
        typedef typename lslboost::numeric::odeint::detail::is_range< Container1 >::type is_range_type;
