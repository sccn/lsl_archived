/*
 [auto_generated]
 lslboost/numeric/odeint/algebra/algebra_dispatcher.hpp
...
#include <lslboost/numeric/odeint/algebra/array_algebra.hpp>
...
struct algebra_dispatcher< lslboost::array< T , N > >
{
...
template< typename T >
struct algebra_dispatcher_sfinae< T , typename lslboost::enable_if< typename lslboost::is_floating_point< T >::type >::type >
{
...
struct algebra_dispatcher< lslboost::numeric::ublas::vector< T , A > >
{
    typedef vector_space_algebra algebra_type;
};

template< class T , class L , class A >
struct algebra_dispatcher< lslboost::numeric::ublas::matrix< T , L , A > >
{
    typedef vector_space_algebra algebra_type;
};
//*/
