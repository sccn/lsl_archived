/*
 [auto_generated]
 lslboost/numeric/odeint/algebra/detail/macros.hpp
...
#define BOOST_ODEINT_CHECK_CONTAINER_TYPE( Type1 , Type2 ) \
        BOOST_STATIC_ASSERT(( lslboost::is_same< typename lslboost::remove_const< Type1 >::type , Type2 >::value ))
...
#define BOOST_ODEINT_CHECK_OPERATION_ARITY( Operation , Arity ) \
        BOOST_STATIC_ASSERT(( lslboost::function_traits< Operation >::arity == Arity ))
 */
