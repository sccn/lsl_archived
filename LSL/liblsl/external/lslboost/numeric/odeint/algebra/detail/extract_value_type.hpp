/*
 [auto_generated]
 lslboost/numeric/odeint/algebra/detail/extract_value_type.hpp
...
template< typename S >
struct extract_value_type<S , typename lslboost::disable_if< has_value_type<S> >::type >
{
...
template< typename S >
struct extract_value_type< S , typename lslboost::enable_if< has_value_type<S> >::type >
{
