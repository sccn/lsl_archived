/*
 [auto_generated]
 lslboost/numeric/odeint/algebra/vector_space_algebra.hpp
...
struct vector_space_algebra
{
    ...
    template< class S >
    static typename lslboost::numeric::odeint::vector_space_norm_inf< S >::result_type norm_inf( const S &s )
    {
        lslboost::numeric::odeint::vector_space_norm_inf< S > n;
        return n( s );
    }
};
