/*
 [auto_generated]
  lslboost/numeric/odeint/iterator/detail/adaptive_iterator_impl.hpp
...
namespace odeint {
    ...
    private:
        ...
        typedef typename lslboost::numeric::odeint::unwrap_reference< stepper_type >::type unwrapped_stepper_type;
