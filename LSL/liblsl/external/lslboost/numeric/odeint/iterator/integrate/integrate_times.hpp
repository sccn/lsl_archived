/*
 [auto_generated]
 lslboost/numeric/odeint/integrate/integrate_times.hpp
...
#include <lslboost/numeric/odeint/iterator/integrate/detail/integrate_times.hpp>
        ...
        Observer observer )
{
    return integrate_times(
            stepper , system , start_state ,
            lslboost::begin( times ) , lslboost::end( times ) , dt , observer );
}
