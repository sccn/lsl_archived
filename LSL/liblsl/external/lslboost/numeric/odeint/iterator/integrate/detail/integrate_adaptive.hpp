/*
 [auto_generated]
 lslboost/numeric/odeint/integrate/detail/integrate_adaptive.hpp
...
#include <lslboost/numeric/odeint/iterator/integrate/detail/integrate_const.hpp>
...
)
{
    ...
    lslboost::for_each( make_adaptive_time_range( stepper , system , start_state ,
