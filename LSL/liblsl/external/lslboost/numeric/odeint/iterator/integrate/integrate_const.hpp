/*
 [auto_generated]
 lslboost/numeric/odeint/integrate/integrate_const.hpp
...
#include <lslboost/numeric/odeint/iterator/integrate/null_observer.hpp>
...
)
{
    ...
    if( lslboost::is_same< null_observer , Observer >::value )
    {
