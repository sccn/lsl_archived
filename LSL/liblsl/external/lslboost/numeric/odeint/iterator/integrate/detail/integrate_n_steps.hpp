/*
 [auto_generated]
 lslboost/numeric/odeint/integrate/detail/integrate_n_steps.hpp
...
#include <lslboost/numeric/odeint/iterator/integrate/detail/integrate_adaptive.hpp>
#include <lslboost/numeric/odeint/iterator/integrate/detail/functors.hpp>
#include <lslboost/numeric/odeint/iterator/n_step_time_iterator.hpp>
        ...
        Observer observer , stepper_tag )
{
    ...
    lslboost::for_each( make_n_step_time_range( stepper , system , start_state ,
        ...
        Observer observer , controlled_stepper_tag )
{
    ...
    for( size_t step = 0; step < num_of_steps ; ++step )
    {
        ...
        // we need clumsy type analysis to get lslboost units working here
