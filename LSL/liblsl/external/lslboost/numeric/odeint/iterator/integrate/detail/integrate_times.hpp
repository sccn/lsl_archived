/*
 [auto_generated]
 lslboost/numeric/odeint/integrate/detail/integrate_times.hpp
...
#include <lslboost/numeric/odeint/iterator/times_time_iterator.hpp>
...
)
{
    ...
    lslboost::for_each( make_times_time_range( stepper , system , start_state ,
