/*
 [auto_generated]
 lslboost/numeric/odeint/external/thrust/thrust_resize.hpp
...
{                                                             \
    static void resize( THRUST_VECTOR<T,A> &x ,               \
                        const Range &y )                      \
    {                                                         \
        x.resize( thrust::distance(lslboost::begin(y),           \
                                   lslboost::end(y)));           \
    }                                                         \
};                                                            \
...
{                                                                \
    static bool same_size( const THRUST_VECTOR<T,A> &x ,         \
                           const Range &y )                      \
    {                                                            \
        return x.size() == thrust::distance(lslboost::begin(y),     \
                                            lslboost::end(y));      \
    }                                                            \
};                                                               \
...
{                                                                       \
    ...
    {                                                                   \
        thrust::copy( lslboost::begin( from ) , lslboost::end( from ) ,       \
                      lslboost::begin( to ) );                             \
    }                                                                   \
};                                                                      \
                                                                        \
