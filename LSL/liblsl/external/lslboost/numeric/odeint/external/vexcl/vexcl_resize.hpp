/*
 [auto_generated]
 lslboost/numeric/odeint/external/vexcl/vexcl_resize.hpp
 ...
 */
template< typename T >
struct is_resizeable< vex::vector< T > > : lslboost::true_type { };
...
struct is_resizeable< vex::multivector< T , N > > : lslboost::true_type { };
