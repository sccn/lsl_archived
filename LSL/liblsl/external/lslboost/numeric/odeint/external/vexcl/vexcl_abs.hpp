/*
  [auto_generated]
  lslboost/numeric/odeint/external/vexcl/vexcl_abs.hpp
...
typename std::enable_if<
    ...
    typename lslboost::proto::result_of::make_expr<
        lslboost::proto::tag::function,
        abs_func,
        const vex::multivector<T, N>&
    >::type const
>::type
abs(const multivector<T, N> &arg) {
    return lslboost::proto::make_expr<lslboost::proto::tag::function>(
            abs_func(),
            lslboost::ref(arg)
            );
}
