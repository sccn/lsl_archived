/*
  [auto_generated]
  lslboost/numeric/odeint/external/eigen/eigen_algebra_dispatcher.hpp
...
struct algebra_dispatcher_sfinae< Derived ,
                      typename lslboost::enable_if< typename lslboost::is_base_of< Eigen::MatrixBase< Derived > , Derived >::type >::type >
{ 
...
template < class Derived  >
struct algebra_dispatcher_sfinae< Derived ,
                      typename lslboost::enable_if< typename lslboost::is_base_of< Eigen::ArrayBase< Derived > , Derived >::type >::type >
{ 
    typedef vector_space_algebra algebra_type;
};
