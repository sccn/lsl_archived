/*
 [auto_generated]
 lslboost/numeric/odeint/external/gsl/gsl_wrapper.hpp
 ...
 */
class gsl_vector_iterator : public lslboost::iterator_facade< gsl_vector_iterator , double , lslboost::random_access_traversal_tag >
{
public :
 ...
 */
class const_gsl_vector_iterator : public lslboost::iterator_facade< const_gsl_vector_iterator , const double , lslboost::random_access_traversal_tag >
{
public :
