/*
 [auto_generated]
 lslboost/numeric/odeint/external/compute/compute_algebra.hpp
...
#undef BOOST_ODEINT_COMPUTE_STATE_PARAM
    ...
    static typename S::value_type norm_inf( const S &s ) {
        ...
        return lslboost::compute::accumulate(s.begin(), s.end(), value_type(), max_abs);
    }
};
} // odeint
} // numeric
