/*
 [auto_generated]
 lslboost/numeric/odeint/external/openmp/openmp_state.hpp
...
#include <lslboost/numeric/odeint/external/openmp/openmp_nested_algebra.hpp>
...
template< class T >
struct is_resizeable< openmp_state< T > > : lslboost::true_type { };
