...
//  Revision History
//  23 JUN 05  Code extracted from /lslboost/cast.hpp into this new header.
//             Keeps this legacy version of numeric_cast<> for old compilers
//             wich can't compile the new version in /lslboost/numeric/conversion/cast.hpp
//             (Fernando Cacciola)
...
# include <lslboost/numeric/conversion/converter_policies.hpp>
...
//  FLC: This macro is repeated in lslboost/cast.hpp but only locally (is undefined at the bottom)
...
//  numeric_cast  ------------------------------------------------------------//
    ...
    namespace detail
    {
      ...
      // Move to namespace lslboost in utility.hpp?
...
# ifdef BOOST_HAS_LONG_LONG
      ...
      template <>
      struct fixed_numeric_limits_base< ::lslboost::long_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = true);
          static  ::lslboost::long_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::lslboost::long_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      template <>
      struct fixed_numeric_limits_base< ::lslboost::ulong_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = false);
          static  ::lslboost::ulong_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::lslboost::ulong_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
...
# endif
    ...
    || (!defined(__HP_aCC) || __HP_aCC > 33900) \
        ...
        // (to be replaced by lslboost compile time assertions
