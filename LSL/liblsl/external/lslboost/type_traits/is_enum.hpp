...
{
    template <typename T> struct type
       : public ::lslboost::is_convertible<typename lslboost::add_reference<T>::type,::lslboost::detail::int_convertible>
    {
    };
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::lslboost::detail::is_enum_impl<T>::value)
