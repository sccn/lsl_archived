...
#   define BOOST_HAS_TRIVIAL_COPY(T) (__has_trivial_copy(T)|| ( ::lslboost::is_pod<T>::value && !::lslboost::is_volatile<T>::value))
...
#   define BOOST_HAS_NOTHROW_COPY(T) (__has_nothrow_copy(T) || ::lslboost::has_trivial_copy<T>::value)
...
#       define BOOST_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) ((__has_trivial_move_constructor(T) || __is_pod(T)) && !::lslboost::is_volatile<T>::value && !::lslboost::is_reference<T>::value)
#       define BOOST_HAS_TRIVIAL_MOVE_ASSIGN(T) ((__has_trivial_move_assign(T) || __is_pod(T)) && ! ::lslboost::is_const<T>::value && !::lslboost::is_volatile<T>::value && !::lslboost::is_reference<T>::value)
#   endif
...
// but maybe the best we can do for now.  See https://svn.lslboost.org/trac/lslboost/ticket/10694
//
#   include <cstddef>
#   include <lslboost/type_traits/is_same.hpp>
...
#   define BOOST_HAS_TRIVIAL_COPY(T) ((__has_trivial_copy(T) BOOST_INTEL_TT_OPTS) && !is_reference<T>::value && ! ::lslboost::is_volatile<T>::value)
...
#   define BOOST_HAS_TRIVIAL_COPY(T) (__oracle_has_trivial_copy(T) && !is_reference<T>::value && ! ::lslboost::is_volatile<T>::value)
#   define BOOST_HAS_TRIVIAL_ASSIGN(T) ((__oracle_has_trivial_assign(T) || __oracle_is_trivial(T)) && ! ::lslboost::is_volatile<T>::value && ! ::lslboost::is_const<T>::value)
