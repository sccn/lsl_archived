...
#       define BOOST_HAS_TRIVIAL_MOVE_CONSTRUCTOR(T) ((__has_trivial_move_constructor(T) || ::lslboost::is_pod<T>::value) && !::lslboost::is_volatile<T>::value)
#       define BOOST_HAS_TRIVIAL_MOVE_ASSIGN(T) ((__has_trivial_move_assign(T) || ::lslboost::is_pod<T>::value) && ! ::lslboost::is_const<T>::value && !::lslboost::is_volatile<T>::value)
#   endif
...
#     define BOOST_IS_CONVERTIBLE(T,U) (__is_convertible_to(T,U) && !::lslboost::is_abstract<U>::value)
#   endif
