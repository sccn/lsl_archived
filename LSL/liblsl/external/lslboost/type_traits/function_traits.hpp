...
struct function_traits : 
  public lslboost::detail::function_traits_helper<typename lslboost::add_pointer<Function>::type>
{
};
...
struct function_traits
{
  BOOST_STATIC_CONSTANT(unsigned, arity = (sizeof(lslboost::detail::function_arity_helper((Function*)0))-1));
};
