...
#   include <lslboost/type_traits/detail/cv_traits_impl.hpp>
#   ifdef __GNUC__
...
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1400)
   BOOST_STATIC_CONSTANT(bool, value = ::lslboost::detail::cv_traits_imp<typename lslboost::remove_bounds<T>::type*>::is_const);
#else
   BOOST_STATIC_CONSTANT(bool, value = ::lslboost::detail::cv_traits_imp<T*>::is_const);
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::lslboost::detail::is_const_rvalue_filter<T>::value)
...
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T const,!(::lslboost::is_reference<T>::value))
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T volatile const,!(::lslboost::is_reference<T>::value))
#endif
...
struct is_const_helper<false,false>
{
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(lslboost::detail::yes_type) == sizeof(lslboost::detail::is_const_tester(t))
            ));
    };
};
...
//* is a type T  declared const - is_const<T>
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::lslboost::detail::is_const_impl<T>::value)
