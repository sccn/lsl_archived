...
#   include <lslboost/type_traits/detail/wrap.hpp>
#endif
...
// types.
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T const ,::lslboost::is_lvalue_reference<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T volatile ,::lslboost::is_lvalue_reference<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T const volatile ,::lslboost::is_lvalue_reference<T>::value)
...
using ::lslboost::type_traits::wrap;
...
struct is_lvalue_reference_impl
{
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(
            ::lslboost::detail::is_lvalue_reference_helper2(
                ::lslboost::detail::is_lvalue_reference_helper1(::lslboost::type_traits::wrap<T>()))) == 1
        );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_lvalue_reference,T,::lslboost::detail::is_lvalue_reference_impl<T>::value)
