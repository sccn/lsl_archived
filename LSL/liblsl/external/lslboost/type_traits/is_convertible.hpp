    ...
    enum { value =
        (::lslboost::type_traits::ice_and<
            ::lslboost::type_traits::ice_or<
               ::lslboost::detail::is_convertible_basic_impl<From,To>::value,
               ::lslboost::is_void<To>::value
            >::value,
            ::lslboost::type_traits::ice_not<
               ::lslboost::is_array<To>::value
            >::value,
            ::lslboost::type_traits::ice_not<
               ::lslboost::is_function<To>::value
            >::value
        >::value) };
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_convertible,From,To,(::lslboost::detail::is_convertible_impl_dispatch<From,To>::value))
