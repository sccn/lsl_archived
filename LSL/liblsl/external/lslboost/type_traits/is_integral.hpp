...
// compiler, see http://lists.lslboost.org/MailArchives/lslboost-users/msg06567.php,
// and define BOOST_NO_INTRINSIC_WCHAR_T on the command line.
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,wchar_t,true)
#endif

// Same set of integral types as in lslboost/type_traits/integral_promotion.hpp.
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::lslboost::ulong_long_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral, ::lslboost::long_long_type,true)
...
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,lslboost::int128_type,true)
BOOST_TT_AUX_BOOL_TRAIT_CV_SPEC1(is_integral,lslboost::uint128_type,true)
#endif
