...
#ifndef FILE_lslboost_type_traits_floating_point_promotion_hpp_INCLUDED
#define FILE_lslboost_type_traits_floating_point_promotion_hpp_INCLUDED
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , BOOST_DEDUCED_TYPENAME
        lslboost::type_traits::detail::floating_point_promotion<T>::type
    )
}

#include <lslboost/type_traits/detail/type_trait_undef.hpp>

#endif // #ifndef FILE_lslboost_type_traits_floating_point_promotion_hpp_INCLUDED
