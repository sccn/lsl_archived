...
struct is_pointer_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (::lslboost::type_traits::ice_and<
              ::lslboost::detail::is_pointer_helper<T>::value
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (::lslboost::type_traits::ice_and<
        ::lslboost::detail::is_pointer_helper<typename remove_cv<T>::type>::value
            , ::lslboost::type_traits::ice_not<
                ::lslboost::is_member_pointer<T>::value
                >::value
            >::value)
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,::lslboost::detail::is_pointer_impl<T>::value)
