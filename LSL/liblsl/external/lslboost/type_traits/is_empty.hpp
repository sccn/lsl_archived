    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (
            ::lslboost::type_traits::ice_or<
              ::lslboost::detail::empty_helper<cvt,::lslboost::is_class<T>::value>::value
       ...
       bool, value = (
           ::lslboost::type_traits::ice_or<
              ::lslboost::detail::empty_helper<
                ...
                , ::lslboost::is_convertible< r_type,int>::value
              >::value
              , BOOST_INTERNAL_IS_EMPTY(cvt)
           >::value));
};
...
struct is_empty_impl
{
   typedef ::lslboost::detail::empty_helper_chooser<
      ::lslboost::type_traits::ice_and<
         ::lslboost::type_traits::ice_not< ::lslboost::is_reference<T>::value >::value,
         ::lslboost::type_traits::ice_not< ::lslboost::is_convertible<T,double>::value >::value,
         ::lslboost::type_traits::ice_not< ::lslboost::is_pointer<T>::value >::value,
         ::lslboost::type_traits::ice_not< ::lslboost::is_member_pointer<T>::value >::value,
         ...
         ::lslboost::type_traits::ice_not<
            ::lslboost::is_convertible<T,void const volatile*>::value
            >::value
      >::value > chooser;
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::lslboost::type_traits::ice_or<eh_type::value, BOOST_INTERNAL_IS_EMPTY(T)>::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_empty,T,::lslboost::detail::is_empty_impl<T>::value)
