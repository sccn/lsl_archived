...
#ifndef FILE_lslboost_type_traits_integral_promotion_hpp_INCLUDED
#define FILE_lslboost_type_traits_integral_promotion_hpp_INCLUDED
...
// 4.5/2
template <class T> struct need_promotion : public lslboost::is_enum<T> {};
...
// Same set of integral types as in lslboost/type_traits/is_integral.hpp.
// Please, keep in sync.
...
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(lslboost::ulong_long_type)
BOOST_TT_AUX_PROMOTE_NONSTANDARD_TYPE(lslboost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTE_FROM_INDEX(5, lslboost::long_long_type )
BOOST_TT_AUX_PROMOTE_FROM_INDEX(6, lslboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(5, lslboost::long_long_type )
BOOST_TT_AUX_PROMOTED_INDEX_TESTER(6, lslboost::ulong_long_type)
#elif defined(BOOST_HAS_MS_INT64)
...
struct integral_promotion_impl
{
    typedef BOOST_DEDUCED_TYPENAME promote_from_index<
        (lslboost::type_traits::detail::promoted_index<T>::value)
      , (lslboost::is_const<T>::value)
      , (lslboost::is_volatile<T>::value)
      >::type type;
};

template<class T>
struct integral_promotion
  : public lslboost::mpl::eval_if<
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(
    ...
    , BOOST_DEDUCED_TYPENAME
        lslboost::type_traits::detail::integral_promotion<T>::type
    )
}

#include <lslboost/type_traits/detail/type_trait_undef.hpp>

#endif // #ifndef FILE_lslboost_type_traits_integral_promotion_hpp_INCLUDED
