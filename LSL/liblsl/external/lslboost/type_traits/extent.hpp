...
#include <lslboost/type_traits/detail/size_t_trait_def.hpp>
...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::lslboost::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::lslboost::integral_constant<std::size_t, ::lslboost::detail::extent_imp<T,N>::value>
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1300) 
   typedef ::lslboost::integral_constant<std::size_t, ::lslboost::detail::extent_imp<T,N>::value> base_; 
   using base_::value;
#endif
...
#include <lslboost/type_traits/detail/size_t_trait_undef.hpp>
