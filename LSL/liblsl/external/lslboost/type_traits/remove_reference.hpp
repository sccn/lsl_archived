...
#include <lslboost/type_traits/msvc/remove_reference.hpp>
#endif
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_reference,T,typename lslboost::detail::remove_rvalue_ref<T>::type)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_reference,T,typename lslboost::detail::remove_reference_impl<T>::type)
