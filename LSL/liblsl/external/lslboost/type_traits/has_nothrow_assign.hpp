...
struct has_nothrow_assign_imp{
   ...
   BOOST_STATIC_CONSTANT(bool, value = ::lslboost::has_trivial_assign<T>::value);
#else
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_assign,T,::lslboost::detail::has_nothrow_assign_imp<T>::value)
