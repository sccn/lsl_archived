...
#  if !defined(BOOST_MSVC) && !defined(__ICL)
      ...
      struct unique{};
      virtual void unique_name_to_lslboost5487629(unique*);
#  endif
      char padding[256];
   private:
      // keep some picky compilers happy:
...
{
   typedef is_polymorphic_selector< ::lslboost::is_class<T>::value> selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_polymorphic,T,::lslboost::detail::is_polymorphic_imp<T>::value)
