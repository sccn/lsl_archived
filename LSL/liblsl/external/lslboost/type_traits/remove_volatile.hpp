...
#include <lslboost/type_traits/msvc/remove_volatile.hpp>
#endif
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_volatile,T,typename lslboost::detail::remove_volatile_impl<T>::type)
