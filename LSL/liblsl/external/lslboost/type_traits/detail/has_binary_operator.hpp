...
struct operator_exists {
   static ::lslboost::type_traits::yes_type check(has_operator); // this version is preferred when operator exists
   static ::lslboost::type_traits::no_type check(no_operator); // this version is used otherwise

   BOOST_STATIC_CONSTANT(bool, value = (sizeof(check(((make<Lhs>() BOOST_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::lslboost::type_traits::yes_type)));
};
