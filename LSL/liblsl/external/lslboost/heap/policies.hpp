...
#include <lslboost/parameter.hpp>
...
template <bool T>
struct stable:
    lslboost::parameter::template_keyword<tag::stable, lslboost::mpl::bool_<T> >
{};
...
template <bool T>
struct mutable_:
    lslboost::parameter::template_keyword<tag::mutable_, lslboost::mpl::bool_<T> >
{};
...
struct constant_time_size:
    lslboost::parameter::template_keyword<tag::constant_time_size, lslboost::mpl::bool_<T> >
{};
...
struct store_parent_pointer:
    lslboost::parameter::template_keyword<tag::store_parent_pointer, lslboost::mpl::bool_<T> >
{};
...
struct arity:
    lslboost::parameter::template_keyword<tag::arity, lslboost::mpl::int_<T> >
{};
...
struct objects_per_page:
    lslboost::parameter::template_keyword<tag::objects_per_page, lslboost::mpl::int_<T> >
{};
...
struct has_arg
{
    typedef typename lslboost::parameter::binding<bound_args, tag_type, mpl::void_>::type type;
