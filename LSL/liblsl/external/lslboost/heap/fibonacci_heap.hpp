...
public:
    ...
    /** \copydoc lslboost::heap::fibonacci_heap::update(handle_type, const_reference)
     *
    ...
    /** \copydoc lslboost::heap::fibonacci_heap::update (handle_type handle)
     *
     * \b Rationale: The lazy update function is a modification of the traditional update, that just invalidates
     *               the iterator the the object referred to by the handle.
     * */
...
private:
    ...
    void consolidate(void)
    {
        ...
        lslboost::array<node_pointer, max_log2> aux;
        aux.assign(NULL);
