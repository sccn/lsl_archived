...
#include <lslboost/heap/policies.hpp>
...
private:
    ...
    typedef lslboost::intrusive::list<detail::heap_node_base<true>,
                                   lslboost::intrusive::constant_time_size<false>
                                  > node_child_list;
#endif
...
public:
    ...
    /// \copydoc lslboost::heap::d_ary_heap_mutable::s_handle_from_iterator
