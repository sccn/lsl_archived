    ...
    lslboost::ForwardContainer<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((lslboost::Assignable<value_type>));
        BOOST_CONCEPT_ASSERT((lslboost::Container<C>));
        BOOST_CONCEPT_ASSERT((lslboost::EqualityComparable<C>));
        BOOST_CONCEPT_ASSERT((lslboost::Comparable<C>));

        BOOST_CONCEPT_ASSERT((lslboost::Const_BinaryPredicate<value_compare, value_type, value_type>));
    ...
    PriorityQueue<C>
{
    ...
    {
        BOOST_CONCEPT_ASSERT((lslboost::Assignable<typename MutablePriorityQueue::handle_type>));
