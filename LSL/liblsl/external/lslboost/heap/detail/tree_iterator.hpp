// lslboost heap: node tree iterator helper classes
//
...
template <typename Node,
         ...
         >
class tree_iterator:
    public lslboost::iterator_adaptor<tree_iterator<Node,
                                                 ValueType,
                                                 Alloc,
                                                 ValueExtractor,
                                                 PointerExtractor,
    ...
    PointerExtractor
{
    typedef lslboost::iterator_adaptor<tree_iterator<Node,
                                                  ValueType,
                                                  Alloc,
                                                  ValueExtractor,
                                                  PointerExtractor,
    ...
    typedef typename lslboost::mpl::if_c< ordered_iterator,
...
class recursive_tree_iterator:
    public lslboost::iterator_adaptor<recursive_tree_iterator<Node,
                                                           NodeIterator,
                                                           ValueType,
                                                           ValueExtractor,
                                                           IteratorCoverter
...
{
    typedef lslboost::iterator_adaptor<recursive_tree_iterator<Node,
                                                            NodeIterator,
                                                            ValueType,
                                                            ValueExtractor,
                                                            IteratorCoverter
                                    ...
                                    NodeIterator,
                                    ValueType const,
                                    lslboost::bidirectional_traversal_tag> adaptor_type;
