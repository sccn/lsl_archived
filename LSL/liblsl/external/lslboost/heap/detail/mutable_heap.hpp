...
public:
    ...
    class iterator_base:
        public lslboost::iterator_adaptor<iterator_base<iterator_type>,
                                       iterator_type,
                                       value_type const,
                                       lslboost::bidirectional_traversal_tag>
    {
        typedef lslboost::iterator_adaptor<iterator_base<iterator_type>,
                                       iterator_type,
                                       value_type const,
                                       lslboost::bidirectional_traversal_tag> super_t;
    ...
    class ordered_iterator:
        public lslboost::iterator_adaptor<ordered_iterator,
                                       const_list_iterator,
                                       value_type const,
    ...
    {
        typedef lslboost::iterator_adaptor<ordered_iterator,
                                        const_list_iterator,
                                        value_type const,
                                        lslboost::forward_traversal_tag
                                      > adaptor_type;
