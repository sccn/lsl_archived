// // lslboost heap: d-ary heap as containter adaptor
//
...
#include <lslboost/heap/detail/ordered_adaptor_iterator.hpp>
#include <lslboost/heap/detail/stable_heap.hpp>
#include <lslboost/heap/detail/mutable_heap.hpp>
...
typedef parameter::parameters<lslboost::parameter::required<tag::arity>,
                              lslboost::parameter::optional<tag::allocator>,
...
private:
    ...
    template<typename U,
             ...
             typename X>
    struct rebind {
        typedef d_ary_heap<U, typename d_ary_heap_signature::bind<lslboost::heap::stable<heap_base_maker::is_stable>,
                                                                  lslboost::heap::stability_counter_type<typename heap_base_maker::stability_counter_type>,
                                                                  lslboost::heap::arity<D>,
                                                                  lslboost::heap::compare<V>,
                                                                  lslboost::heap::allocator<W>
                                                                    >::type,
                           X
                          > other;
    };
 ...
 * - \c lslboost::heap::arity<>, required
 ...
 * - \c lslboost::heap::mutable_<>, defaults to \c mutable_<false>
 *
 */
...
public:
    ...
    /// \copydoc lslboost::heap::priority_queue::operator=(priority_queue const &)
    d_ary_heap & operator=(d_ary_heap const & rhs)
    {
    ...
    /// \copydoc lslboost::heap::priority_queue::size
    size_type size(void) const
    {
        return super_t::size();
    }
    ...
    /// \copydoc lslboost::heap::priority_queue::push
...
#if defined(BOOST_HAS_RVALUE_REFS) && !defined(BOOST_NO_VARIADIC_TEMPLATES)
    /// \copydoc lslboost::heap::priority_queue::emplace
    template <class... Args>
    ...
    /// \copydoc lslboost::heap::priority_queue::pop
    void pop(void)
    {
        super_t::pop();
    }
    ...
    /// \copydoc lslboost::heap::fibonacci_heap::ordered_end
    ordered_iterator ordered_end(void) const
    {
        return super_t::ordered_end();
    }

    /// \copydoc lslboost::heap::priority_queue::reserve
    void reserve (size_type element_count)
    {
