...
#include <lslboost/heap/detail/heap_comparison.hpp>
#include <lslboost/heap/detail/heap_node.hpp>
#include <lslboost/heap/detail/stable_heap.hpp>
#include <lslboost/heap/detail/tree_iterator.hpp>
    ...
    parent_holder<skew_heap_node<value_type, store_parent_pointer>*, store_parent_pointer>
{
    ...
    typedef lslboost::array<skew_heap_node*, 2> child_list_type;
    ...
    value_type value;
    lslboost::array<skew_heap_node*, 2> children;
};


typedef parameter::parameters<lslboost::parameter::optional<tag::allocator>,
                              lslboost::parameter::optional<tag::compare>,
                              lslboost::parameter::optional<tag::stable>,
                              lslboost::parameter::optional<tag::store_parent_pointer>,
                              lslboost::parameter::optional<tag::stability_counter_type>,
                              lslboost::parameter::optional<tag::constant_time_size>,
                              lslboost::parameter::optional<tag::mutable_>
                             > skew_heap_signature;
...
struct make_skew_heap_base
{
    ...
    static const bool store_parent_pointer = parameter::binding<BoundArgs,
                                                              ...
                                                              lslboost::mpl::false_>::type::value || is_mutable;
 ...
 * - \c lslboost::heap::compare<>, defaults to \c compare<std::less<T> >
 * - \c lslboost::heap::stable<>, defaults to \c stable<false>
 * - \c lslboost::heap::stability_counter_type<>, defaults to \c stability_counter_type<lslboost::uintmax_t>
 * - \c lslboost::heap::allocator<>, defaults to \c allocator<std::allocator<T> >
 * - \c lslboost::heap::constant_time_size<>, defaults to \c constant_time_size<true>
 * - \c lslboost::heap::store_parent_pointer<>, defaults to \c store_parent_pointer<true>. Maintaining a parent pointer adds some
 *   maintenance and size overhead, but iterating a heap is more efficient.
 * - \c lslboost::heap::mutable<>, defaults to \c mutable<false>.
 *
 */
...
#else
template <typename T,
          class A0 = lslboost::parameter::void_,
          class A1 = lslboost::parameter::void_,
          class A2 = lslboost::parameter::void_,
          class A3 = lslboost::parameter::void_,
          class A4 = lslboost::parameter::void_,
          class A5 = lslboost::parameter::void_,
          class A6 = lslboost::parameter::void_
         >
#endif
class skew_heap:
                                         ...
                                         >::type
{
        ...
        detail::extract_allocator_types<typename base_maker::allocator_argument>
    {
        ...
        typedef lslboost::array<node_pointer, 2> child_list_type;
        typedef typename child_list_type::iterator child_list_iterator;

        typedef typename lslboost::mpl::if_c<false,
...
public:
    ...
    /// \copydoc lslboost::heap::priority_queue::iterator
    ...
    /// \copydoc lslboost::heap::priority_queue::priority_queue(value_compare const &)
    explicit skew_heap(value_compare const & cmp = value_compare()):
        super_t(cmp), root(NULL)
    {}

    /// \copydoc lslboost::heap::priority_queue::priority_queue(priority_queue const &)
    ...
    /// \copydoc lslboost::heap::priority_queue::operator=(priority_queue const & rhs)
...
#ifdef BOOST_HAS_RVALUE_REFS
    /// \copydoc lslboost::heap::priority_queue::priority_queue(priority_queue &&)
    ...
    /// \copydoc lslboost::heap::priority_queue::operator=(priority_queue &&)
    ...
    /// \copydoc lslboost::heap::priority_queue::empty
    bool empty(void) const
    {
        return root == NULL;
    }

    /// \copydoc lslboost::heap::binomial_heap::size
    ...
    /// \copydoc lslboost::heap::priority_queue::max_size
    size_type max_size(void) const
    {
        return allocator_type::max_size();
    }

    /// \copydoc lslboost::heap::priority_queue::clear
    void clear(void)
    {
        if (empty())
            return;
    ...
    /// \copydoc lslboost::heap::priority_queue::get_allocator
    allocator_type get_allocator(void) const
    {
        return *this;
    }

    /// \copydoc lslboost::heap::priority_queue::swap
    ...
    /// \copydoc lslboost::heap::priority_queue::top
    ...
    /// \copydoc lslboost::heap::priority_queue::begin
    iterator begin(void) const
    {
        return iterator(root, super_t::value_comp());
    }

    /// \copydoc lslboost::heap::priority_queue::end
    iterator end(void) const
    {
        return iterator();
    }

    /// \copydoc lslboost::heap::fibonacci_heap::ordered_begin
    ...
    /// \copydoc lslboost::heap::priority_queue::value_comp
    value_compare const & value_comp(void) const
    {
        return super_t::value_comp();
    }

    /// \copydoc lslboost::heap::priority_queue::operator<(HeapType const & rhs) const
    ...
    /// \copydoc lslboost::heap::d_ary_heap::s_handle_from_iterator
