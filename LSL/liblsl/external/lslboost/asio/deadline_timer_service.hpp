...
#include <lslboost/asio/detail/deadline_timer_service.hpp>
...
template <typename TimeType,
    typename TimeTraits = lslboost::asio::time_traits<TimeType> >
...
public:
  ...
  explicit deadline_timer_service(lslboost::asio::io_service& io_service)
  ...
  std::size_t cancel(implementation_type& impl, lslboost::system::error_code& ec)
  {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, lslboost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration_type& expiry_time, lslboost::system::error_code& ec)
  {
    return service_impl_.expires_from_now(impl, expiry_time, ec);
  }

  // Perform a blocking wait on the timer.
  void wait(implementation_type& impl, lslboost::system::error_code& ec)
  {
      ...
      BOOST_ASIO_MOVE_ARG(WaitHandler) handler)
  {
    detail::async_result_init<
      WaitHandler, void (lslboost::system::error_code)> init(
