...
/**
 * The lslboost::asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  lslboost::asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates lslboost::asio::local::basic_endpoint
 */
