 ...
 * lslboost::asio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
...
#else
  typedef lslboost::asio::const_buffers_1 const_buffers_type;
  typedef lslboost::asio::mutable_buffers_1 mutable_buffers_type;
#endif
  ...
  {
    return lslboost::asio::buffer(lslboost::asio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return lslboost::asio::buffer(lslboost::asio::mutable_buffer(
