 ...
 * @code
 * lslboost::array<char, 128> buf;
 * lslboost::system::error_code ec;
 * std::size_t n = lslboost::asio::read(
 *     sock, lslboost::asio::buffer(buf),
 *     lslboost::asio::transfer_all(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = lslboost::asio::read(
 *     sock, lslboost::asio::buffer(buf),
 *     lslboost::asio::transfer_at_least(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = lslboost::asio::read(
 *     sock, lslboost::asio::buffer(buf),
 *     lslboost::asio::transfer_exactly(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
