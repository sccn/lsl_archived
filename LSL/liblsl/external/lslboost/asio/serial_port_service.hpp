...
#include <lslboost/asio/detail/reactive_serial_port_service.hpp>
#include <lslboost/asio/detail/win_iocp_serial_port_service.hpp>
...
#else
  : public lslboost::asio::detail::service_base<serial_port_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit serial_port_service(lslboost::asio::io_service& io_service)
    : lslboost::asio::detail::service_base<serial_port_service>(io_service),
