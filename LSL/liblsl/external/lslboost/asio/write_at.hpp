...
/**
 * @defgroup write_at lslboost::asio::write_at
 *
 ...
 * @code lslboost::asio::write_at(d, 42, lslboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code lslboost::asio::write_at(
 *     d, offset, buffers,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::write_at(d, 42,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::write_at(d, 42, lslboost::asio::buffer(data, size),
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d, lslboost::uint64_t offset,
...
/*@}*/
/**
 * @defgroup async_write_at lslboost::asio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * lslboost::asio::async_write_at(d, 42, lslboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
...
void async_write_at(AsyncRandomAccessWriteDevice& d, lslboost::uint64_t offset,
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::async_write_at(d, 42,
...
#include <lslboost/asio/impl/write_at.hpp>
