...
namespace detail
{
  ...
  class read_at_op<AsyncRandomAccessReadDevice,
      lslboost::asio::mutable_buffers_1, CompletionCondition, ReadHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    read_at_op(AsyncRandomAccessReadDevice& device,
        lslboost::uint64_t offset, const lslboost::asio::mutable_buffers_1& buffers,
        CompletionCondition completion_condition, ReadHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        device_(device),
  ...
  template <typename AsyncRandomAccessReadDevice, typename Elem,
      typename CompletionCondition, typename ReadHandler>
  class read_at_op<AsyncRandomAccessReadDevice, lslboost::array<Elem, 2>,
      CompletionCondition, ReadHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    read_at_op(AsyncRandomAccessReadDevice& device,
        lslboost::uint64_t offset, const lslboost::array<Elem, 2>& buffers,
        CompletionCondition completion_condition, ReadHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        device_(device),
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      typename lslboost::asio::detail::dependent_type<Elem,
          lslboost::array<lslboost::asio::mutable_buffer, 2> >::type bufs = {{
        lslboost::asio::mutable_buffer(buffers_[0]),
        lslboost::asio::mutable_buffer(buffers_[1]) }};
  ...
  public:
    read_at_op(AsyncRandomAccessReadDevice& device,
        lslboost::uint64_t offset, const std::array<Elem, 2>& buffers,
        CompletionCondition completion_condition, ReadHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        device_(device),
    ...
    {
      typename lslboost::asio::detail::dependent_type<Elem,
          std::array<lslboost::asio::mutable_buffer, 2> >::type bufs = {{
        lslboost::asio::mutable_buffer(buffers_[0]),
        lslboost::asio::mutable_buffer(buffers_[1]) }};
      std::size_t buffer_size0 = lslboost::asio::buffer_size(bufs[0]);
      std::size_t buffer_size1 = lslboost::asio::buffer_size(bufs[1]);
...
namespace detail
{
  ...
  public:
    read_at_streambuf_op(AsyncRandomAccessReadDevice& device,
        lslboost::uint64_t offset, basic_streambuf<Allocator>& streambuf,
        CompletionCondition completion_condition, ReadHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
        device_(device),
