...
namespace detail
{
  struct default_connect_condition
  {
    ...
    Iterator operator()(const lslboost::system::error_code&, Iterator next)
    {
      return next;
    }
  };
    ...
    lslboost::system::error_code& ec)
{
  ...
  if (!ec)
    ec = lslboost::asio::error::not_found;
...
namespace detail
{
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const lslboost::system::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const lslboost::system::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(lslboost::system::error_code ec, int start = 0)
    {
      switch (start_ = start)
      {
        case 1:
        ...
        handler_(static_cast<const lslboost::system::error_code&>(ec),
    ...
    Iterator begin, BOOST_ASIO_MOVE_ARG(ComposedConnectHandler) handler)
{
  ...
  detail::async_result_init<ComposedConnectHandler,
    void (lslboost::system::error_code, Iterator)> init(
  ...
  detail::connect_op<Protocol, SocketService, Iterator,
    detail::default_connect_condition, BOOST_ASIO_HANDLER_TYPE(
      ComposedConnectHandler, void (lslboost::system::error_code, Iterator))>(s,
        begin, Iterator(), detail::default_connect_condition(), init.handler)(
          lslboost::system::error_code(), 1);
