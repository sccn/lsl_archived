...
# include <lslboost/asio/ssl/context_service.hpp>
...
# include <lslboost/asio/ssl/detail/password_callback.hpp>
# include <lslboost/asio/ssl/detail/verify_callback.hpp>
# include <lslboost/asio/ssl/verify_mode.hpp>
...
public:
  ...
  BOOST_ASIO_DECL context(lslboost::asio::io_service&, method m);
   ...
   * @note Calls @c SSL_CTX_clear_options.
   */
  BOOST_ASIO_DECL lslboost::system::error_code clear_options(options o,
   ...
   * @note Calls @c SSL_CTX_set_options.
   */
  BOOST_ASIO_DECL lslboost::system::error_code set_options(options o,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_verify.
   */
  BOOST_ASIO_DECL lslboost::system::error_code set_verify_mode(
   ...
   * @note Calls @c SSL_CTX_set_verify_depth.
   */
  BOOST_ASIO_DECL lslboost::system::error_code set_verify_depth(
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  BOOST_ASIO_DECL lslboost::system::error_code load_verify_file(
   ...
   * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
   */
  BOOST_ASIO_DECL lslboost::system::error_code add_certificate_authority(
      const const_buffer& ca, lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_default_verify_paths.
   */
  BOOST_ASIO_DECL lslboost::system::error_code set_default_verify_paths(
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  BOOST_ASIO_DECL lslboost::system::error_code add_verify_path(
   ...
   * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_certificate(
      const const_buffer& certificate, file_format format,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate_file.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_certificate_file(
      const std::string& filename, file_format format,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate and SSL_CTX_add_extra_chain_cert.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_certificate_chain(
      const const_buffer& chain, lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_certificate_chain_file.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_certificate_chain_file(
      const std::string& filename, lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_private_key(
      const const_buffer& private_key, file_format format,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey_file.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_private_key_file(
      const std::string& filename, file_format format,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_rsa_private_key(
      const const_buffer& private_key, file_format format,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_rsa_private_key_file(
      const std::string& filename, file_format format,
      lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_tmp_dh(
      const const_buffer& dh, lslboost::system::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  BOOST_ASIO_DECL lslboost::system::error_code use_tmp_dh_file(
      const std::string& filename, lslboost::system::error_code& ec);
   ...
   */
  template <typename PasswordCallback>
  lslboost::system::error_code set_password_callback(PasswordCallback callback,
      lslboost::system::error_code& ec);
...
private:
  ...
  BOOST_ASIO_DECL lslboost::system::error_code do_set_verify_callback(
  ...
  BOOST_ASIO_DECL lslboost::system::error_code do_set_password_callback(
  ...
  BOOST_ASIO_DECL lslboost::system::error_code do_use_tmp_dh(
      BIO* bio, lslboost::system::error_code& ec);
...
#include <lslboost/asio/ssl/impl/context.hpp>
