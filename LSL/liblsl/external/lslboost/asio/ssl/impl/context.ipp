...
void context::clear_options(context::options o)
{
  lslboost::system::error_code ec;
  clear_options(o, ec);
  lslboost::asio::detail::throw_error(ec, "clear_options");
}

lslboost::system::error_code context::clear_options(
    ...
    context::options o, lslboost::system::error_code& ec)
{
  ...
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      lslboost::asio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
lslboost::system::error_code context::set_verify_depth(
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  lslboost::asio::detail::throw_error(ec, "add_certificate_authority");
}

lslboost::system::error_code context::add_certificate_authority(
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  lslboost::asio::detail::throw_error(ec, "use_certificate");
}

lslboost::system::error_code context::use_certificate(
    const const_buffer& certificate, file_format format,
    lslboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  lslboost::asio::detail::throw_error(ec, "use_certificate_chain");
}

lslboost::system::error_code context::use_certificate_chain(
    const const_buffer& chain, lslboost::system::error_code& ec)
{
  ...
  if (bio.p)
  {
    ...
    if (!cert.p)
    {
      ec = lslboost::system::error_code(ERR_R_PEM_LIB,
          lslboost::asio::error::get_ssl_category());
      return ec;
    }
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  lslboost::asio::detail::throw_error(ec, "use_private_key");
}

lslboost::system::error_code context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    lslboost::system::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  lslboost::asio::detail::throw_error(ec, "use_rsa_private_key");
}

lslboost::system::error_code context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    lslboost::system::error_code& ec)
{
  ::ERR_clear_error();
...
void context::use_tmp_dh(const const_buffer& dh)
{
  lslboost::system::error_code ec;
  use_tmp_dh(dh, ec);
  lslboost::asio::detail::throw_error(ec, "use_tmp_dh");
}

lslboost::system::error_code context::use_tmp_dh(
...
lslboost::system::error_code context::do_use_tmp_dh(
