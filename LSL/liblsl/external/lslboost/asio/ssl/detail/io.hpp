...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, lslboost::system::error_code& ec)
{
  ...
  case engine::want_input_and_retry:
    ...
    if (lslboost::asio::buffer_size(core.input_) == 0)
      core.input_ = lslboost::asio::buffer(core.input_buffer_,
  ...
  case engine::want_output_and_retry:
    ...
    // transport.
    lslboost::asio::write(next_layer,
    ...
    case 1: // Called after at least one async operation.
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.pending_read_.expires_at() == lslboost::posix_time::neg_infin)
          {
            // Prevent other read operations from being started.
            core_.pending_read_.expires_at(lslboost::posix_time::pos_infin);
        ...
        case engine::want_output:
          ...
          if (core_.pending_write_.expires_at() == lslboost::posix_time::neg_infin)
          {
            // Prevent other write operations from being started.
            core_.pending_write_.expires_at(lslboost::posix_time::pos_infin);
        ...
        case engine::want_input_and_retry:
          ...
          core_.pending_read_.expires_at(lslboost::posix_time::neg_infin);
        ...
        case engine::want_output_and_retry:
          ...
          core_.pending_write_.expires_at(lslboost::posix_time::neg_infin);
