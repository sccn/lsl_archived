...
#include <lslboost/asio/ssl/stream_service.hpp>
 ...
 * lslboost::asio::ssl::context context(io_service, lslboost::asio::ssl::context::sslv23);
 * lslboost::asio::ssl::stream<lslboost::asio::ip::tcp::socket> sock(io_service, context);
 * @endcode
 *
 * @par Concepts:
...
public:
  ...
  explicit stream(Arg& arg, basic_context<Context_Service>& context)
    : next_layer_(arg),
      service_(lslboost::asio::use_service<Service>(next_layer_.get_io_service())),
      impl_(service_.null())
  {
