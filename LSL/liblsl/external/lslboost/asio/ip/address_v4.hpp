...
/**
 * The lslboost::asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef lslboost::asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  lslboost::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates lslboost::asio::ip::address_v4
 */
...
#include <lslboost/asio/ip/impl/address_v4.hpp>
