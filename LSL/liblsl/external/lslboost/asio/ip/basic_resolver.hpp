...
public:
   ...
   */
  explicit basic_resolver(lslboost::asio::io_service& io_service)
   ...
   * will be invoked with the lslboost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    lslboost::asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, lslboost::system::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, lslboost::system::error_code& ec)
  {
