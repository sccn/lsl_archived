...
/**
 * The lslboost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const lslboost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  lslboost::asio::detail::addrinfo_type hints_;
