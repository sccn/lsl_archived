...
/**
 * The lslboost::asio::ip::address class provides the ability to use either IP
...
public:
  ...
  BOOST_ASIO_DECL address(const lslboost::asio::ip::address_v4& ipv4_address);

  /// Construct an address from an IPv6 address.
  BOOST_ASIO_DECL address(const lslboost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL address& operator=(
      const lslboost::asio::ip::address_v4& ipv4_address);

  /// Assign from an IPv6 address.
  BOOST_ASIO_DECL address& operator=(
      const lslboost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL lslboost::asio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  BOOST_ASIO_DECL lslboost::asio::ip::address_v6 to_v6() const;

  /// Get the address as a string in dotted decimal format.
  BOOST_ASIO_DECL std::string to_string() const;

  /// Get the address as a string in dotted decimal format.
  BOOST_ASIO_DECL std::string to_string(lslboost::system::error_code& ec) const;
...
private:
  ...
  lslboost::asio::ip::address_v4 ipv4_address_;

  // The underlying IPv6 address.
  lslboost::asio::ip::address_v6 ipv6_address_;
};
 ...
 *
 * @relates lslboost::asio::ip::address
 */
...
#include <lslboost/asio/ip/impl/address.hpp>
