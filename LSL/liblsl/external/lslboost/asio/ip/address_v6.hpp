...
/**
 * The lslboost::asio::ip::address_v6 class provides the ability to use and
...
public:
   ...
   * when it is available. Otherwise, it uses @c lslboost:array.
   */
#if defined(GENERATING_DOCUMENTATION)
  typedef array<unsigned char, 16> bytes_type;
#else
  typedef lslboost::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  lslboost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates lslboost::asio::ip::address_v6
 */
...
#include <lslboost/asio/ip/impl/address_v6.hpp>
