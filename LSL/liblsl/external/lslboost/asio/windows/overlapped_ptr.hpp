...
#include <lslboost/asio/detail/win_iocp_overlapped_ptr.hpp>
...
public:
  ...
  explicit overlapped_ptr(lslboost::asio::io_service& io_service,
  ...
  /// object.
  template <typename Handler>
  void reset(lslboost::asio::io_service& io_service,
      BOOST_ASIO_MOVE_ARG(Handler) handler)
  {
  ...
  void complete(const lslboost::system::error_code& ec,
