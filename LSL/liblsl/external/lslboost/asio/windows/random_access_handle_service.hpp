...
#else
  : public lslboost::asio::detail::service_base<random_access_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit random_access_handle_service(lslboost::asio::io_service& io_service)
  ...
  std::size_t write_some_at(implementation_type& impl, lslboost::uint64_t offset,
  ...
  std::size_t read_some_at(implementation_type& impl, lslboost::uint64_t offset,
