...
#else
  : public lslboost::asio::detail::service_base<object_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit object_handle_service(lslboost::asio::io_service& io_service)
    : lslboost::asio::detail::service_base<object_handle_service>(io_service),
