...
public:
   ...
   */
  explicit basic_handle(lslboost::asio::io_service& io_service)
   ...
   */
  basic_handle(lslboost::asio::io_service& io_service,
   ...
   */
  lslboost::system::error_code assign(const native_handle_type& handle,
      lslboost::system::error_code& ec)
  {
