...
public:
   ...
   * handle.
   */
  explicit basic_random_access_handle(lslboost::asio::io_service& io_service)
   ...
   */
  basic_random_access_handle(lslboost::asio::io_service& io_service,
   ...
   * @code
   * handle.write_some_at(42, lslboost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_write_some_at(42, lslboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, lslboost::array or
   * std::vector.
  ...
  void async_write_some_at(lslboost::uint64_t offset,
      const ConstBufferSequence& buffers,
   ...
   * @code
   * handle.read_some_at(42, lslboost::asio::buffer(data, size));
   * @endcode
  ...
  std::size_t read_some_at(lslboost::uint64_t offset,
      const MutableBufferSequence& buffers)
  {
    lslboost::system::error_code ec;
    std::size_t s = this->get_service().read_some_at(
        this->get_implementation(), offset, buffers, ec);
    lslboost::asio::detail::throw_error(ec, "read_some_at");
    return s;
  }
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_read_some_at(42, lslboost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, lslboost::array or
   * std::vector.
  ...
  void async_read_some_at(lslboost::uint64_t offset,
      const MutableBufferSequence& buffers,
