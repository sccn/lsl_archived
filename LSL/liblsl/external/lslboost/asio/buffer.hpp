...
public:
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  mutable_buffer(void* data, std::size_t size,
      lslboost::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const lslboost::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  lslboost::function<void()> debug_check_;
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
};
...
struct buffer_types
  : public buffer_types_base<lslboost::is_const<PodType>::value>
{
};
