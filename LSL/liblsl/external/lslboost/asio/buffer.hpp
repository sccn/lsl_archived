...
# include <lslboost/asio/detail/function.hpp>
 ...
 *
 * @code lslboost::asio::mutable_buffer b1 = ...;
 * std::size_t s1 = lslboost::asio::buffer_size(b1);
 * unsigned char* p1 = lslboost::asio::buffer_cast<unsigned char*>(b1);
 * @endcode
 *
 * The lslboost::asio::buffer_cast function permits violations of type safety, so
...
public:
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  mutable_buffer(void* data, std::size_t size,
      lslboost::asio::detail::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const lslboost::asio::detail::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
...
private:
  friend void* lslboost::asio::detail::buffer_cast_helper(
      const mutable_buffer& b);
  friend std::size_t lslboost::asio::detail::buffer_size_helper(
      const mutable_buffer& b);
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  lslboost::asio::detail::function<void()> debug_check_;
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
};
 ...
 * and @ref buffer_cast functions:
 *
 * @code lslboost::asio::const_buffer b1 = ...;
 * std::size_t s1 = lslboost::asio::buffer_size(b1);
 * const unsigned char* p1 = lslboost::asio::buffer_cast<const unsigned char*>(b1);
 * @endcode
 *
 * The lslboost::asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
...
public:
  ...
  const_buffer(const mutable_buffer& b)
    : data_(lslboost::asio::detail::buffer_cast_helper(b)),
      size_(lslboost::asio::detail::buffer_size_helper(b))
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
...
private:
  friend const void* lslboost::asio::detail::buffer_cast_helper(
...
/** @defgroup buffer_size lslboost::asio::buffer_size
 *
 * @brief The lslboost::asio::buffer_size function determines the total number of
...
/** @defgroup buffer_cast lslboost::asio::buffer_cast
 *
 * @brief The lslboost::asio::buffer_cast function is used to obtain a pointer to
 ...
 * @code lslboost::asio::mutable_buffer b2 = ...;
 * unsigned char* p2 = lslboost::asio::buffer_cast<unsigned char*>(b2);
 * @endcode
 *
 * The lslboost::asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
...
/** @defgroup buffer lslboost::asio::buffer
 *
 * @brief The lslboost::asio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(lslboost::asio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of lslboost::asio::buffer meets the
 * requirements of the ConstBufferSequence concept so that it may be directly
 * passed to the socket's write function. A buffer created for modifiable
 * memory also meets the requirements of the MutableBufferSequence concept.
 *
 * An individual buffer may be created from a builtin array, std::vector,
 * std::array or lslboost::array of POD elements. This helps prevent buffer
 * overruns by automatically determining the size of the buffer:
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(lslboost::asio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(lslboost::asio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(lslboost::asio::buffer(d3));
 *
 * lslboost::array<char, 128> d4;
 * bytes_transferred = sock.receive(lslboost::asio::buffer(d4)); @endcode
 *
 ...
 * unsigned char* p1 = lslboost::asio::buffer_cast<unsigned char*>(b1);
 *
 * lslboost::asio::const_buffer b2 = ...;
 * std::size_t s2 = lslboost::asio::buffer_size(b2);
 * const void* p2 = lslboost::asio::buffer_cast<const void*>(b2); @endcode
 *
 * The lslboost::asio::buffer_cast function permits violations of type safety, so
 * uses of it in application code should be carefully considered.
 *
 ...
 *
 * vector<unsigned char> data(lslboost::asio::buffer_size(buffers));
 * lslboost::asio::buffer_copy(lslboost::asio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the lslboost::asio::buffer overloads that accept an argument of type
 ...
 * follows:
 *
 * @code lslboost::array<char, 6> a = { 'a', 'b', 'c', 'd', 'e' }; @endcode
 *
 * A buffer object @c b1 created using:
 *
 * @code b1 = lslboost::asio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the lslboost::asio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = lslboost::asio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = lslboost::asio::buffer(b1 + 1, 3); @endcode
 *
 ...
 * char d1[128];
 * std::vector<char> d2(128);
 * lslboost::array<char, 128> d3;
 *
 * lslboost::array<mutable_buffer, 3> bufs1 = {
 *   lslboost::asio::buffer(d1),
 *   lslboost::asio::buffer(d2),
 *   lslboost::asio::buffer(d3) };
 * bytes_transferred = sock.receive(bufs1);
 *
 * std::vector<const_buffer> bufs2;
 * bufs2.push_back(lslboost::asio::buffer(d1));
 * bufs2.push_back(lslboost::asio::buffer(d2));
 * bufs2.push_back(lslboost::asio::buffer(d3));
...
//
//   unspecified buffer(lslboost::array<PodType, N>& array ...);
//
// and
//
//   unspecified buffer(lslboost::array<const PodType, N>& array ...);
//
...
buffer(lslboost::array<PodType, N>& data)
{
  typedef typename lslboost::asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
  typedef typename lslboost::asio::detail::buffer_types<PodType>::container_type
    container_type;
...
template <typename PodType, std::size_t N>
inline typename detail::buffer_types<PodType>::container_type
buffer(lslboost::array<PodType, N>& data, std::size_t max_size_in_bytes)
{
  typedef typename lslboost::asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
  typedef typename lslboost::asio::detail::buffer_types<PodType>::container_type
 ...
 */
template <typename PodType, std::size_t N>
inline mutable_buffers_1 buffer(lslboost::array<PodType, N>& data)
{
  return mutable_buffers_1(
 ...
 */
template <typename PodType, std::size_t N>
inline const_buffers_1 buffer(lslboost::array<const PodType, N>& data)
{
  return const_buffers_1(
 ...
 */
template <typename PodType, std::size_t N>
inline const_buffers_1 buffer(const lslboost::array<PodType, N>& data)
{
  return const_buffers_1(
      const_buffer(data.data(), data.size() * sizeof(PodType)));
}
...
/** @defgroup buffer_copy lslboost::asio::buffer_copy
 *
 * @brief The lslboost::asio::buffer_copy function is used to copy bytes from a
