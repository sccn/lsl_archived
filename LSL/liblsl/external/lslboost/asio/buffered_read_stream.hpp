...
#include <lslboost/asio/detail/buffer_resize_guard.hpp>
...
public:
  ...
  std::size_t fill(lslboost::system::error_code& ec)
  {
    detail::buffer_resize_guard<detail::buffered_stream_storage>
      resize_guard(storage_);
    std::size_t previous_size = storage_.size();
  ...
  {
  public:
    fill_handler(lslboost::asio::io_service& io_service,
  ...
  {
  public:
    read_some_handler(lslboost::asio::io_service& io_service,
        detail::buffered_stream_storage& storage,
      ...
      ReadHandler handler)
  {
    ...
    else
    {
      ...
      get_io_service().post(detail::bind_handler(
            handler, lslboost::system::error_code(), length));
    }
  }
...
private:
  ...
  {
    return lslboost::asio::buffer_copy(buffers, storage_.data(), storage_.size());
  }
