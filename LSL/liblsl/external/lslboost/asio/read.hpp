...
/**
 * @defgroup read lslboost::asio::read
 *
 ...
 * @code lslboost::asio::read(s, lslboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code lslboost::asio::read(
 *     s, buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::read(s, lslboost::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::read(s, lslboost::asio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read lslboost::asio::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * lslboost::asio::async_read(s, lslboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::async_read(s,
...
#include <lslboost/asio/impl/read.hpp>
