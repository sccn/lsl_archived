...
#else
  : public lslboost::asio::detail::service_base<signal_set_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit signal_set_service(lslboost::asio::io_service& io_service)
    : lslboost::asio::detail::service_base<signal_set_service>(io_service),
  ...
  lslboost::system::error_code add(implementation_type& impl,
  ...
  lslboost::system::error_code remove(implementation_type& impl,
      int signal_number, lslboost::system::error_code& ec)
  {
  ...
  lslboost::system::error_code clear(implementation_type& impl,
