 ...
 *
 * Most applications will use one of the lslboost::asio::steady_timer,
 * lslboost::asio::system_timer or lslboost::asio::high_resolution_timer typedefs.
 *
 ...
 * lslboost::asio::steady_timer timer(io_service);
 *
