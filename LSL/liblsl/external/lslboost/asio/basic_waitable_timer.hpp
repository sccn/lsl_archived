 ...
 *
 * Most applications will use the lslboost::asio::waitable_timer typedef.
 *
 ...
 * lslboost::asio::waitable_timer timer(io_service);
 *
 ...
 * @endcode
 *
 * @li The lslboost::asio::basic_waitable_timer::expires_from_now() function
...
public:
   ...
   */
  explicit basic_waitable_timer(lslboost::asio::io_service& io_service)
   ...
   * as an absolute time.
   */
  basic_waitable_timer(lslboost::asio::io_service& io_service,
