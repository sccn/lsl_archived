...
# include <lslboost/asio/detail/null_socket_service.hpp>
...
#else
  : public lslboost::asio::detail::service_base<datagram_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit datagram_socket_service(lslboost::asio::io_service& io_service)
  ...
  lslboost::system::error_code shutdown(implementation_type& impl,
