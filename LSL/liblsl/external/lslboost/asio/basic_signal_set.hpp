 ...
 *
 * Most applications will use the lslboost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * lslboost::asio::signal_set signals(io_service, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(lslboost::asio::io_service& io_service)
   ...
   * @code lslboost::asio::signal_set signals(io_service);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(lslboost::asio::io_service& io_service, int signal_number_1)
    : basic_io_object<SignalSetService>(io_service)
  {
    lslboost::system::error_code ec;
    this->service.add(this->implementation, signal_number_1, ec);
    lslboost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  lslboost::system::error_code add(int signal_number,
      lslboost::system::error_code& ec)
  {
  ...
  void remove(int signal_number)
  {
    ...
    lslboost::asio::detail::throw_error(ec, "remove");
  }
   ...
   * signal number.
   */
  lslboost::system::error_code remove(int signal_number,
      lslboost::system::error_code& ec)
  {
  ...
  void clear()
  {
    ...
    lslboost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  lslboost::system::error_code clear(lslboost::system::error_code& ec)
  {
   ...
   * operation will be invoked with the lslboost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code lslboost::asio::error::operation_aborted.
   *
