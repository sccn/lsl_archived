...
public:
  ...
  explicit waitable_timer_service(lslboost::asio::io_service& io_service)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, lslboost::system::error_code& ec)
  {
  ...
  std::size_t expires_from_now(implementation_type& impl,
      const duration& expiry_time, lslboost::system::error_code& ec)
  {
