 ...
 *
 * Most applications will use the lslboost::asio::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * lslboost::asio::deadline_timer timer(io_service);
 *
 * // Set an expiry time relative to now.
 * timer.expires_from_now(lslboost::posix_time::seconds(5));
 *
 ...
 * @code
 * void handler(const lslboost::system::error_code& error)
 * {
 *   if (!error)
 *   {
 *     // Timer expired.
 ...
 * lslboost::asio::deadline_timer timer(io_service,
 *     lslboost::posix_time::time_from_string("2005-12-07 23:59:59.000"));
 *
 ...
 * }
 *
 * void on_timeout(const lslboost::system::error_code& e)
 * {
 *   if (e != lslboost::asio::error::operation_aborted)
 *   {
 ...
 * @endcode
 *
 * @li The lslboost::asio::basic_deadline_timer::expires_from_now() function
...
template <typename Time,
    typename TimeTraits = lslboost::asio::time_traits<Time>,
...
public:
   ...
   */
  explicit basic_deadline_timer(lslboost::asio::io_service& io_service)
   ...
   * as an absolute time.
   */
  basic_deadline_timer(lslboost::asio::io_service& io_service,
   ...
   * be invoked with the lslboost::asio::error::operation_aborted error code.
   *
   ...
   * lslboost::asio::error::operation_aborted error code.
   *
   * Cancelling the timer does not change the expiry time.
   *
   ...
   * code lslboost::asio::error::operation_aborted.
   *
