...
#include <lslboost/asio/detail/win_iocp_handle_read_op.hpp>
#include <lslboost/asio/detail/win_iocp_handle_write_op.hpp>
...
public:
  ...
  BOOST_ASIO_DECL win_iocp_handle_service(lslboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL lslboost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a handle implementation.
  BOOST_ASIO_DECL lslboost::system::error_code close(implementation_type& impl,
  ...
  BOOST_ASIO_DECL lslboost::system::error_code cancel(implementation_type& impl,
      lslboost::system::error_code& ec);
  ...
  // written.
  template <typename ConstBufferSequence>
  size_t write_some_at(implementation_type& impl, lslboost::uint64_t offset,
      const ConstBufferSequence& buffers, lslboost::system::error_code& ec)
  {
  ...
  template <typename ConstBufferSequence, typename Handler>
  void async_write_some_at(implementation_type& impl, lslboost::uint64_t offset,
      const ConstBufferSequence& buffers, Handler handler)
  {
    // Allocate and construct an operation to wrap the handler.
    typedef win_iocp_handle_write_op<ConstBufferSequence, Handler> op;
  ...
  template <typename MutableBufferSequence>
  size_t read_some_at(implementation_type& impl, lslboost::uint64_t offset,
      const MutableBufferSequence& buffers, lslboost::system::error_code& ec)
  {
  ...
  // operation.
  template <typename MutableBufferSequence, typename Handler>
  void async_read_some_at(implementation_type& impl, lslboost::uint64_t offset,
      const MutableBufferSequence& buffers, Handler handler)
  {
    // Allocate and construct an operation to wrap the handler.
    typedef win_iocp_handle_read_op<MutableBufferSequence, Handler> op;
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, lslboost::system::error_code& ec);
  size_t write_some_at(implementation_type& impl, lslboost::uint64_t offset,
      const null_buffers& buffers, lslboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_write(implementation_type& impl,
      lslboost::uint64_t offset, const lslboost::asio::const_buffer& buffer,
      lslboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_read(implementation_type& impl,
      lslboost::uint64_t offset, const lslboost::asio::mutable_buffer& buffer,
      lslboost::system::error_code& ec);
