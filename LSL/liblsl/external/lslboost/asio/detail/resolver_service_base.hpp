...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL resolver_service_base(lslboost::asio::io_service& io_service);
...
protected:
  ...
  {
  public:
    explicit auto_addrinfo(lslboost::asio::detail::addrinfo_type* ai)
      : ai_(ai)
    {
    }
    ...
    operator lslboost::asio::detail::addrinfo_type*()
    {
      return ai_;
    }

  private:
    lslboost::asio::detail::addrinfo_type* ai_;
  };
...
private:
  ...
  lslboost::asio::detail::scoped_ptr<lslboost::asio::io_service> work_io_service_;

  // The work io_service implementation used to post completions.
  io_service_impl& work_io_service_impl_;

  // Work for the private io_service to perform.
  lslboost::asio::detail::scoped_ptr<lslboost::asio::io_service::work> work_;

  // Thread used for running the work io_service's run loop.
  lslboost::asio::detail::scoped_ptr<lslboost::asio::detail::thread> work_thread_;
};
