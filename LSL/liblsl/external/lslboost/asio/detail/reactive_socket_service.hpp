...
#include <lslboost/asio/detail/reactive_socket_accept_op.hpp>
#include <lslboost/asio/detail/reactive_socket_connect_op.hpp>
#include <lslboost/asio/detail/reactive_socket_recvfrom_op.hpp>
#include <lslboost/asio/detail/reactive_socket_sendto_op.hpp>
...
public:
  ...
  // Constructor.
  reactive_socket_service(lslboost::asio::io_service& io_service)
  ...
  lslboost::system::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, lslboost::system::error_code& ec)
  {
