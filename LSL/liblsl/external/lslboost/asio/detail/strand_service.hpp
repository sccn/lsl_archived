...
class strand_service
  : public lslboost::asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  BOOST_ASIO_DECL explicit strand_service(lslboost::asio::io_service& io_service);
...
private:
  ...
  BOOST_ASIO_DECL static void do_complete(io_service_impl* owner,
      operation* base, const lslboost::system::error_code& ec,
...
#include <lslboost/asio/detail/impl/strand_service.hpp>
