...
#include <lslboost/asio/detail/reactive_null_buffers_op.hpp>
#include <lslboost/asio/detail/reactive_socket_recv_op.hpp>
#include <lslboost/asio/detail/reactive_socket_recvmsg_op.hpp>
#include <lslboost/asio/detail/reactive_socket_send_op.hpp>
...
protected:
  ...
  BOOST_ASIO_DECL lslboost::system::error_code do_open(
      ...
      int type, int protocol, lslboost::system::error_code& ec);
