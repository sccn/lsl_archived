...
#include <lslboost/asio/detail/winrt_async_manager.hpp>
#include <lslboost/asio/detail/winrt_socket_recv_op.hpp>
#include <lslboost/asio/detail/winrt_socket_send_op.hpp>
...
public:
  ...
  // Destroy a socket implementation.
  BOOST_ASIO_DECL lslboost::system::error_code close(
      base_implementation_type& impl, lslboost::system::error_code& ec);
  ...
  lslboost::system::error_code cancel(base_implementation_type&,
  ...
  lslboost::system::error_code io_control(base_implementation_type&,
      IO_Control_Command&, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  lslboost::system::error_code non_blocking(base_implementation_type&,
      bool, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  lslboost::system::error_code native_non_blocking(base_implementation_type&,
      bool, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  ...
  lslboost::system::error_code shutdown(base_implementation_type&,
      socket_base::shutdown_type, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  std::size_t send(base_implementation_type&, const null_buffers&,
      socket_base::message_flags, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return 0;
  }
  ...
  {
    lslboost::system::error_code ec = lslboost::asio::error::operation_not_supported;
...
protected:
  ...
  BOOST_ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, lslboost::system::error_code& ec) const;

  // Helper function to set a socket option.
  BOOST_ASIO_DECL lslboost::system::error_code do_set_option(
  ...
  BOOST_ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, lslboost::system::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  BOOST_ASIO_DECL lslboost::system::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, lslboost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const lslboost::asio::const_buffer& data,
      socket_base::message_flags flags, lslboost::system::error_code& ec);

  // Helper function to start an asynchronous send.
  BOOST_ASIO_DECL void start_send_op(base_implementation_type& impl,
      const lslboost::asio::const_buffer& data, socket_base::message_flags flags,
  ...
  BOOST_ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const lslboost::asio::mutable_buffer& data,
      socket_base::message_flags flags, lslboost::system::error_code& ec);

  // Helper function to start an asynchronous receive.
  BOOST_ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const lslboost::asio::mutable_buffer& data, socket_base::message_flags flags,
