...
class kqueue_reactor
  : public lslboost::asio::detail::service_base<kqueue_reactor>
{
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL kqueue_reactor(lslboost::asio::io_service& io_service);
...
#include <lslboost/asio/detail/impl/kqueue_reactor.hpp>
