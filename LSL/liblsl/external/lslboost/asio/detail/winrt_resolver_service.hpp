...
#include <lslboost/asio/detail/winrt_resolve_op.hpp>
...
public:
  ...
  // The iterator type.
  typedef lslboost::asio::ip::basic_resolver_iterator<Protocol> iterator_type;

  // Constructor.
  winrt_resolver_service(lslboost::asio::io_service& io_service)
  ...
  void fork_service(lslboost::asio::io_service::fork_event)
  {
  }
  ...
  iterator_type resolve(implementation_type&,
      const query_type& query, lslboost::system::error_code& ec)
  {
    try
    {
      ...
      const query_type& query, Handler& handler)
  {
    ...
    {
      p.p->ec_ = lslboost::system::error_code(
