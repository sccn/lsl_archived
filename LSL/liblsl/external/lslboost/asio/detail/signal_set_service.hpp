...
#include <lslboost/asio/detail/signal_handler.hpp>
#include <lslboost/asio/detail/signal_op.hpp>
...
extern "C" BOOST_ASIO_DECL void lslboost_asio_signal_handler(int signal_number);
...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL signal_set_service(lslboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL lslboost::system::error_code add(implementation_type& impl,
      int signal_number, lslboost::system::error_code& ec);

  // Remove a signal to a signal_set.
  BOOST_ASIO_DECL lslboost::system::error_code remove(implementation_type& impl,
      int signal_number, lslboost::system::error_code& ec);

  // Remove all signals from a signal_set.
  BOOST_ASIO_DECL lslboost::system::error_code clear(implementation_type& impl,
