...
#include <lslboost/asio/detail/object_pool.hpp>
...
class epoll_reactor
  : public lslboost::asio::detail::service_base<epoll_reactor>
{
public:
  ...
  class descriptor_state : operation
  {
    ...
    int descriptor_;
    lslboost::uint32_t registered_events_;
  ...
  // Constructor.
  BOOST_ASIO_DECL epoll_reactor(lslboost::asio::io_service& io_service);
...
#include <lslboost/asio/detail/impl/epoll_reactor.hpp>
