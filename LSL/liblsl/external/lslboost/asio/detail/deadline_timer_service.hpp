...
public:
  ...
  // Constructor.
  deadline_timer_service(lslboost::asio::io_service& io_service)
    : scheduler_(lslboost::asio::use_service<timer_scheduler>(io_service))
  {
...
private:
  ...
  // either be of type lslboost::posix_time::time_duration, or implement the
