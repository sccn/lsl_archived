...
# include <lslboost/asio/detail/socket_select_interrupter.hpp>
#elif defined(BOOST_ASIO_HAS_EVENTFD)
# include <lslboost/asio/detail/eventfd_select_interrupter.hpp>
#else
# include <lslboost/asio/detail/pipe_select_interrupter.hpp>
#endif
