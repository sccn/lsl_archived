...
service_registry::~service_registry()
{
  ...
  lslboost::asio::io_service::service* service = first_service_;
  while (service)
  {
  ...
  {
    lslboost::asio::io_service::service* next_service = first_service_->next_;
    destroy(first_service_);
    first_service_ = next_service;
  }
}

void service_registry::notify_fork(lslboost::asio::io_service::fork_event fork_ev)
{
  // Make a copy of all of the services while holding the lock. We don't want
  // to hold the lock while calling into each service, as it may try to call
  // back into this class.
  std::vector<lslboost::asio::io_service::service*> services;
  {
  ...
  if (fork_ev == lslboost::asio::io_service::fork_prepare)
...
void service_registry::init_key(lslboost::asio::io_service::service::key& key,
...
void service_registry::destroy(lslboost::asio::io_service::service* service)
{
  delete service;
}

lslboost::asio::io_service::service* service_registry::do_use_service(
