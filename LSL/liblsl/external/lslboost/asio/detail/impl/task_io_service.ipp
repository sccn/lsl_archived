...
#include <lslboost/asio/detail/task_io_service_thread_info.hpp>
...
struct task_io_service::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      lslboost::asio::detail::increment(
...
task_io_service::task_io_service(
    lslboost::asio::io_service& io_service, std::size_t concurrency_hint)
  : lslboost::asio::detail::service_base<task_io_service>(io_service),
...
std::size_t task_io_service::run(lslboost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(lslboost::system::error_code& ec)
{
  ec = lslboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(lslboost::system::error_code& ec)
{
  ec = lslboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll_one(lslboost::system::error_code& ec)
{
  ec = lslboost::system::error_code();
  if (outstanding_work_ == 0)
  {
