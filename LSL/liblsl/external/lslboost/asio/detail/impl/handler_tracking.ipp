    ...
    const char* object_type, void* object, const char* op_name)
{
  ...
  lslboost::uint64_t current_id = 0;
...
#endif // defined(BOOST_WINDOWS)
      static_cast<lslboost::uint64_t>(now.total_seconds()),
      static_cast<lslboost::uint64_t>(now.total_microseconds() % 1000000),
...
#endif // defined(BOOST_WINDOWS)
      static_cast<lslboost::uint64_t>(now.total_seconds()),
      static_cast<lslboost::uint64_t>(now.total_microseconds() % 1000000), id_);
    ...
    const lslboost::system::error_code& ec, std::size_t bytes_transferred)
{
  ...
  write_line(
      ...
      static_cast<lslboost::uint64_t>(now.total_microseconds() % 1000000),
      id_, ec.category().name(), ec.value(),
      static_cast<lslboost::uint64_t>(bytes_transferred));
