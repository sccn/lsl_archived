...
#include <lslboost/asio/detail/resolver_service_base.hpp>
...
{
public:
  work_io_service_runner(lslboost::asio::io_service& io_service)
...
resolver_service_base::resolver_service_base(
  ...
  : io_service_impl_(lslboost::asio::use_service<io_service_impl>(io_service)),
    work_io_service_(new lslboost::asio::io_service),
    work_io_service_impl_(lslboost::asio::use_service<
        io_service_impl>(*work_io_service_)),
    work_(new lslboost::asio::io_service::work(*work_io_service_)),
    work_thread_(0)
{
}
    ...
    lslboost::asio::io_service::fork_event fork_ev)
{
  if (work_thread_.get())
  {
    ...
    {
      work_io_service_->reset();
      work_thread_.reset(new lslboost::asio::detail::thread(
