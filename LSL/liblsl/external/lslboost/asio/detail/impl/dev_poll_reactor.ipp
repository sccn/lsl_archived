...
dev_poll_reactor::dev_poll_reactor(lslboost::asio::io_service& io_service)
  : lslboost::asio::detail::service_base<dev_poll_reactor>(io_service),
...
void dev_poll_reactor::fork_service(lslboost::asio::io_service::fork_event fork_ev)
{
...
{
  lslboost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, lslboost::asio::error::operation_aborted);
}
...
void dev_poll_reactor::run(bool block, op_queue<operation>& ops)
{
  ...
  if (events_size > 0)
  {
    ...
    {
      lslboost::system::error_code ec = lslboost::system::error_code(
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    lslboost::system::error_code ec(errno,
        lslboost::asio::error::get_system_category());
    lslboost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
