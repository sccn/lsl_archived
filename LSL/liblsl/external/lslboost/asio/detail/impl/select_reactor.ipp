...
select_reactor::select_reactor(lslboost::asio::io_service& io_service)
  : lslboost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  lslboost::asio::detail::signal_blocker sb;
  thread_ = new lslboost::asio::detail::thread(
...
void select_reactor::fork_service(lslboost::asio::io_service::fork_event fork_ev)
{
