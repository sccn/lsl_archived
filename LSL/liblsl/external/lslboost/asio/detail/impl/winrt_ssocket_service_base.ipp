...
lslboost::system::error_code winrt_ssocket_service_base::close(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
lslboost::system::error_code winrt_ssocket_service_base::do_set_option(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
lslboost::system::error_code winrt_ssocket_service_base::do_connect(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    const void* addr, winrt_async_op<void>* op, bool is_continuation)
{
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    op->ec_ = lslboost::asio::error::address_family_not_supported;
    break;
  }
    ...
    socket_base::message_flags flags, lslboost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<lslboost::asio::const_buffer,
      lslboost::asio::const_buffers_1> bufs(lslboost::asio::buffer(data));
    ...
    socket_base::message_flags flags, lslboost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<lslboost::asio::mutable_buffer,
        lslboost::asio::mutable_buffers_1> bufs(lslboost::asio::buffer(data));
