...
win_iocp_io_service::win_iocp_io_service(
    lslboost::asio::io_service& io_service, size_t concurrency_hint)
  : lslboost::asio::detail::service_base<win_iocp_io_service>(io_service),
    iocp_(),
    outstanding_work_(0),
    stopped_(0),
...
lslboost::system::error_code win_iocp_io_service::register_handle(
...
size_t win_iocp_io_service::run(lslboost::system::error_code& ec)
{
...
size_t win_iocp_io_service::run_one(lslboost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
...
size_t win_iocp_io_service::poll(lslboost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
...
size_t win_iocp_io_service::poll_one(lslboost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
...
size_t win_iocp_io_service::do_one(bool block, lslboost::system::error_code& ec)
{
  for (;;)
  {
