...
#include <lslboost/asio/detail/reactor.hpp>
#include <lslboost/asio/detail/reactor_op.hpp>
#include <lslboost/asio/detail/socket_holder.hpp>
...
#include <lslboost/asio/detail/win_iocp_null_buffers_op.hpp>
#include <lslboost/asio/detail/win_iocp_socket_connect_op.hpp>
#include <lslboost/asio/detail/win_iocp_socket_send_op.hpp>
#include <lslboost/asio/detail/win_iocp_socket_recv_op.hpp>
#include <lslboost/asio/detail/win_iocp_socket_recvmsg_op.hpp>
...
public:
  ...
  BOOST_ASIO_DECL lslboost::system::error_code cancel(
      base_implementation_type& impl, lslboost::system::error_code& ec);
  ...
  lslboost::system::error_code listen(base_implementation_type& impl,
  ...
  lslboost::system::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, lslboost::system::error_code& ec)
  {
  ...
  lslboost::system::error_code non_blocking(base_implementation_type& impl,
  ...
  lslboost::system::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, lslboost::system::error_code& ec)
  {
  ...
  lslboost::system::error_code shutdown(base_implementation_type& impl,
      socket_base::shutdown_type what, lslboost::system::error_code& ec)
  {
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, lslboost::system::error_code& ec)
  {
    buffer_sequence_adapter<lslboost::asio::mutable_buffer,
        MutableBufferSequence> bufs(buffers);
...
protected:
  ...
  BOOST_ASIO_DECL lslboost::system::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, lslboost::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  BOOST_ASIO_DECL lslboost::system::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, lslboost::system::error_code& ec);
