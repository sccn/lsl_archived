...
#include <lslboost/asio/detail/reactive_socket_connect_op.hpp>
...
#include <lslboost/asio/detail/win_iocp_socket_accept_op.hpp>
#include <lslboost/asio/detail/win_iocp_socket_recvfrom_op.hpp>
...
public:
  ...
  // Constructor.
  win_iocp_socket_service(lslboost::asio::io_service& io_service)
  ...
  lslboost::system::error_code accept(implementation_type& impl, Socket& peer,
