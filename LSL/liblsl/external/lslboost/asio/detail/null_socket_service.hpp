...
public:
  ...
  // Constructor.
  null_socket_service(lslboost::asio::io_service& io_service)
  ...
  lslboost::system::error_code open(implementation_type&,
      const protocol_type&, lslboost::system::error_code& ec)
  {
  ...
  lslboost::system::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  lslboost::system::error_code close(implementation_type&,
  ...
  lslboost::system::error_code cancel(implementation_type&,
      lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  ...
  lslboost::system::error_code listen(implementation_type&,
      int, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  lslboost::system::error_code io_control(implementation_type&,
  ...
  lslboost::system::error_code non_blocking(implementation_type&,
  ...
  lslboost::system::error_code native_non_blocking(implementation_type&,
      bool, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  ...
  lslboost::system::error_code shutdown(implementation_type&,
  ...
  lslboost::system::error_code set_option(implementation_type&,
      const Option&, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  lslboost::system::error_code get_option(const implementation_type&,
      Option&, lslboost::system::error_code& ec) const
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  lslboost::system::error_code accept(implementation_type&,
      Socket&, endpoint_type*, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  lslboost::system::error_code connect(implementation_type&,
      const endpoint_type&, lslboost::system::error_code& ec)
  {
    ec = lslboost::asio::error::operation_not_supported;
    return ec;
