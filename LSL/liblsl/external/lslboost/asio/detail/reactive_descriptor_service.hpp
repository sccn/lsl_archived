...
#include <lslboost/asio/detail/descriptor_read_op.hpp>
#include <lslboost/asio/detail/descriptor_write_op.hpp>
...
public:
  ...
  class implementation_type
    : private lslboost::asio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, lslboost::system::error_code& ec)
  {
