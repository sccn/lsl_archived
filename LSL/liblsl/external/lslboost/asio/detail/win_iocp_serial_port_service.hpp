...
public:
  ...
  BOOST_ASIO_DECL lslboost::system::error_code open(implementation_type& impl,
      const std::string& device, lslboost::system::error_code& ec);
  ...
  lslboost::system::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, lslboost::system::error_code& ec)
  {
  ...
  lslboost::system::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, lslboost::system::error_code& ec) const
  {
  ...
  lslboost::system::error_code send_break(implementation_type&,
      lslboost::system::error_code& ec)
  {
...
private:
  ...
  typedef lslboost::system::error_code (*store_function_type)(
      const void*, ::DCB&, lslboost::system::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static lslboost::system::error_code store_option(const void* option,
      ::DCB& storage, lslboost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL lslboost::system::error_code do_set_option(
      ...
      const void* option, lslboost::system::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef lslboost::system::error_code (*load_function_type)(
      void*, const ::DCB&, lslboost::system::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static lslboost::system::error_code load_option(void* option,
      const ::DCB& storage, lslboost::system::error_code& ec)
  {
    return static_cast<GettableSerialPortOption*>(option)->load(storage, ec);
  }

  // Helper function to get a serial port option.
  BOOST_ASIO_DECL lslboost::system::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, lslboost::system::error_code& ec) const;
