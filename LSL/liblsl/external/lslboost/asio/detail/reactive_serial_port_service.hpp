...
#include <lslboost/asio/detail/reactive_descriptor_service.hpp>
...
public:
  ...
  lslboost::system::error_code send_break(implementation_type& impl,
      lslboost::system::error_code& ec)
  {
    errno = 0;
