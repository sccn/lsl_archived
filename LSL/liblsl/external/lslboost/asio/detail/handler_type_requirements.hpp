...
#define BOOST_ASIO_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::zero_arg_handler_test( \
          lslboost::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef lslboost::asio::detail::handler_type_requirements< \
      sizeof( \
        lslboost::asio::detail::argbyv( \
          lslboost::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()(), \
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::two_arg_handler_test( \
          lslboost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const lslboost::system::error_code*>(0), \
  ...
  typedef lslboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            lslboost::asio::detail::lvref<const lslboost::system::error_code>(), \
            lslboost::asio::detail::lvref<const std::size_t>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::one_arg_handler_test( \
          lslboost::asio::detail::clvref< \
            asio_true_handler_type>(), \
          static_cast<const lslboost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_COMPOSED_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(lslboost::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(lslboost::asio::detail::two_arg_handler_test( \
  ...
  typedef lslboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            lslboost::asio::detail::lvref<const lslboost::system::error_code>(), \
            lslboost::asio::detail::lvref<const iter_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
  ...
  typedef lslboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        lslboost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            lslboost::asio::detail::lvref<const lslboost::system::error_code>(), \
            lslboost::asio::detail::lvref<const int>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
