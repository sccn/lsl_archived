...
class dev_poll_reactor
  : public lslboost::asio::detail::service_base<dev_poll_reactor>
{
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL dev_poll_reactor(lslboost::asio::io_service& io_service);
...
#include <lslboost/asio/detail/impl/dev_poll_reactor.hpp>
