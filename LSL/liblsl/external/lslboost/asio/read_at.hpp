...
/**
 * @defgroup read_at lslboost::asio::read_at
 *
 ...
 * @code lslboost::asio::read_at(d, 42, lslboost::asio::buffer(data, size)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code lslboost::asio::read_at(
 *     d, 42, buffers,
 *     lslboost::asio::transfer_all()); @endcode
 */
template <typename SyncRandomAccessReadDevice, typename MutableBufferSequence>
std::size_t read_at(SyncRandomAccessReadDevice& d,
    lslboost::uint64_t offset, const MutableBufferSequence& buffers);
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::read_at(d, 42,
 *     lslboost::asio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 *
 ...
 * @code lslboost::asio::read_at(
 *     d, 42, buffers,
 *     lslboost::asio::transfer_all(), ec); @endcode
 */
template <typename SyncRandomAccessReadDevice, typename MutableBufferSequence>
std::size_t read_at(SyncRandomAccessReadDevice& d,
    lslboost::uint64_t offset, const MutableBufferSequence& buffers,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::read_at(d, 42, lslboost::asio::buffer(data, size),
 *     lslboost::asio::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 */
...
std::size_t read_at(SyncRandomAccessReadDevice& d,
    lslboost::uint64_t offset, basic_streambuf<Allocator>& b);
...
/*@}*/
/**
 * @defgroup async_read_at lslboost::asio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * lslboost::asio::async_read_at(d, 42, lslboost::asio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
 *
 * @note This overload is equivalent to calling:
 * @code lslboost::asio::async_read_at(
 *     d, 42, buffers,
 *     lslboost::asio::transfer_all(),
 *     handler); @endcode
 */
template <typename AsyncRandomAccessReadDevice, typename MutableBufferSequence,
    typename ReadHandler>
void async_read_at(AsyncRandomAccessReadDevice& d, lslboost::uint64_t offset,
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code lslboost::asio::async_read_at(d, 42,
 *     lslboost::asio::buffer(data, size),
 *     lslboost::asio::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, lslboost::array or
 * std::vector.
...
#include <lslboost/asio/impl/read_at.hpp>
