...
# include <lslboost/asio/detail/winrt_ssocket_service.hpp>
...
#else
  : public lslboost::asio::detail::service_base<stream_socket_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_socket_service(lslboost::asio::io_service& io_service)
