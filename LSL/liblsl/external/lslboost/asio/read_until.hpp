...
#include <lslboost/asio/detail/regex_fwd.hpp>
...
struct is_match_condition
{
  ...
  enum
  {
    value = lslboost::is_function<typename lslboost::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until lslboost::asio::read_until
 *
 ...
 * @code lslboost::asio::streambuf b;
 * lslboost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    lslboost::asio::basic_streambuf<Allocator>& b, const std::string& delim);
 ...
 * @code lslboost::asio::streambuf b;
 * lslboost::asio::read_until(s, b, lslboost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    lslboost::asio::basic_streambuf<Allocator>& b, const lslboost::regex& expr);
 ...
 * @code typedef lslboost::asio::buffers_iterator<
 *     lslboost::asio::streambuf::const_buffers_type> iterator;
 *
 ...
 * }
 * ...
 * lslboost::asio::streambuf b;
 * lslboost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * lslboost::asio::streambuf b;
 * lslboost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    lslboost::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
    typename lslboost::enable_if<is_match_condition<MatchCondition> >::type* = 0);
...
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    lslboost::asio::basic_streambuf<Allocator>& b,
    MatchCondition match_condition, lslboost::system::error_code& ec,
    typename lslboost::enable_if<is_match_condition<MatchCondition> >::type* = 0);

/*@}*/
/**
 * @defgroup async_read_until lslboost::asio::async_read_until
 *
 ...
 * @code void handler(
 *   // Result of operation.
 *   const lslboost::system::error_code& error,
 *
 ...
 * @code lslboost::asio::streambuf b;
 * ...
 * void handler(const lslboost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::istream is(&b);
 ...
 * }
 * ...
 * lslboost::asio::async_read_until(s, b, '\n', handler); @endcode
 ...
 * }
 * ...
 * lslboost::asio::async_read_until(s, b, lslboost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * lslboost::asio::streambuf b;
 * lslboost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * lslboost::asio::streambuf b;
 * lslboost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
...
#include <lslboost/asio/impl/read_until.hpp>
