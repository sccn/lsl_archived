...
#else
  : public lslboost::asio::detail::service_base<stream_descriptor_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_descriptor_service(lslboost::asio::io_service& io_service)
    : lslboost::asio::detail::service_base<stream_descriptor_service>(io_service),
