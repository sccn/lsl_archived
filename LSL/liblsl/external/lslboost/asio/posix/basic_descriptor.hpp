...
public:
   ...
   * descriptor.
   */
  explicit basic_descriptor(lslboost::asio::io_service& io_service)
   ...
   */
  basic_descriptor(lslboost::asio::io_service& io_service,
   ...
   */
  lslboost::system::error_code assign(const native_handle_type& native_descriptor,
      lslboost::system::error_code& ec)
  {
   ...
   * @code
   * lslboost::asio::posix::stream_descriptor descriptor(io_service);
   * ...
