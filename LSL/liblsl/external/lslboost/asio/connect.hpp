...
/**
 * @defgroup connect lslboost::asio::connect
 *
 ...
 *
 * @throws lslboost::system::system_error Thrown on failure. If the sequence is
 * empty, the associated @c error_code is lslboost::asio::error::not_found.
 ...
 * empty, set to lslboost::asio::error::not_found. Otherwise, contains the error
 ...
 * tcp::socket s(io_service);
 * lslboost::asio::connect(s, i, end); @endcode
 */
template <typename Protocol, typename SocketService, typename Iterator>
Iterator connect(basic_socket<Protocol, SocketService>& s,
 ...
 * tcp::socket s(io_service);
 * lslboost::system::error_code ec;
 * lslboost::asio::connect(s, i, end, ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
 ...
 * tcp::resolver::query q("host", "service");
 * tcp::socket s(io_service);
 * tcp::resolver::iterator i = lslboost::asio::connect(
 ...
 * tcp::resolver::iterator i = r.resolve(q), end;
 * tcp::socket s(io_service);
 * i = lslboost::asio::connect(s, i, end, my_connect_condition());
 * std::cout << "Connected to: " << i->endpoint() << std::endl; @endcode
 */
template <typename Protocol, typename SocketService,
    typename Iterator, typename ConnectCondition>
 ...
 * tcp::socket s(io_service);
 * lslboost::system::error_code ec;
 * i = lslboost::asio::connect(s, i, end, my_connect_condition(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
...
/**
 * @defgroup async_connect lslboost::asio::async_connect
 *
 ...
 *   // lslboost::asio::error::not_found. Otherwise, contains the
 ...
 *   if (!ec)
 *   {
 *     lslboost::asio::async_connect(s, i, connect_handler);
 *   }
 * }
 *
 * // ...
 ...
 *     lslboost::asio::async_connect(s, i, end, connect_handler);
 *   }
 * }
 *
 * // ...
 ...
 *   if (!ec)
 *   {
 *     lslboost::asio::async_connect(s, i,
 ...
 *   {
 *     tcp::resolver::iterator end;
 *     lslboost::asio::async_connect(s, i, end,
 *         my_connect_condition(),
 *         connect_handler);
 *   }
 * }
...
#include <lslboost/asio/impl/connect.hpp>
