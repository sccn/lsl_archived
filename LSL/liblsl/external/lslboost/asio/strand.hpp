...
#include <lslboost/asio/detail/strand_service.hpp>
...
public:
   ...
   */
  explicit strand(lslboost::asio::io_service& io_service)
    : service_(lslboost::asio::use_service<
        lslboost::asio::detail::strand_service>(io_service))
  {
...
private:
  ...
  lslboost::asio::detail::strand_service::implementation_type impl_;
};

/// (Deprecated: Use lslboost::asio::io_service::strand.) Typedef for backwards
/// compatibility.
typedef lslboost::asio::io_service::strand strand;
