...
public:
   ...
   * socket.
   */
  explicit basic_datagram_socket(lslboost::asio::io_service& io_service)
   ...
   */
  basic_datagram_socket(lslboost::asio::io_service& io_service,
   ...
   *     lslboost::asio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, lslboost::array or
   * std::vector.
   */
