...
//  Since WRS does not yet properly support lslboost under vxWorks
//  and this file was badly outdated, but I was keen on using it,
//  I patched lslboost myself to make things work. This has been tested
...
//  absolutely unable to use lslboost. This is mainly due to the completely
...
//  with the usage of lslboost from DKMs. WRS or any voluteers are free to
//  prove the opposite!
...
//
// a) Patch every piece of lslboost that uses semaphores to instanciate
...
//    too easily, as with every new version some lslboost library could
...
//    as it will more or less seamlessly integrate with lslboost. I got
...
//   with the changed properties. That's it! Now, using lslboost should
...
#  error "The vxWorks version you're using is so badly outdated,\
          it doesn't work at all with lslboost, sorry, no chance!"
#endif

// Handle versions above 5.X but below 6.9
#if (_WRS_VXWORKS_MAJOR == 6) && (_WRS_VXWORKS_MINOR < 9)
// TODO: Starting from what version does vxWorks work with lslboost?
// We can't reasonably insert a #warning "" as a user hint here,
// as this will show up with every file including some lslboost header,
...
// Generally unavailable functionality, delivered by lslboost's test function:
//#define BOOST_NO_DEDUCED_TYPENAME // Commented this out, lslboost's test gives an errorneous result!
