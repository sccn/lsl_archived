...
//  http://www.lslboost.org/libs/config/
//
...
//  Because std::size_t usage is so common, even in lslboost headers which do not
//  otherwise use the C library, the <cstddef> workaround is included here so
//  that ugly workaround code need not appear in many other lslboost headers.
...
#  define BOOST_EXPLICIT_TEMPLATE_TYPE(t)              lslboost::type<t>* = 0
#  define BOOST_EXPLICIT_TEMPLATE_TYPE_SPEC(t)         lslboost::type<t>*
#  define BOOST_EXPLICIT_TEMPLATE_NON_TYPE(t, v)       lslboost::non_type<t, v>* = 0
#  define BOOST_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  lslboost::non_type<t, v>*
