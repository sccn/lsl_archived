...
#include <lslboost/exception/all.hpp>
...
typename lslboost::enable_if<lslboost::is_integral<typename detail::hex_iterator_traits<InputIterator>::value_type>, OutputIterator>::type
...
/// \note           Based on the MySQL function of the same name
template <typename T, typename OutputIterator>
typename lslboost::enable_if<lslboost::is_integral<T>, OutputIterator>::type
...
typename lslboost::enable_if<lslboost::is_integral<typename detail::hex_iterator_traits<typename Range::iterator>::value_type>, OutputIterator>::type
hex ( const Range &r, OutputIterator out ) {
    return hex (lslboost::begin(r), lslboost::end(r), out);
}
...
OutputIterator unhex ( const Range &r, OutputIterator out ) {
    return unhex (lslboost::begin(r), lslboost::end(r), out);
    }
