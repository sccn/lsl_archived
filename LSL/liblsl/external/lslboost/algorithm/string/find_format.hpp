...
#include <lslboost/algorithm/string/detail/find_format.hpp>
#include <lslboost/algorithm/string/detail/find_format_all.hpp>
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            return detail::find_format_copy_impl(
                ...
                lit_input,
                Formatter,
                Finder( ::lslboost::begin(lit_input), ::lslboost::end(lit_input) ) );
        }
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            return detail::find_format_copy_impl(
                Input,
                Formatter,
                Finder(::lslboost::begin(Input), ::lslboost::end(Input)));
        }
