...
#include <lslboost/algorithm/string/std/string_traits.hpp>
#include <lslboost/algorithm/string/std/list_traits.hpp>

#ifdef BOOST_HAS_SLIST
#   include <lslboost/algorithm/string/std/slist_traits.hpp>
#endif
