...
#include <lslboost/algorithm/string/detail/find_iterator.hpp>
        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::lslboost::as_literal(Col));
                m_Match=::lslboost::make_iterator_range(::lslboost::begin(lit_col), ::lslboost::begin(lit_col));
                m_End=::lslboost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::lslboost::as_literal(Col));
                m_Match=make_iterator_range(::lslboost::begin(lit_col), ::lslboost::begin(lit_col));
                m_Next=::lslboost::begin(lit_col);
                m_End=::lslboost::end(lit_col);
