...
#include <lslboost/algorithm/string/detail/finder.hpp>
            ...
            return 
                detail::first_finderF<
                    BOOST_STRING_TYPENAME 
                        ...
                        is_equal>( ::lslboost::as_literal(Search), is_equal() ) ;
        }
            ...
            const RangeT& Search, PredicateT Comp )
        {
            return 
                detail::first_finderF<
                    BOOST_STRING_TYPENAME 
                        range_const_iterator<RangeT>::type,
                    PredicateT>( ::lslboost::as_literal(Search), Comp );
        }
            ...
            int Nth)
        {
            return 
                detail::nth_finderF<
                    BOOST_STRING_TYPENAME 
                        range_const_iterator<RangeT>::type,
                    is_equal>( ::lslboost::as_literal(Search), Nth, is_equal() ) ;
        }
        //! "Nth" finder
        /*!
            \overload
            ...
            PredicateT Comp )
        {
            return 
                detail::nth_finderF<
                    BOOST_STRING_TYPENAME 
                        range_const_iterator<RangeT>::type,
                    PredicateT>( ::lslboost::as_literal(Search), Nth, Comp );
        }
