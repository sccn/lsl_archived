...
Explanations:   lslboostinspect:noascii (test tool complains)
...
///
    ...
    {
        typedef typename lslboost::range_iterator<PatternRange> pattern_iterator;
        boyer_moore<pattern_iterator> bm ( lslboost::begin(pattern), lslboost::end (pattern));
        return bm ( corpus_first, corpus_last );
    }
    ...
    template <typename Range>
    lslboost::algorithm::boyer_moore<typename lslboost::range_iterator<const Range>::type>
    make_boyer_moore ( const Range &r ) {
        return lslboost::algorithm::boyer_moore
            <typename lslboost::range_iterator<const Range>::type> (lslboost::begin(r), lslboost::end(r));
        }
    
    template <typename Range>
    lslboost::algorithm::boyer_moore<typename lslboost::range_iterator<Range>::type>
