...
#include <lslboost/algorithm/cxx11/is_permutation.hpp>
#include <lslboost/algorithm/cxx14/mismatch.hpp>
...
//  and ForwardIterator2::value_type could be different? Define my own comparison predicate?
    std::pair<ForwardIterator1, ForwardIterator2> eq = lslboost::algorithm::mismatch
