...
///       typename std::iterator_traits<typename lslboost::range_iterator<const Range>::type>::value_type lo,
///       typename std::iterator_traits<typename lslboost::range_iterator<const Range>::type>::value_type hi )
/// \return clamp the sequence of values [first, last) into [ lo, hi ]
/// 
