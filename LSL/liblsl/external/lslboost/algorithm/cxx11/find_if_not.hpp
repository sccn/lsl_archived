...
typename lslboost::range_iterator<const Range>::type find_if_not ( const Range &r, Predicate p )
{
    return lslboost::algorithm::find_if_not (lslboost::begin (r), lslboost::end(r), p);
}
