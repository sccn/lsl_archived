...
#include <lslboost/algorithm/cxx11/none_of.hpp>
...
bool one_of ( InputIterator first, InputIterator last, Predicate p )
{
    ...
    return lslboost::algorithm::none_of (++i, last, p);
}
...
{
    return lslboost::algorithm::one_of ( lslboost::begin (r), lslboost::end (r), p );
}
...
bool one_of_equal ( InputIterator first, InputIterator last, const V &val )
{
    ...
    if (i == last)
        return false;                    // Didn't occur at all
    return lslboost::algorithm::none_of_equal (++i, last, val);
}
...
{
    return lslboost::algorithm::one_of_equal ( lslboost::begin (r), lslboost::end (r), val );
} 
