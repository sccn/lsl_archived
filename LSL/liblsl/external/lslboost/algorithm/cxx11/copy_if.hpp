...
{
    return lslboost::algorithm::copy_if (lslboost::begin (r), lslboost::end(r), result, p);
}
...
///
template<typename Range, typename OutputIterator, typename Predicate>
std::pair<typename lslboost::range_iterator<const Range>::type, OutputIterator> 
copy_while ( const Range &r, OutputIterator result, Predicate p )
{
    return lslboost::algorithm::copy_while (lslboost::begin (r), lslboost::end(r), result, p);
}
...
{
    return lslboost::algorithm::copy_until (lslboost::begin (r), lslboost::end(r), result, p);
}
