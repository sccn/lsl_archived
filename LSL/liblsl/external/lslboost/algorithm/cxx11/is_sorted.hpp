...
//
//  See http://www.lslboost.org/ for latest version.
//
...
///
    ...
    ForwardIterator is_sorted_until ( ForwardIterator first, ForwardIterator last )
    {
        ...
        return lslboost::algorithm::is_sorted_until ( first, last, std::less_equal<value_type>());
    }
...
///
    ...
    {
        return lslboost::algorithm::is_sorted_until (first, last, p) == last;
    }
...
///
    ...
    {
        return lslboost::algorithm::is_sorted_until (first, last) == last;
    }
#endif
...
///
    ...
    typename lslboost::lazy_disable_if_c<
        lslboost::is_same<R, Pred>::value, 
        typename lslboost::range_iterator<const R> 
    >::type is_sorted_until ( const R &range, Pred p )
    {
        return lslboost::algorithm::is_sorted_until ( lslboost::begin ( range ), lslboost::end ( range ), p );
    }
...
///
    template <typename R>
    typename lslboost::range_iterator<const R>::type is_sorted_until ( const R &range )
    {
        return lslboost::algorithm::is_sorted_until ( lslboost::begin ( range ), lslboost::end ( range ));
    }
...
///
    template <typename R, typename Pred>
    typename lslboost::lazy_disable_if_c< lslboost::is_same<R, Pred>::value, lslboost::mpl::identity<bool> >::type
    is_sorted ( const R &range, Pred p )
    {
        return lslboost::algorithm::is_sorted ( lslboost::begin ( range ), lslboost::end ( range ), p );
    }
...
///
    ...
    {
        return lslboost::algorithm::is_sorted ( lslboost::begin ( range ), lslboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return lslboost::algorithm::is_sorted (first, last, std::less_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        return is_increasing ( lslboost::begin ( range ), lslboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return lslboost::algorithm::is_sorted (first, last, std::greater_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        return is_decreasing ( lslboost::begin ( range ), lslboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return lslboost::algorithm::is_sorted (first, last, std::less<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        return is_strictly_increasing ( lslboost::begin ( range ), lslboost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return lslboost::algorithm::is_sorted (first, last, std::greater<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        return is_strictly_decreasing ( lslboost::begin ( range ), lslboost::end ( range ));
    }
