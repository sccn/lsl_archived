...
#include <lslboost/tr1/tr1/tuple>      // for tie
...
//  2. Any common elements on the front have been removed (not necessary for correctness, just for performance)
    ...
    //  Skip the common prefix (if any)
        ...
        if ( first1 != last1 && first2 != last2 )
            return lslboost::algorithm::detail::is_permutation_inner ( first1, last1, first2, last2,
...
//  std::tie (first1, first2) = std::mismatch (first1, last1, first2, p);
    ...
    //  Create last2
        ...
        return lslboost::algorithm::detail::is_permutation_inner ( first1, last1, first2, last2, p );
        }
...
//  How should I deal with the idea that ForwardIterator1::value_type
//  and ForwardIterator2::value_type could be different? Define my own comparison predicate?
    return lslboost::algorithm::detail::is_permutation_tag (
...
{
    return lslboost::algorithm::is_permutation (lslboost::begin (r), lslboost::end (r), first2 );
}
...
typename lslboost::disable_if_c<lslboost::is_same<Range, ForwardIterator>::value, bool>::type
is_permutation ( const Range &r, ForwardIterator first2, BinaryPredicate pred )
{
    return lslboost::algorithm::is_permutation (lslboost::begin (r), lslboost::end (r), first2, pred );
}
