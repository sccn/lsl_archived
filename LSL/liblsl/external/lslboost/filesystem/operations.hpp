//  lslboost/filesystem/operations.hpp  ---------------------------------------------------//
...
#include <lslboost/detail/bitmask.hpp>
...
namespace lslboost
{
  namespace filesystem
  {
    ...
    {
      // see http://www.lslboost.org/more/error_handling.html for design rationale
...
# endif
  ...
  inline
  lslboost::uintmax_t file_size(const path& p, system::error_code& ec)
  ...
  inline
  lslboost::uintmax_t remove_all(const path& p, system::error_code& ec)
...
# endif
  ...
  const lslboost::filesystem::path&  path() const               {return m_path;}
