...
namespace lslboost { namespace filesystem {
...
namespace path_traits {
  ...
  template <class Container> inline
    ...
    typename lslboost::disable_if<lslboost::is_array<Container>, bool>::type
  ...
  template <class Container, class U> inline
    ...
    typename lslboost::disable_if<lslboost::is_array<Container>, void>::type
