...
#include <lslboost/archive/detail/iserializer.hpp>
#include <lslboost/archive/detail/interface_iarchive.hpp>
...
public:
    ...
    virtual void load(lslboost::long_long_type & t) = 0;
    virtual void load(lslboost::ulong_long_type & t) = 0;
    ...
    template<class T>
    void load_override(
        const lslboost::serialization::nvp< T > & t
    ){
        load_start(t.name());
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(lslboost::archive::polymorphic_iarchive)
