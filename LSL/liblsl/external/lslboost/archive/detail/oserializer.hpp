...
#include <lslboost/archive/detail/basic_oarchive.hpp>
...
public:
    ...
    virtual bool tracking(const unsigned int /* flags */) const {
        return lslboost::serialization::tracking_level< T >::value == lslboost::serialization::track_always
            || (lslboost::serialization::tracking_level< T >::value == lslboost::serialization::track_selectively
...
BOOST_DLLEXPORT void oserializer<Archive, T>::save_object_data(
    ...
    BOOST_STATIC_ASSERT(lslboost::is_const< T >::value == false);
...
BOOST_DLLEXPORT void pointer_oserializer<Archive, T>::save_object_ptr(
    ...
    const unsigned int file_version = lslboost::serialization::version< T >::value;
    Archive & ar_impl 
        = lslboost::serialization::smart_cast_reference<Archive &>(ar);
    lslboost::serialization::save_construct_data_adl<Archive, T>(
        ar_impl, 
        t, 
        file_version
    );
...
struct save_pointer_type {
    ...
    static const basic_pointer_oserializer * register_type(Archive &ar, T & /*t*/){
        ...
        typedef 
            BOOST_DEDUCED_TYPENAME mpl::eval_if<
                lslboost::serialization::is_abstract< T >,
    ...
    struct polymorphic
    {
        ...
        static void save(
            ...
            BOOST_DEDUCED_TYPENAME 
            lslboost::serialization::type_info_implementation< T >::type const
            & i = lslboost::serialization::singleton<
                BOOST_DEDUCED_TYPENAME 
                lslboost::serialization::type_info_implementation< T >::type
            >::get_const_instance();

            lslboost::serialization::extended_type_info const * const this_type = & i;
    ...
    static void invoke(Archive &ar, const TPtr t){
        ...
        if(NULL == t){
            basic_oarchive & boa 
                = lslboost::serialization::smart_cast_reference<basic_oarchive &>(ar);
...
struct save_array_type
{
    template<class T>
    static void invoke(Archive &ar, const T &t){
        typedef BOOST_DEDUCED_TYPENAME lslboost::remove_extent< T >::type value_type;
        ...
        lslboost::serialization::collection_size_type count(c);
