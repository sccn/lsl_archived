...
#include <lslboost/archive/detail/interface_oarchive.hpp>
...
public:
    ...
    virtual void save(const lslboost::long_long_type t) = 0;
    virtual void save(const lslboost::ulong_long_type t) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(lslboost::archive::polymorphic_oarchive)
