...
#include <lslboost/archive/iterators/wchar_from_mb.hpp>
#include <lslboost/archive/iterators/ostream_iterator.hpp>
#include <lslboost/archive/iterators/dataflow_exception.hpp>
...
void save_iterator(std::wostream &os, InputIterator begin, InputIterator end){
    ...
    std::copy(
        ...
        lslboost::archive::iterators::ostream_iterator<wchar_t>(os)
    );
}
    ...
    basic_xml_oarchive<Archive>(flags)
{
    ...
    if(0 == (flags & no_codecvt)){
        lslboost::archive::detail::utf8_codecvt_facet *pfacet;
        #if defined(__SGI_STL_PORT)
            static lslboost::archive::detail::utf8_codecvt_facet 
                facet(static_cast<size_t>(1));
            pfacet = & facet;
        #else
            pfacet = new lslboost::archive::detail::utf8_codecvt_facet;
        #endif
