...
#include <lslboost/archive/binary_oarchive_impl.hpp>
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(lslboost::archive::binary_oarchive)
BOOST_SERIALIZATION_USE_ARRAY_OPTIMIZATION(lslboost::archive::binary_oarchive)
