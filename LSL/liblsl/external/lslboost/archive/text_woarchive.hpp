...
#include <lslboost/archive/basic_text_oarchive.hpp>
...
protected:
    ...
    void save(const lslboost::serialization::item_version_type & t){
        save(static_cast<const unsigned int>(t));
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(lslboost::archive::text_woarchive)
