...
#include <lslboost/serialization/strong_typedef.hpp>
...
// by specifying friend class lslboost::serialization::access
...
// i.e. lslboost::serialization will be searched.
// 
