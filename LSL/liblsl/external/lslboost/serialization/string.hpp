...
BOOST_CLASS_IMPLEMENTATION(std::string, lslboost::serialization::primitive_type)
#ifndef BOOST_NO_STD_WSTRING
BOOST_CLASS_IMPLEMENTATION(std::wstring, lslboost::serialization::primitive_type)
#endif
...
inline void load(
    ...
    lslboost::serialization::stl::load_collection<
        ...
        lslboost::serialization::stl::archive_input_seq<
            ...
            std::basic_string<U, Allocator> 
        >,
        lslboost::serialization::stl::reserve_imp<
            std::basic_string<U, Allocator> 
        >
    >(ar, t);
}
