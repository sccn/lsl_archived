...
#include <lslboost/serialization/void_cast_fwd.hpp>
    ...
    private lslboost::noncopyable
{
    ...
    friend 
    BOOST_SERIALIZATION_DECL(void const *)  
    lslboost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            lslboost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            lslboost::serialization::smart_cast<const Base *, const Derived *>(
...
{
    typedef
        BOOST_DEDUCED_TYPENAME mpl::eval_if<lslboost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
