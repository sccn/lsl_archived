...
//  See http://www.lslboost.org/libs/serialization for updates, documentation, and revision history.
    ...
    typedef
        BOOST_DEDUCED_TYPENAME mpl::eval_if<
            BOOST_DEDUCED_TYPENAME mpl::or_<
                lslboost::is_same<void *, U>,
                lslboost::is_same<void *, T>,
                lslboost::is_same<const void *, U>,
                lslboost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        BOOST_DEDUCED_TYPENAME mpl::eval_if<lslboost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        BOOST_DEDUCED_TYPENAME mpl::eval_if<lslboost::is_reference<U>,
