...
//  4. VC6: class previously seen as struct (as in 'lslboost/mpl/print.hpp')
...
struct static_warning_test{
    typename lslboost::mpl::eval_if_c<
        B,
        lslboost::mpl::true_,
        typename lslboost::mpl::identity<
            lslboost::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef lslboost::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( lslboost::serialization::static_warning_test< B, L > ) \
