...
public:
    ...
    friend void lslboost::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    struct non_polymorphic {
        ...
        get_object_type(U & ){
            return & lslboost::serialization::singleton<
                typename 
                lslboost::serialization::type_info_implementation< U >::type
            >::get_const_instance();
        }
    };
    struct polymorphic {
...
public:
    ...
    void reset(SPT< T > & s, T * t){
        ...
        if(NULL == true_type)
            lslboost::serialization::throw_exception(
                lslboost::archive::archive_exception(
                    lslboost::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            lslboost::serialization::throw_exception(
                lslboost::archive::archive_exception(
                    lslboost::archive::archive_exception::unregistered_cast,
