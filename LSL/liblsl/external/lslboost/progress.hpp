//  lslboost progress.hpp header file  ------------------------------------------//

//  Copyright Beman Dawes 1994-99.  Distributed under the Boost
//  Software License, Version 1.0. (See accompanying file
//  LICENSE_1_0.txt or copy at http://www.lslboost.org/LICENSE_1_0.txt)

//  See http://www.lslboost.org/libs/timer for documentation.
...
//   6 Jul 99  Initial lslboost version

#ifndef BOOST_PROGRESS_HPP
#define BOOST_PROGRESS_HPP

#include <lslboost/timer.hpp>
#include <lslboost/utility.hpp>  // for noncopyable
#include <lslboost/cstdint.hpp>  // for uintmax_t
...
// NOTE: (Jan 12, 2001) Tried to change unsigned long to lslboost::uintmax_t, but
