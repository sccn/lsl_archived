...
#include <lslboost/property_tree/detail/json_parser_error.hpp>
#include <lslboost/spirit/include/classic.hpp>
...
namespace lslboost { namespace property_tree { namespace json_parser
{
    ...
    template<class Ptree>
    struct json_grammar :
        public lslboost::spirit::classic::grammar<json_grammar<Ptree> >
    {
        ...
        struct definition
        {
            ...
            lslboost::spirit::classic::rule<Scanner>
                root, object, member, array, item, value, string, number;
            lslboost::spirit::classic::rule<
                typename lslboost::spirit::classic::lexeme_scanner<Scanner>::type>
                character, escape;

            definition(const json_grammar &self)
            {

                using namespace lslboost::spirit::classic;
                // There's a lslboost::assertion too, so another explicit using
                // here:
                using lslboost::spirit::classic::assertion;
            ...
            const lslboost::spirit::classic::rule<Scanner> &start() const
            {
                return root;
            }
