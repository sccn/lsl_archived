...
#include <lslboost/property_tree/detail/json_parser/parser.hpp>
#include <lslboost/property_tree/detail/json_parser/narrow_encoding.hpp>
#include <lslboost/property_tree/detail/json_parser/wide_encoding.hpp>
#include <lslboost/property_tree/detail/json_parser/standard_callbacks.hpp>
    ...
    namespace json_parser { namespace detail
{
        ...
        Ptree &pt, const std::string &filename)
    {
        ...
        parser.set_input(filename,
            lslboost::make_iterator_range(iterator(stream), iterator()));
        parser.parse_value();
        parser.finish();
