...
#include <lslboost/property_tree/ptree_fwd.hpp>
#include <lslboost/property_tree/string_path.hpp>
#include <lslboost/property_tree/stream_translator.hpp>
#include <lslboost/property_tree/exceptions.hpp>
#include <lslboost/property_tree/detail/ptree_utils.hpp>

#include <lslboost/multi_index_container.hpp>
#include <lslboost/multi_index/indexed_by.hpp>
#include <lslboost/multi_index/sequenced_index.hpp>
#include <lslboost/multi_index/ordered_index.hpp>
...
namespace lslboost { namespace property_tree
{
    ...
    public:
        ...
        /** Equivalent to erase(lslboost::prior(end())). */
        void pop_back();
        ...
        /** Get the child at the given path, or return lslboost::null. */
        ...
        typename lslboost::enable_if<detail::is_translator<Translator>, Type>::type
         ...
         */
        template<class Type>
        typename lslboost::disable_if<detail::is_translator<Type>, Type>::type
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the supplied translator. Return lslboost::null if
         * this fails.
         */
        template<class Type, class Translator>
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the default translator. Return lslboost::null if
         * this fails.
         */
        template<class Type>
...
#include <lslboost/property_tree/detail/ptree_implementation.hpp>
