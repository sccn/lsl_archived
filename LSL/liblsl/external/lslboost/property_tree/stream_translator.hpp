...
#include <lslboost/optional/optional_io.hpp>
...
namespace lslboost { namespace property_tree
{
    ...
    namespace detail
    {
        ...
        struct is_inexact_impl<true>
        {
            ...
            struct test
            {
              typedef lslboost::integral_constant<bool,
        ...
        struct is_inexact
        {
            typedef typename lslboost::decay<F>::type decayed;
    ...
    struct customize_stream<Ch, Traits, F,
        typename lslboost::enable_if< detail::is_inexact<F> >::type
    >
    {
    ...
    public:
        ...
        lslboost::optional<E> get_value(const internal_type &v) {
            std::basic_istringstream<Ch, Traits, Alloc> iss(v);
            iss.imbue(m_loc);
            E e;
            customized::extract(iss, e);
            if(iss.fail() || iss.bad() || iss.get() != Traits::eof()) {
                return lslboost::optional<E>();
            }
            return e;
        }
        lslboost::optional<internal_type> put_value(const E &v) {
            ...
            return lslboost::optional<internal_type>();
        }
