...
namespace lslboost { namespace property_tree
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // lslboost::serialization support
     ...
     *       library's @c lslboost::property_tree::xml_parser::write_xml.
    ...
    namespace detail
    {
        ...
        inline void load_children(Archive &ar,
                                  basic_ptree<K, D, C> &t)
        {
            namespace bsl = lslboost::serialization;
            namespace bsa = lslboost::archive;
