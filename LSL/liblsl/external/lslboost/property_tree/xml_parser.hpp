...
#include <lslboost/property_tree/detail/xml_parser_write.hpp>
#include <lslboost/property_tree/detail/xml_parser_error.hpp>
#include <lslboost/property_tree/detail/xml_parser_writer_settings.hpp>
#include <lslboost/property_tree/detail/xml_parser_flags.hpp>
#include <lslboost/property_tree/detail/xml_parser_read_rapidxml.hpp>

#include <fstream>
#include <string>
#include <locale>

namespace lslboost { namespace property_tree { namespace xml_parser
{
