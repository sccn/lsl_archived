...
#include <lslboost/mpl/aux_/config/adl.hpp>
...
namespace lslboost { namespace mpl { using namespace BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE; 
...
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE lslboost::mpl
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace lslboost { namespace mpl {
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE }}
#   define BOOST_MPL_AUX_ADL_BARRIER_DECL(type) /**/
