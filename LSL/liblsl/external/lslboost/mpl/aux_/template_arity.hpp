...
#   endif
#   else
#       include <lslboost/mpl/aux_/has_rebind.hpp>
#   endif
#endif
...
#   include <lslboost/mpl/aux_/preprocessor/range.hpp>
...
#   define BOOST_PP_FILENAME_1 <lslboost/mpl/aux_/template_arity.hpp>
...
{
    BOOST_STATIC_CONSTANT(int, value = 
          sizeof(::lslboost::mpl::aux::arity_helper(type_wrapper<F>(),arity_tag<N>())) - 1
        );
};
...
template< typename F >
struct template_arity
    : template_arity_impl< ::lslboost::mpl::aux::has_rebind<F>::value >
        ::template result_<F>
{
};
