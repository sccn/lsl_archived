...
#   include <lslboost/mpl/aux_/na_fwd.hpp>
...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::lslboost::mpl::aux::yes_tag operator|( \
      ::lslboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::lslboost::mpl::aux::no_tag operator|( \
      ::lslboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::lslboost::mpl::na) >* \
    ); \
/**/
...
::lslboost::mpl::aux::yes_tag operator|( \
      ::lslboost::mpl::aux::has_rebind_tag<int> \
    , ::lslboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
