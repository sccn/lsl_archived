...
#   include <lslboost/mpl/bind_fwd.hpp>
...
#   include <lslboost/mpl/aux_/arity_spec.hpp>
...
#include <lslboost/mpl/aux_/config/bind.hpp>
...
#   include <lslboost/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <lslboost/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <lslboost/mpl/aux_/preprocessor/ext_params.hpp>
#   include <lslboost/mpl/aux_/preprocessor/repeat.hpp>
#   include <lslboost/mpl/aux_/preprocessor/enum.hpp>
#   include <lslboost/mpl/aux_/preprocessor/add.hpp>
#   include <lslboost/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
...
template< typename T > struct is_bind_template
    : is_bind_template_impl< ::lslboost::detail::is_reference_impl<T>::value >
        ::template result_<T>
{
};
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <lslboost/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <lslboost/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <lslboost/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
