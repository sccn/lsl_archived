...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        streamName = new QLineEdit(groupBox);
        streamName->setObjectName(QString::fromUtf8("streamName"));

        formLayout->setWidget(2, QFormLayout::FieldRole, streamName);
        ...
        menuBar->setGeometry(QRect(0, 0, 206, 18));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Cognionics Connector", 0, QApplication::UnicodeUTF8));
