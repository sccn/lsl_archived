...
public:
	...
	void getCameraInfo(std::string deviceName, std::vector<wmfCameraInfo>& cameraInfo, t_cameraSettings& cameraSettings);

private:
	
	// helper functions to pare the camera options
	void parseCameraOptions(std::vector<wmfCameraInfo>& cameraInfo, t_cameraSettings& cameraSettings);
	// wmf stuff
