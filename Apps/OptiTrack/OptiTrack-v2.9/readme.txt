...
The OptiTrack connector is currently untested but should in principle run out of the box without further dependencies. To operate it, an OptiTrack server program (e.g. Arena) must be running and streaming data.
...
We have found that this recorder does not seem to work with Arena older than 2.0 -- please use the OptiTrack-v1.4 connector in this case.
