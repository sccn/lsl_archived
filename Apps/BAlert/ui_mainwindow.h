...
**
** Created: Sun Jul 29 23:47:28 2012
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        useFilter = new QCheckBox(centralWidget);
        useFilter->setObjectName(QString::fromUtf8("useFilter"));
        useFilter->setChecked(true);

        verticalLayout->addWidget(useFilter);
        ...
        menuBar->setGeometry(QRect(0, 0, 188, 18));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        useFilter->setText(QApplication::translate("MainWindow", "Use Filter", 0, QApplication::UnicodeUTF8));
